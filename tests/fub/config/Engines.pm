...
#
#
# fub-config file that specifies all engines known to FUB applications
#
...
# This list contains all engines that fub-config is aware of.
#
# IMPORTANT: New source files must be added to both Engines.pm and Sources.def.
#

# fub-config does not lwrrently manage any engines yet, so this list has a temporary member below.
my $enginesRef = [
    FUB =>
    {
        DESCRIPTION         => "FUB - Fuse Update Binary Engine",

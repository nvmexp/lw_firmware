 ...
 */
#ifndef _PASCAL_BL_REMAPPER_H
#define _PASCAL_BL_REMAPPER_H

#include "mdiag/tests/gpu/host/bl_remapper.h"
#include "core/include/refparse.h"

class PascalBlockLinearRemapperTest: virtual public BlockLinearRemapperTest
{
public:
    ...
    PascalBlockLinearRemapperTest(bl_remapperTest& parent, ArgReader *params);

    //! Set's up one host block linear remapper register
    //!
    //! \param remapper Remapper to setup, Pascal has 0-7

 ...
 */
#ifndef _KEPLER_BL_REMAPPER_H
#define _KEPLER_BL_REMAPPER_H

#include "mdiag/tests/gpu/host/bl_remapper.h"
#include "core/include/refparse.h"

class KeplerBlockLinearRemapperTest: virtual public BlockLinearRemapperTest
{
public:
    ...
    KeplerBlockLinearRemapperTest(bl_remapperTest& parent, ArgReader *params);

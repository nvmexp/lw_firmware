 ...
 */
#ifndef _L1_SUBSTATE_H_
#define _L1_SUBSTATE_H_
...
class L1_substate : public LWGpuSingleChannelTest {
public:
    L1_substate(ArgReader *params);

    virtual ~L1_substate(void);
...
CREATE_TEST_LIST_ENTRY(L1_substate, L1_substate, "GPU L1 substate Test");
#undef TEST_LIST_HEAD
#define TEST_LIST_HEAD &L1_substate_testentry
#endif

#endif  // _L1_SUBSTATE_H_

...
#include "sysmembar_l2_l2b_no_p2p.h"
...
extern const ParamDecl sysmembar_l2_l2b_no_p2p_params[] = {
...
sysmembar_l2_l2b_no_p2pTest::sysmembar_l2_l2b_no_p2pTest(ArgReader *reader) :
...
sysmembar_l2_l2b_no_p2pTest::~sysmembar_l2_l2b_no_p2pTest(void)
{
    delete surfaceBuffer;
}

STD_TEST_FACTORY(sysmembar_l2_l2b_no_p2p, sysmembar_l2_l2b_no_p2pTest)

// a little extra setup to be done
int sysmembar_l2_l2b_no_p2pTest::Setup(void)
{
    //_DMA_TARGET target;
    local_status = 1;

    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::Setup() starts\n");
    ...
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::Setup() creating class objects\n");
    ...
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::Setup() will create a destination DMA buffer with size of %08x bytes\n",surfaceSize);
    ...
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::Setup() class object created\n");
    ...
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::Init() will create a source DMA buffer with size of %08x bytes\n",surfaceSize);
    ...
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::Setup() done succesfully\n");
    return(1);
}

// a little extra cleanup to be done
void sysmembar_l2_l2b_no_p2pTest::CleanUp(void)
{
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::CleanUp() starts\n");
    ...
    DebugPrintf("sysmembar_l2_l2b_no_p2pTest::CleanUp() done\n");
}

// the real test
void sysmembar_l2_l2b_no_p2pTest::Run(void)
{

    SetStatus(Test::TEST_INCOMPLETE);

    InfoPrintf("sysmembar_l2_l2b_no_p2pTest::Run() starts\n");
    ...
    ch->WaitForIdle();
    InfoPrintf("Done with sysmembar_l2_l2b_no_p2p test\n");
...
void sysmembar_l2_l2b_no_p2pTest::WriteSrc(void)
{
    UINT32 *data = (UINT32 *)surfaceBuffer;

    InfoPrintf("sysmembar_l2_l2b_no_p2pTest::WriteSrc() - writing out src surface\n");
...
int sysmembar_l2_l2b_no_p2pTest::ReadDst(void)
{
    UINT32 value;
    int rtnStatus = 1;

    // read back the dst surface and compare it with the original
    InfoPrintf("sysmembar_l2_l2b_no_p2pTest::ReadDst() - reading back dst surface\n");
...
void sysmembar_l2_l2b_no_p2pTest::EnableBackdoor(void)
{
...
void sysmembar_l2_l2b_no_p2pTest::DisableBackdoor(void)
{
    // Turn off backdoor accesses
    if(Platform::GetSimulationMode() != Platform::Hardware)
    {
...
int sysmembar_l2_l2b_no_p2pTest::setup_copy1(void)
{
...
int sysmembar_l2_l2b_no_p2pTest::setup_copy2(void)
{
    // Set up the src offset
    int local_status = 1;
    UINT32 methodData[4];

...
#ifndef _SYSMEMBAR_L2L2B_H
#define _SYSMEMBAR_L2L2B_H
...
class sysmembar_l2_l2bTest : public LWGpuSingleChannelTest
{
public:
    sysmembar_l2_l2bTest(ArgReader *params);

    virtual ~sysmembar_l2_l2bTest(void);
...
CREATE_TEST_LIST_ENTRY(sysmembar_l2_l2b, sysmembar_l2_l2bTest, "Verifies gart by accessing AGP memory through the aperture from CPU and GPU + direct access to sysmem");
#undef TEST_LIST_HEAD
#define TEST_LIST_HEAD &sysmembar_l2_l2b_testentry
#endif

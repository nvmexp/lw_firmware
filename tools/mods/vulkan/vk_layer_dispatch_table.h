...
typedef struct VkLayerInstanceDispatchTable_ {
    ...
    // ---- VK_LW_external_memory_capabilities extension commands
    PFN_vkGetPhysicalDeviceExternalImageFormatPropertiesLW GetPhysicalDeviceExternalImageFormatPropertiesLW;
    ...
    // ---- VK_LW_cooperative_matrix extension commands
    PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesLW GetPhysicalDeviceCooperativeMatrixPropertiesLW;
...
typedef struct VkLayerDispatchTable_ {
    ...
    PFN_vkIlwalidateMappedMemoryRanges IlwalidateMappedMemoryRanges;
    ...
    PFN_vkCmdExelwteCommands CmdExelwteCommands;
    ...
    PFN_vkCreateSamplerYcbcrColwersion CreateSamplerYcbcrColwersion;
    PFN_vkDestroySamplerYcbcrColwersion DestroySamplerYcbcrColwersion;
    ...
    // ---- VK_KHR_sampler_ycbcr_colwersion extension commands
    PFN_vkCreateSamplerYcbcrColwersionKHR CreateSamplerYcbcrColwersionKHR;
    PFN_vkDestroySamplerYcbcrColwersionKHR DestroySamplerYcbcrColwersionKHR;
    ...
    // ---- VK_LWX_image_view_handle extension commands
    PFN_vkGetImageViewHandleLWX GetImageViewHandleLWX;
    ...
    // ---- VK_LW_external_memory_win32 extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    PFN_vkGetMemoryWin32HandleLW GetMemoryWin32HandleLW;
#endif // VK_USE_PLATFORM_WIN32_KHR
    ...
    // ---- VK_LW_clip_space_w_scaling extension commands
    PFN_vkCmdSetViewportWScalingLW CmdSetViewportWScalingLW;
    ...
    // ---- VK_LW_shading_rate_image extension commands
    PFN_vkCmdBindShadingRateImageLW CmdBindShadingRateImageLW;
    PFN_vkCmdSetViewportShadingRatePaletteLW CmdSetViewportShadingRatePaletteLW;
    PFN_vkCmdSetCoarseSampleOrderLW CmdSetCoarseSampleOrderLW;
    ...
    // ---- VK_LW_mesh_shader extension commands
    PFN_vkCmdDrawMeshTasksLW CmdDrawMeshTasksLW;
    PFN_vkCmdDrawMeshTasksIndirectLW CmdDrawMeshTasksIndirectLW;
    PFN_vkCmdDrawMeshTasksIndirectCountLW CmdDrawMeshTasksIndirectCountLW;

    // ---- VK_LW_scissor_exclusive extension commands
    PFN_vkCmdSetExclusiveScissorLW CmdSetExclusiveScissorLW;

    // ---- VK_LW_device_diagnostic_checkpoints extension commands
    PFN_vkCmdSetCheckpointLW CmdSetCheckpointLW;
    PFN_vkGetQueueCheckpointDataLW GetQueueCheckpointDataLW;

...
#    diag/mods/gpu/js/pvsstatexp.js. This is best done with
...
if len(sys.argv) > 3 or len(sys.argv) < 2:
    ...
    Usage: python %s path/to/stat/logs/ where/to/output/EV/file.js
           python %s path/to/stat/logs/ 

    (Second form defaults to ./exp.js)
...
#Grab filepaths
srcdir = sys.argv[1]
dest = sys.argv[2] if len(sys.argv) == 3 else "exp.js"
...
with open(dest, 'wt') as f:
    ...
    jsonstring = "var TestEVs = " + json.dumps(stats, sort_keys = True, indent=4)
    f.write(jsonstring)

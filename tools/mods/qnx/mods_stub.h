...
* Any use, reproduction, or disclosure without the
* written permission of LWPU Corporation is prohibited.
*
* LWIDIA_COPYRIGHT_END
*/

#ifndef _MODS_STUB_H_
#define _MODS_STUB_H_

// Equivalent mods.h file for QNX since we don't compile the linux kernel driver
// for QNX. This ensures that the MODS userspace code which calls into the linux
// kernel driver compiles correctly on QNX as well. Define the necessary
// enums and structs to ensure MODS code can compile for QNX.
...
#define MODS_ILWALIDATE_CPU_CACHE 2
...
struct MODS_TEGRA_DC_WINDOW {
	...
	__u32 out_w;
	__u32 out_h;
	__u32 pixformat; /* LWDC pix format */
...
/* MODS_ESC_SET_LWLINK_SYSMEM_TRAINED */
struct MODS_SET_LWLINK_SYSMEM_TRAINED {
	/* IN */
	struct mods_pci_dev_2 pci_device;
	__u8		      trained;
};

/* MODS_ESC_GET_LWLINK_LINE_RATE */
struct MODS_GET_LWLINK_LINE_RATE {
	/* IN */
	struct mods_pci_dev_2 pci_device;
	__s32		      npu_index;
...
#define MODS_ESC_GET_ATS_ADDRESS_RANGE        \
		   ...
		   struct MODS_GET_ATS_ADDRESS_RANGE)
#define MODS_ESC_SET_LWLINK_SYSMEM_TRAINED			\
		   _IOW(MODS_IOC_MAGIC, 102,		\
		   struct MODS_SET_LWLINK_SYSMEM_TRAINED)
#define MODS_ESC_GET_LWLINK_LINE_RATE			\

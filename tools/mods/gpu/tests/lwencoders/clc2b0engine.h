...
public:
    ...
    ClC2B0Engine() = delete;
    ClC2B0Engine(Channel *lwCh, LwRm::Handle hLwdec, Memory::Location semLoc, bool useFESem,
                 Tee::Priority printPri);

    ClC2B0Engine(const ClC2B0Engine &);
...
private:
    ...
    enum ApplicationId
    {
        APPLICATION_ID_MPEG12       = LWC2B0_SET_APPLICATION_ID_ID_MPEG12,
        APPLICATION_ID_VC1          = LWC2B0_SET_APPLICATION_ID_ID_VC1,
        APPLICATION_ID_H264         = LWC2B0_SET_APPLICATION_ID_ID_H264,
        APPLICATION_ID_MPEG4        = LWC2B0_SET_APPLICATION_ID_ID_MPEG4,
        APPLICATION_ID_VP8          = LWC2B0_SET_APPLICATION_ID_ID_VP8,
        APPLICATION_ID_CTR64        = LWC2B0_SET_APPLICATION_ID_ID_CTR64,
        APPLICATION_ID_HEVC         = LWC2B0_SET_APPLICATION_ID_ID_HEVC,
        APPLICATION_ID_VP9          = LWC2B0_SET_APPLICATION_ID_ID_VP9,
        APPLICATION_ID_HEVC_PARSER  = LWC2B0_SET_APPLICATION_ID_ID_HEVC_PARSER
    };
    ...
    enum CodecType
    {
        CODEC_TYPE_MPEG1 = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG1,
        CODEC_TYPE_MPEG2 = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG2,
        CODEC_TYPE_VC1   = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_VC1,
        CODEC_TYPE_H264  = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_H264,
        CODEC_TYPE_MPEG4 = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG4,
        CODEC_TYPE_DIVX3 = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_DIVX3,
        CODEC_TYPE_VP8   = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_VP8,
        CODEC_TYPE_HEVC  = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_HEVC,
        CODEC_TYPE_VP9   = LWC2B0_SET_CONTROL_PARAMS_CODEC_TYPE_VP9
    };
    ...
    typedef boost::optional<NotifySemaphore> OptionalSem;
    const bool                    m_useFESem;
    OptionalSem                   m_semaphore;

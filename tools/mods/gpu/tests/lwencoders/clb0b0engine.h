...
public:
    ...
    ClB0B0Engine() = delete;
    ClB0B0Engine(Channel *lwCh, LwRm::Handle hLwdec, Tee::Priority printPri);
...
private:
    ...
    enum ApplicationId
    {
        APPLICATION_ID_MPEG12       = LWB0B0_SET_APPLICATION_ID_ID_MPEG12,
        APPLICATION_ID_VC1          = LWB0B0_SET_APPLICATION_ID_ID_VC1,
        APPLICATION_ID_H264         = LWB0B0_SET_APPLICATION_ID_ID_H264,
        APPLICATION_ID_MPEG4        = LWB0B0_SET_APPLICATION_ID_ID_MPEG4,
        APPLICATION_ID_VP8          = LWB0B0_SET_APPLICATION_ID_ID_VP8,
        APPLICATION_ID_CTR64        = LWB0B0_SET_APPLICATION_ID_ID_CTR64,
    };
    ...
    enum CodecType
    {
        CODEC_TYPE_MPEG1 = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG1,
        CODEC_TYPE_MPEG2 = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG2,
        CODEC_TYPE_VC1   = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_VC1,
        CODEC_TYPE_H264  = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_H264,
        CODEC_TYPE_MPEG4 = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG4,
        CODEC_TYPE_DIVX3 = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_DIVX3,
        CODEC_TYPE_VP8   = LWB0B0_SET_CONTROL_PARAMS_CODEC_TYPE_VP8
    };

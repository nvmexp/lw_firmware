...
public:
    ...
    ClC0B0SocEngine() = delete;
    ClC0B0SocEngine(Channel *lwCh, Tee::Priority printPri);
...
private:
    ...
    enum ApplicationId
    {
        APPLICATION_ID_MPEG12       = LWC0B0_SET_APPLICATION_ID_ID_MPEG12,
        APPLICATION_ID_VC1          = LWC0B0_SET_APPLICATION_ID_ID_VC1,
        APPLICATION_ID_H264         = LWC0B0_SET_APPLICATION_ID_ID_H264,
        APPLICATION_ID_MPEG4        = LWC0B0_SET_APPLICATION_ID_ID_MPEG4,
        APPLICATION_ID_VP8          = LWC0B0_SET_APPLICATION_ID_ID_VP8,
        APPLICATION_ID_CTR64        = LWC0B0_SET_APPLICATION_ID_ID_CTR64,
        APPLICATION_ID_HEVC         = LWC0B0_SET_APPLICATION_ID_ID_HEVC,
        APPLICATION_ID_VP9          = LWC0B0_SET_APPLICATION_ID_ID_VP9,
        APPLICATION_ID_PASS1        = LWC0B0_SET_APPLICATION_ID_ID_PASS1
    };
    ...
    enum CodecType
    {
        CODEC_TYPE_MPEG1 = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG1,
        CODEC_TYPE_MPEG2 = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG2,
        CODEC_TYPE_VC1   = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_VC1,
        CODEC_TYPE_H264  = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_H264,
        CODEC_TYPE_MPEG4 = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_MPEG4,
        CODEC_TYPE_DIVX3 = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_DIVX3,
        CODEC_TYPE_VP8   = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_VP8,
        CODEC_TYPE_HEVC  = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_HEVC,
        CODEC_TYPE_VP9   = LWC0B0_SET_CONTROL_PARAMS_CODEC_TYPE_VP9
    };

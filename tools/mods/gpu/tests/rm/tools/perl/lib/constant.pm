...
my %forced_into_main = map +($_, 1),
    qw{ STDIN STDOUT STDERR ARGV ARGVOUT ELW INC SIG };
...
scalar context as one might expect.  They lwrrently return the number
...
ELW INC SIG> is not allowed anywhere but in package C<main::>, for
technical reasons. 
...
The CPAN distribution is maintained by SE<ealwte>bastien Aperghis-Tramoni

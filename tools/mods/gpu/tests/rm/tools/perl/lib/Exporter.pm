...
sub import {
  ...
  # shortlwt for the common case of no type character
...
C<use> statement for a module. Modules and C<use> are dolwmented
...
oclwrs. The advanced export features of Exporter are accessed like this,
...
The Exporter module will colwert an attempt to import a number from a
...
This may happen for instance with mutually relwrsive
modules, which are affected by the time the relevant
constructions are exelwted.

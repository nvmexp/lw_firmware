...
$yr += 1900;
my $logdir = "/home/vyadav/fmodUpdateLog/r185_00/log_".$yr.$month.$dayofm.$$hr.$min.$sec;
# Create Directory
...
my $validatefmodellog = "$logdir"."\/r185_00.log";
my $fmodelList = $ELW{HOME}."/.fmodelAttemptedR185_00";
...
my %netlists = (
   "gt212" => "//sw/rel/gpu_drv/r185/r185_00/drivers/resman/kernel/inc/gt212/net/netlists.h",
   "gt215" => "//sw/rel/gpu_drv/r185/r185_00/drivers/resman/kernel/inc/gt215/net/netlists.h",
   "gt216" => "//sw/rel/gpu_drv/r185/r185_00/drivers/resman/kernel/inc/gt216/net/netlists.h",
   "gt218" => "//sw/rel/gpu_drv/r185/r185_00/drivers/resman/kernel/inc/gt218/net/netlists.h",
#   "igt21a" => "//sw/rel/gpu_drv/r185/r185_00/drivers/resman/kernel/inc/igt21a/net/netlists.h",
#   "gf100" => "//sw/rel/gpu_drv/r185/r185_00/drivers/resman/kernel/inc/fermi/gf100/net/netlists.h"
);
...
sub syncChipsa {
    ...
    my @p4synclog = `$p4spec sync -f $ELW{P4ROOT}/sw/rel/gpu_drv/r185/r185_00/...\@$lastSubTotSwCl 2>&1`;
#    my @p4synclog = `$p4spec sync $ELW{P4ROOT}/sw/rel/gpu_drv/r185/r185_00/...\@$lastSubTotSwCl 2>&1`;
...
#
sub mailStatus {
    my $email_status = "mail -s \"[R185_00]Status of RMTESTS on TOT sync with latest regsys fmodels \" sw-rmtest\@lwpu.com < $emailLog" ;
...
#   }
    ...
    print MAIL "Summary of RMTESTS Run On R185_00 branch at Changelist $lastSubTotSwCl :\n";
    print MAIL "+-------+----------------------------------------------------+\n";

...
$yr += 1900;
my $logdir = "/home/vyadav/fmodUpdateLog/chips_a/log_".$yr.$month.$dayofm.$$hr.$min.$sec;
# Create Directory
...
my $validatefmodellog = "$logdir"."\/chipsa.log";
my $fmodelList = $ELW{HOME}."/.fmodelAttemptedChips_a";
my $changelistfile = "changelist.txt";
my $statusfile = "$logdir"."\/report.log";
my $emailLog = "$logdir"."\/email.log";
my $debug = 1;
my $dofast = 0;
my @hasBugArray = (622825, # "libgflit1_pwr_falcon.so" symlink issue
                   0);
...
#   "gf100" => "/home/scratch.regress04/linux50/fermi1_gf100",
   ...
   "gf118" => "/home/scratch.autobuild1/packages/Linux/fermi1_gf11x",
);
...
my %fmodlocation =  (
#   "gt212" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gt212",
#   "gt215" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gt215",
#   "gt216" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gt216",
#   "gt218" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gt218",
   "igt21a" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/igt21a",
#   "gf100" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gf100",
   "gf104" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gf104",
   "gf106" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gf106",
   "gf108" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gf108",
   "gf118" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forChipsa/gf118",
);
...
#   "gf100" => "//sw/dev/gpu_drv/chips_a/drivers/resman/kernel/inc/fermi/gf100/net/netlists.h",
   "gf104" => "//sw/dev/gpu_drv/chips_a/drivers/resman/kernel/inc/fermi/gf104/net/netlists.h",
   "gf106" => "//sw/dev/gpu_drv/chips_a/drivers/resman/kernel/inc/fermi/gf106/net/netlists.h",
   "gf108" => "//sw/dev/gpu_drv/chips_a/drivers/resman/kernel/inc/fermi/gf108/net/netlists.h",
   "gf118" => "//sw/dev/gpu_drv/chips_a/drivers/resman/kernel/inc/fermi/gf118/net/netlists.h",
);
...
sub syncChipsa {
    ...
    my @p4synclog;
	if ( ! $dofast ) {
        @p4synclog = `$p4spec sync -f $ELW{P4ROOT}/sw/dev/gpu_drv/chips_a/... $ELW{P4ROOT}/sw/mods/...\@$lastSubTotSwCl 2>&1`;
    } else {
...
#    print @Info;
    ...
    print LOG "\n$as2spec -r submit -c $newClNetlist 2>&1\n";
    my @bundleInfo = system("$as2spec -r submit -c $newClNetlist 2>&1");
...
#
sub mailStatus {
    my $email_status = "mail -s \"[chips_a]Status of RMTESTS on TOT sync with latest regsys fmodels \" sw-gpu-rm-autofmodupdate-notify\@lwpu.com < $emailLog" ;

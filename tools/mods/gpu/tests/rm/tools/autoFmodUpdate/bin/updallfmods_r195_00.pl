...
$yr += 1900;
my $logdir = "/home/vyadav/fmodUpdateLog/r195_00/log_".$yr.$month.$dayofm.$$hr.$min.$sec;
# Create Directory
...
my $validatefmodellog = "$logdir"."\/r195_00.log";
my $fmodelList = $ELW{HOME}."/.fmodelAttemptedR195_00";
...
my %fmodlocation =  (
#   "gt212" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gt212",
#   "gt215" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gt215",
#   "gt216" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gt216",
#   "gt218" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gt218",
   "igt21a" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/igt21a",
#   "gf100" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gf100",
   "gf104" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gf104",
   "gf106" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gf106",
   "gf108" => "/home/scratch.vyadav_fermi-arch/autoFmodUpdate/fmodels/forR195_00/gf108",
);

my %netlists = (
#   "gt212" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/gt212/net/netlists.h",
#   "gt215" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/gt215/net/netlists.h",
#   "gt216" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/gt216/net/netlists.h",
#   "gt218" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/gt218/net/netlists.h",
   "igt21a" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/igt21a/net/netlists.h",
#   "gf100" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/fermi/gf100/net/netlists.h"
   "gf104" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/fermi/gf104/net/netlists.h",
   "gf106" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/fermi/gf106/net/netlists.h",
   "gf108" => "//sw/rel/gpu_drv/r195/r195_00/drivers/resman/kernel/inc/fermi/gf108/net/netlists.h",
);
...
sub syncChipsa {
    ...
    my @p4synclog;
	if ( ! $dofast ) {
        @p4synclog = `$p4spec sync -f $ELW{P4ROOT}/sw/rel/gpu_drv/r195/r195_00/... $ELW{P4ROOT}/sw/mods/...\@$lastSubTotSwCl 2>&1`;
    } else {
        @p4synclog = `$p4spec sync $ELW{P4ROOT}/sw/rel/gpu_drv/r195/r195_00/... $ELW{P4ROOT}/sw/mods/...\@$lastSubTotSwCl 2>&1`;
    }
...
#    my @bundleInfo = "Avoiding submission to p4\n";
...
#
sub mailStatus {
    my $email_status = "mail -s \"[R195_00]Status of RMTESTS on TOT sync with latest regsys fmodels \" sw-gpu-rm-autofmodupdate-notify\@exchange.lwpu.com < $emailLog" ;
...
#   }
    ...
    print MAIL "Summary of RMTESTS Run On R195_00 branch at Changelist $lastSubTotSwCl :\n";
    print MAIL "+-------+----------------------------------------------------+\n";

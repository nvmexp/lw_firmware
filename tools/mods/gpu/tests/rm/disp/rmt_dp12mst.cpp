...
class DP12MstTest : public RmTest
{
public:
    DP12MstTest();
    virtual ~DP12MstTest();
...
//!         false otherwise
//------------------------------------------------------------------------------
string DP12MstTest::IsTestSupported()
{
...
RC DP12MstTest::MSTAllocation()
{
    ...
    CHECK_RC(m_pDisplay->EnumAllocAndGetDPDisplays(dpConnectors[0], &m_pDpConnector, &displayIDs, m_branchDevice));
...
RC DP12MstTest::VerifyImage(DisplayID displayID, LwU32 width, LwU32 height, LwU32 depth, LwU32 refreshRate, Surface2D* CoreImage)
{
    RC rc;
...
//------------------------------------------------------------------------------
JS_CLASS_INHERIT(DP12MstTest, RmTest, "DP1.2 Lane count & Bandwidth change test \n");
CLASS_PROP_READWRITE(DP12MstTest,branchDevice,bool,
                     "Actual Branch Device present default = 0");
CLASS_PROP_READWRITE(DP12MstTest,manualVerif,bool,

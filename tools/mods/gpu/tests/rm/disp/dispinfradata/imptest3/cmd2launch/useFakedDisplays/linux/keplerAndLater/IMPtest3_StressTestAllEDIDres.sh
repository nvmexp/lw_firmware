#!/bin/sh
#=======================================================
# IMPTest3 cmdline for Linux to stress test all edid modes
# useFakedDisplays\linux\keplerAndLater\IMPtest3_StressTestAllEDIDres.sh
#=======================================================
...
imptest3_rmtest_cmd=" -forcetestname Modeset -no_pstate_lock_at_init -ignoreClockDiffError -freqTolerance100x 2 -forceLargeCursor -enableMSCGTest -protocol DP -useDFPFakeEdid HDMI_LG_3D_TV_4k_2k.txt  -inputconfigfile $imptest3_config_file "

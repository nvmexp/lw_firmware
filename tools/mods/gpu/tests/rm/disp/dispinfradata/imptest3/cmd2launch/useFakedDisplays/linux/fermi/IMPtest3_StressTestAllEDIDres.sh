...
# onlyConnectedDisplays\linux\fermi\IMPtest3_StressTestAllEDIDres.sh
#=======================================================
...
imptest3_rmtest_cmd=" -forcetestname Modeset -no_pstate_lock_at_init -ignoreClockDiffError -freqTolerance100x 2 -forceLargeCursor -protocol DP -useDFPFakeEdid HDMI_LG_3D_TV_4k_2k.txt  -inputconfigfile $imptest3_config_file"

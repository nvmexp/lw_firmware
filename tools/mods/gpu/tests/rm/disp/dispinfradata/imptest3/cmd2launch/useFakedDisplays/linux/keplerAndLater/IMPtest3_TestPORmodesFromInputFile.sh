...
imptest3_rmtest_cmd=" -forcetestname Modeset -no_pstate_lock_at_init -ignoreClockDiffError -freqTolerance100x 2 -forceLargeCursor -enableMSCGTest -protocol DP -autoGenerateEdid -runfrominputfile -inputconfigfile $imptest3_config_file "

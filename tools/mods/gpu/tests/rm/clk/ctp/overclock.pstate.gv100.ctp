...
sys2clk.freq = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

name=hub2clk.OverClock.P0
hub2clk.freq = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

name=legclk.OverClock.P0
legclk.freq  = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

name=gpc2clk.OverClock.P0
gpc2clk.freq = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

name=ltc2clk.OverClock.P0
ltc2clk.freq = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

name=mclk.OverClock.P0
mclk.freq    = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

# msdclk == lwdclk due to aliasing inside the RMAPI.
name=msdclk.OverClock.P0
msdclk.freq  = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

name=xbar2clk.OverClock.P0
xbar2clk.freq = +5%:-FORCE_BYPASS,1630MHz:-FORCE_BYPASS

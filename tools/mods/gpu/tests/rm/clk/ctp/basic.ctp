...
# Trial Specification
# Run on the bypass path at half-speed bypass of P0 and P8
# the run at full speed P0.
# For a sanity test, once in each is sufficient.
name        = BasicSanityTest
test        = vbiosp0:BasicSanity.HalfFreqBypass, vbiosp8:BasicSanity.HalfFreqBypass, vbiosp0, vbiosp0:BasicSanity.FullFreqPLL
tolerance   = 0.15, 0.25
rmapi       = clk
order       = sequence
prune       = auto

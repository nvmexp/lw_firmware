...
test        = initPstate:BasicSanity.dispclk, initPstate:BasicSanity.gpc2clk, initPstate:BasicSanity.xbar2clk, initPstate:BasicSanity.ltc2clk, initPstate:BasicSanity.other
tolerance   = 0.05, 0.10
rmapi       = clk
order       = sequence
prune       = auto

# Emulation SDDR3 MClkSwitchTest
...
# create a file named as mclk.trial.sddr3[.<platform>][.<family>].ctp
...
# For example: mclk.trial.sddr3.emu.ctp or mclk.trial.sddr3.gm10x.ctp or mclk.trial.sddr3.emu.maxwell.ctp

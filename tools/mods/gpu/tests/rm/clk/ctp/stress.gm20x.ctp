...
gpc2clk.freq = 162MHz:+FORCE_BYPASS:-FORCE_PLL, 324MHz:+FORCE_BYPASS:-FORCE_PLL, 900MHz:-FORCE_BYPASS:+FORCE_PLL, 2.8GHz:-FORCE_BYPASS:+FORCE_PLL
xbar2clk.freq = 162MHz:+FORCE_BYPASS:-FORCE_PLL, 324MHz:+FORCE_BYPASS:-FORCE_PLL, 900MHz:-FORCE_BYPASS:+FORCE_PLL
ltc2clk.freq = 162MHz:+FORCE_BYPASS:-FORCE_PLL, 324MHz:+FORCE_BYPASS:-FORCE_PLL, 900MHz:-FORCE_BYPASS:+FORCE_PLL
...
name       = StressTest
test       = vbiosp0:defaults:sys2clk:hub2clk, vbiosp8:defaults:sys2clk:hub2clk
rmapi      = clocks
order      = random
end        = 1000
tolerance  = 0.05, 0.05

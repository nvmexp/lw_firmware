...
sys2clk.freq = 1630MHz:-FORCE_BYPASS:+FORCE_PLL

name=hub2clk.OverClock.P0
hub2clk.freq = 1630MHz

name=gpc2clk.OverClock.P0
gpc2clk.freq = 1630MHz:-FORCE_BYPASS:+FORCE_PLL

name=ltc2clk.OverClock.P0
ltc2clk.freq = 1630MHz:-FORCE_BYPASS:+FORCE_PLL

name=mclk.OverClock.P0
mclk.freq    = 1630MHz:-FORCE_BYPASS:+FORCE_PLL

name=xbar2clk.OverClock.P0
xbar2clk.freq = 1630MHz:-FORCE_BYPASS:+FORCE_PLL

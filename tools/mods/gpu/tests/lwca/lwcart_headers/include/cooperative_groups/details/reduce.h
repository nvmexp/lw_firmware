...
namespace experimental {
    ...
    #if defined(_CG_HAS_STL_ATOMICS)
    template<typename TyGroup, typename TyVal, lwca::thread_scope Sco, typename TyInputVal, typename TyFn>
    void _CG_QUALIFIER reduce_update_async(const TyGroup& group, lwca::atomic<TyVal, Sco>& dst, TyInputVal&& val, TyFn&& op) {
    ...
    template<typename TyGroup, typename TyVal, lwca::thread_scope Sco, typename TyInputVal, typename TyFn>
    void _CG_QUALIFIER reduce_update_async(const TyGroup& group, const lwca::atomic_ref<TyVal, Sco>& dst, TyInputVal&& val, TyFn&& op) {
        details::check_async_reduce_params<TyGroup, TyVal, details::remove_qual<TyInputVal>, decltype(op(val, val))>();

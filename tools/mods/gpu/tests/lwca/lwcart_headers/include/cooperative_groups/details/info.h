...
# if (__LWDA_ARCH__ >= 900) || !defined(__LWDA_ARCH__)
...
// Include liblw++ where supported.
    ...
    (defined(_MSC_VER) || defined(__GNUC__) || defined(__clang__) || defined(__LWDACC_RTC__))
# define _CG_USE_LWDA_STL
#else
# define _CG_USE_OWN_TRAITS
#endif

#if defined(_CG_USE_LWDA_STL) && (!defined(__LWDA_ARCH__) || \
    ((!defined(_MSC_VER) && __LWDA_ARCH__ >= 600) || (defined(_MSC_VER) && __LWDA_ARCH__ >= 700)))

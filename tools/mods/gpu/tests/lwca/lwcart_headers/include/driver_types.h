...
#define lwdaArrayDeferredMapping            0x80  /**< Must be set in lwdaMallocArray, lwdaMalloc3DArray or lwdaMallocMipmappedArray in order to create a deferred mapping LWCA array or LWCA mipmapped array */
...
enum __device_builtin__ lwdaError
{
     ...
     * ::lwdaComputeModeProhibited, ::lwdaComputeModeExclusiveProcess, or when long
     ...
     * correspond to a valid LWCA device or that the action requested is
   ...
   lwdaErrorSoftwareValidityNotEstablished  =     103,
    ...
    /**
     * This indicates that the provided exelwtion affinity is not supported by the device.
     */
    lwdaErrorUnsupportedExecAffinity      =     224,
    ...
    /**
     * This indicates that an async error has oclwrred in a device outside of LWCA.
     * If LWCA was waiting for an external device's signal before consuming shared data,
     * the external device signaled an error indicating that the data is not valid for
     * consumption. This leaves the process in an inconsistent state and any further LWCA
     * work will return the same error. To continue using LWCA, the process must be
     * terminated and relaunched.
     */
    lwdaErrorExternalDevice               =    911,


    /**
     * This indicates that a kernel launch error has oclwrred due to cluster
     * misconfiguration.
     */
    lwdaErrorIlwalidClusterSize           =    912,
...
enum __device_builtin__ lwdaChannelFormatKind
{
    ...
    lwdaChannelFormatKindUnsignedBlockCompressed1       =   17,     /**< 4 channel unsigned normalized block-compressed (BC1 compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed1SRGB   =   18,     /**< 4 channel unsigned normalized block-compressed (BC1 compression) format with sRGB encoding*/
    lwdaChannelFormatKindUnsignedBlockCompressed2       =   19,     /**< 4 channel unsigned normalized block-compressed (BC2 compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed2SRGB   =   20,     /**< 4 channel unsigned normalized block-compressed (BC2 compression) format with sRGB encoding */
    lwdaChannelFormatKindUnsignedBlockCompressed3       =   21,     /**< 4 channel unsigned normalized block-compressed (BC3 compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed3SRGB   =   22,     /**< 4 channel unsigned normalized block-compressed (BC3 compression) format with sRGB encoding */
    lwdaChannelFormatKindUnsignedBlockCompressed4       =   23,     /**< 1 channel unsigned normalized block-compressed (BC4 compression) format */
    lwdaChannelFormatKindSignedBlockCompressed4         =   24,     /**< 1 channel signed normalized block-compressed (BC4 compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed5       =   25,     /**< 2 channel unsigned normalized block-compressed (BC5 compression) format */
    lwdaChannelFormatKindSignedBlockCompressed5         =   26,     /**< 2 channel signed normalized block-compressed (BC5 compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed6H      =   27,     /**< 3 channel unsigned half-float block-compressed (BC6H compression) format */
    lwdaChannelFormatKindSignedBlockCompressed6H        =   28,     /**< 3 channel signed half-float block-compressed (BC6H compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed7       =   29,     /**< 4 channel unsigned normalized block-compressed (BC7 compression) format */
    lwdaChannelFormatKindUnsignedBlockCompressed7SRGB   =   30      /**< 4 channel unsigned normalized block-compressed (BC7 compression) format with sRGB encoding */
};
...
/**
 * LWCA array and LWCA mipmapped array memory requirements
 */
struct __device_builtin__ lwdaArrayMemoryRequirements {
...
/**
 * Cluster scheduling policies. These may be passed to ::lwdaFuncSetAttribute
 */
enum __device_builtin__ lwdaClusterSchedulingPolicy {
    lwdaClusterSchedulingPolicyDefault       = 0, /**< the default policy */
    lwdaClusterSchedulingPolicySpread        = 1, /**< spread the blocks within a cluster to the SMs */
    lwdaClusterSchedulingPolicyLoadBalancing = 2  /**< allow the hardware to load-balance the blocks in a cluster to the SMs */
};
...
struct __device_builtin__ lwdaFuncAttributes
{
    ...
    * Setting it at runtime should return lwdaErrorNotPermitted.
    * See ::lwdaFuncSetAttribute
    */
    ...
    *
    * LWCA API provides ::lwdaOclwpancyMaxActiveClusters to assist with checking
...
enum __device_builtin__ lwdaFuncAttribute
{
    ...
    lwdaFuncAttributeClusterDimMustBeSet = 10, /**< Indicator to enforce valid cluster dimension specification on kernel launch */
    lwdaFuncAttributeRequiredClusterWidth = 11, /**< Required cluster width */
    lwdaFuncAttributeRequiredClusterHeight = 12, /**< Required cluster height */
    lwdaFuncAttributeRequiredClusterDepth = 13, /**< Required cluster depth */
    lwdaFuncAttributeNonPortableClusterSizeAllowed = 14, /**< Whether non-portable cluster scheduling policy is supported */
    lwdaFuncAttributeClusterSchedulingPolicyPreference = 15, /**< Required cluster scheduling policy preference */
...
enum __device_builtin__ lwdaDeviceAttr
{
    ...
    lwdaDevAttrTimelineSemaphoreInteropSupported = 114,  /**< External timeline semaphore interop is supported on the device */
    lwdaDevAttrMaxTimelineSemaphoreInteropSupported = 114,  /**< Deprecated, External timeline semaphore interop is supported on the device */
    ...
    lwdaDevAttrClusterLaunch                  = 120, /**< Indicates device supports cluster launch */


    lwdaDevAttrDeferredMappingLwdaArraySupported = 121, /**< Device supports deferred mapping LWCA arrays and LWCA mipmapped arrays */
 ...
 */
struct __device_builtin__ lwdaMemAllocNodeParams {
    /**
    * in: location where the allocation should reside (specified in ::location).
    * ::handleTypes must be ::lwdaMemHandleTypeNone. IPC is not supported.
    */
    struct lwdaMemPoolProps         poolProps;       /**< in: array of memory access descriptors. Used to describe peer GPU access */
    const struct lwdaMemAccessDesc *accessDescs;     /**< in: number of memory access descriptors.  Must not exceed the number of GPUs. */
    size_t                          accessDescCount; /**< in: Number of `accessDescs`s */
    size_t                          bytesize;        /**< in: size in bytes of the requested allocation */
    void                           *dptr;            /**< out: address of the allocation returned by LWCA */
};

/**
 * Graph memory attributes
 */
enum __device_builtin__ lwdaGraphMemAttributeType {
    /**
     * (value type = lwuint64_t)
     * Amount of memory, in bytes, lwrrently associated with graphs.
     */
    lwdaGraphMemAttrUsedMemLwrrent      = 0x0,
     ...
     * last time it was reset.  High watermark can only be reset to zero.
     */
    lwdaGraphMemAttrUsedMemHigh         = 0x1,

    /**
     * (value type = lwuint64_t)
     * Amount of memory, in bytes, lwrrently allocated for use by
     * the LWCA graphs asynchronous allocator.
     */
    lwdaGraphMemAttrReservedMemLwrrent  = 0x2,

    /**
     * (value type = lwuint64_t)
     * High watermark of memory, in bytes, lwrrently allocated for use by
     * the LWCA graphs asynchronous allocator.
     */
    lwdaGraphMemAttrReservedMemHigh     = 0x3
};
...
/* __TEMP_WAR__ bug 3316272: Since LWCFG cannot be used within the define of
 * lwdaDevicePropDontCare, it is not possible to safely include a value in the
 * intializer for clusterLaunch. */
...
enum __device_builtin__ lwdaGraphNodeType {
    ...
    lwdaGraphNodeTypeExtSemaphoreSignal = 0x08, /**< External semaphore signal node */
    lwdaGraphNodeTypeExtSemaphoreWait = 0x09, /**< External semaphore wait node */
    lwdaGraphNodeTypeMemAlloc    = 0x0a, /**< Memory allocation node */
    lwdaGraphNodeTypeMemFree     = 0x0b, /**< Memory free node */
...
enum __device_builtin__ lwdaGraphExelwpdateResult {
    ...
    lwdaGraphExelwpdateErrorAttributesChanged = 0x8 /**< The update failed because the node attributes changed in a way that is not supported */
};
 ...
 */
enum __device_builtin__ lwdaGraphInstantiateFlags {
    lwdaGraphInstantiateFlagAutoFreeOnLaunch = 1 /**< Automatically free memory allocated in a graph before relaunching. */
};


typedef __device_builtin__ enum lwdaLaunchAttributeID_enum {
    lwdaLaunchAttributeIgnore = 0, /* Ignored entry, for colwenient composition */
    lwdaLaunchAttributeAccessPolicyWindow    = 1, /* Valid for streams, graph nodes, launches. */
    lwdaLaunchAttributeCooperative           = 2, /**< Valid for graph nodes, launches. */
    lwdaLaunchAttributeSynchronizationPolicy = 3, /**< Valid for streams. */

    lwdaLaunchAttributeClusterDimension                  = 4, /**< Valid for graph nodes, launches. */
    lwdaLaunchAttributeClusterSchedulingPolicyPreference = 5, /**< Valid for graph nodes, launches. */


    lwdaLaunchAttributeProgrammaticStreamSerialization   = 6, /**< Valid for launches. Setting
                                                                   ...
                                                                   the LWCA runtime should opportunistically allow
                                                                   the grid's exelwtion to overlap with the previous
                                                                   kernel in the stream, if that kernel requests the
                                                                   overlap. */
    lwdaLaunchAttributeProgrammaticEvent                 = 7, /**< Valid for launches. Event recorded through this
                                                                   launch attribute is guaranteed to only trigger after
                                                                   all block in the associated kernel trigger the
                                                                   event. A block can trigger the event programmatically
                                                                   in a future LWCA release. A trigger can also be
                                                                   inserted at the beginning of each block's exelwtion
                                                                   if triggerAtBlockStart is set to non-0. Note that
                                                                   dependents (including the CPU thread calling
                                                                   lwdaEventSynchronize()) are not guaranteed to observe
                                                                   the release precisely when it is released. For
                                                                   example, lwdaEventSynchronize() may only observe the
                                                                   ...
                                                                   (i.e. created with ::lwdaEventDisableTiming flag
                                                                   set). */

} lwdaLaunchAttributeID;

typedef __device_builtin__ union lwdaLaunchAttributeValue_union {
    ...
    enum lwdaClusterSchedulingPolicy clusterSchedulingPolicyPreference;
...
} lwdaLaunchAttributeValue;

typedef __device_builtin__ struct lwdaLaunchAttribute_st {
    lwdaLaunchAttributeID id;
    lwdaLaunchAttributeValue val;
} lwdaLaunchAttribute;

typedef __device_builtin__ struct lwdaLaunchConfig_st {
    dim3 gridDim;
    dim3 blockDim;
    size_t dynamicSmemBytes;
    struct LWstream_st *stream;
    lwdaLaunchAttribute *attrs;  /* nullable if numAttrs == 0 */
...
typedef lwdaLaunchAttributeID lwdaStreamAttrID;
#define lwdaStreamAttributeAccessPolicyWindow    lwdaLaunchAttributeAccessPolicyWindow
#define lwdaStreamAttributeSynchronizationPolicy lwdaLaunchAttributeSynchronizationPolicy
...
typedef lwdaLaunchAttributeValue lwdaStreamAttrValue;
...
typedef lwdaLaunchAttributeID lwdaKernelNodeAttrID;
#define lwdaKernelNodeAttributeAccessPolicyWindow lwdaLaunchAttributeAccessPolicyWindow
#define lwdaKernelNodeAttributeCooperative        lwdaLaunchAttributeCooperative
...
typedef lwdaLaunchAttributeValue lwdaKernelNodeAttrValue;

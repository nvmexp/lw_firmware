...
extern "C" {
  __device__ unsigned __lw_isGlobal_impl(const void *);
  __device__ unsigned __lw_isShared_impl(const void *);
  __device__ unsigned __lw_isConstant_impl(const void *);
  __device__ unsigned __lw_isLocal_impl(const void *);
  __device__ unsigned __lw_isGridConstant_impl(const void *);
}

__SM_20_INTRINSICS_DECL__ unsigned int __isGlobal(const void *ptr)
{
  return __lw_isGlobal_impl(ptr); 
}

__SM_20_INTRINSICS_DECL__ unsigned int __isShared(const void *ptr)
{
  return __lw_isShared_impl(ptr); 
}

__SM_20_INTRINSICS_DECL__ unsigned int __isConstant(const void *ptr)
{
  return __lw_isConstant_impl(ptr); 
}

__SM_20_INTRINSICS_DECL__ unsigned int __isLocal(const void *ptr)
{
  return __lw_isLocal_impl(ptr); 
}

#if !defined(__LWDA_ARCH__) || (__LWDA_ARCH__ >= 700)
__SM_20_INTRINSICS_DECL__ unsigned int __isGridConstant(const void *ptr)
{
  return __lw_isGridConstant_impl(ptr); 
}
#endif  /* !defined(__LWDA_ARCH__) || (__LWDA_ARCH__ >= 700) */

extern "C" {
  __device__ size_t __lw_cvta_generic_to_global_impl(const void *);
  __device__ size_t __lw_cvta_generic_to_shared_impl(const void *);
  __device__ size_t __lw_cvta_generic_to_constant_impl(const void *);
  __device__ size_t __lw_cvta_generic_to_local_impl(const void *);
  __device__ void * __lw_cvta_global_to_generic_impl(size_t);
  __device__ void * __lw_cvta_shared_to_generic_impl(size_t);
  __device__ void * __lw_cvta_constant_to_generic_impl(size_t);
  __device__ void * __lw_cvta_local_to_generic_impl(size_t);
}

__SM_20_INTRINSICS_DECL__ size_t __cvta_generic_to_global(const void *p)
{
  return __lw_cvta_generic_to_global_impl(p);
}

__SM_20_INTRINSICS_DECL__ size_t __cvta_generic_to_shared(const void *p)
{
  return __lw_cvta_generic_to_shared_impl(p);
}

__SM_20_INTRINSICS_DECL__ size_t __cvta_generic_to_constant(const void *p)
{
  return __lw_cvta_generic_to_constant_impl(p);
}

__SM_20_INTRINSICS_DECL__ size_t __cvta_generic_to_local(const void *p)
{
  return __lw_cvta_generic_to_local_impl(p);
}

__SM_20_INTRINSICS_DECL__ void * __cvta_global_to_generic(size_t rawbits)
{
  return __lw_cvta_global_to_generic_impl(rawbits);
}

__SM_20_INTRINSICS_DECL__ void * __cvta_shared_to_generic(size_t rawbits)
{
  return __lw_cvta_shared_to_generic_impl(rawbits);
}

__SM_20_INTRINSICS_DECL__ void * __cvta_constant_to_generic(size_t rawbits)
{
  return __lw_cvta_constant_to_generic_impl(rawbits);
}

__SM_20_INTRINSICS_DECL__ void * __cvta_local_to_generic(size_t rawbits)
{
  return __lw_cvta_local_to_generic_impl(rawbits);
}

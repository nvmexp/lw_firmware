...
__LWDA_HOSTDEVICE_BF16_DECL__ int __bfloat162int_rz(const __lw_bfloat16 h)
{
    ...
    const unsigned short bits = static_cast<unsigned short>(static_cast<__lw_bfloat16_raw>(h).x << 1U);
    // saturation fixup
...
#define __BF16_SPEC_CASE2(i,r, spc, ulp) \
   "{.reg.b32 spc, ulp, p;\n"\
   "  mov.b32 spc," __LWDA_BF16_STRINGIFY(spc) ";\n"\
   "  mov.b32 ulp," __LWDA_BF16_STRINGIFY(ulp) ";\n"\
   "  set.eq.f16x2.f16x2 p," __LWDA_BF16_STRINGIFY(i) ", spc;\n"\
   "  fma.rn.bf16x2 " __LWDA_BF16_STRINGIFY(r) ",p,ulp," __LWDA_BF16_STRINGIFY(r) ";\n}\n"
#define __BF16_SPEC_CASE(i,r, spc, ulp) \
   "{.reg.b16 spc, ulp, p;\n"\
   "  mov.b16 spc," __LWDA_BF16_STRINGIFY(spc) ";\n"\
   "  mov.b16 ulp," __LWDA_BF16_STRINGIFY(ulp) ";\n"\
   "  set.eq.f16.f16 p," __LWDA_BF16_STRINGIFY(i) ", spc;\n"\
   "  fma.rn.bf16 " __LWDA_BF16_STRINGIFY(r) ",p,ulp," __LWDA_BF16_STRINGIFY(r) ";\n}\n"

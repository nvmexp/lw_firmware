...
_LWDA_AWBARRIER_STATIC_QUALIFIER __host__
...
_LWDA_AWBARRIER_STATIC_QUALIFIER
__mbarrier_token_t __mbarrier_arrive_tx(__mbarrier_t* barrier, uint32_t arrive_count, uint32_t tx_count) {
    return _LWDA_AWBARRIER_INTERNAL_NAMESPACE::awbarrier_arrive_tx(barrier, arrive_count, tx_count);
}

_LWDA_AWBARRIER_STATIC_QUALIFIER
void __mbarrier_notoken_arrive_tx(__mbarrier_t* barrier, uint32_t arrive_count, uint32_t tx_count) {
    return _LWDA_AWBARRIER_INTERNAL_NAMESPACE::awbarrier_notoken_arrive_tx(barrier, arrive_count, tx_count);
}

_LWDA_AWBARRIER_STATIC_QUALIFIER
bool __mbarrier_test_wait_parity(__mbarrier_t* barrier, bool phase_parity) {
   return _LWDA_AWBARRIER_INTERNAL_NAMESPACE::awbarrier_test_wait_parity(barrier, phase_parity);
}

_LWDA_AWBARRIER_STATIC_QUALIFIER
bool __mbarrier_try_wait(__mbarrier_t* barrier, __mbarrier_token_t token, uint32_t max_sleep_nanosec) {
   return _LWDA_AWBARRIER_INTERNAL_NAMESPACE::awbarrier_try_wait(barrier, token, max_sleep_nanosec);
}

_LWDA_AWBARRIER_STATIC_QUALIFIER
bool __mbarrier_try_wait_parity(__mbarrier_t* barrier, bool phase_parity, uint32_t max_sleep_nanosec) {
   return _LWDA_AWBARRIER_INTERNAL_NAMESPACE::awbarrier_try_wait_parity(barrier, phase_parity, max_sleep_nanosec);
}

...
#if defined(_MSC_VER)
#pragma message("crt/math_functions.hpp is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead.")
#else
#warning "crt/math_functions.hpp is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead."
#endif
#define __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_MATH_FUNCTIONS_HPP__
#endif
...
__host__ __device__ __lwdart_builtin__ int signbit(const float x) { return __signbitf(x); }
__host__ __device__ __lwdart_builtin__ int signbit(const double x) { return __signbit(x); }
__host__ __device__ __lwdart_builtin__ int signbit(const long double x) { return __signbitl(static_cast<double>(x));}

__host__ __device__ __lwdart_builtin__ int isfinite(const float x) { return __finitef(x); }
__host__ __device__ __lwdart_builtin__ int isfinite(const double x) { return __finite(x); }
__host__ __device__ __lwdart_builtin__ int isfinite(const long double x) { return __finitel(static_cast<double>(x)); }

__host__ __device__ __lwdart_builtin__ int isnan(const float x) { return __isnanf(x); }
__host__ __device__ __lwdart_builtin__ int isnan(const double x) { return __isnan(x); }
__host__ __device__ __lwdart_builtin__ int isnan(const long double x) { return __isnanl(static_cast<double>(x)); }

__host__ __device__ __lwdart_builtin__ int isinf(const float x) { return __isinff(x); }
__host__ __device__ __lwdart_builtin__ int isinf(const double x) { return __isinf(x); }
__host__ __device__ __lwdart_builtin__ int isinf(const long double x) { return __isinfl(static_cast<double>(x)); }

__host__ __device__ __lwdart_builtin__ long long int abs(const long long int a) { return llabs(a); }

__host__ __device__ __lwdart_builtin__ long int  abs(const long int in)        { return llabs(in); }
__host__ __device__ __lwdart_builtin__ float     abs(const float in)           { return fabsf(in); }
__host__ __device__ __lwdart_builtin__ double    abs(const double in)          { return fabs(in); }
__host__ __device__ __lwdart_builtin__ float     fabs(const float in)          { return fabsf(in); }
__host__ __device__ __lwdart_builtin__ float     ceil(const float in)          { return ceilf(in); }
__host__ __device__ __lwdart_builtin__ float     floor(const float in)         { return floorf(in); }
__host__ __device__ __lwdart_builtin__ float     sqrt(const float in)          { return sqrtf(in); }
__host__ __device__ __lwdart_builtin__ float     pow(const float a, const float b)   { return powf(a, b); }
__device__ float powif(float, int); 
__host__ __device__ __lwdart_builtin__ float     pow(const float a, const int b)     { return powif(a, b); }
__device__ double powi(double, int);
__host__ __device__ __lwdart_builtin__ double    pow(const double a, const int b)    { return powi(a, b); }
__host__ __device__ __lwdart_builtin__ float     log(const float in)           { return logf(in); }
__host__ __device__ __lwdart_builtin__ float     log10(const float in)         { return log10f(in); }
__host__ __device__ __lwdart_builtin__ float     fmod(const float a, const float b)  { return fmodf(a, b); }
__host__ __device__ __lwdart_builtin__ float     modf(const float a, float*b)  { return modff(a, b); }
__host__ __device__ __lwdart_builtin__ float     exp(const float in)           { return expf(in); }
__host__ __device__ __lwdart_builtin__ float     frexp(const float a, int*b)   { return frexpf(a, b); }
__host__ __device__ __lwdart_builtin__ float     ldexp(const float a, int b)   { return ldexpf(a, b); }
__host__ __device__ __lwdart_builtin__ float     asin(const float in)          { return asinf(in); }
__host__ __device__ __lwdart_builtin__ float     sin(const float in)           { return sinf(in); }
__host__ __device__ __lwdart_builtin__ float     sinh(const float in)          { return sinhf(in); }
__host__ __device__ __lwdart_builtin__ float     acos(const float in)          { return acosf(in); }
__host__ __device__ __lwdart_builtin__ float     cos(const float in)           { return cosf(in); }
__host__ __device__ __lwdart_builtin__ float     cosh(const float in)          { return coshf(in); }
__host__ __device__ __lwdart_builtin__ float     atan(const float in)          { return atanf(in); }
__host__ __device__ __lwdart_builtin__ float     atan2(const float a, const float b) { return atan2f(a, b); }
__host__ __device__ __lwdart_builtin__ float     tan(const float in)           { return tanf(in); }
__host__ __device__ __lwdart_builtin__ float     tanh(const float in)          { return tanhf(in); }
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const float x) { return __signbitf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const double x) { return __signbitd(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const long double x) { return __signbitl(x);}

__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const float x) { return __isfinitef(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double x) { return __isfinited(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const long double x) { return __isfinite(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const double x) throw()  { return __isnand(x); }
#if defined(_LIBCPP_VERSION) && _LIBCPP_VERSION < 7000
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const float x) { return __isnanf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const long double x) { return __isnan(x); }
#endif /* defined(_LIBCPP_VERSION) && _LIBCPP_VERSION < 7000 */

__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const double x) throw()  { return __isinfd(x); }
#if defined(_LIBCPP_VERSION) && _LIBCPP_VERSION < 7000
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const float x) { return __isinff(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const long double x) { return __isinf(x); }
#endif /* defined(_LIBCPP_VERSION) && _LIBCPP_VERSION < 7000 */
#else /* __APPLE__ */

#if ((defined _GLIBCXX_MATH_H) && _GLIBCXX_MATH_H) && (__cplusplus >= 201103L)
#if defined(__LWDA_ARCH__)
#define __LW_BUILTIN_FUNC_DECL__ __forceinline__ __host__ __device__ __lwdart_builtin__
#if _GLIBCXX_HAVE_OBSOLETE_ISNAN && !_GLIBCXX_NO_OBSOLETE_ISINF_ISNAN_DYNAMIC
__LW_BUILTIN_FUNC_DECL__ int  isnan(const double a) throw() { return __isnan(a); }
__LW_BUILTIN_FUNC_DECL__ int  isinf(const double x) throw() { return __isinf(x); }
#endif /* _GLIBCXX_HAVE_OBSOLETE_ISNAN && !_GLIBCXX_NO_OBSOLETE_ISINF_ISNAN_DYNAMIC */
#undef __LW_BUILTIN_FUNC_DECL__
#endif /* __LWDA_ARCH */
#else /* !(((defined _GLIBCXX_MATH_H) && _GLIBCXX_MATH_H) && (__cplusplus >= 201103L)) */

#if defined(__QNX__)
#if defined(__QNX__) && defined(_LIBCPP_VERSION)
static __inline__ __host__ __device__ __lwdart_builtin__ bool signbit(const float x)
{
#if defined(__LWDA_ARCH__)
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool signbit(const double x)
{
#if defined(__LWDA_ARCH__)
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool signbit(const long double x)
{
#if defined(__LWDA_ARCH__)
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isfinite(const long double a)
{
#if defined(__LWDA_ARCH__)
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isfinite(const double a)
{
#if defined(__LWDA_ARCH__)
  return (__finite(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isfinite(const float a)
{
#if defined(__LWDA_ARCH__)
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isnan(const long double a)
{
#if defined(__LWDA_ARCH__)
  return (__isnanl(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isnan(const double a)
{
#if defined(__LWDA_ARCH__)
  return (__isnan(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isnan(const float a)
{
#if defined(__LWDA_ARCH__)
  return (__isnanf(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isinf(const long double a)
{
#if defined(__LWDA_ARCH__)
  return (__isinfl(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isinf(const double a)
{
#if defined(__LWDA_ARCH__)
  return (__isinf(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
static __inline__ __host__ __device__ __lwdart_builtin__ bool isinf(const float a)
{
#if defined(__LWDA_ARCH__)
  return (__isinff(a) != 0);
#else /* defined(__LWDA_ARCH__) */
...
#if defined(__LWDA_ARCH__)
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const float x) { return __signbitf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const double x) { return __signbit(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const long double x) { return __signbitl(x);}

__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const float x) { return __finitef(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double x) { return __finite(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const long double x) { return __finitel(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const double x)  { return __isnan(x); }
#if _LIBCPP_VERSION < 8000
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const float x) { return __isnanf(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const long double x) { return __isnanl(x); }
#endif  /* _LIBCPP_VERSION < 8000 */

__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const double x) { return __isinf(x); }
#if _LIBCPP_VERSION < 8000
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const float x) { return __isinff(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const long double x) { return __isinfl(x); }
#endif /* _LIBCPP_VERSION < 8000 */
#else /* !defined(__LWDA_ARCH__) */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const float x) { return signbit<float>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const double x) { return signbit<double>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const long double x) { return signbit<long double>(x);}

__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const float x) { return isfinite<float>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double x) { return isfinite<double>(x); }
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const long double x) { return isfinite<long double>(x); }

#if _LIBCPP_VERSION < 8000
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const float x) { return isnan<float>(x); }
/* int isnan(double) provided by math.h */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const long double x) { return isnan<long double>(x); }

__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const float x) { return isinf<float>(x); }
/* int isinf(double) provided by math.h */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const long double x) { return isinf<long double>(x); }
#endif /* _LIBCPP_VERSION < 8000 */
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const float x) { return __signbitf(x); }
#if defined(__ICC)
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const double x) throw() { return __signbit(x); }
#else /* !__ICC */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const double x) { return __signbit(x); }
#endif /* __ICC */
__forceinline__ __host__ __device__ __lwdart_builtin__ int signbit(const long double x) { return __signbitl(x);}
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const float x) {
#if defined(__LWDA_ARCH__)
  return __finitef(x);
#else	/* !__LWDA_ARCH__ */
...
#if defined(__ANDROID__)
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double x)
{
#ifdef __LWDA_ARCH__
  return __finite(x);
#else  /* !__LWDA_ARCH__ */
...
#elif defined(__ICC)
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double x) throw() { return __finite(x); }
#else
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double x) { return __finite(x); }
#endif /* __ANDROID__ */

#if defined(__ANDROID__)
__forceinline__ __host__ __device__ __lwdart_builtin__ int isfinite(const long double x)
{
#ifdef __LWDA_ARCH__
   return __finitel(x);
#else /* !__LWDA_ARCH__ */
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const double x) { return __isnan(x); }
#else /* !__ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const double x) throw()  { return __isnan(x); }
#endif /* __ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isnan(const long double x) { return __isnanl(x); }
...
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const double x) { return __isinf(x); }
#else /* !__ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const double x) throw()  { return __isinf(x); }
#endif /* __ANDROID__ */
__forceinline__ __host__ __device__ __lwdart_builtin__ int isinf(const long double x) { return __isinfl(x); }
...
static __inline__ __host__ __device__ __lwdart_builtin__ long long int abs(const long long int a)
{
  return llabs(a);
}
#endif /* !__QNX__ && !__HORIZON__*/
...
static __inline__ __host__ __device__ __lwdart_builtin__ int signbit(const long double a)
{
  return __signbitl(a);
}

static __inline__ __host__ __device__ __lwdart_builtin__ int signbit(const double a)
{
  return __signbit(a);
}

static __inline__ __host__ __device__ __lwdart_builtin__ int signbit(const float a)
{
  return __signbitf(a);
}
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isinf(const long double a)
{
  return __isinfl(a);
}
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isinf(const double a)
{
  return __isinf(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isinf(const float a)
{
  return __isinff(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isnan(const long double a)
{
  return __isnanl(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isnan(const double a)
{
  return __isnan(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isnan(const float a)
{
  return __isnanf(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isfinite(const long double a)
{
  return __finitel(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isfinite(const double a)
{
  return __finite(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
static __inline__ __host__ __device__ __lwdart_builtin__ int isfinite(const float a)
{
  return __finitef(a);
}
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if defined(__LWDACC_RTC__) || (!defined(_MSC_VER) || _MSC_VER < 1800)
#if defined(__QNX__) && defined(_LIBCPP_VERSION)
...
#endif
#endif /* __LWDACC_RTC__ || (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if defined(_MSC_VER) && !defined(__LWDA_ARCH__)
#pragma warning (disable: 4127)
#endif /* _MSC_VER && !defined(__LWDA_ARCH__) */
...
{
  double fa = fabs(a);
  double u = LWDART_TWO_TO_52 + fa;
  if (fa >= LWDART_TWO_TO_52) {
    u = a;
  } else {
    u = u - LWDART_TWO_TO_52;
    u = copysign (u, a);
  }
  return u;  
}
...
__func__(double cbrt(double a))
{
  ...
  s = fabs(a);
  t = exp2(LWDART_THIRD * log2(s));           /* initial approximation */
  t = t - (t - (s / (t * t))) * LWDART_THIRD; /* refine approximation */
  t = copysign(t, a);
  return t;
}
...
__func__(int ilogb(double a))
{
  ...
  if (__isnan(a)) return -__lwda_INT_MAX-1;
  if (__isinf(a)) return __lwda_INT_MAX;
  memcpy(&i, &a, sizeof(double));
  i = i & 0x7fffffffffffffffULL;
  if (i == 0) return -__lwda_INT_MAX-1;
  ...
  if (fabs(x) < 20.0) {
    ...
    if (x >= 0.0) {
      ...
      if (x < -185.0) {
        ...
        return negative ? (-1.0 / 1e308 / 1e308) : LWDART_ZERO;
      }
      /* compute sin(pi*x) aclwrately */
      xx = rint (2.0 * x);
...
__func__(double rcbrt(const double a))
{
  ...
  s = fabs(a);
  t = exp2(-LWDART_THIRD * log2(s));                /* initial approximation */
  t = ((t*t) * (-s*t) + 1.0) * (LWDART_THIRD*t) + t;/* refine approximation */
#if defined(__APPLE__)
  if (__signbitd(a))
#else /* __APPLE__ */
  if (__signbit(a))
...
__func__(double erfilw(const double a))
{
  double p, q, t, fa;
  unsigned long long int l;
  ...
  if (fa >= 1.0) {
    ...
    /* Based on: J.M. Blair, C.A. Edwards, J.H. Johnson: Rational Chebyshev
       Approximations for the Ilwerse of the Error Function. Mathematics of
...
__func__(double erfcilw(const double a))
{
  double t;
  unsigned long long int l;
...
__func__(double normcdfilw(const double a))
{
  return -1.4142135623730951 * erfcilw(a + a);
}
...
__func__(double normcdf(double a))
{
  ...
  t1 = a * -LWDART_SQRT_HALF_HI;
  t2 = (((u1 * v1 - t1) + u1 * v2) + u2 * v1) + u2 * v2;
  t2 = (a * -LWDART_SQRT_HALF_LO) + t2;
  ah = t1 + t2;
  z = erfc (ah);
  if (a < -1.0) {
    al = (t1 - ah) + t2;
...
__func__(float erfilwf(const float a))
{
  return static_cast<float>(erfilw(static_cast<double>(a)));
}

__func__(float erfcilwf(const float a))
{
  return static_cast<float>(erfcilw(static_cast<double>(a)));
}

__func__(float normcdfilwf(const float a))
{
  return static_cast<float>(normcdfilw(static_cast<double>(a)));
}
...
#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_MATH_FUNCTIONS_HPP__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_MATH_FUNCTIONS_HPP__
#endif

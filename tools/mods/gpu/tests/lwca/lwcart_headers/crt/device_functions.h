...
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_DEVICE_FUNCTIONS_H__
#endif
...
#define __DEVICE_FUNCTIONS_DECL__ __device__ __lwdart_builtin__
#define __DEVICE_FUNCTIONS_STATIC_DECL__ __device__ __lwdart_builtin__
#else
#define __DEVICE_FUNCTIONS_DECL__ __device__ __lwdart_builtin__
#define __DEVICE_FUNCTIONS_STATIC_DECL__ static __inline__ __device__ __lwdart_builtin__
...
{
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Callwlate the most significant 32 bits of the product of the two 32-bit integers.
 *
 * Callwlate the most significant 32 bits of the 64-bit product \p x * \p y, where \p x and \p y
 * are 32-bit integers.
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Callwlate the most significant 32 bits of the product of the two 32-bit unsigned integers.
 *
 * Callwlate the most significant 32 bits of the 64-bit product \p x * \p y, where \p x and \p y
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Callwlate the most significant 64 bits of the product of the two 64-bit integers.
 *
 * Callwlate the most significant 64 bits of the 128-bit product \p x * \p y, where \p x and \p y
 * are 64-bit integers. 
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Callwlate the most significant 64 bits of the product of the two 64 unsigned bit integers.
 *
 * Callwlate the most significant 64 bits of the 128-bit product \p x * \p y, where \p x and \p y
...
#if defined(__GNUC__) || defined(__LWDACC_RTC__)
__attribute__((__noreturn__))
#elif defined(_MSC_VER)
__declspec(noreturn)
#endif  /* defined(__GNUC__) || defined(__LWDACC_RTC__) */
__device_builtin__ void                   __trap(void);
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ void                   __brkpt();
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Callwlate the least significant 32 bits of the product of the least significant 24 bits of two integers.
 *
 * Callwlate the least significant 32 bits of the product of the least significant 24 bits of \p x and \p y.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Callwlate the least significant 32 bits of the product of the least significant 24 bits of two unsigned integers.
 *
 * Callwlate the least significant 32 bits of the product of the least significant 24 bits of \p x and \p y.
 * The high order 8 bits of  \p x and  \p y are ignored. 
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate division of the input arguments.
 *
 * Callwlate the fast approximate division of \p x by \p y.
 *
 * \return Returns \p x / \p y.
 * - __fdividef(
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate sine of the input argument.
 *
 * Callwlate the fast approximate sine of the input argument \p x, measured in radians.
 *
 ...
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __sinf(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate cosine of the input argument.
 *
 * Callwlate the fast approximate cosine of the input argument \p x, measured in radians.
 *
 * \return Returns the approximate cosine of \p x.
 *
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __cosf(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate tangent of the input argument.
 *
 * Callwlate the fast approximate tangent of the input argument \p x, measured in radians.
 *
 ...
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __tanf(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate of sine and cosine of the first input argument.
 *
 * Callwlate the fast approximate of sine and cosine of the first input argument \p x (measured
 ...
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ void                   __sincosf(float x, float *sptr, float *cptr) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate base 
 ...
 *
 * Callwlate the fast approximate base 
 * \latexonly $e$ \endlatexonly
 * \xmlonly
 * <d4p_MathML outputclass="xmlonly">
 * <m:math xmlns:m="http://www.w3.org/1998/Math/MathML">
 ...
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __expf(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate base 10 exponential of the input argument.
 *
 * Callwlate the fast approximate base 10 exponential of the input argument \p x, 
 ...
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __exp10f(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate base 2 logarithm of the input argument.
 *
 * Callwlate the fast approximate base 2 logarithm of the input argument \p x.
 *
 * \return Returns an approximation to 
 ...
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __log2f(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate base 10 logarithm of the input argument.
 *
 * Callwlate the fast approximate base 10 logarithm of the input argument \p x.
 *
 * \return Returns an approximation to 
 ...
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __log10f(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate base 
 * \latexonly $e$ \endlatexonly
 ...
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __logf(float x) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_SINGLE
 * \brief Callwlate the fast approximate of 
 ...
 * </d4p_MathML>\endxmlonly.
 *
 * Callwlate the fast approximate of \p x, the first input argument, 
 ...
 * \note_aclwracy_single_intrinsic
 */
__DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ float                  __powf(float x, float y) __THROW;
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed integer in round-to-nearest-even mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed integer
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed integer in round-towards-zero mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed integer
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed integer in round-up mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed integer
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed integer in round-down mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed integer
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned integer in round-to-nearest-even mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned integer
 * in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned integer in round-towards-zero mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned integer
 * in round-towards-zero mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned integer in round-up mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned integer
 * in round-up (to positive infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned integer in round-down mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned integer
 * in round-down (to negative infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a signed integer to a float in round-to-nearest-even mode.
 *
 * Colwert the signed integer value \p x to a single-precision floating-point value
 * in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a signed integer to a float in round-towards-zero mode.
 *
 * Colwert the signed integer value \p x to a single-precision floating-point value
 * in round-towards-zero mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a signed integer to a float in round-up mode.
 *
 * Colwert the signed integer value \p x to a single-precision floating-point value
 * in round-up (to positive infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a signed integer to a float in round-down mode.
 *
 * Colwert the signed integer value \p x to a single-precision floating-point value
 * in round-down (to negative infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert an unsigned integer to a float in round-to-nearest-even mode.
 *
 * Colwert the unsigned integer value \p x to a single-precision floating-point value
 * in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert an unsigned integer to a float in round-towards-zero mode.
 *
 * Colwert the unsigned integer value \p x to a single-precision floating-point value
 * in round-towards-zero mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert an unsigned integer to a float in round-up mode.
 *
 * Colwert the unsigned integer value \p x to a single-precision floating-point value
 * in round-up (to positive infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert an unsigned integer to a float in round-down mode.
 *
 * Colwert the unsigned integer value \p x to a single-precision floating-point value
 * in round-down (to negative infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed 64-bit integer in round-to-nearest-even mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed 64-bit integer
 * in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed 64-bit integer in round-towards-zero mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed 64-bit integer
 * in round-towards-zero mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed 64-bit integer in round-up mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed 64-bit integer
 * in round-up (to positive infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to a signed 64-bit integer in round-down mode.
 *
 * Colwert the single-precision floating-point value \p x to a signed 64-bit integer
 * in round-down (to negative infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned 64-bit integer in round-to-nearest-even mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned 64-bit integer
 * in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned 64-bit integer in round-towards-zero mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned 64-bit integer
 * in round-towards-zero mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned 64-bit integer in round-up mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned 64-bit integer
 * in round-up (to positive infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a float to an unsigned 64-bit integer in round-down mode.
 *
 * Colwert the single-precision floating-point value \p x to an unsigned 64-bit integer
 * in round-down (to negative infinity) mode.
 * \return Returns colwerted value.
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a signed 64-bit integer to a float in round-to-nearest-even mode.
 *
 * Colwert the signed 64-bit integer value \p x to a single-precision floating-point value
 * in round-to-nearest-even mode.
 * \return Returns colwerted value.
 */
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Return the number of conselwtive high-order zero bits in a 32-bit integer.
 *
 * Count the number of conselwtive leading zero bits, starting at the most significant bit (bit 31) of \p x.
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_INT
 * \brief Count the number of conselwtive high-order zero bits in a 64-bit integer.
 *
 * Count the number of conselwtive leading zero bits, starting at the most significant bit (bit 63) of \p x.
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a double to a signed int in round-towards-zero mode.
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a double to an unsigned int in round-towards-zero mode.
 *
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a double to a signed 64-bit int in round-towards-zero mode.
 *
 * Colwert the double-precision floating-point value \p x to a
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_CAST
 * \brief Colwert a double to an unsigned 64-bit int in round-towards-zero mode.
 *
 * Colwert the double-precision floating-point value \p x to an
...
/**
 * \ingroup LWDA_MATH_INTRINSIC_SIMD
...
__DEVICE_FUNCTIONS_STATIC_DECL__ __DEVICE_FUNCTIONS_DEPRECATED__(__DEVICE_FUNCTIONS_DEPRECATION_MESSAGE2(float2int,_ru|_rd|_rn|_rz)) int float2int(const float a, const enum lwdaRoundMode mode = lwdaRoundZero);

__DEVICE_FUNCTIONS_STATIC_DECL__ __DEVICE_FUNCTIONS_DEPRECATED__(__DEVICE_FUNCTIONS_DEPRECATION_MESSAGE2(float2uint,_ru|_rd|_rn|_rz)) unsigned int float2uint(const float a, const enum lwdaRoundMode mode = lwdaRoundZero);

__DEVICE_FUNCTIONS_STATIC_DECL__ __DEVICE_FUNCTIONS_DEPRECATED__(__DEVICE_FUNCTIONS_DEPRECATION_MESSAGE2(int2float,_ru|_rd|_rn|_rz)) float int2float(const int a, const enum lwdaRoundMode mode = lwdaRoundNearest);

__DEVICE_FUNCTIONS_STATIC_DECL__ __DEVICE_FUNCTIONS_DEPRECATED__(__DEVICE_FUNCTIONS_DEPRECATION_MESSAGE2(uint2float,_ru|_rd|_rn|_rz)) float uint2float(const unsigned int a, const enum lwdaRoundMode mode = lwdaRoundNearest);
...
#include "lwdacc_ext.h"

#ifdef __LWDACC__
extern "C" __host__ __device__  unsigned LWDARTAPI __lwdaPushCallConfiguration(dim3 gridDim,
                                      dim3 blockDim, 
                                      size_t sharedMem = 0, 
                                      struct LWstream_st *stream = 0);
#endif  /* __LWDACC__ */

#endif /* !__DEVICE_FUNCTIONS_H__ */

#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_DEVICE_FUNCTIONS_H__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_DEVICE_FUNCTIONS_H__
#endif

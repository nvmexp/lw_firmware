...
#if defined(_MSC_VER)
#pragma message("crt/sm_80_rt.hpp is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead.")
#else
#warning "crt/sm_80_rt.hpp is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead."
#endif
#define __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_SM_80_RT_HPP__
#endif
...
#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_SM_80_RT_HPP__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_SM_80_RT_HPP__
#endif

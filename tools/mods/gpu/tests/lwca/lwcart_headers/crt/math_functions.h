...
#if defined(_MSC_VER)
#pragma message("crt/math_functions.h is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead.")
#else
#warning "crt/math_functions.h is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead."
#endif
#define __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_MATH_FUNCTIONS_H__
#endif

#if !defined(__MATH_FUNCTIONS_H__)
#define __MATH_FUNCTIONS_H__

#if defined(__QNX__) && (__GNUC__ >= 5) && defined(__LWDACC__)
...
/**
 * \defgroup LWDA_MATH Mathematical Functions
 *
 * LWCA mathematical functions are always available in device code.
 *
 ...
 * For example, see ::erfilw(). Other, less common functions,
...
*/
/**
 * \defgroup LWDA_MATH_SINGLE Single Precision Mathematical Functions
...
/**
 * \defgroup LWDA_MATH_DOUBLE Double Precision Mathematical Functions
...
/**
 * \defgroup LWDA_MATH_INT Integer Mathematical Functions
...
/**
 * \defgroup LWDA_MATH_INTRINSIC_SINGLE Single Precision Intrinsics
...
/**
 * \defgroup LWDA_MATH_INTRINSIC_DOUBLE Double Precision Intrinsics
...
/**
 * \defgroup LWDA_MATH_INTRINSIC_INT Integer Intrinsics
...
/**
 * \defgroup LWDA_MATH_INTRINSIC_CAST Type Casting Intrinsics
...
/**
 *
 * \defgroup LWDA_MATH_INTRINSIC_SIMD SIMD Intrinsics
...
#if !defined(_MSC_VER)
#define __LWDA_MATH_CRTIMP
#else
#if _MSC_VER < 1900
#define __LWDA_MATH_CRTIMP _CRTIMP
#else
#define __LWDA_MATH_CRTIMP _ACRTIMP
#endif
#endif

#if defined(__ANDROID__) && (__ANDROID_API__ <= 20) && !defined(__aarch64__)
static __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ int                    abs(int);
static __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ long int               labs(long int);
static __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ long long int          llabs(long long int);
#else /* __ANDROID__ */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
namespace std {
#endif
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the absolute value of the input \p int argument.
 *
 * Callwlate the absolute value of the input argument \p a.
 *
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ int            __cdecl abs(int a) __THROW;
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the absolute value of the input \p long \p int argument.
 *
 * Callwlate the absolute value of the input argument \p a.
 *
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ long int       __cdecl labs(long int a) __THROW;
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the absolute value of the input \p long \p long \p int argument.
 *
 * Callwlate the absolute value of the input argument \p a.
 *
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __lwdart_builtin__ long long int          llabs(long long int a) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
}
#endif
#endif /* __ANDROID__ */
...
#endif
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the absolute value of the input argument.
 *
 * Callwlate the absolute value of the input argument \p x.
 *
 * \return
...
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the absolute value of its argument
 *
 * Callwlate the absolute value of the input argument \p x.
 *
 * \return
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ int                    min(const int a, const int b);
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p unsigned \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p long \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p unsigned \p long \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
 */
...
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl fminf(float x, float y);
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl fmin(double x, double y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ int                    max(const int a, const int b);

/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p unsigned \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p long \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p unsigned \p long \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
 */
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl fmaxf(float x, float y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Determine the maximum numeric value of the arguments.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl fmax(double, double);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the sine of the input argument.
 *
 * Callwlate the sine of the input argument \p x (measured in radians).
 *
 * \return 
 * - sin(
 * \latexonly $\pm 0$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the cosine of the input argument.
 *
 * Callwlate the cosine of the input argument \p x (measured in radians).
 *
 * \return 
 * - cos(
 * \latexonly $\pm 0$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the sine and cosine of the first input argument.
 *
 * Callwlate the sine and cosine of the first input argument \p x (measured 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the tangent of the input argument.
 *
 * Callwlate the tangent of the input argument \p x (measured in radians).
 *
 * \return 
 * - tan(
 * \latexonly $\pm 0$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the square root of the input argument.
 *
 * Callwlate the nonnegative square root of \p x, 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the reciprocal of the square root of the input argument.
 *
 * Callwlate the reciprocal of the nonnegative square root of \p x, 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the base 2 logarithm of the input argument.
 *
 * Callwlate the base 2 logarithm of the input argument \p x.
 *
 * \return 
 * - log2(
 * \latexonly $\pm 0$ \endlatexonly
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl log2(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the base 2 exponential of the input argument.
 * 
 * Callwlate
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl exp2(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the base 2 exponential of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl exp2f(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the base 10 exponential of the input argument.
 *
 * Callwlate
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl expm1(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the base 
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl expm1f(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the base 2 logarithm of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl log2f(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the base 10 logarithm of the input argument.
 *
 * Callwlate the base 10 logarithm of the input argument \p x.
 *
 * \return
 * - log10(
 * \latexonly $\pm 0$ \endlatexonly
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl log1p(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the value of 
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl log1pf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the largest integer less than or equal to \p x.
 * 
 * Callwlates the largest integer value which is less than or equal to \p x.
 * 
 * \return
 * Returns 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl floor(double x) __THROW;
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the base 
 * \latexonly $e$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the hyperbolic cosine of the input argument.
 *
 * Callwlate the hyperbolic cosine of the input argument \p x.
 *
 * \return
 * - cosh(
 * \latexonly $\pm 0$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the hyperbolic sine of the input argument.
 *
 * Callwlate the hyperbolic sine of the input argument \p x.
 *
 * \return
 * - sinh(
 * \latexonly $\pm 0$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the hyperbolic tangent of the input argument.
 *
 * Callwlate the hyperbolic tangent of the input argument \p x.
 *
 * \return
 * - tanh(
 * \latexonly $\pm 0$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the nonnegative ilwerse hyperbolic cosine of the input argument.
 *
 * Callwlate the nonnegative ilwerse hyperbolic cosine of the input argument \p x.
 *
 * \return 
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl acosh(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the nonnegative ilwerse hyperbolic cosine of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl acoshf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the ilwerse hyperbolic sine of the input argument.
 *
 * Callwlate the ilwerse hyperbolic sine of the input argument \p x.
 *
 * \return
 * - asinh(
 * \latexonly $\pm 0$ \endlatexonly
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl asinh(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse hyperbolic sine of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl asinhf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the ilwerse hyperbolic tangent of the input argument.
 *
 * Callwlate the ilwerse hyperbolic tangent of the input argument \p x.
 *
 * \return 
 * - atanh(
 * \latexonly $\pm 0$ \endlatexonly
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl atanh(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse hyperbolic tangent of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl atanhf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl ldexp(double x, int exp) __THROW;
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the value of 
 * \latexonly $x\cdot 2^{exp}$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the floating-point representation of the exponent of the input argument.
 *
 * Callwlate the floating-point representation of the exponent of the input argument \p x.
 *
 * \return 
 * - logb(
 * \latexonly $\pm 0$ \endlatexonly
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl logb(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the floating-point representation of the exponent of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl logbf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Compute the unbiased integer exponent of the argument.
 *
 * Callwlates the unbiased integer exponent of the input argument \p x.
 *
 * \return
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP int    __cdecl ilogb(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Compute the unbiased integer exponent of the argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP int    __cdecl ilogbf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl scalbn(double x, int n);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Scale floating-point input by integer power of two.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl scalbnf(float x, int n);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Scale floating-point input by integer power of two.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl scalbln(double x, long int n);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Scale floating-point input by integer power of two.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl scalblnf(float x, long int n);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl frexp(double x, int *nptr) __THROW;
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Extract mantissa and exponent of a floating-point value
 * 
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl round(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Round to nearest integer value in floating-point.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl roundf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long int __cdecl lround(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Round to nearest integer value.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long int __cdecl lroundf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Round to nearest integer value.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long long int __cdecl llround(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Round to nearest integer value.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long long int __cdecl llroundf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Round to nearest integer value in floating-point.
 ...
 * </d4p_MathML>\endxmlonly.
 */
#if defined(__LWDA_ARCH__) || defined(__DOXYGEN_ONLY__)
/*
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl rint(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#endif /* __LWDA_ARCH__ || __DOXYGEN_ONLY__ */
/**
 * \ingroup LWDA_MATH_SINGLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl rintf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long int __cdecl lrint(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Round input to nearest integer value.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long int __cdecl lrintf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Round input to nearest integer value.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long long int __cdecl llrint(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Round input to nearest integer value.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP long long int __cdecl llrintf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl nearbyint(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Round the input argument to the nearest integer.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl nearbyintf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 ...
 * </d4p_MathML>\endxmlonly.
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl ceil(double x) __THROW;
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl trunc(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Truncate input argument to the integral part.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl truncf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl fdim(double x, double y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Compute the positive difference between \p x and \p y.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl fdimf(float x, float y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the arc tangent of the ratio of first and second input arguments.
 *
 * Callwlate the principal value of the arc tangent of the ratio of first
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the arc tangent of the input argument.
 *
 * Callwlate the principal value of the arc tangent of the input argument \p x.
 *
 * \return 
 * Result will be in radians, in the interval [-
 * \latexonly $\pi$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the arc cosine of the input argument.
 *
 * Callwlate the principal value of the arc cosine of the input argument \p x.
 *
 * \return 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the arc sine of the input argument.
 *
 * Callwlate the principal value of the arc sine of the input argument \p x.
 *
 * \return 
 * Result will be in radians, in the interval [-
 * \latexonly $\pi$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the square root of the sum of squares of two arguments.
 *
 * Callwlate the length of the hypotenuse of a right triangle whose two sides have lengths 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate one over the square root of the sum of squares of two arguments.
 *
 * Callwlate one over the length of the hypotenuse of a right triangle whose two sides have 
 ...
 * \brief Callwlate the square root of the sum of squares of two arguments.
 *
 * Callwlates the length of the hypotenuse of a right triangle whose two sides have lengths 
 * \p x and \p y without undue overflow or underflow.
 *
 * \return Returns the length of the hypotenuse 
 * \latexonly $\sqrt{x^2+y^2}$ \endlatexonly
 ...
 * \brief Callwlate one over the square root of the sum of squares of two arguments.
 *
 * Callwlates one over the length of the hypotenuse of a right triangle whose two sides have 
 * lengths \p x and \p y without undue overflow or underflow.
 *
 * \return Returns one over the length of the hypotenuse 
 * \latexonly $\frac{1}{\sqrt{x^2+y^2}}$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the square root of the sum of squares of three coordinates of the argument.
 *
 * Callwlate the length of three dimensional vector in Euclidean space without undue overflow or underflow.
 *
 ...
 * \note_aclwracy_double
 */
extern __device__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl norm3d(double a, double b, double c) __THROW;

/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate one over the square root of the sum of squares of three coordinates.
 *
 * Callwlate one over the length of three dimensional vector in Euclidean space without undue overflow or underflow.
 *
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the square root of the sum of squares of four coordinates of the argument.
 *
 * Callwlate the length of four dimensional vector in Euclidean space without undue overflow or underflow.
 *
 ...
 * \note_aclwracy_double
 */
extern __device__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl norm4d(double a, double b, double c, double d) __THROW;

/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate one over the square root of the sum of squares of four coordinates.
 *
 * Callwlate one over the length of four dimensional vector in Euclidean space without undue overflow or underflow.
 *
 * \return Returns one over the length of the 3D vector 
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the square root of the sum of squares of any number of coordinates.
 *
 * Callwlate the length of a vector p, dimension of which is passed as an argument \p without undue overflow or underflow.
 *
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the reciprocal of square root of the sum of squares of any number of coordinates.
 *
 * Callwlates one over the length of vector \p p, dimension of which is passed as an argument, in Euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate the square root of the sum of squares of any number of coordinates.
 *
 * Callwlates the length of a vector \p p, dimension of which is passed as an argument without undue overflow or underflow.
 *
 * \return Returns the length of the dim-D vector 
 * \latexonly $\sqrt{\sum_{i=0}^{dim-1} p_i^2}$ \endlatexonly
 * \xmlonly
 ...
 * \brief Callwlate the square root of the sum of squares of three coordinates of the argument.
 *
 * Callwlates the length of three dimensional vector in Euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate one over the square root of the sum of squares of three coordinates.
 *
 * Callwlates one over the length of three dimension vector in Euclidean space without undue overflow or underflow.
 *
 * \return Returns one over the length of the 3D vector
 * \latexonly $\frac{1}{\sqrt{a^2+b^2+c^2}}$ \endlatexonly
 * \xmlonly
 ...
 * \brief Callwlate the square root of the sum of squares of four coordinates of the argument.
 *
 * Callwlates the length of four dimensional vector in Euclidean space without undue overflow or underflow.
 *
 ...
 * \brief Callwlate one over the square root of the sum of squares of four coordinates.
 *
 * Callwlates one over the length of four dimension vector in Euclidean space without undue overflow or underflow.
 *
 * \return Returns one over the length of the 3D vector
 * \latexonly $\frac{1}{\sqrt{a^2+b^2+c^2+d^2}}$ \endlatexonly
 * \xmlonly
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the lwbe root of the input argument.
 *
 * Callwlate the lwbe root of \p x, 
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl cbrt(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the lwbe root of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl cbrtf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate reciprocal lwbe root function.
 *
 * Callwlate reciprocal lwbe root function of \p x.
 *
 * \return 
 * - rcbrt(
 * \latexonly $\pm 0$ \endlatexonly
 ...
 * </d4p_MathML>\endxmlonly.
 *
 * Callwlate the sine and cosine of the first input argument, \p x (measured in radians), 
 * \latexonly $\times \pi$ \endlatexonly
 * \xmlonly
 * <d4p_MathML outputclass="xmlonly">
 * <m:math xmlns:m="http://www.w3.org/1998/Math/MathML">
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of first argument to the power of second argument.
 *
 * Callwlate the value of \p x to the power of \p y.
 *
 * \return 
 * - pow(
 * \latexonly $\pm 0$ \endlatexonly
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl modf(double x, double *iptr) __THROW;
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the double-precision floating-point remainder of \p x / \p y.
 *
 * Callwlate the double-precision floating-point remainder of \p x / \p y.
 * The floating-point remainder of the division operation \p x / \p y callwlated
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl remainder(double x, double y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl remainderf(float x, float y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl remquo(double x, double y, int *quo);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl remquof(float x, float y, int *quo);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the Bessel function of the first kind of order 0 for the input argument.
 *
 * Callwlate the value of the Bessel function of the first kind of order 0 for
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl j0(double x) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the Bessel function of the first kind of order 1 for the input argument.
 *
 * Callwlate the value of the Bessel function of the first kind of order 1 for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl j1(double x) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the Bessel function of the first kind of order n for the input argument.
 *
 * Callwlate the value of the Bessel function of the first kind of order \p n for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl jn(int n, double x) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the Bessel function of the second kind of order 0 for the input argument.
 *
 * Callwlate the value of the Bessel function of the second kind of order 0 for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl y0(double x) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the Bessel function of the second kind of order 1 for the input argument.
 *
 * Callwlate the value of the Bessel function of the second kind of order 1 for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl y1(double x) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the Bessel function of the second kind of order n for the input argument.
 *
 * Callwlate the value of the Bessel function of the second kind of order \p n for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl yn(int n, double x) __THROW;
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the regular modified cylindrical Bessel function of order 0 for the input argument.
 *
 * Callwlate the value of the regular modified cylindrical Bessel function of order 0 for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __device__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl cyl_bessel_i0(double x) __THROW;
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the value of the regular modified cylindrical Bessel function of order 0 for the input argument.
 *
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the value of the regular modified cylindrical Bessel function of order 1 for the input argument.
 *
 * Callwlate the value of the regular modified cylindrical Bessel function of order 1 for
 * the input argument \p x, 
 ...
 * \note_aclwracy_double
 */
extern __device__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl cyl_bessel_i1(double x) __THROW;
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the value of the regular modified cylindrical Bessel function of order 1 for the input argument.
 *
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the error function of the input argument.
 *
 * Callwlate the value of the error function for the input argument \p x,
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl erf(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the error function of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl erff(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the ilwerse error function of the input argument.
 *
 * Callwlate the ilwerse error function
 ...
 * </m:math>
 * </d4p_MathML>\endxmlonly.
 * - erfilw(\p x) returns NaN for \p x outside [-1, +1].
 *
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ double                 erfilw(double x);
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse error function of the input argument.
 *
 ...
 * </m:math>
 * </d4p_MathML>\endxmlonly.
 * - erfilwf(\p x) returns NaN for \p x outside [-1, +1].
 *
 * \note_aclwracy_single
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float                  erfilwf(float x);
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the complementary error function of the input argument.
 *
 * Callwlate the complementary error function of the input argument \p x,
 * 1 - erf(\p x).
 *
 * \return 
 * - erfc(
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl erfc(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the complementary error function of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl erfcf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the natural logarithm of the absolute value of the gamma function of the input argument.
 *
 * Callwlate the natural logarithm of the absolute value of the gamma function of the input argument \p x, namely the value of
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl lgamma(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the ilwerse complementary error function of the input argument.
 *
 * Callwlate the ilwerse complementary error function
 ...
 * </m:math>
 * </d4p_MathML>\endxmlonly.
 * - erfcilw(\p x) returns NaN for \p x outside [0, 2].
 *
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ double                 erfcilw(double x);
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse complementary error function of the input argument.
 *
 ...
 * </m:math>
 * </d4p_MathML>\endxmlonly.
 * - erfcilwf(\p x) returns NaN for \p x outside [0, 2].
 *
 * \note_aclwracy_single
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float                  erfcilwf(float x);
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the ilwerse of the standard normal cumulative distribution function.
 *
 * Callwlate the ilwerse of the standard normal cumulative distribution function for input argument \p x,
 ...
 * </m:math>
 * </d4p_MathML>\endxmlonly.
 * - normcdfilw(\p x) returns NaN
 *  if \p x is not in the interval [0,1].
 *
 * \note_aclwracy_double
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ double                 normcdfilw(double x);
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the ilwerse of the standard normal cumulative distribution function.
 *
 ...
 * </m:math>
 * </d4p_MathML>\endxmlonly.
 * - normcdfilwf(\p x) returns NaN
 *  if \p x is not in the interval [0,1].
 *
 * \note_aclwracy_single
 */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float                  normcdfilwf(float x);
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the standard normal cumulative distribution function.
 *
 * Callwlate the cumulative distribution function of the standard normal distribution for input argument \p x,
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the scaled complementary error function of the input argument.
 *
 * Callwlate the scaled complementary error function of the input argument \p x,
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl lgammaf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the gamma function of the input argument.
 *
 * Callwlate the gamma function of the input argument \p x, namely the value of
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl tgamma(double x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the gamma function of the input argument.
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl tgammaf(float x);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/** \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl copysign(double x, double y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/** \ingroup LWDA_MATH_SINGLE
 * \brief Create value with given magnitude, copying sign of second value.
 *
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl copysignf(float x, float y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Return next representable double-precision floating-point value after argument \p x in the direction of \p y.
 *
 * Callwlate the next representable double-precision floating-point value
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl nextafter(double x, double y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Return next representable single-precision floating-point value after argument \p x in the direction of \p y.
 *
 * Callwlate the next representable single-precision floating-point value
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl nextafterf(float x, float y);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_DOUBLE
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl nan(const char *tagp);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Returns "Not a Number" value
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl nanf(const char *tagp);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* namespace std */
#endif
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP double __cdecl fma(double x, double y, double z);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Compute 
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __DEVICE_FUNCTIONS_DECL__ __device_builtin__ __LWDA_MATH_CRTIMP float  __cdecl fmaf(float x, float y, float z);
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
#if defined(__QNX__) && !defined(_LIBCPP_VERSION)
} /* std */
#endif
...
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl acosf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl asinf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl atanf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl atan2f(float, float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl cosf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl sinf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl tanf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl coshf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl sinhf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl tanhf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl expf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl logf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl log10f(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl modff(float, float*) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl powf(float, float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl sqrtf(float) __THROW;         
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl ceilf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl floorf(float) __THROW;
extern __LWDA_MATH_CRTIMP __DEVICE_FUNCTIONS_DECL__ __device_builtin__ float __cdecl fmodf(float, float) __THROW;
...
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the natural logarithm of the input argument.
 *
 * Callwlate the natural logarithm of the input argument \p x.
 *
 * \return 
 * - logf(
 * \latexonly $\pm 0$ \endlatexonly
 ...
 * \brief Callwlate the largest integer less than or equal to \p x.
 * 
 * Callwlate the largest integer value which is less than or equal to \p x.
 * 
 * \return
 * Returns 
 * \latexonly $\lfloor x \rfloor$ \endlatexonly
...
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the floating-point remainder of \p x / \p y.
 *
 * Callwlate the floating-point remainder of \p x / \p y.
 * The floating-point remainder of the division operation \p x / \p y callwlated
 * by this function is exactly the value <tt>x - n*y</tt>, where \p n is \p x / \p y with its fractional part truncated.
 * The computed value will have the same sign as \p x, and its magnitude will be less than the magnitude of \p y.
 * \return
...
#include <cmath>
#include <cstdlib>
#endif /* __LWDA_INTERNAL_SKIP_CPP_HEADERS__ */
...
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(long double x);

__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(long double x);

__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(long double x);

__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(long double x);
...
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(float x);
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(double x);
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(long double x);

__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(float x); 
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(double x);
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(long double x);

__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(double x) throw();
#if !defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 7000
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(float x);
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(long double x);
#else /* !(!defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 7000) */
template <typename T>
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool __libcpp_isnan(T) _NOEXCEPT;
inline _LIBCPP_INLINE_VISIBILITY __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool isnan(float x) _NOEXCEPT;
inline _LIBCPP_INLINE_VISIBILITY  __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool isnan(long double x) _NOEXCEPT;
#endif /* !defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 7000 */

__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(double x) throw();
#if !defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 7000
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(float x);
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(long double x);
#else /* !(!defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 7000) */
template <typename T>
__lwdart_builtin__ __DEVICE_FUNCTIONS_DECL__ bool __libcpp_isinf(T) _NOEXCEPT;
inline _LIBCPP_INLINE_VISIBILITY __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool isinf(float x) _NOEXCEPT;
inline _LIBCPP_INLINE_VISIBILITY __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool isinf(long double x) _NOEXCEPT;
#endif /* !defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 7000 */
...
namespace std {
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool signbit(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool signbit(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool signbit(long double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isfinite(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isfinite(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isfinite(long double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isnan(float x);
...
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isnan(double x) throw();
#else /* !(_GLIBCXX_HAVE_OBSOLETE_ISNAN && !_GLIBCXX_NO_OBSOLETE_ISINF_ISNAN_DYNAMIC) */
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isnan(double x);
#endif /* _GLIBCXX_HAVE_OBSOLETE_ISNAN && !_GLIBCXX_NO_OBSOLETE_ISINF_ISNAN_DYNAMIC */
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isnan(long double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isinf(float x);
...
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(double x) throw();
#else /* !(_GLIBCXX_HAVE_OBSOLETE_ISINF && !_GLIBCXX_NO_OBSOLETE_ISINF_ISNAN_DYNAMIC) */
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isinf(double x);
#endif /* _GLIBCXX_HAVE_OBSOLETE_ISINF && !_GLIBCXX_NO_OBSOLETE_ISINF_ISNAN_DYNAMIC */
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ constexpr bool isinf(long double x);
}
...
namespace std {
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool signbit(float x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool signbit(double x);
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool signbit(long double x);
}
#else
...
#else /* ! __QNX__ */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(const float x);
#if defined(__ICC)
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(const double x) throw();
#else /* !__ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(const double x);
#endif /* __ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int signbit(const long double x);

__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(const float x);
#if defined(__ICC)
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(const double x) throw();
#else /* !__ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(const double x);
#endif /* __ICC */
__forceinline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isfinite(const long double x);
...
_LIBCPP_INLINE_VISIBILITY _LIBCPP_PREFERRED_OVERLOAD __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool isnan(double x) _NOEXCEPT;
...
#if _LIBCPP_VERSION >= 7000
#ifdef _LIBCPP_PREFERRED_OVERLOAD
_LIBCPP_INLINE_VISIBILITY _LIBCPP_PREFERRED_OVERLOAD __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool isinf(double x) _NOEXCEPT;
#endif /* _LIBCPP_PREFERRED_OVERLOAD */
#else /* _LIBCPP_VERSION < 7000 */
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ int isinf(double x);
#endif /* _LIBCPP_VERSION >= 7000 */
...
#if !defined(__ANDROID__) || (defined(__LW_GLIBCXX_VERSION) && __LW_GLIBCXX_VERSION < 40800)

#if defined(__QNX__)
/* QNX defines functions in std, need to declare them here */
namespace std {
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs (long long int a);
}
...
__DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs (long long int a) throw();
_LIBCPP_END_NAMESPACE_STD
#else
static __inline__ __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs(long long int a);
#endif /* __QNX__ || __HORIZON__*/

#endif /* !__ANDROID__ || (defined(__LW_GLIBCXX_VERSION) && __LW_GLIBCXX_VERSION < 40800) */
#endif /* __arm__ && !_STLPORT_VERSION && !_GLIBCXX_USE_C99 */
#endif /* !defined(__HORIZON__) || !defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 3800 */

#if defined(__LW_GLIBCXX_VERSION) && __LW_GLIBCXX_VERSION < 40800 && !defined(__ibmxl__)
...
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs(long long int a);

#if !defined(_STLPORT_VERSION)
}
#endif /* !_STLPORT_VERSION */

#endif /* defined(__LW_GLIBCXX_VERSION) && __LW_GLIBCXX_VERSION < 40800 && !__ibmxl__ */

namespace std
{
  template<typename T> extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ T __pow_helper(T, int);
  template<typename T> extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ T __cmath_power(T, unsigned int);
}
...
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __LWDA_MATH_CRTIMP double __cdecl _hypot(double x, double y);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __LWDA_MATH_CRTIMP float  __cdecl _hypotf(float x, float y);
...
#endif
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ bool signbit(long double) __SIGNBIT_THROW;
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __device_builtin__ __LWDA_MATH_CRTIMP int _ldsign(long double);
 ...
 * nonzero value if and only if \p a is negative. 
 */
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __RETURN_TYPE signbit(double) __SIGNBIT_THROW;
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __device_builtin__ __LWDA_MATH_CRTIMP int _dsign(double);
#undef __RETURN_TYPE 
#undef __SIGNBIT_THROW
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
 ...
 * if and only if \p a is negative.  
 */
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __RETURN_TYPE signbit(float) __SIGNBIT_THROW;
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ __device_builtin__ __LWDA_MATH_CRTIMP int _fdsign(float);
#undef __RETURN_TYPE
#undef __SIGNBIT_THROW
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if (!defined(_MSC_VER) || _MSC_VER < 1800)
template<class T> extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ T _Pow_int(T, int);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs(long long int);
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
template<class T> extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ T _Pow_int(T, int) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs(long long int) throw();
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
#if defined(__LWDACC_RTC__) || defined(__GNUC__)

#if defined(__LWDACC_RTC__) || \
    (defined(__LW_GLIBCXX_VERSION) && __LW_GLIBCXX_VERSION >= 40800) || \
    defined(__ibmxl__)
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int abs(long long int);
#endif /* __LWDACC__RTC__ ||
          (defined(__LW_GLIBCXX_VERSION) && __LW_GLIBCXX_VERSION >= 40800) ||
          __ibmxl__ */

#endif /* __LWDACC_RTC__ || __GNUC__ */

#if defined(__LWDACC_RTC__) || \
    (!defined(_MSC_VER) || _MSC_VER < 1800) && \
    (!defined(_LIBCPP_VERSION) || (_LIBCPP_VERSION < 1101))
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long int __cdecl abs(long int);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl abs(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ double   __cdecl abs(double);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl fabs(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl ceil(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl floor(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl sqrt(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl pow(float, float);

#if !defined(__QNX__)
     
#if defined(__GNUC__) && __cplusplus >= 201103L && !defined(_LIBCPP_VERSION)
template<typename _Tp, typename _Up>
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__
...
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl pow(float, int);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ double   __cdecl pow(double, int);
#endif  /* defined(__GNUC__) && __cplusplus >= 201103L && !defined(_LIBCPP_VERSION) */
     
#endif  /* !defined(__QNX__) */

extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl log(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl log10(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl fmod(float, float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl modf(float, float*);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl exp(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl frexp(float, int*);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl ldexp(float, int);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl asin(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl sin(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl sinh(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl acos(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl cos(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl cosh(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl atan(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl atan2(float, float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl tan(float);
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl tanh(float);
#else /* __LWDACC_RTC__ ||
         (!defined(_MSC_VER) || _MSC_VER < 1800) &&
         (!defined(_LIBCPP_VERSION) || (_LIBCPP_VERSION < 1101)) */
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long int __cdecl abs(long int) throw();
#if defined(_LIBCPP_VERSION)
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ long long int __cdecl abs(long long int) throw();
#endif /* defined(_LIBCPP_VERSION) */
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl abs(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ double   __cdecl abs(double) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl fabs(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl ceil(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl floor(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl sqrt(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl pow(float, float) throw();
#if defined(_LIBCPP_VERSION)
...
>::type pow(_A1 __lcpp_x, _A2 __lcpp_y) __LW_NOEXCEPT;
...
>::type pow(_Tp __x, _Up __y) __LW_NOEXCEPT;
...
#if (defined(_MSC_VER) && (_MSC_VER >= 1928)) && !(defined __LWDA_INTERNAL_SKIP_CPP_HEADERS__)
template <class _Ty1, class _Ty2, ::std:: enable_if_t< ::std:: is_arithmetic_v<_Ty1> && ::std:: is_arithmetic_v<_Ty2>, int> > [[nodiscard]] __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ ::std:: _Common_float_type_t<_Ty1, _Ty2> __cdecl pow(_Ty1 _Left, _Ty2 _Right) noexcept;
#else
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl pow(float, int) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ double   __cdecl pow(double, int) throw();
#endif /* (defined(_MSC_VER) && (_MSC_VER >= 1928)) && !(defined __LWDA_INTERNAL_SKIP_CPP_HEADERS__) */
#endif /* !(defined(__GNUC__) && __cplusplus >= 201103L) */
#endif /* defined(_LIBCPP_VERSION) */
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl log(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl log10(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl fmod(float, float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl modf(float, float*) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl exp(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl frexp(float, int*) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl ldexp(float, int) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl asin(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl sin(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl sinh(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl acos(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl cos(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl cosh(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl atan(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl atan2(float, float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl tan(float) throw();
extern __DEVICE_FUNCTIONS_DECL__ __lwdart_builtin__ float    __cdecl tanh(float) throw();
#endif /* __LWDACC_RTC__ ||
          (!defined(_MSC_VER) || _MSC_VER < 1800) &&
          (!defined(_LIBCPP_VERSION) || (_LIBCPP_VERSION < 1101)) */
...
#else /* __LWDACC_RTC__ */
#define __MATH_FUNCTIONS_DECL__ static inline __host__ __device__ __lwdart_builtin__
#define __MATH_FUNCTIONS_DEVICE_DECL__ static inline __device__ __lwdart_builtin__
#endif /* __LWDACC_RTC__ */
...
#if defined(_LIBCPP_VERSION)
#define __LW_NOEXCEPT _NOEXCEPT
_LIBCPP_BEGIN_NAMESPACE_STD
#else
#define __LW_NOEXCEPT
namespace std {
__host__ __device__ __lwdart_builtin__ int ilogbf(float a);
#endif
...
__host__ __device__ __lwdart_builtin__ float logb(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ int ilogb(float a) __LW_NOEXCEPT;

__host__ __device__ __lwdart_builtin__ float scalbn(float a, int b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float scalbln(float a, long int b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float exp2(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float expm1(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float log2(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float log1p(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float acosh(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float asinh(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float atanh(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float hypot(float a, float b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float cbrt(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float erf(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float erfc(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float lgamma(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float tgamma(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float copysign(float a, float b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float nextafter(float a, float b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float remainder(float a, float b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float remquo(float a, float b, int *quo) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float round(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ long int lround(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ long long int llround(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float trunc(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float rint(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ long int lrint(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ long long int llrint(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float nearbyint(float a) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float fdim(float a, float b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float fma(float a, float b, float c) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float fmax(float a, float b) __LW_NOEXCEPT;
__host__ __device__ __lwdart_builtin__ float fmin(float a, float b) __LW_NOEXCEPT;
#if defined(__QNX__) && (!defined(_LIBCPP_VERSION) || _LIBCPP_VERSION < 8000)
#if defined(_LIBCPP_VERSION)
_LIBCPP_END_NAMESPACE_STD
using _VSTD::logb;
...
#if ((defined _GLIBCXX_MATH_H) && _GLIBCXX_MATH_H) && (__cplusplus >= 201103L)
namespace std {
__host__ __device__ __lwdart_builtin__ constexpr float logb(float a);
__host__ __device__ __lwdart_builtin__ constexpr int ilogb(float a);
__host__ __device__ __lwdart_builtin__ constexpr float scalbn(float a, int b);
__host__ __device__ __lwdart_builtin__ constexpr float scalbln(float a, long int b);
__host__ __device__ __lwdart_builtin__ constexpr float exp2(float a);
__host__ __device__ __lwdart_builtin__ constexpr float expm1(float a);
__host__ __device__ __lwdart_builtin__ constexpr float log2(float a);
__host__ __device__ __lwdart_builtin__ constexpr float log1p(float a);
__host__ __device__ __lwdart_builtin__ constexpr float acosh(float a);
__host__ __device__ __lwdart_builtin__ constexpr float asinh(float a);
__host__ __device__ __lwdart_builtin__ constexpr float atanh(float a);
__host__ __device__ __lwdart_builtin__ constexpr float hypot(float a, float b);
__host__ __device__ __lwdart_builtin__ constexpr float cbrt(float a);
__host__ __device__ __lwdart_builtin__ constexpr float erf(float a);
__host__ __device__ __lwdart_builtin__ constexpr float erfc(float a);
__host__ __device__ __lwdart_builtin__ constexpr float lgamma(float a);
__host__ __device__ __lwdart_builtin__ constexpr float tgamma(float a);
__host__ __device__ __lwdart_builtin__ constexpr float copysign(float a, float b);
__host__ __device__ __lwdart_builtin__ constexpr float nextafter(float a, float b);
__host__ __device__ __lwdart_builtin__ constexpr float remainder(float a, float b);
__host__ __device__ __lwdart_builtin__ float remquo(float a, float b, int *quo);
__host__ __device__ __lwdart_builtin__ constexpr float round(float a);
__host__ __device__ __lwdart_builtin__ constexpr long int lround(float a);
__host__ __device__ __lwdart_builtin__ constexpr long long int llround(float a);
__host__ __device__ __lwdart_builtin__ constexpr float trunc(float a);
__host__ __device__ __lwdart_builtin__ constexpr float rint(float a);
__host__ __device__ __lwdart_builtin__ constexpr long int lrint(float a);
__host__ __device__ __lwdart_builtin__ constexpr long long int llrint(float a);
__host__ __device__ __lwdart_builtin__ constexpr float nearbyint(float a);
__host__ __device__ __lwdart_builtin__ constexpr float fdim(float a, float b);
__host__ __device__ __lwdart_builtin__ constexpr float fma(float a, float b, float c);
__host__ __device__ __lwdart_builtin__ constexpr float fmax(float a, float b);
__host__ __device__ __lwdart_builtin__ constexpr float fmin(float a, float b);
}
#else /* !(((defined _GLIBCXX_MATH_H) && _GLIBCXX_MATH_H) && (__cplusplus >= 201103L)) */
...
#else /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
extern __host__ __device__ __lwdart_builtin__ float __cdecl logb(float) throw();
extern __host__ __device__ __lwdart_builtin__ int   __cdecl ilogb(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl scalbn(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl scalbln(float, long int) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl exp2(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl expm1(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl log2(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl log1p(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl acosh(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl asinh(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl atanh(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl hypot(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl cbrt(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl erf(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl erfc(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl lgamma(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl tgamma(float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl copysign(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl nextafter(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl remainder(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl remquo(float, float, int *) throw();
extern __host__ __device__ __lwdart_builtin__ float __cdecl round(float) throw();
extern __host__ __device__ __lwdart_builtin__ long int      __cdecl lround(float) throw();
extern __host__ __device__ __lwdart_builtin__ long long int __cdecl llround(float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl trunc(float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl rint(float) throw();
extern __host__ __device__ __lwdart_builtin__ long int      __cdecl lrint(float) throw();
extern __host__ __device__ __lwdart_builtin__ long long int __cdecl llrint(float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl nearbyint(float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl fdim(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl fma(float, float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl fmax(float, float) throw();
extern __host__ __device__ __lwdart_builtin__ float         __cdecl fmin(float, float) throw();
#endif /* (!defined(_MSC_VER) || _MSC_VER < 1800) */
...
__MATH_FUNCTIONS_DECL__ float erfilw(const float a);

__MATH_FUNCTIONS_DECL__ float erfcilw(const float a);

__MATH_FUNCTIONS_DECL__ float normcdfilw(const float a);
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p int and \p unsigned \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b, perform integer promotion first.
 */
__MATH_FUNCTIONS_DECL__ unsigned int min(const int a, const unsigned int b);

/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p unsigned \p int and \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p unsigned \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p long \p int and \p unsigned \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p unsigned \p long \p int and \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p long \p long \p int and \p unsigned \p long \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the minimum value of the input \p unsigned \p long \p long \p int and \p long \p long \p int arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the minimum value of the input \p float arguments.
 *
 * Callwlate the minimum value of the arguments \p a and \p b.
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the minimum value of the input \p float and \p double arguments.
 *
 * Colwert \p float argument \p a to \p double, followed by ::fmin().
 *
 * Note, this is different from \p std:: specification
 */
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the minimum value of the input \p double and \p float arguments.
 *
 * Colwert \p float argument \p b to \p double, followed by ::fmin().
 *
 * Note, this is different from \p std:: specification
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p int and \p unsigned \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b, perform integer promotion first.
 */
__MATH_FUNCTIONS_DECL__ unsigned int max(const int a, const unsigned int b);

/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p unsigned \p int and \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p unsigned \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p long \p int and \p unsigned \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p unsigned \p long \p int and \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p long \p long \p int and \p unsigned \p long \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_INT
 * \brief Callwlate the maximum value of the input \p unsigned \p long \p long \p int and \p long \p long \p int arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b, perform integer promotion first.
 */
...
/**
 * \ingroup LWDA_MATH_SINGLE
 * \brief Callwlate the maximum value of the input \p float arguments.
 *
 * Callwlate the maximum value of the arguments \p a and \p b.
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the maximum value of the input \p float and \p double arguments.
 *
 * Colwert \p float argument \p a to \p double, followed by ::fmax().
 *
 * Note, this is different from \p std:: specification
 */
...
/**
 * \ingroup LWDA_MATH_DOUBLE
 * \brief Callwlate the maximum value of the input \p double and \p float arguments.
 *
 * Colwert \p float argument \p b to \p double, followed by ::fmax().
 *
 * Note, this is different from \p std:: specification
 */
...
extern "C"{
inline __device__ void *__lw_aligned_device_malloc(size_t size, size_t align)
{
  __device__ void *__lw_aligned_device_malloc_impl(size_t, size_t);
  return __lw_aligned_device_malloc_impl(size, align);
}
}
...
/*******************************************************************************
*                                                                              *
* ONLY FOR HOST CODE! NOT FOR DEVICE EXELWTION                                 *
*                                                                              *
*******************************************************************************/
...
__func__(double erfilw(double a));

__func__(double erfcilw(double a));

__func__(double normcdfilw(double a));
...
__func__(float erfilwf(float a));

__func__(float erfcilwf(float a));

__func__(float normcdfilwf(float a));
...
#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_MATH_FUNCTIONS_H__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_MATH_FUNCTIONS_H__
#endif

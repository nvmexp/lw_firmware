...
#if defined(_MSC_VER)
#pragma message("crt/common_functions.h is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead.")
#else
#warning "crt/common_functions.h is an internal header file and must not be used directly.  Please use lwda_runtime_api.h or lwda_runtime.h instead."
#endif
#define __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#define __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_COMMON_FUNCTIONS_H__
#endif
...
#ifndef __LWDA_API_VER_MAJOR__
#define __LWDA_API_VER_MAJOR__ __LWDACC_VER_MAJOR__
#endif /* __LWDA_API_VER_MAJOR__ */

#ifndef __LWDA_API_VER_MINOR__
#define __LWDA_API_VER_MINOR__ __LWDACC_VER_MINOR__
#endif /* __LWDA_API_VER_MINOR__ */
...
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete[](void*, void*) throw();
# if __cplusplus >= 201402L || (defined(_MSC_VER) && _MSC_VER >= 1900) || defined(__LWDA_XLC_CPP14__) || defined(__LWDA_ICC_CPP14__)
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete(void*, STD size_t) throw();
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete[](void*, STD size_t) throw();
#endif /* __cplusplus >= 201402L || (defined(_MSC_VER) && _MSC_VER >= 1900) || defined(__LWDA_XLC_CPP14__)  || defined(__LWDA_ICC_CPP14__) */
#endif /* __LWDACC_RTC__ */
...
__host__ __device__ __device_builtin__ __lwdart_builtin__ int     __cdecl printf(const char*, ...) __THROW;
#else /* newer glibc */
...
#if defined(_MSC_VER)
extern  __host__ __device__ __lwdart_builtin__ void*   __cdecl _alloca(size_t);
#endif
...
#if (__cplusplus >= 201103L)  && ((!(defined(__QNX__) && defined(_LIBCPP_VERSION))) || (defined(__QNX__) && __LW_GLIBCXX_VERSION >= 80300))
#define THROWBADALLOC 
#else
#if defined(__ANDROID__) && !defined(_LIBCPP_VERSION) && (defined(__BIONIC__) || __LW_GLIBCXX_VERSION < 40900)
#define THROWBADALLOC
#else
...
extern         __host__ __device__ __lwdart_builtin__ void*   __cdecl operator new(STD size_t, std::align_val_t);
extern         __host__ __device__ __lwdart_builtin__ void*   __cdecl operator new[](STD size_t, std::align_val_t);
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete(void*, std::align_val_t) noexcept;
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete[](void*, std::align_val_t) noexcept;
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete(void*, STD size_t, std::align_val_t) noexcept;
extern         __host__ __device__ __lwdart_builtin__ void    __cdecl operator delete[](void*, STD size_t, std::align_val_t) noexcept;
...
#if defined(__UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_COMMON_FUNCTIONS_H__)
#undef __LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS__
#undef __UNDEF_LWDA_INCLUDE_COMPILER_INTERNAL_HEADERS_COMMON_FUNCTIONS_H__
#endif

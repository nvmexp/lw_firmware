...
#include <b40c/util/lwca_properties.cuh>
...
struct KeysTex
{
	static texture<KeyType, lwcaTextureType1D, lwcaReadModeElementType> ref;
};
template <typename KeyType>
texture<KeyType, lwcaTextureType1D, lwcaReadModeElementType> KeysTex<KeyType>::ref;

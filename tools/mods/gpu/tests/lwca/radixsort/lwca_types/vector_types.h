...
#if !defined(__LWDA_LIBDEVICE__)
//#include "builtin_types.h"
#include "driver_types.h"
#endif /* !__LWDA_LIBDEVICE__ */
...
#define __lwda_builtin_vector_align8(tag, members) \
...
#else /* !__LWDACC__ && !__LWDABE__ && _WIN32 && !_WIN64 */
...
#endif /* !__LWDACC__ && !__LWDABE__ && _WIN32 && !_WIN64 */
...
__lwda_builtin_vector_align8(short4, short x; short y; short z; short w;);
__lwda_builtin_vector_align8(ushort4, unsigned short x; unsigned short y; unsigned short z; unsigned short w;);
...
__lwda_builtin_vector_align8(int2, int x; int y;);
__lwda_builtin_vector_align8(uint2, unsigned int x; unsigned int y;);
...
#if defined (_WIN32)
__lwda_builtin_vector_align8(long2, long int x; long int y;);
__lwda_builtin_vector_align8(ulong2, unsigned long int x; unsigned long int y;);
#else /* _WIN32 */
...
#if !defined(__LWDACC__) && !defined(__LWDABE__) && defined(__arm__) && \
...
{
    float x; float y; float __lwda_gnu_arm_ice_workaround[0];
};

#pragma GCC poison __lwda_gnu_arm_ice_workaround
#pragma GCC diagnostic pop

#else /* !__LWDACC__ && !__LWDABE__ && __arm__ && __ARM_PCS_VFP &&
         __GNUC__ == 4&& __GNUC_MINOR__ == 6 */

__lwda_builtin_vector_align8(float2, float x; float y;);

#endif /* !__LWDACC__ && !__LWDABE__ && __arm__ && __ARM_PCS_VFP &&
          __GNUC__ == 4&& __GNUC_MINOR__ == 6 */
...
#undef  __lwda_builtin_vector_align8

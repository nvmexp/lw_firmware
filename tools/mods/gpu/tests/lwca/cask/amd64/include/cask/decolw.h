#ifndef INCLUDE_GUARD_CASK_DECOLW_H
#define INCLUDE_GUARD_CASK_DECOLW_H

// enable doxygen:
//! @file

#if !defined(INCLUDE_GUARD_CASK_H)
# error "Never use <cask/decolw.h> directly; include <cask.h> instead."
#endif
...
typedef ShaderList<DecolwShader, Decolwolution> DecolwShaderList;
...
class
Decolwolution : public Operation {
public:
    ...
    /// \brief Ctor.
    ///
    /// Decolwolution constructor takes no parameters and expects the
    ...
    ///
    /// Decolwolution does not allocate or own resources, so the destructor
    /// does nothing.
    /////////////////////////////////////////////////////////////////////////
    virtual ~Decolwolution() {}
    ...
    /////////////////////////////////////////////////////////////////////////
    /// \brief Set Description::inputADesc with Y tensor desc.
    /////////////////////////////////////////////////////////////////////////
    inline void setYDesc(const TensorDesc &yDesc) {
        mDescription.inputADesc = yDesc;
    }
    ...
    /////////////////////////////////////////////////////////////////////////
    /// \brief Set Description::outputDesc with X tensor desc.
    /////////////////////////////////////////////////////////////////////////
    inline void setXDesc(const TensorDesc &xDesc) {
        mDescription.outputDesc = xDesc;
    }
...
//////////////////////////////////////////////////////////////////////////////
struct
DecolwShader : public Shader { // Shader (has name and hash)
    ...
    //////////////////////////////////////////////////////////////////////////
    DecolwShader(const KernelInfo* ki);
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual int yScalarsPerElement() const = 0;
    //////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual int yVectorizedDim() const = 0;
    //////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual const DecolwKernelInfo* getInfo() const;
    ...
    inline bool isNhwc() const {
        return getInfo()->yLayout() == md::ActivationLayoutType::NHWC;
    }
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual Error         canImplement(const Decolwolution& decolw) const;
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual Error         canImplement(const Decolwolution& decolw,
    ...
    ///          return code.
    /////////////////////////////////////////////////////////////////////////
    virtual Error updateRuntimeParameters(RunInfo& ri, platformStream_t lwdaStream);
    ...
    static DecolwShader* deserialize(const uint8_t* buffer, int64_t size);

};

} // namespace cask

#endif // INCLUDE_GUARD_CASK_DECOLW_H

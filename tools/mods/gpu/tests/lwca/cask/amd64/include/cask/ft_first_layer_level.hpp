#ifndef __FT_FIRST_LAYER_LEVEL_HPP__
#define __FT_FIRST_LAYER_LEVEL_HPP__
...
class ft_first_layer_level {
   public:
    ...
    static const uint32_t LEVEL_FILT_PAD_COUNT  = SCI(FL_FILTER_PAD_COUNT);
    static const uint32_t LEVEL_FL_FILT_K_COUNT = SCI(FL_FILTER_K_COUNT);
    static const uint32_t LEVEL_FL_INP_C_COUNT  = SCI(FL_INPUT_C_COUNT);

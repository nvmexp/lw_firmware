...
public:
    ...
    /////////////////////////////////////////////////////////////////////////
    /// \brief set isBlasl3InputTriangularRight flag. It is 0 by default
    /////////////////////////////////////////////////////////////////////////
    inline void setIsBlasl3InputTriangularRight(int isBlasl3InputTriangularRight) {
        mDescription.isBlasl3InputTriangularRight = isBlasl3InputTriangularRight == 1;
    }
...
GemmShader : public Shader {    // Shader (has name and handle)
    ...
    /////////////////////////////////////////////////////////////////////////
    /// \brief Overloaded run() with a additional metadata pointer for fp8
    ///
    /// The implementation is similar to the original run().
    /////////////////////////////////////////////////////////////////////////
    virtual Error
    run(RunInfo& ri,
        ...
        const void*  deviceAlphaPointer,
        const void*  deviceBetaPointer,
        const void*  deviceScaleAPointer,
        const void*  deviceScaleBPointer,
        const void*  deviceScaleCPointer,
        const void*  deviceScaleDPointer,
        platformStream_t lwdaStream);

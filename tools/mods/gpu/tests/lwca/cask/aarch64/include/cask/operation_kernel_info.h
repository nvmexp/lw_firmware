...
template<> struct OptionalMetadata< INPUT_TRIANGULAR_RIGHT   > { using type = bool;                };
...
struct TensorType {
    ...
    TensorType(cask::ScalarType scalar_type,
...
public:
    ...
    virtual BackboneType backboneType() const { return BackboneType::GEMM; }
    virtual uint64_t backboneHandle() const { return 0; }

    /////////////////////////////////////////////////////////////////////////
    /// \brief Return this kernel's aclwmulator data type.
    /////////////////////////////////////////////////////////////////////////
    virtual ScalarType     accScalarType()            const { return ScalarType::FP32; }
    /////////////////////////////////////////////////////////////////////////
    ...
    virtual TensorType     inputTensorType(int index)           const { return TensorType(); }
    virtual TensorType     outputTensorType(int index)          const { return TensorType(); }

...
public:
  ...
  ArgParser(void *args_data) : cask::tester::ArgParser(args_data) {
    ...
    std::vector<cask::tester::ParamDesc::Param> options{
      ...
      { "", "w.stride.filters",
        ...
        value<int64_t>(&(args_->w.stride.filters), -1) },
      { "", "c.stride.depth",
        "ConvolutionDgrad: c.stride.depth. Default: -1.",
        value<int64_t>(&(args_->c.stride.depth), -1) },
      { "", "c.stride.height",
        "ConvolutionDgrad: c.stride.height. Default: -1.",
        value<int64_t>(&(args_->c.stride.height), -1) },
      { "", "c.stride.width",
        "ConvolutionDgrad: c.stride.width. Default: -1.",
        value<int64_t>(&(args_->c.stride.width), -1) },
      { "", "c.stride.channels",
        "ConvolutionDgrad: c.stride.channels. Default: -1.",
        value<int64_t>(&(args_->c.stride.channels), -1) },
      { "", "c.stride.batches",
        "ConvolutionDgrad: c.stride.batches. Default: -1.",
  ...
  int parse(const int argc, const char *argv[], bool fail_on_bad_opt = true) {
    ...
    args_->valpha.elems = args_->dy.channels;
    args_->vbeta.elems = args_->dy.channels;
...
public:
  ...
  ArgParser(void *args_data) : cask::tester::ArgParser(args_data) {
    ...
    std::vector<cask::tester::ParamDesc::Param> options{
      ...
      { "", "c.stride.depth",
        "ConvolutionWgrad: c.stride.depth. Default: -1.",
        value<int64_t>(&(args_->c.stride.depth), -1) },
      { "", "c.stride.height",
        "ConvolutionWgrad: c.stride.height. Default: -1.",
        value<int64_t>(&(args_->c.stride.height), -1) },
      { "", "c.stride.width",
        "ConvolutionWgrad: c.stride.width. Default: -1.",
        value<int64_t>(&(args_->c.stride.width), -1) },
      { "", "c.stride.channels",
        "ConvolutionWgrad: c.stride.channels. Default: -1.",
        value<int64_t>(&(args_->c.stride.channels), -1) },
      { "", "c.stride.filters",
        "ConvolutionWgrad: c.stride.filters. Default: -1.",
        value<int64_t>(&(args_->c.stride.filters), -1) },
      { "", "groups",
  ...
  ArgParser(void *args_data) : cask::tester::ArgParser(args_data) {
    ...
    std::vector<cask::tester::ParamDesc::Param> options{
      ...
      { "", "w.stride.filters",
        ...
        value<int64_t>(&(args_->w.stride.filters), -1) },
      { "", "c.stride.depth",
        "Deconvolution: c.stride.depth. Default: -1.",
        value<int64_t>(&(args_->c.stride.depth), -1) },
      { "", "c.stride.height",
        "Deconvolution: c.stride.height. Default: -1.",
        value<int64_t>(&(args_->c.stride.height), -1) },
      { "", "c.stride.width",
        "Deconvolution: c.stride.width. Default: -1.",
        value<int64_t>(&(args_->c.stride.width), -1) },
      { "", "c.stride.channels",
        "Deconvolution: c.stride.channels. Default: -1.",
        value<int64_t>(&(args_->c.stride.channels), -1) },
      { "", "c.stride.batches",
        "Deconvolution: c.stride.batches. Default: -1.",
        value<int64_t>(&(args_->c.stride.batches), -1) },
      { "", "bias.stride.elems",

...
class LwLinkThroughputCountersV3 : public LwLinkThroughputCountersImpl
{
public:
    LwLinkThroughputCountersV3() = default;
    virtual ~LwLinkThroughputCountersV3() { }
private:
    ...
    virtual RC CaptureCounter(LwLinkThroughputCount::CounterId counterId, UINT32 linkId);
};

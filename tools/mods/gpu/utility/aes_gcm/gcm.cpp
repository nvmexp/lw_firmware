...
*         http://csrc.nist.gov/groups/ST/toolkit/BCM/dolwments/proposedmodes/
 ...
 *
 *  This code was developed for use within SQRL's fixed elwironmnent. Thus, it
 ...
 *  is being ilwoked by its author or by someone who understands the values it
...
/* Callwlating the "GHASH"
 *
 * There are many ways of callwlating the so-called GHASH in software, each with
 ...
 *  and populates the gcm context's pre-callwlated HTables.
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 *    GCM processing oclwrs four phases: SETKEY, START, UPDATE and FINISH.
 *
 *  SETKEY: 
 *  
...
{   /*
       assuming that the caller has already ilwoked gcm_setkey to
       prepare the gcm context with the keying material, we simply
       ilwoke each of the three GCM sub-functions in turn...
    */

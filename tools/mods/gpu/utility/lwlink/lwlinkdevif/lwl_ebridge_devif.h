...
#ifndef INCLUDED_LWL_EBRIDGE_DEVIF_H
#define INCLUDED_LWL_EBRIDGE_DEVIF_H
...
{
    //--------------------------------------------------------------------------
    //! \brief Interface definition for interacting with Ebridge LwLink devices
    class EbridgeInterface : public Interface
    {
    public:
        EbridgeInterface();
        virtual ~EbridgeInterface();
    private:
        ...
        vector<TestDevicePtr> m_Devices; //!< List of ebridge devices

...
RC SamsungHbm2XDieGA100::RowRepair
(
...
RC SamsungHbm2XDieGA100::PrintRepairedRows() const
{
    MASSERT(IsSetup());
    RC rc;
...
RC SamsungHbm2XDieGA100::ForEachFbpaSetRegister(ModsGpuRegAddress address, UINT32 value) const
{
    RC rc;
    ...
    Settings *pSettings = pGpuIntf->GetSettings();
    MASSERT(pSettings);
    ...
    for (UINT32 hbmSiteId = 0; hbmSiteId < numHbmSites; ++hbmSiteId)
    {
        ...
        for (UINT32 fbp : {fbpNum0, fbpNum1})
        {
            ...
            for (UINT32 n = 0; n < fbpasPerFbp; ++n)
            {
                ...
                Repair::Write32(*pSettings, regs, address, fbpa, value);
            }
        }
    }
...
RC SamsungHbm2XDieGA100::DoEnableFuseScanIoPinSetup() const
{
    RC rc;
    ...
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_CONFIG, 0x00000004);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_CONFIGREG, 0x20234101);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 0, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 1, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 2, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 3, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 4, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 5, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 6, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 7, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 8, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 9, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 10, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 11, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 12, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 13, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 14, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 15, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 16, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 17, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 18, 0xFFFFFFFC);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 19, 0xFFFFFFFF);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 20, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 21, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 22, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 23, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 24, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 25, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 26, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 27, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 28, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 29, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 30, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 31, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 32, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 33, 0x55555555);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 34, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 35, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 36, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 37, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 38, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 39, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 40, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 41, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 42, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 43, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 44, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 45, 0x00000000);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 46, 0x22222222);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PBUF1_x, 47, 0x22222222);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_CONFIG, 0x0000001C);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 0, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 1, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 2, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 3, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 4, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 5, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 6, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 7, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 8, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 9, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 10, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 11, 0x0000090C);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 12, 0x00000021);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 13, 0x00000021);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 14, 0x00000021);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_LANE_x_CONFIG, 15, 0x00000021);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PRBS_HBM_0, 0x3456789A);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PRBS_HBM_1, 0x00000000);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PROTOCOLGEN_0, 0x142850C0);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PROTOCOLGEN_1, 0xA142850A);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PROTOCOLGEN_2, 0x0A142850);
    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_PROTOCOLGEN_3, 0x00014285);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_FBCONFIG, 0x00094200);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_FBCONFIG2, 0x000009FC);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_FBREFCLKCNT, 0xFFFFFFFE);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_FBRDQSPATBUF, 0x0000AAAA);

    Repair::Write32(*pSettings, regs, MODS_FBIO_BIST_FBCONFIG, 0x02094200);
...
RC SamsungHbm2XDieGA100::DoEnableFuseScan
(
    const Site& hbmSite,
...
RC SamsungHbm2XDieGA100::HardRowRepair
(
    const Settings& settings,
...
RC SamsungHbm2XDieGA100::SoftRowRepair
(
    const Settings& settings,
    const SiteRowErrorMap& siteRowErrorMap
) const
...
RC SamsungHbm2XDieGA100::GetNumSpareRowsAvailable
(
    const Site& hbmSite,
    const HbmChannel& hbmChannel,
    const Stack& stack,
    ...
    *pNumRowsAvailable = 0;
    ...
    for (UINT32 spareRow = 0; spareRow < s_NumSpareRowsPerBank; ++spareRow)
    {
             ...
             pseudoChannel++)
        {
            ...
            CHECK_RC(DoEnableFuseScanWar(hbmSite, stack));
            ...
            // instructions.
            CHECK_RC(pGpuIntf->WirWrite(*pWirBypass, hbmSite, Wir::CHANNEL_SELECT_ALL, WdrData({0})));
            pGpuIntf->SleepMs(1);
...
RC SamsungHbm2XDieGA100::DoEnableFuseScanWar
(
    const Site& hbmSite,
    const Stack& stack
) const
{
    ...
    constexpr UINT32 warWaitTimeMs = 1;

    // 3 TMRS Shifts
    CHECK_RC(pGpuIntf->WirWriteRaw(*pWirTmrs, hbmSite, Wir::CHANNEL_SELECT_ALL));
    CHECK_RC(pGpuIntf->ModeWriteRaw(*pWirTmrs, hbmSite));
    pGpuIntf->SleepMs(warWaitTimeMs);
    CHECK_RC(pGpuIntf->WdrWriteRaw(hbmSite, Wir::CHANNEL_SELECT_ALL, {0x00500008}));
    CHECK_RC(pGpuIntf->WdrWriteRaw(hbmSite, Wir::CHANNEL_SELECT_ALL, {0x0000000E}));
    ...
    CHECK_RC(pGpuIntf->ModeWriteRaw(*pWirTmrs, hbmSite));
    pGpuIntf->SleepMs(warWaitTimeMs);
    CHECK_RC(pGpuIntf->WdrWriteRaw(hbmSite, Wir::CHANNEL_SELECT_ALL, {0x00020001}));
    CHECK_RC(pGpuIntf->WdrWriteRaw(hbmSite, Wir::CHANNEL_SELECT_ALL, {0x0000000D}));

    pGpuIntf->SleepMs(warWaitTimeMs);

    UINT32 sidTmrsData = (stack.Number() == 0) ? 0x8 : 0x4;
    CHECK_RC(pGpuIntf->WirWriteRaw(*pWirTmrs, hbmSite, Wir::CHANNEL_SELECT_ALL));
    CHECK_RC(pGpuIntf->ModeWriteRaw(*pWirTmrs, hbmSite));
    pGpuIntf->SleepMs(warWaitTimeMs);
    CHECK_RC(pGpuIntf->WdrWriteRaw(hbmSite, Wir::CHANNEL_SELECT_ALL, {0x01010100}));
    CHECK_RC(pGpuIntf->WdrWriteRaw(hbmSite, Wir::CHANNEL_SELECT_ALL, {sidTmrsData}));

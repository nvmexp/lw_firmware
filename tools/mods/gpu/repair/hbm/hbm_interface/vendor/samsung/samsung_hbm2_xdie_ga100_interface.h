...
{
    //!
    //! \brief Samsung HBM2 X-die interface for GA100.
    //!
    ...
    //!
    class SamsungHbm2XDieGA100 : public SamsungHbm2XDie
    {
    ...
    private:
        ...
        //!
        //! \brief WAR required after eveery reset for enable fuse scan.
        //!
        //! \param hbmSite HBM site.
        //! \param stack Stack ID.
        //!
        RC DoEnableFuseScanWar(const Site& hbmSite, const Stack& stack) const;

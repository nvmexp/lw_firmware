...
function specBasic(testList)
{
    testList.AddTests([
       ...
       ,["CheckConfig2", g_VerboseL0] // -test 350
       ,["CheckHotPlug", g_VerboseL0] // -test 8
       ...
       ,["ElpgGraphicsStress", g_VerboseL2] // -test 122
       ...
       ,["Random2dNc", { // -test 9
        ...
        ,["LwvddStress", g_VerboseL2] // -test 300
        ,["PcieSpeedChange", g_VerboseL0] // -test 30
        ,["PerfPunish", g_VerboseL1] // -test 6
        ,["PerfSwitch", g_VerboseL1] // -test 145
        ,["PexBandwidth", g_VerboseL0] // -test 146
        ,["PexMargin", g_VerboseL1] // -test 165
        ,["PwrRegCheck", g_VerboseL2] // -test 394
        ,["QuickSlowdown", g_VerboseL2] // -test 319
    ]);
}
...
function specCask(testList)
{
    ...
    testList.AddTests([
       ...
       ,["CaskLinpackPulseDgemm", caskArgsL1] // -test 605
       ,["CaskLinpackPulseDMMAgemm", caskArgsL1] // -test 615
       ,["CaskLinpackPulseE8M10", caskArgsL1] // -test 621
       ,["CaskLinpackPulseE8M7", caskArgsL1] // -test 623
       ,["CaskLinpackPulseHgemm", caskArgsL1] // -test 607
       ,["CaskLinpackPulseHMMAgemm", caskArgsL1] // -test 611
       ,["CaskLinpackPulseIgemm", caskArgsL1] // -test 603
       ,["CaskLinpackPulseIMMAgemm", caskArgsL1] // -test 613
       ,["CaskLinpackPulseINT4", caskArgsL1] // -test 643
       ,["CaskLinpackPulseSparseHMMA", caskArgsL1] // -test 631
       ,["CaskLinpackPulseSparseIMMA", caskArgsL1] // -test 633
       ,["LwdaLinpackCombi", {
            TestDescription: "Level1",
            RuntimeMs: 0,
            TestConfiguration: { Verbose: true, Loops : 10 },
            Ksize: 128,
            fgTestArg: caskArgsL1,
            bgTestArg: caskArgsL1
        }]
    ]);
}
...
function specVulkan(testList)
{
    ...
    testList.AddTests([
        ...
        ,["VkStressRay", vkStressArgsL0] // -test 368
    ]);
}

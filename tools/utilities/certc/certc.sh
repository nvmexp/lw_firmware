...
#
# This script file is written to run CERTC and commit defects on server.
...
export STREAM="ACR_chips_a"
#Stream must be specified so that can be filtered @server

export TARGET_PROFILE="acr_chips_a_tu10x_ahesasc_eaes_certc"
#Must Specify as will be added to DESCRIPTION

export ACRCFG_PROFILE="acr_sec2-tu10x_ahesasc"
#Comment it if you want to build all profiles

export BUILD_PATH=$P4ROOT/sw/$GPGPU_BRANCH/uproc/acr/src/
#---------------------------------------------------

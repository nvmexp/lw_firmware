...
export STREAM="SEC2_RISCV_gpu_drv_chips"
#Stream must be specified so that can be filtered @server

export TARGET_PROFILE="sec2-rv-gh100_eaes_certc"
#Must Specify as will be added to DESCRIPTION

export SEC2CFG_PROFILE="sec2-gh100"
#Comment it if you want to build all profiles

export BUILD_PATH=$P4ROOT/sw/$GPGPU_BRANCH/uproc/sec2_riscv/src/
#---------------------------------------------------

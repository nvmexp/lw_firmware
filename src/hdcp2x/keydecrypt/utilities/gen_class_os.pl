...
{
  my $arg = "";
  my $hdr_file = "", my $dmp_file = "", my $path_vpm = "$ELW{'LW_TOOLS'}/falcon-gcc/falcon6/6.2.1/Linux/falcon-elf-gcc/bin";
...
sub write_hdr
{
  ...
  print SRC_FILE ""."\n";
  print SRC_FILE ""."\n";
  print SRC_FILE "LwU32 hkd_ucode_data_".$chip."[] = {\n";
  ...
  print SRC_FILE "// \n";
  print SRC_FILE "// \n";
  print SRC_FILE " LwU32 hkd_ucode_header_".$chip."[] = {\n";
  my $count;
...
# print("array size: $arrsize\n");
  ...
  print SRC_FILE "\nLwU32 hkd_ucode_data"."_size_".$chip." = $ucode_size_dwords;\n"; #ucode_size in DWORDS

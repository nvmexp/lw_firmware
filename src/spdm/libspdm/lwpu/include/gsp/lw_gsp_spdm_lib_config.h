...
#ifndef _LW_GSP_SPDM_LIB_CONFIG_
#define _LW_GSP_SPDM_LIB_CONFIG_
#include "cc_rts.h"

/*!
 * @file   lw_gsp_spdm_lib_config.h
...
#define MAX_SPDM_MEASUREMENT_BLOCK_COUNT        CC_MSR_NUM
#define MAX_SPDM_MEASUREMENT_RECORD_SIZE        (CC_MSR_NUM * (CC_MEASUREMENT_HASH_SIZE_BYTE + sizeof(spdm_measurement_block_dmtf_t)))
...
#endif // _LW_GSP_SPDM_LIB_CONFIG_

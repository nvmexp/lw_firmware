	...
	IN spdm_context_t *spdm_context)
{
	...
	if (spdm_context->local_context.selwred_message_version
		    .spdm_version_count == 0) {
		return 0;
	}

	size = sizeof(selwred_message_general_opaque_data_table_header_t) +
	       sizeof(selwred_message_opaque_element_table_header_t) +
	       sizeof(selwred_message_opaque_element_version_selection_t);
	// Add Padding
	return (size + 3) & ~3;
}
	...
	IN spdm_context_t *spdm_context)
{
	...
	size = sizeof(selwred_message_general_opaque_data_table_header_t) +
	       sizeof(selwred_message_opaque_element_table_header_t) +
	       sizeof(selwred_message_opaque_element_supported_version_t) +
					      ...
					      OUT void *data_out)
{
	...
	general_opaque_data_table_header->spec_id =
		SELWRED_MESSAGE_OPAQUE_DATA_SPEC_ID;
	general_opaque_data_table_header->opaque_version =
		SELWRED_MESSAGE_OPAQUE_VERSION;
	...
	opaque_element_support_version->sm_data_version =
		SELWRED_MESSAGE_OPAQUE_ELEMENT_SMDATA_DATA_VERSION;
	opaque_element_support_version->sm_data_id =
		SELWRED_MESSAGE_OPAQUE_ELEMENT_SMDATA_ID_SUPPORTED_VERSION;
					      ...
					      OUT void *data_out)
{
	...
	OpaqueElementVersionSection->sm_data_id =
		SELWRED_MESSAGE_OPAQUE_ELEMENT_SMDATA_ID_VERSION_SELECTION;

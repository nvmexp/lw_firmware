...
// LWE (tandrewprinz) LW_COVERITY: Adding return status for checking.
	...
	// Cache
	//
	// LWE (tandrewprinz) LW_COVERITY: Add check for return value.
	// Return ILWALID_REQUEST error response upon failure.
	//

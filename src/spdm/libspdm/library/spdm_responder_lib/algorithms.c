...
// Global structures have had their location specified via GCC_ATTRIB_SECTION.
//
...
uint32 m_hash_priority_table[]
    GCC_ATTRIB_SECTION("dmem_spdm", "m_hash_priority_table") = {
...
uint32 m_asym_priority_table[]
    GCC_ATTRIB_SECTION("dmem_spdm", "m_asym_priority_table") = {
...
uint32 m_req_asym_priority_table[]
    GCC_ATTRIB_SECTION("dmem_spdm", "m_req_asym_priority_table") = {
#if OPENSPDM_RSA_PSS_SUPPORT == 1
	SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_4096,
	SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_3072,
	SPDM_ALGORITHMS_BASE_ASYM_ALGO_TPM_ALG_RSAPSS_2048,
...
uint32 m_dhe_priority_table[]
    GCC_ATTRIB_SECTION("dmem_spdm", "m_dhe_priority_table") = {
...
uint32 m_aead_priority_table[]
    GCC_ATTRIB_SECTION("dmem_spdm", "m_aead_priority_table") = {
// LWE (tandrewprinz) LW_LWSTOM_ALG: Adding support for LW-defined AEAD.
#if OPENSPDM_AEAD_AES_CTR_HMAC_SHA == 1
	SPDM_ALGORITHMS_AEAD_CIPHER_SUITE_AES_128_CTR_HMAC_SHA_256,
#endif
...
uint32 m_key_schedule_priority_table[]
    GCC_ATTRIB_SECTION("dmem_spdm", "m_key_schedule_priority_table") = {
	SPDM_ALGORITHMS_KEY_SCHEDULE_HMAC_HASH,
};

uint32 m_measurement_hash_priority_table[]
     GCC_ATTRIB_SECTION("dmem_spdm", "m_measurement_hash_priority_table") = {
#if OPENSPDM_SHA256_SUPPORT == 1
...
uint32 m_measurement_spec_priority_table[] 
    GCC_ATTRIB_SECTION("dmem_spdm", "m_measurement_spec_priority_table") = {

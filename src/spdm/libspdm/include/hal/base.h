...
// LWE (tandrewprinz): Included LWPU copyright, as file contains LWPU modifications.
...
//
// LWE (tandrewprinz): Including section macro to specify overlay placement.
// Copied from lwuproc.h so that we didn't have to include the entire file.
//
...
/// NULL pointer (void *)
///
// LWE (tandrewprinz): Only define NULL if not already defined.
#ifndef NULL
#define NULL ((void *)0)
#endif
...
//
// LWE (tandrewprinz): BIT32 has different meaning in some LWPU headers.
// Ensure we use the expected version in libSPDM.
//
#ifdef BIT32
#undef BIT32
#endif
...
#else
// LWE (tandrewprinz): Use ct_assert for static asserts.
#include <lwctassert.h>
#define STATIC_ASSERT(x, y) ct_assert(x)
#endif
...
//
// status codes common to all exelwtion phases
//
...
/**
  ...
  @param  status_code    The status code value to colwert into a warning code.
...
///
#define RETURN_ILWALID_PARAMETER ENCODE_ERROR(2)
...
/// parameter when this error oclwrs.
///
...
///
/// An ICMP error oclwrred during the network operation.
///
#define RETURN_ICMP_ERROR ENCODE_ERROR(22)

///
/// A TFTP error oclwrred during the network operation.
///
#define RETURN_TFTP_ERROR ENCODE_ERROR(23)

///
/// A protocol error oclwrred during the network operation.
///
...
///
#define RETURN_SELWRITY_VIOLATION ENCODE_ERROR(26)
...
///
#define RETURN_ILWALID_LANGUAGE ENCODE_ERROR(32)
...
///
/// A HTTP error oclwrred during the network operation.
///
...
/**
    ...
    the instruction in the calling function that will be exelwted after
...
//
// LWE (tandrewprinz): Include header for baseline memory funcitonality.
// Makes compilation cleaner, especially when specifying sections.
//

...
uint32 spdm_get_hash_size(IN uint32 bash_hash_algo)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_hash_size");
...
boolean spdm_hash_all(IN uint32 bash_hash_algo, IN const void *data,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_hash_all");
...
uint32 spdm_get_measurement_hash_size(IN uint32 measurement_hash_algo)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_measurement_hash_size");
...
boolean spdm_measurement_hash_all(IN uint32 measurement_hash_algo,
				  ...
				  OUT uint8 *hash_value)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_measurement_hash_all");
...
boolean spdm_hmac_all(IN uint32 bash_hash_algo, IN const void *data,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_hmac_all");
...
boolean spdm_hkdf_expand(IN uint32 bash_hash_algo, IN const uint8 *prk,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_hkdf_expand");
...
uint32 spdm_get_asym_signature_size(IN uint32 base_asym_algo)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_asym_signature_size");
...
boolean spdm_asym_get_public_key_from_x509(IN uint32 base_asym_algo,
					   ...
					   IN uintn cert_size,
					   OUT void **context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_asym_get_public_key_from_x509");
...
void spdm_asym_free(IN uint32 base_asym_algo, IN void *context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_asym_free");
...
boolean spdm_asym_verify(IN uint32 base_asym_algo, IN uint32 bash_hash_algo,
			 ...
			 IN uintn sig_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_asym_verify");
...
boolean spdm_asym_get_private_key_from_pem(IN uint32 base_asym_algo,
					   ...
					   IN const char8 *password,
					   OUT void **context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_asym_get_private_key_from_pem");
...
boolean spdm_asym_sign(IN uint32 base_asym_algo, IN uint32 bash_hash_algo,
		       ...
		       IN uintn message_size, OUT uint8 *signature,
		       IN OUT uintn *sig_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_asym_sign");
...
uint32 spdm_get_req_asym_signature_size(IN uint16 req_base_asym_alg)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_req_asym_signature_size");
...
boolean spdm_req_asym_get_public_key_from_x509(IN uint16 req_base_asym_alg,
					       ...
					       IN uintn cert_size,
					       OUT void **context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_req_asym_get_public_key_from_x509");
...
void spdm_req_asym_free(IN uint16 req_base_asym_alg, IN void *context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_req_asym_free");
...
boolean spdm_req_asym_verify(IN uint16 req_base_asym_alg,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_req_asym_verify");
...
boolean spdm_req_asym_get_private_key_from_pem(IN uint16 req_base_asym_alg,
					       ...
					       IN const char8 *password,
					       OUT void **context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_req_asym_get_private_key_from_pem");
...
boolean spdm_req_asym_sign(IN uint16 req_base_asym_alg,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_req_asym_sign");
...
uint32 spdm_get_dhe_pub_key_size(IN uint16 dhe_named_group)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_dhe_pub_key_size");
...
void *spdm_dhe_new(IN uint16 dhe_named_group)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_dhe_new");
...
void spdm_dhe_free(IN uint16 dhe_named_group, IN void *context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_dhe_free");
...
boolean spdm_dhe_generate_key(IN uint16 dhe_named_group, IN OUT void *context,
			      OUT uint8 *public_key,
			      IN OUT uintn *public_key_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_dhe_generate_key");
...
boolean spdm_dhe_compute_key(IN uint16 dhe_named_group, IN OUT void *context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_dhe_compute_key");
...
uint32 spdm_get_aead_key_size(IN uint16 aead_cipher_suite)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_aead_key_size");
...
uint32 spdm_get_aead_iv_size(IN uint16 aead_cipher_suite)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_aead_iv_size");
...
uint32 spdm_get_aead_tag_size(IN uint16 aead_cipher_suite)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_aead_tag_size");
...
uint32 spdm_get_aead_block_size(IN uint16 aead_cipher_suite)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_aead_block_size");
...
boolean spdm_aead_encryption(IN uint16 aead_cipher_suite, IN const uint8 *key,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_aead_encryption");
...
boolean spdm_aead_decryption(IN uint16 aead_cipher_suite, IN const uint8 *key,
			     ...
			     IN uintn tag_size, OUT uint8 *data_out,
			     OUT uintn *data_out_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_aead_decryption");
...
void spdm_get_random_number(IN uintn size, OUT uint8 *rand)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_random_number");
...
boolean spdm_x509_certificate_check(IN const uint8 *cert, IN uintn cert_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_x509_certificate_check");
...
return_status spdm_get_dmtf_subject_alt_name_from_bytes(
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_dmtf_subject_alt_name_from_bytes");
...
spdm_get_dmtf_subject_alt_name(IN const uint8 *cert, IN intn cert_size,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_dmtf_subject_alt_name");
...
boolean spdm_verify_cert_chain_data(IN uint8 *cert_chain_data,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_verify_cert_chain_data");
...
boolean spdm_verify_certificate_chain_buffer(IN uint32 bash_hash_algo,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_verify_certificate_chain_buffer");
...
uintn get_spdm_hash_nid(IN uint32 bash_hash_algo)
    GCC_ATTRIB_SECTION("imem_libspdm", "get_spdm_hash_nid");

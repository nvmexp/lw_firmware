...
typedef enum {
	...
	SPDM_DATA_SELWRED_MESSAGE_VERSION,
	//
	// SPDM capability
	//
...
/**
  ...
  @retval RETURN_ILWALID_PARAMETER     The data is NULL or the data_type is zero.
...
return_status spdm_set_data(IN void *spdm_context,
			    ...
			    IN uintn data_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_set_data");
...
/**
  ...
  @retval RETURN_SUCCESS               The SPDM context data is set successfully.
  @retval RETURN_ILWALID_PARAMETER     The data_size is NULL or the data is NULL and *data_size is not zero.
  @retval RETURN_UNSUPPORTED           The data_type is unsupported.
...
return_status spdm_get_data(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_data");
...
uint32 spdm_get_last_error(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_last_error");
...
void spdm_get_last_spdm_error_struct(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_last_spdm_error_struct");
...
void spdm_set_last_spdm_error_struct(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_set_last_spdm_error_struct");
...
void spdm_init_context(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_init_context");
...
uintn spdm_get_context_size(void)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_context_size");

/**
  Send an SPDM transport layer message to a device.

  The message is an SPDM message with transport layer wrapper,
  or a selwred SPDM message with transport layer wrapper.
  ...
  @param  timeout                      The timeout, in 100ns units, to use for the exelwtion
  ...
  @retval RETURN_DEVICE_ERROR          A device error oclwrs when the SPDM message is sent to the device.
  @retval RETURN_ILWALID_PARAMETER     The message is NULL or the message_size is zero.
  @retval RETURN_TIMEOUT               A timeout oclwrred while waiting for the SPDM message
                                       to execute.
**/
...
/**
  ...
  @retval RETURN_DEVICE_ERROR          A device error oclwrs when the SPDM message is received from the device.
  @retval RETURN_ILWALID_PARAMETER     The message is NULL, message_size is NULL or
...
void spdm_register_device_io_func(
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_register_device_io_func");

/**
  Encode an SPDM or APP message to a transport layer message.

  For normal SPDM message, it adds the transport layer wrapper.
  For selwred SPDM message, it encrypts a selwred message then adds the transport layer wrapper.
  For selwred APP message, it encrypts a selwred message then adds the transport layer wrapper.
...
/**
  ...
  For selwred SPDM message, it removes the transport layer wrapper, then decrypts and verifies a selwred message.
  For selwred APP message, it removes the transport layer wrapper, then decrypts and verifies a selwred message.
...
void spdm_register_transport_layer_func(
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_register_transport_layer_func");

//
// LWE (tandrewprinz) LW_REMOVE_FP: To remove reliance of transport layer on FP,
// add declarations for transport encode/decode functions which will be called directly.
// The functions "spdm_transport_encode_message" and "spdm_transport_decode_message"
// must be implemented by the consumer utilizing the libspdm module.
//
/**
  Encode an SPDM or APP message to a transport layer message.
...
return_status spdm_transport_encode_message (
    ...
    IN void *spdm_message, IN OUT uintn *transport_message_size,
    OUT void *transport_message)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_transport_encode_message");
...
return_status spdm_transport_decode_message(
    ...
    IN uintn transport_message_size, IN void *transport_message,
    IN OUT uintn *message_size, OUT void *message)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_transport_decode_message");
...
void spdm_reset_message_a(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_reset_message_a");
...
void spdm_reset_message_b(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_reset_message_b");
...
void spdm_reset_message_c(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_reset_message_c");
...
void spdm_reset_message_mut_b(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_reset_message_mut_b");
...
void spdm_reset_message_mut_c(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_reset_message_mut_c");
...
void spdm_reset_message_m(IN void *spdm_context)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_reset_message_m");
...
return_status spdm_append_message_a(IN void *spdm_context, IN void *message,
				    IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_a");
...
return_status spdm_append_message_b(IN void *spdm_context, IN void *message,
				    IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_b");
...
return_status spdm_append_message_c(IN void *spdm_context, IN void *message,
				    IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_c");
...
return_status spdm_append_message_mut_b(IN void *spdm_context, IN void *message,
					IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_mut_b");
...
return_status spdm_append_message_mut_c(IN void *spdm_context, IN void *message,
					IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_mut_c");
...
return_status spdm_append_message_m(IN void *spdm_context, IN void *message,
				    IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_m");
...
return_status spdm_append_message_k(IN void *spdm_session_info,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_k");
...
return_status spdm_append_message_f(IN void *spdm_session_info,
				    IN void *message, IN uintn message_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_append_message_f");
...
void *spdm_get_session_info_via_session_id(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_session_info_via_session_id");
...
void *spdm_get_selwred_message_context_via_session_id(IN void *spdm_context,
						      IN uint32 session_id)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_selwred_message_context_via_session_id");
...
spdm_get_selwred_message_context_via_session_info(IN void *spdm_session_info)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_selwred_message_context_via_session_info");
...
void *spdm_assign_session_id(IN void *spdm_context, IN uint32 session_id,
			     IN boolean use_psk)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_assign_session_id");
...
void *spdm_free_session_id(IN void *spdm_context, IN uint32 session_id)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_free_session_id");

/*
  This function callwlates current TH data with message A and message K.
  ...
  @retval RETURN_SUCCESS  current TH data is callwlated.
*/
boolean spdm_callwlate_th_for_exchange(
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_callwlate_th_for_exchange");

/*
  This function callwlates current TH data with message A, message K and message F.
  ...
  @retval RETURN_SUCCESS  current TH data is callwlated.
*/
boolean spdm_callwlate_th_for_finish(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_callwlate_th_for_finish");

/*
  This function callwlates th1 hash.
  ...
  @retval RETURN_SUCCESS  th1 hash is callwlated.
*/
return_status spdm_callwlate_th1_hash(IN void *spdm_context,
				      IN void *spdm_session_info,
				      IN boolean is_requester,
				      OUT uint8 *th1_hash_data)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_callwlate_th1_hash");

/*
  This function callwlates th2 hash.
  ...
  @retval RETURN_SUCCESS  th2 hash is callwlated.
*/
return_status spdm_callwlate_th2_hash(IN void *spdm_context,
				      IN void *spdm_session_info,
				      IN boolean is_requester,
				      OUT uint8 *th2_hash_data)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_callwlate_th2_hash");
...
boolean spdm_get_peer_cert_chain_buffer(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_peer_cert_chain_buffer");
...
boolean spdm_get_peer_cert_chain_data(IN void *spdm_context,
    ...
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_peer_cert_chain_data");
...
boolean spdm_get_local_cert_chain_buffer(IN void *spdm_context,
					 OUT void **cert_chain_buffer,
					 OUT uintn *cert_chain_buffer_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_local_cert_chain_buffer");
...
boolean spdm_get_local_cert_chain_data(IN void *spdm_context,
				       OUT void **cert_chain_data,
				       OUT uintn *cert_chain_data_size)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_get_local_cert_chain_data");
...
uint32 spdm_read_uint24(IN uint8 *buffer)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_read_uint24");
...
uint32 spdm_write_uint24(IN uint8 *buffer, IN uint32 value)
    GCC_ATTRIB_SECTION("imem_libspdm", "spdm_write_uint24");

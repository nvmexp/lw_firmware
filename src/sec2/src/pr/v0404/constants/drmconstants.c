...
/* Rights */
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_RIGHT_NONE                        [] =  { DRM_INIT_WCHAR_OBFUS('N'),  DRM_INIT_WCHAR_OBFUS('o'),  DRM_INIT_WCHAR_OBFUS('n'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('\0')};
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_RIGHT_PLAYBACK                    [] =  { DRM_INIT_WCHAR_OBFUS('P'),  DRM_INIT_WCHAR_OBFUS('l'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('y'),  DRM_INIT_WCHAR_OBFUS('\0')};
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_RIGHT_COLLABORATIVE_PLAY          [] =  { DRM_INIT_WCHAR_OBFUS('C'),  DRM_INIT_WCHAR_OBFUS('o'),  DRM_INIT_WCHAR_OBFUS('l'),  DRM_INIT_WCHAR_OBFUS('l'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('b'),  DRM_INIT_WCHAR_OBFUS('o'),  DRM_INIT_WCHAR_OBFUS('r'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('t'),  DRM_INIT_WCHAR_OBFUS('i'),  DRM_INIT_WCHAR_OBFUS('v'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('P'),  DRM_INIT_WCHAR_OBFUS('l'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('y'),  DRM_INIT_WCHAR_OBFUS('\0')};
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_RIGHT_COPY_TO_CD                  [] =  { DRM_INIT_WCHAR_OBFUS('P'),  DRM_INIT_WCHAR_OBFUS('r'),  DRM_INIT_WCHAR_OBFUS('i'),  DRM_INIT_WCHAR_OBFUS('n'),  DRM_INIT_WCHAR_OBFUS('t'),  DRM_INIT_WCHAR_OBFUS('.'),  DRM_INIT_WCHAR_OBFUS('r'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('d'),  DRM_INIT_WCHAR_OBFUS('b'),  DRM_INIT_WCHAR_OBFUS('o'),  DRM_INIT_WCHAR_OBFUS('o'),  DRM_INIT_WCHAR_OBFUS('k'),  DRM_INIT_WCHAR_OBFUS('\0')};
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_RIGHT_COPY                        [] =  { DRM_INIT_WCHAR_OBFUS('C'),  DRM_INIT_WCHAR_OBFUS('o'),  DRM_INIT_WCHAR_OBFUS('p'),  DRM_INIT_WCHAR_OBFUS('y'),  DRM_INIT_WCHAR_OBFUS('\0')};
/* "CreateThumbnailImage" */
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_RIGHT_CREATE_THUMBNAIL_IMAGE      [] =  { DRM_INIT_WCHAR_OBFUS('C'),  DRM_INIT_WCHAR_OBFUS('r'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('t'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('T'),  DRM_INIT_WCHAR_OBFUS('h'),  DRM_INIT_WCHAR_OBFUS('u'),  DRM_INIT_WCHAR_OBFUS('m'),  DRM_INIT_WCHAR_OBFUS('b'),  DRM_INIT_WCHAR_OBFUS('n'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('i'),  DRM_INIT_WCHAR_OBFUS('l'),  DRM_INIT_WCHAR_OBFUS('I'),  DRM_INIT_WCHAR_OBFUS('m'),  DRM_INIT_WCHAR_OBFUS('a'),  DRM_INIT_WCHAR_OBFUS('g'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('\0') };
...
/* deleted" */
DRM_STR_CONST        DRM_WCHAR      g_rgwchDRM_LS_DELETED_ATTR                   [] =  { DRM_INIT_WCHAR_OBFUS('d'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('l'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('t'),  DRM_INIT_WCHAR_OBFUS('e'),  DRM_INIT_WCHAR_OBFUS('d'),  DRM_INIT_WCHAR_OBFUS('\0') };
...
DRM_STR_CONST        DRM_WCHAR      g_rgwchAttributeVersion4_3Value              [] =  { DRM_INIT_WCHAR_OBFUS('4'),  DRM_INIT_WCHAR_OBFUS('.'),  DRM_INIT_WCHAR_OBFUS('3'),  DRM_INIT_WCHAR_OBFUS('.'),  DRM_INIT_WCHAR_OBFUS('0'),  DRM_INIT_WCHAR_OBFUS('.'),  DRM_INIT_WCHAR_OBFUS('0'),  DRM_INIT_WCHAR_OBFUS('\0')};
...
DRM_STR_CONST        DRM_CHAR       g_rgchTagKID                                 [] =  { DRM_INIT_CHAR_OBFUS('K'),   DRM_INIT_CHAR_OBFUS('I'),   DRM_INIT_CHAR_OBFUS('D'),   DRM_INIT_CHAR_OBFUS('\0')};
...
DRM_STR_CONST        DRM_WCHAR      g_rgwchTagKeyLenNodeDataAESCBC               [] =  { DRM_INIT_WCHAR_OBFUS( '1'), DRM_INIT_WCHAR_OBFUS( '6'), DRM_INIT_WCHAR_OBFUS( '\0') };
...
DRM_STR_CONST        DRM_WCHAR      g_rgwchTagAESCBC                             [] =  { DRM_INIT_WCHAR_OBFUS( 'A'), DRM_INIT_WCHAR_OBFUS( 'E'), DRM_INIT_WCHAR_OBFUS( 'S'), DRM_INIT_WCHAR_OBFUS( 'C'), DRM_INIT_WCHAR_OBFUS( 'B'), DRM_INIT_WCHAR_OBFUS( 'C'), DRM_INIT_WCHAR_OBFUS( '\0') };
...
DRM_STR_CONST        DRM_WCHAR      g_rgwchEmptyWRMHeaderV4_2                    [] =  { DRM_INIT_WCHAR_OBFUS( '<'), DRM_INIT_WCHAR_OBFUS( 'W'), DRM_INIT_WCHAR_OBFUS( 'R'), DRM_INIT_WCHAR_OBFUS( 'M'),
                                                                                         ...
                                                                                         DRM_INIT_WCHAR_OBFUS( 'E'), DRM_INIT_WCHAR_OBFUS( 'A'), DRM_INIT_WCHAR_OBFUS( 'D'), DRM_INIT_WCHAR_OBFUS( 'E'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'R'), DRM_INIT_WCHAR_OBFUS( '>'), DRM_INIT_WCHAR_OBFUS( '\0') };
DRM_STR_CONST        DRM_WCHAR      g_rgwchEmptyWRMHeaderV4_3                    [] =  { DRM_INIT_WCHAR_OBFUS( '<'), DRM_INIT_WCHAR_OBFUS( 'W'), DRM_INIT_WCHAR_OBFUS( 'R'), DRM_INIT_WCHAR_OBFUS( 'M'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'H'), DRM_INIT_WCHAR_OBFUS( 'E'), DRM_INIT_WCHAR_OBFUS( 'A'), DRM_INIT_WCHAR_OBFUS( 'D'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'E'), DRM_INIT_WCHAR_OBFUS( 'R'), DRM_INIT_WCHAR_OBFUS( ' '), DRM_INIT_WCHAR_OBFUS( 'x'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'm'), DRM_INIT_WCHAR_OBFUS( 'l'), DRM_INIT_WCHAR_OBFUS( 'n'), DRM_INIT_WCHAR_OBFUS( 's'),
                                                                                         DRM_INIT_WCHAR_OBFUS( '='), DRM_INIT_WCHAR_OBFUS( '"'), DRM_INIT_WCHAR_OBFUS( 'h'), DRM_INIT_WCHAR_OBFUS( 't'),
                                                                                         ...
                                                                                         DRM_INIT_WCHAR_OBFUS( 'v'), DRM_INIT_WCHAR_OBFUS( 'e'), DRM_INIT_WCHAR_OBFUS( 'r'), DRM_INIT_WCHAR_OBFUS( 's'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'i'), DRM_INIT_WCHAR_OBFUS( 'o'), DRM_INIT_WCHAR_OBFUS( 'n'), DRM_INIT_WCHAR_OBFUS( '='),
                                                                                         DRM_INIT_WCHAR_OBFUS( '"'), DRM_INIT_WCHAR_OBFUS( '4'), DRM_INIT_WCHAR_OBFUS( '.'), DRM_INIT_WCHAR_OBFUS( '3'),
                                                                                         DRM_INIT_WCHAR_OBFUS( '.'), DRM_INIT_WCHAR_OBFUS( '0'), DRM_INIT_WCHAR_OBFUS( '.'), DRM_INIT_WCHAR_OBFUS( '0'),
                                                                                         DRM_INIT_WCHAR_OBFUS( '"'), DRM_INIT_WCHAR_OBFUS( '>'), DRM_INIT_WCHAR_OBFUS( '<'), DRM_INIT_WCHAR_OBFUS( '/'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'W'), DRM_INIT_WCHAR_OBFUS( 'R'), DRM_INIT_WCHAR_OBFUS( 'M'), DRM_INIT_WCHAR_OBFUS( 'H'),
                                                                                         DRM_INIT_WCHAR_OBFUS( 'E'), DRM_INIT_WCHAR_OBFUS( 'A'), DRM_INIT_WCHAR_OBFUS( 'D'), DRM_INIT_WCHAR_OBFUS( 'E'),
...
DRM_STR_CONST        DRM_CHAR g_rgchLicAcqReeTag               [] = { DRM_INIT_CHAR_OBFUS('R'), DRM_INIT_CHAR_OBFUS('E'), DRM_INIT_CHAR_OBFUS('E'), DRM_INIT_CHAR_OBFUS('\0') };
#define g_rgchLicAcqReeTag_LEN 3
...
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_ANSI_CONST_STRING g_dastrLicAcqReeTag                         = DRM_CREATE_DRM_ANSI_STRING_EX( g_rgchLicAcqReeTag, g_rgchLicAcqReeTag_LEN );

/* Rights */
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrDRM_RIGHT_NONE                         = DRM_CREATE_DRM_STRING( g_rgwchDRM_RIGHT_NONE );
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrDRM_RIGHT_PLAYBACK                     = DRM_CREATE_DRM_STRING( g_rgwchDRM_RIGHT_PLAYBACK );
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrDRM_RIGHT_COLLABORATIVE_PLAY           = DRM_CREATE_DRM_STRING( g_rgwchDRM_RIGHT_COLLABORATIVE_PLAY );
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrDRM_RIGHT_COPY_TO_CD                   = DRM_CREATE_DRM_STRING( g_rgwchDRM_RIGHT_COPY_TO_CD );
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrDRM_RIGHT_COPY                         = DRM_CREATE_DRM_STRING( g_rgwchDRM_RIGHT_COPY );
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrDRM_RIGHT_CREATE_THUMBNAIL_IMAGE       = DRM_CREATE_DRM_STRING( g_rgwchDRM_RIGHT_CREATE_THUMBNAIL_IMAGE );
...
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrAttributeVersion4_3Value              = DRM_CREATE_DRM_STRING( g_rgwchAttributeVersion4_3Value );
...
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_ANSI_CONST_STRING g_dastrTagKID                               = DRM_CREATE_DRM_ANSI_STRING_EX( g_rgchTagKID, 3 );
...
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrKeyLenNodeDataAESCBC                  = DRM_CREATE_DRM_STRING( g_rgwchTagKeyLenNodeDataAESCBC );
...
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrTagAESCBC                             = DRM_CREATE_DRM_STRING( g_rgwchTagAESCBC );
...
DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_CONST_STRING      g_dstrEmptyWRMHeaderV4_3                    = DRM_CREATE_DRM_STRING( g_rgwchEmptyWRMHeaderV4_3 );
...
DRM_DEFINE_GUID( g_guidRevocationTypeLegacyXMLCert,
...
DRM_DEFINE_GUID( DRM_PLAYENABLER_FRAME_SERVER,
                 0xAE092501, 0xA9E3, 0x46f6, 0xAF, 0xBE, 0x62, 0x85, 0x77, 0xDC, 0xDF, 0x55 );
#endif
...
//
// kwilson - We don't need to check for g_guidSCMS guid because it will only appear when
//           wCategory is audio.
//
/*
** SCMS control bits
...
#ifdef NONE
//
// kwilson - We don't need to check for g_guidPsshBox guid because it is completely unrelated
//           to output protection.
//
/*
** PSSH box
** {D08A4F18-10F3-4A82-B6C8-32D8ABA183D3}
*/
DRM_DEFINE_GUID( g_guidPsshBox,
                 0xD08A4F18, 0x10F3, 0x4A82, 0xB6, 0xC8, 0x32, 0xD8, 0xAB, 0xA1, 0x83, 0xD3 );

DRM_GLOBAL_CONST  DRM_DISCARDABLE DRM_ID g_idNull = DRM_ID_EMPTY;
#endif

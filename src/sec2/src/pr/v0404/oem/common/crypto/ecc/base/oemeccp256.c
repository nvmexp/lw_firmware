...
**
*************************************************************************************************/
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Convert_BigEndianBytesToDigits(
...
**
*************************************************************************************************/
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Convert_DigitsToBigEndianBytes(
...
**
*************************************************************************************************/
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Convert_P256_BigEndianBytesToDigits(
...
**
*************************************************************************************************/
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Convert_P256_BigEndianBytesToDigitsModOrder(
...
**
*************************************************************************************************/
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Convert_P256_DigitsToBigEndianBytes(
...
**
*************************************************************************************************/
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Convert_P256_ModularIntToDigitsModOrder(
...
/************************************************************************************************
**
** Function: OEM_ECC_GenerateTeeSigningPublicKey_P256
**
    ...
    __in            DRM_DWORD       f_cbBigCtx )
{
    ...
    ChkDR( OEM_ECC_GenerateTeeSigningPublicKey_P256Impl(
        f_pPubkeyOriginal,
        f_rgbPubkeyDoubled,
        f_pBigCtx,
        f_cbBigCtx ) );
...
ErrorExit:
    return dr; OEM_ECC_GenKeyPairRestrictedPriv_P256

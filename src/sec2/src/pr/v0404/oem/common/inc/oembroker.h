...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Oem_Broker_CRITSEC_Uninitialize( DRM_VOID );
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Oem_Broker_CRITSEC_Enter( DRM_VOID );
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL Oem_Broker_CRITSEC_Leave( DRM_VOID );

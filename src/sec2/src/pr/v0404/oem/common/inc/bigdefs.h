...
#define MP_EXTEND_DRMBIGNUM_IMPL() DRM_DO {                                                     \
    if( lngb >= lnga )                                                                          \
    {                                                                                           \
        OEM_SELWRE_DIGITTCPY( b, a, ( lnga ) );                                                 \
        OEM_SELWRE_ZERO_MEMORY( b + lnga, ( lngb - lnga ) * sizeof( digit_t ) );                \
    }                                                                                           \
    else                                                                                        \
    {                                                                                           \
        OEM_SELWRE_DIGITTCPY( b, a, ( lngb ) );                                                 \
    }                                                                                           \
} DRM_WHILE_FALSE
...
#define DIGITS_TO_DWORDS_DRMBIGNUM_IMPL() DRM_DO { OEM_SELWRE_DIGITTCPY( pbyte, pdigit, lng_dwords ); return TRUE; } DRM_WHILE_FALSE
#define DWORDS_TO_DIGITS_DRMBIGNUM_IMPL() DRM_DO { OEM_SELWRE_DIGITTCPY( pdigit, (digit_t*)pdword, lng_dwords ); return TRUE; } DRM_WHILE_FALSE
...
#define DIGITS_TO_DWORDS_DRMBIGNUM_IMPL() DRM_DO {                                              \
    ...
    {                                                                                           \
        OEM_SELWRE_DIGITTCPY(pbyte+(lng_dwords-1)*sizeof(DRM_DWORD), pdigit[lng_half], 1);      \
    }                                                                                           \
    ...
    {                                                                                           \
        ...
        DRM_DWORD dwTmp = (DRM_DWORD)(dig >> DRM_RADIX_BITS);                                   \
                                                                                                \
        OEM_SELWRE_DIGITTCPY(pbyte+2*i*sizeof(DRM_DWORD), &dig, 1);                             \
        OEM_SELWRE_DIGITTCPY(pbyte+(2*i+1)*sizeof(DRM_DWORD), &dwTmp, 1);                       \
    }                                                                                           \
    return TRUE;                                                                                \
} DRM_WHILE_FALSE

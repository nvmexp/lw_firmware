...
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wch0                 = DRM_WCHAR_CAST('0');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wch9                 = DRM_WCHAR_CAST('9');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wcha                 = DRM_WCHAR_CAST('a');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchf                 = DRM_WCHAR_CAST('f');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchz                 = DRM_WCHAR_CAST('z');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchA                 = DRM_WCHAR_CAST('A');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchF                 = DRM_WCHAR_CAST('F');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchZ                 = DRM_WCHAR_CAST('Z');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchSpace             = DRM_WCHAR_CAST(' ');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchTab               = DRM_WCHAR_CAST('\x9');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchLineFeed          = DRM_WCHAR_CAST('\xA');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchVerticalTab       = DRM_WCHAR_CAST('\xB');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchFormFeed          = DRM_WCHAR_CAST('\xC');
static DRM_GLOBAL_CONST    DRM_WCHAR    s_wchCarriageReturn    = DRM_WCHAR_CAST('\xD');
static DRM_GLOBAL_CONST    DRM_CHAR     s_ch0                  = '0';
static DRM_GLOBAL_CONST    DRM_CHAR     s_ch9                  = '9';
...
{
    while( ( *first != s_wchNull ) && ( *last != s_wchNull )
...
PREFAST_PUSH_DISABLE_EXPLAINED( __WARNING_POTENTIAL_RANGE_POSTCONDITION_VIOLATION_26071, "Code correctly determines the string length." )

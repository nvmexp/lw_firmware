...
#define DRM_BCERTFORMAT_LWRRENT_VERSION 1
...
#define DRM_BCERTFORMAT_OBJTYPE_SELWRITY_VERSION 0x0010
#define DRM_BCERTFORMAT_OBJTYPE_SELWRITY_VERSION_2 0x0011
...
typedef enum __tagDRM_BCERTFORMAT_CERT_TYPES 
{
    ...
    DRM_BCERTFORMAT_SELWRITY_VERSION_ENTRY_TYPE         = 0x10,
    DRM_BCERTFORMAT_SELWRITY_VERSION2_ENTRY_TYPE        = 0x11,
...
typedef struct __tagDRM_BCERTFORMAT_SELWRITY_VERSION
{
    DRM_BOOL      fValid;
    DRM_DWORD     dwSelwrityVersion;
    DRM_DWORD     dwPlatformID;
} DRM_BCERTFORMAT_SELWRITY_VERSION;

typedef struct __tagDRM_BCERTFORMAT_SELWRITY_VERSION2
{
    DRM_BOOL      fValid;
    DRM_DWORD     dwSelwrityVersion;
    DRM_DWORD     dwPlatformID;
} DRM_BCERTFORMAT_SELWRITY_VERSION2;
...
typedef struct __tagDRM_BCERTFORMAT_CERT
{
    ...
    DRM_BCERTFORMAT_SELWRITY_VERSION            SelwrityVersion;
    DRM_BCERTFORMAT_SELWRITY_VERSION2           SelwrityVersion2;
...
typedef enum __tagDRM_BCERTFORMAT_CHAIN_TYPES 
{
    ...
    DRM_BCERTFORMAT_CHIAN_SELWRITY_VERSION_ENTRY_TYPE  = 0x3,

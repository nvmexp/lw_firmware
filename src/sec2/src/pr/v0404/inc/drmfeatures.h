...
#error Neither DRM_COMPILE_FOR_NORMAL_WORLD nor DRM_COMPILE_FOR_SELWRE_WORLD are defined.  One must be defined to 1 by your profile.  The other must be defined to 0 by your profile.
...
#error DRM_COMPILE_FOR_SELWRE_WORLD is defined to neither 0 nor 1.

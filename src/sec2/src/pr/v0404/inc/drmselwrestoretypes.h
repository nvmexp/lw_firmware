...
#ifndef __DRMSELWRESTORETYPES_H__
#define __DRMSELWRESTORETYPES_H__
...
#define DRM_SECSTORE_CONTEXT_EMPTY { {0}, {0}, {0}, {0}, {0}, DRM_ID_EMPTY, DRM_ID_EMPTY, NULL, SELWRE_STORE_UNDEFINED_DATA, 0, 0, 0, 0, FALSE, NULL, FALSE, FALSE, FALSE, 0, FALSE, {0} }

EXIT_PK_NAMESPACE;

#endif /* __DRMSELWRESTORETYPES_H__ */

...
#define DRM_BCERT_SELWRITYLEVEL_150         150  /* for testing */
#define DRM_BCERT_SELWRITYLEVEL_2000        2000
#define DRM_BCERT_SELWRITYLEVEL_3000        3000 /* Refer to PlayReady compliance rules (CRs) */
...
#define DRM_BCERT_CERTTYPE_SELWRETIMESERVER 0x0000000d
...
#define DRM_BCERT_SELWRITY_VERSION_UNSPECIFIED           (DRM_MAX_UNSIGNED_TYPE(DRM_DWORD))
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_UNSPECIFIED  (DRM_MAX_UNSIGNED_TYPE(DRM_DWORD))
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_OEM          DRM_BCERT_SELWRITY_VERSION_PLATFORM_UNSPECIFIED

#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WINDOWS      0x0
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_OSX          0x1
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WINDOWS_ARM  0x2

#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WM_7         0x5

#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_IOS_ARM      0x6
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_XBOX_PPC     0x7
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WP8_ARM      0x8
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WP8_X86      0x9
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_XBOX_ONE     0xa
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_ANDROID_ARM  0xb
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WP8_1_ARM    0xc
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WP8_1_X86    0xd

#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WINDOWS_INTEL_HWDRM     100
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WINDOWS_QUALCOMM_HWDRM  101
#define DRM_BCERT_SELWRITY_VERSION_PLATFORM_WINDOWS_SL150_HWDRM     102
...
#define DRM_BCERT_FEATURE_SELWRE_CLOCK            0x00000004
...
#define DRM_BCERT_FEATURE_DEPRECATED_SELWRE_STOP  0x0000000E
...
/* List of supported key types. (lwrrently just one) */
...
#define DRM_BCERT_KEYUSAGE_ISSUER_SELWRETIMESERVER                0x00000017
...
** is lwrrently used to represent key usage set.
*/
...
#define BCERT_KEYUSAGE_PARENT_ISSUERS_MASK                              \
    ...
    | BCERT_KEYUSAGE_BIT( DRM_BCERT_KEYUSAGE_ISSUER_SELWRETIMESERVER )  \

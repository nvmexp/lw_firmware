...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_SIGNATUREINFO_SIZE(cbSignatureLength, cbIssuerKeyLength) \
...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_SIGNATUREINFO_SIZE_SAFE(__cbSignature, __cbIssuerKey, __cbSigInfo) DRM_DO {   \
...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_RECORD_SIZE(cbBlobLength)                        \
...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_RECORD_SIZE_SAFE(__cbBlob, __cbRecord) DRM_DO {   \
...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_SIGNATURE_SIZE(cbSignatureLength)                \
...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_SIGNATURE_SIZE_SAFE(__cbSignature,__cbExtDataSignature) DRM_DO {  \
...
#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_CONTAINER_SIZE(cbBlobLength, cbSignatureLength)  \
            ( XB_BASE_OBJECT_LENGTH                             /* container obj header        */  \
            + DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_RECORD_SIZE(cbBlobLength)                  \
            + DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_SIGNATURE_SIZE(cbSignatureLength) )

#define DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_CONTAINER_SIZE_SAFE(__cbBlob, __cbSignature, __cbContainer) DRM_DO {  \
    DRM_DWORD __cbData;                                                                                                 \
    ( __cbContainer ) = XB_BASE_OBJECT_LENGTH;                                                                          \
    DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_RECORD_SIZE_SAFE( __cbBlob, __cbData );                                   \
    ChkDR( DRM_DWordAddSame( &( __cbContainer ), ( __cbData ) ) );                                                      \
    DRM_BCERTFORMAT_BUILDER_CALLWLATE_EXTDATA_SIGNATURE_SIZE_SAFE( __cbSignature, __cbData );                           \
    ChkDR( DRM_DWordAddSame( &( __cbContainer ), ( __cbData ) ) );                                                      \
} DRM_WHILE_FALSE
...
typedef union __tagDRM_BCERTFORMAT_CERT_TYPE_DATA
{
    ...
    {
        DRM_DWORD  dwSelwrityVersion;  /* A.B.C.D */
    } PC;

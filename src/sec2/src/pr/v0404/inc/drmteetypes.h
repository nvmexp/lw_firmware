...
**
** DRM_TEE_BLOB_ALLOC_BEHAVIOR_ILWALID: Invalid behavior.
...
typedef enum
{
    DRM_TEE_BLOB_ALLOC_BEHAVIOR_ILWALID = 0,
...
**
** DRM_TEE_BYTE_BLOB_TYPE_ILWALID:      Invalid blob type.
...
** DRM_TEE_BYTE_BLOB_TYPE_SELWRED_MODE: Memory allocated inside the TEE for its
...
#define DRM_TEE_BYTE_BLOB_EMPTY {DRM_TEE_BYTE_BLOB_TYPE_ILWALID,0,0,NULL}
...
** (so that the TEE does not need to be ilwoked repeatedly to re-gather this information)
...
**
** DRM_TEE_LICGEN_OP_ILWALID:                      Invalid operation.
...
typedef enum _tagDRM_TEE_PROPERTY
{
    ...
    DRM_TEE_PROPERTY_SUPPORTS_SELWRE_CLOCK                                  = 5,
    DRM_TEE_PROPERTY_SUPPORTS_SELWRE_STOP                                   = 6,
    DRM_TEE_PROPERTY_SUPPORTS_SELWRE_HDCP_TYPE_1                            = 7,
...
/*
** If the TEE is older than the inselwre world and had fewer enum values defined,
...
typedef struct __tagDRM_TEE_POLICY_RESTRICTION
{
    ...
    ** Note that the Binary Configuration Data is often in BIG ENDIAN and must be colwerted (see XMR spec for details).
    */
...
typedef struct __tagDRM_TEE_POLICY_INFO
{
    ...
    DRM_BOOL                        fSelwreStop2;                                           /* TRUE iff XMRFORMAT_IS_SELWRESTOP2_VALID( leaf-most license ) */
    DRM_DWORD                       dwDecryptionMode;                                       /* One of the values from the OEM_TEE_DECRYPTION_MODE enum */
    DRM_WORD                        wSelwrityLevel;                                         /* Minimum of root/leaf. */
...
/* LWE (nkuo) - Newest TK used in generating the TKs */
#define DRM_TEE_LWRRENT_TK_ID ((DRM_DWORD)(0))
...
#define DRM_SELWRETIME_MAX_RESPONSE_WAIT_IN_MINUTES     ((DRM_DWORD)(1))
#define DRM_SELWRETIME_SERVER_CERT_MIN_SELWRITYLEVEL    ((DRM_DWORD)(3000))
#define ONE_MIN_IN_FILETIME                             ((DRM_DWORD)(600000000)) /* (10000000 x 60) */
#define DRM_SELWRETIME_MAX_REQUEST_WAIT_IN_FILETIME     ((DRM_DWORD)(600000000)) /* DRM_SELWRETIME_MAX_RESPONSE_WAIT_IN_MINUTES * ONE_MIN_IN_FILETIME */

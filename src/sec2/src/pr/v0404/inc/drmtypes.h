...
#define DRM_IDENTICAL_GUIDS(p0,p1) \
    (OEM_SELWRE_ARE_EQUAL((p0), (p1), sizeof(DRM_GUID)))
...
#define DRM_DEFINE_LOCAL_GUID( name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8 )    \
        static DRM_GLOBAL_CONST DRM_GUID name PR_ATTR_DATA_OVLY(_##name)            \
...
#define DRM_DEFINE_GUID( name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8 )          \
        const DRM_EXPORT_VAR DRM_GUID name PR_ATTR_DATA_OVLY(_##name)               \
                = { l, w1, w2, { b1, b2, b3, b4, b5, b6, b7, b8 } }
#else
...
/*
** This macro will callwlate the maximum value of an unsigned data type
...
/*
** This macro will callwlate the maximum value of an signed data type
** where the type is passed in as x.
...
/*
** This macro will callwlate the minimum value of an signed data type
** where the type is passed in as x.
...
**
** The following regular expression used in visual studio can make colwersion easier:
...
/* generic ID type, lwrrently all the same size */
...
** DRM_DIGITS_TO_DWORDS colwerts in the opposite direction.
*/

...
#define XMRFORMAT_IS_SELWRESTOP_VALID( plicenseXMRFORMAT )                             \
    ( ( plicenseXMRFORMAT )->OuterContainer.fValid                                     \
   && ( plicenseXMRFORMAT )->OuterContainer.GlobalPolicyContainer.fValid               \
   && ( plicenseXMRFORMAT )->OuterContainer.GlobalPolicyContainer.SelwreStop.fValid )
...
#define XMRFORMAT_IS_SELWRITY_LEVEL_VALID( plicenseXMRFORMAT )                         \
    ( ( plicenseXMRFORMAT )->OuterContainer.fValid                                     \
   && ( plicenseXMRFORMAT )->OuterContainer.GlobalPolicyContainer.fValid               \
   && ( plicenseXMRFORMAT )->OuterContainer.GlobalPolicyContainer.SelwrityLevel.fValid )
...
#define XMRFORMAT_IS_SELWRESTOP2_VALID( plicenseXMRFORMAT )                            \
    ( ( plicenseXMRFORMAT )->OuterContainer.fValid                                     \
   && ( plicenseXMRFORMAT )->OuterContainer.KeyMaterialContainer.fValid                \
   && ( plicenseXMRFORMAT )->OuterContainer.KeyMaterialContainer.SelwreStop2.fValid )

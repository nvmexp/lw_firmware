...
/* The maximum buffer size of an In memory SelwreStore. */
#define DRM_MAX_IN_MEMORY_SELWRE_STORE_SIZE      204800
...
typedef struct __tagDRM_APP_CONTEXT_INTERNAL
{
    ...
    DRM_SELWRESTOP_CONTEXT           oSelwreStopCtx;

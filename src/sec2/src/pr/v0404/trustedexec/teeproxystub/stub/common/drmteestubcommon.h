...
#ifndef __DRMTEESTUBCOMMON_H__
#define __DRMTEESTUBCOMMON_H__
...
#ifndef DRM_TEE_STUB_DOES_METHOD_USE_TEECTX
#define DRM_TEE_STUB_DOES_METHOD_USE_TEECTX( __oReq )  ( (__oReq).MethodInfo.dwMethodID != DRM_TEE_PROXY_METHOD_ID( DRM_TEE_BASE_AllocTEEContext ) )
#endif  /* DRM_TEE_STUB_DOES_METHOD_USE_TEECTX */

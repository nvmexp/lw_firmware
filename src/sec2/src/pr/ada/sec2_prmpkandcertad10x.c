...
#define OEM_TEE_LPROV_DEVICECERT_SIGNDATA_START_OFFSET_SL3000_AD10X      0x0014
#define OEM_TEE_LPROV_DEVICECERT_SIGNDATA_LENGTH_SL3000_AD10X            0x0188
#define OEM_TEE_LPROV_DEVICECERT_SIGNATURE_OFFSET_SL3000_AD10X           0x01a8

#define OEM_TEE_LPROV_DEVICECERT_CERTID_OFFSET_SL3000_AD10X              0x002c
#define OEM_TEE_LPROV_DEVICECERT_CLIENTID_OFFSET_SL3000_AD10X            0x006c
#define OEM_TEE_LPROV_DEVICECERT_CERTDIGEST_OFFSET_SL3000_AD10X          0x0048

#define OEM_TEE_LPROV_DEVICECERT_PUBKEY_SIGN_OFFSET_SL3000_AD10X         0x00c8
#define OEM_TEE_LPROV_DEVICECERT_PUBKEY_ENCRYPT_OFFSET_SL3000_AD10X      0x0118
#define OEM_TEE_LPROV_DEVICECERT_PUBKEY_PRND_ENCRYPT_OFFSET_SL3000_AD10X 0x0000 /* This define is not applicable since Lwpu doesn't support PRND */
...
CRL Support,PlayReady3 Features,
        ...
        <Manufacturer>
            ...
            <Model_Name>AD10X</Model_Name>
            <Model_Number>AD10X</Model_Number>
        </Manufacturer>
        <Signature>
...
static LwU8 s_rgbDeviceCertTemplate_SL3000_AD10X[] PR_ATTR_DATA_OVLY(_s_rgbDeviceCertTemplate_SL3000_AD10X) =
{
 ...
 */
void
prGetSL3000DeviceCertTemplate_AD10X
(
    LwU8  **ppCert,
    LwU32  *pCertSize,
...
)
{
    ...
    *ppCert    = s_rgbDeviceCertTemplate_SL3000_AD10X;
    *pCertSize = sizeof(s_rgbDeviceCertTemplate_SL3000_AD10X);

    pDTLCI->ibCertID                                             = OEM_TEE_LPROV_DEVICECERT_CERTID_OFFSET_SL3000_AD10X;
    pDTLCI->ibCertClientID                                       = OEM_TEE_LPROV_DEVICECERT_CLIENTID_OFFSET_SL3000_AD10X;
    pDTLCI->ibCertDigest                                         = OEM_TEE_LPROV_DEVICECERT_CERTDIGEST_OFFSET_SL3000_AD10X;
    pDTLCI->ibSignData                                           = OEM_TEE_LPROV_DEVICECERT_SIGNDATA_START_OFFSET_SL3000_AD10X;
    pDTLCI->cbSignData                                           = OEM_TEE_LPROV_DEVICECERT_SIGNDATA_LENGTH_SL3000_AD10X;
    pDTLCI->ibSignature                                          = OEM_TEE_LPROV_DEVICECERT_SIGNATURE_OFFSET_SL3000_AD10X;
    pDTLCI->rgibPubKeys[ DRM_TEE_LPROV_PUBKEY_SIGN_IDX ]         = OEM_TEE_LPROV_DEVICECERT_PUBKEY_SIGN_OFFSET_SL3000_AD10X;
    pDTLCI->rgibPubKeys[ DRM_TEE_LPROV_PUBKEY_ENCRYPT_IDX ]      = OEM_TEE_LPROV_DEVICECERT_PUBKEY_ENCRYPT_OFFSET_SL3000_AD10X;
    pDTLCI->rgibPubKeys[ DRM_TEE_LPROV_PUBKEY_PRND_ENCRYPT_IDX ] = OEM_TEE_LPROV_DEVICECERT_PUBKEY_PRND_ENCRYPT_OFFSET_SL3000_AD10X;
}
 ...
 */
FLCN_STATUS
prCheckDependentBinMilwersion_AD10X(void)
{
    ...
    //
    // Note : Code for AD102 is copy of GA10X
    ...
    // ACR: Adding one to the values found at https://rmopengrok.lwpu.com/source/xref/r400_00/uproc/acr/src/acr/turing/acructu10x.c#acrGetUcodeBuildVersion_AD10X as of 06/26/2018
    ...
    // GSP: Adding one to the values found at https://rmopengrok.lwpu.com/source/s?refs=GSP_AD10X_UCODE_VERSION&project=r400_00 as of 06/26/2018
    //

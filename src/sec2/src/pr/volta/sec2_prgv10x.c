...
/*!
 * @file   sec2_prgv10x.c
 * @brief  Contains all PlayReady routines specific to SEC2 GV10X.
 */
...
//
static LwU16 s_rgwchManufacturerName_GV10X[] PR_ATTR_DATA_OVLY(_s_rgwchManufacturerName_GV10X) = { DRM_WCHAR_CAST('N'), DRM_WCHAR_CAST('v'), DRM_WCHAR_CAST('i'), DRM_WCHAR_CAST('d'), DRM_WCHAR_CAST('i'), DRM_WCHAR_CAST('a'), DRM_WCHAR_CAST('\0') };
static LwU16 s_rgwchModelName_GV10X[] PR_ATTR_DATA_OVLY(_s_rgwchModelName_GV10X) = { DRM_WCHAR_CAST('G'), DRM_WCHAR_CAST('V'), DRM_WCHAR_CAST('1'), DRM_WCHAR_CAST('0'), DRM_WCHAR_CAST('0'), DRM_WCHAR_CAST('\0') };
static LwU16 s_rgwchModelNumber_GV10X[] PR_ATTR_DATA_OVLY(_s_rgwchModelNumber_GV10X) = { DRM_WCHAR_CAST('T'), DRM_WCHAR_CAST('E'), DRM_WCHAR_CAST('S'), DRM_WCHAR_CAST('T'), DRM_WCHAR_CAST('T'), DRM_WCHAR_CAST('E'), DRM_WCHAR_CAST('S'), DRM_WCHAR_CAST('T'), DRM_WCHAR_CAST('T'), DRM_WCHAR_CAST('E'), DRM_WCHAR_CAST('S'), DRM_WCHAR_CAST('T'), DRM_WCHAR_CAST('\0') };
...
)
{
    ...
    //
    *ppManufacturerName         = s_rgwchManufacturerName_GV10X;
    *pManufacturerNameCharCount = sizeof(s_rgwchManufacturerName_GV10X) / sizeof(LwU16);
    *ppModelName                = s_rgwchModelName_GV10X;
    *pModelNameCharCount        = sizeof(s_rgwchModelName_GV10X) / sizeof(LwU16);
    *ppModelNumber              = s_rgwchModelNumber_GV10X;
    *pModelNumberCharCount      = sizeof(s_rgwchModelNumber_GV10X) / sizeof(LwU16);
}

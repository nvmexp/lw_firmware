...
#include <drmteeproxy_generated.c>
        ...
        case DRM_TEE_PROXY_PARAMETER_TYPE__DRM_DWORD:
            {
                ...
                const DRM_DWORD     *pdwParam = ( DRM_DWORD           * )f_pvParam;
        ...
        case DRM_TEE_PROXY_PARAMETER_TYPE__DRM_QWORD:
            {
                ...
                const DRM_UINT64    *pqwParam = ( DRM_UINT64          * )f_pvParam;
        ...
        case DRM_TEE_PROXY_PARAMETER_TYPE__DRM_ID:
            {
                ...
                DRM_ID           *pidParam = ( DRM_ID           * )f_pvParam;
        ...
        case DRM_TEE_PROXY_PARAMETER_TYPE__DRM_TEE_BYTE_BLOB:
            {
                ...
                DRM_TEE_BYTE_BLOB           *pBlobParam = ( DRM_TEE_BYTE_BLOB           * )f_pvParam;
        ...
        case DRM_TEE_PROXY_PARAMETER_TYPE__DRM_TEE_DWORDLIST:
            {
                ...
                DRM_TEE_DWORDLIST       *pTeeParam  = ( DRM_TEE_DWORDLIST       * )f_pvParam;
        ...
        case DRM_TEE_PROXY_PARAMETER_TYPE__DRM_TEE_QWORDLIST:
            {
                ...
                DRM_TEE_QWORDLIST       *pTeeParam  = ( DRM_TEE_QWORDLIST       * )f_pvParam;

...
ENTER_PK_NAMESPACE;
    ...
    /* Returns the performance counter's lwrrrent count in microseconds. */
    static DRM_UINT64 PERF_MICROSECONDS_PER_SECOND = DRM_UI64LITERAL( 0,1000000 );
    #define PERF_LWRRENT_MICROSECOND_COUNT  \
    ...
    #define PERF_ENTER_AGG_SCOPE_X( ModuleID, FuncID, BlockID ) { \
                                                            ...
                                                            DRM_DWORD dwPerfAggEnterTick = PERF_LWRRENT_MICROSECOND_COUNT; \
                                                            Perf_Enter_Agg_Scope( &pAggScopeContext, PERF_SCOPE_ID( ( ModuleID ), ( FuncID ), ( BlockID ) ) );

    #define PERF_LEAVE_AGG_SCOPE_X                          dwPerfAggEnterTick = PERF_LWRRENT_MICROSECOND_COUNT - dwPerfAggEnterTick; \

...
#ifndef DRMCONTRACT_H
#define DRMCONTRACT_H
...
enum ECC_DRM_API_List
{
    ...
    ECC_Drm_Elwelope_Close,
    ECC_Drm_Elwelope_DuplicateFileContext,
    ECC_Drm_Elwelope_GetSize,
    ECC_Drm_Elwelope_GetOriginalFileName,
    ECC_Drm_Elwelope_InitializeRead,
    ECC_Drm_Elwelope_Open,
    ECC_Drm_Elwelope_Read,
    ECC_Drm_Elwelope_Seek,
    ...
    ECC_Drm_SelwreClock_GenerateChallenge,
    ECC_Drm_SelwreClock_GetValue,
    ECC_Drm_SelwreClock_ProcessResponse,
    ECC_Drm_StoreMgmt_CleanupStore,
    ECC_Drm_StoreMgmt_DeleteLicenses,
    ECC_Drm_Uninitialize,
    ECC_Drm_Content_GetProperty,
    ECC_Drm_Elwelope_WritePlayReadyObject,
    ECC_Drm_Content_UpdateEmbeddedStore_Commit,
    ECC_Drm_PlayReadyObject_ColwertFromWmdrmHeader,

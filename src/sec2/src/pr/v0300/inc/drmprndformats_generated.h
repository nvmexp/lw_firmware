...
typedef enum __tagDRM_PRND_REGISTRATION_REQUEST_MESSAGE_TYPES 
{
    ...
    DRM_PRND_REGISTRATION_REQUEST_LWSTOM_DATA_ENTRY_TYPE        = 0x2,
...
typedef struct __tagDRM_PRND_REGISTRATION_REQUEST_BASIC_INFORMATION
{
    ...
    DRM_UINT64           qwReceiverLwrrentTime;
} DRM_PRND_REGISTRATION_REQUEST_BASIC_INFORMATION;

typedef struct __tagDRM_PRND_REGISTRATION_REQUEST_LWSTOM_DATA
{
    DRM_BOOL             fValid;
    DRM_ID               lwstomDataTypeID;
    DRM_XB_BYTEARRAY     xbbaLwstomData;
} DRM_PRND_REGISTRATION_REQUEST_LWSTOM_DATA;
...
typedef struct __tagDRM_PRND_REGISTRATION_REQUEST_MESSAGE
{
    ...
    DRM_PRND_REGISTRATION_REQUEST_LWSTOM_DATA           LwstomData;
...
typedef enum __tagDRM_PRND_REGISTRATION_RESPONSE_MESSAGE_TYPES 
{
    ...
    DRM_PRND_REGISTRATION_RESPONSE_LWSTOM_DATA_ENTRY_TYPE            = 0x6,
...
typedef struct __tagDRM_PRND_REGISTRATION_RESPONSE_LWSTOM_DATA
{
    DRM_BOOL             fValid;
    DRM_ID               lwstomDataTypeID;
    DRM_XB_BYTEARRAY     xbbaLwstomData;
} DRM_PRND_REGISTRATION_RESPONSE_LWSTOM_DATA;
...
typedef struct __tagDRM_PRND_REGISTRATION_RESPONSE_MESSAGE
{
    ...
    DRM_PRND_REGISTRATION_RESPONSE_LWSTOM_DATA               LwstomData;
    DRM_PRND_MESSAGE_SIGNATURE                               Signature;
} DRM_PRND_REGISTRATION_RESPONSE_MESSAGE;
...
typedef enum __tagDRM_PRND_LICENSE_REQUEST_MESSAGE_TYPES 
{
    ...
    DRM_PRND_LICENSE_REQUEST_LWSTOM_DATA_ENTRY_TYPE          = 0xF,
...
typedef struct __tagDRM_PRND_LICENSE_REQUEST_LWSTOM_DATA
{
    DRM_BOOL             fValid;
    DRM_ID               lwstomDataTypeID;
    DRM_XB_BYTEARRAY     xbbaLwstomData;
} DRM_PRND_LICENSE_REQUEST_LWSTOM_DATA;
...
typedef struct __tagDRM_PRND_LICENSE_REQUEST_MESSAGE
{
    ...
    DRM_PRND_LICENSE_REQUEST_LWSTOM_DATA             LwstomData;
    DRM_PRND_MESSAGE_SIGNATURE                       Signature;
} DRM_PRND_LICENSE_REQUEST_MESSAGE;
...
typedef enum __tagDRM_PRND_LICENSE_TRANSMIT_MESSAGE_TYPES 
{
    ...
    DRM_PRND_LICENSE_TRANSMIT_LWSTOM_DATA_ENTRY_TYPE          = 0x14,
...
typedef struct __tagDRM_PRND_LICENSE_TRANSMIT_BASIC_INFORMATION
{
    ...
    DRM_DWORD            dwFlags;
    DRM_ID               guidSessionID;
    DRM_ID               guidLwrrentLicenseMessageID;
    DRM_XB_BYTEARRAY     xbbaTransmitterRevInfo;
...
typedef struct __tagDRM_PRND_LICENSE_TRANSMIT_LWSTOM_DATA
{
    DRM_BOOL             fValid;
    DRM_ID               lwstomDataTypeID;
    DRM_XB_BYTEARRAY     xbbaLwstomData;
} DRM_PRND_LICENSE_TRANSMIT_LWSTOM_DATA;
...
typedef struct __tagDRM_PRND_LICENSE_TRANSMIT_MESSAGE
{
    ...
    DRM_PRND_LICENSE_TRANSMIT_LWSTOM_DATA           LwstomData;
    DRM_PRND_MESSAGE_SIGNATURE                      Signature;
} DRM_PRND_LICENSE_TRANSMIT_MESSAGE;

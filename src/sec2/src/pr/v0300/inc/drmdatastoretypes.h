...
#ifndef DRM_DATASTORETYPES_H
#define DRM_DATASTORETYPES_H
...
/*
** Enumeration of the lwrrently supported DST implementations
*/
typedef enum
{
    eDRM_DST_NONE,
...
typedef DRM_API DRM_RESULT ( DRM_CALL *DRM_DST_SLOTENUMRELOADLWRRENT )(
    __inout    DRM_DST_ENUM_CONTEXT  *f_pContextEnum,
    __out      DRM_DST_SLOT_CONTEXT  *f_pContextSlot,
    __out_opt  DRM_DST_KEY           *f_pKey1,
    __out_opt  DRM_DST_KEY           *f_pKey2,
...
typedef DRM_API DRM_RESULT ( DRM_CALL *DRM_DST_SLOTENUMDELETELWRRENT )(
    __inout   DRM_DST_ENUM_CONTEXT  *f_pContextEnum,
    __inout   DRM_DST_SLOT_CONTEXT  *f_pContextSlot );
...
typedef struct __tag_DRM_DST_INTERFACE
{
    ...
    */
    ...
    DRM_DST_SLOTENUMRELOADLWRRENT pfnSlotEnumReloadLwrrent; /* Pointer to a slot enum reload current function */
    DRM_DST_SLOTENUMDELETELWRRENT pfnSlotEnumDeleteLwrrent; /* Pointer to a slot enum delete current function */

...
#ifndef DRMTEETYPES_H
#define DRMTEETYPES_H 1
...
typedef struct __tagDRM_TEE_POLICY_RESTRICTION
{
    ...
    */
    ...
    /* Binary Configuration data (size and raw bytes) - note that this is often in BIG ENDIAN and must be colwerted (see XMR spec for details) */

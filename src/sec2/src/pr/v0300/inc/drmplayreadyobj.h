...
#ifndef DRMPLAYREADYOBJ_H
#define DRMPLAYREADYOBJ_H
...
DRM_API DRM_RESULT DRM_CALL DRM_PRO_CallwlateRMHeaderChecksum(
...
DRM_API DRM_RESULT DRM_CALL DRM_PRO_CreateRMHeader(
    ...
    __in_ecount_nz_opt( 1 )             const DRM_CONST_STRING      *f_pdstrLwstomAttributesXML,
...
DRM_API DRM_RESULT DRM_CALL DRM_PRO_ColwertHeaderFromWmdrmToPlayReady(
    ...
    __in_ecount_nz_opt( f_cchLwstomAttributes )
                                        const DRM_WCHAR *f_pwchLwstomAttributes,
    __in                                const DRM_DWORD  f_cchLwstomAttributes,

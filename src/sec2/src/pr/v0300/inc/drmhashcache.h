...
#ifndef DRMHASHCACHE_H
#define DRMHASHCACHE_H 1
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_HASHCACHE_Initialize(
    ...
    __in_ecount(f_cPreVerifiedHashes) const DRM_SHA256_Digest           *f_pPreVerifiedHashes,

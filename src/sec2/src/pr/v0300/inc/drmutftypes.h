...
**                   character in Windows dolwmenation. cch always refers to
**                   these.
**
...
**  code point. As such, no colwersion is necessary.
**
**  Notes:
...
** When colwerting the DRM_WCHAR32, an endian colwersion may be necessary.
*/
...
/*
** Takes a 6 bit value and colwerts to a trailing UTF-8 code unit.
*/

...
ENTER_PK_NAMESPACE;
    ...
    extern DRM_GLOBAL_CONST  DRM_WCHAR              g_wchOpenLwrly;
    extern DRM_GLOBAL_CONST  DRM_WCHAR              g_wchCloseLwrly;
    ...
    extern DRM_GLOBAL_CONST  DRM_CONST_STRING       g_dstrSelwreClockNotSet;
    extern DRM_GLOBAL_CONST  DRM_CONST_STRING       g_dstrSelwreClockSet;
    extern DRM_GLOBAL_CONST  DRM_CONST_STRING       g_dstrSelwreClockNeedsRefresh;
    ...
    extern DRM_GLOBAL_CONST  DRM_CONST_STRING       g_dstrTagLwstomAttributes;
    ...
    extern DRM_GLOBAL_CONST  DRM_CONST_STRING       g_dstrTagSelwrityVersion;
    ...
    extern DRM_GLOBAL_CONST  DRM_ANSI_CONST_STRING  g_dastrTagWMDRMCertSelwrityVersion;
    extern DRM_GLOBAL_CONST  DRM_ANSI_CONST_STRING  g_dastrTagWMDRMCertSelwrityLevel;

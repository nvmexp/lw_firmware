...
#ifndef DRM_LICSTORE_H
#define DRM_LICSTORE_H
...
typedef struct _tag_DRM_LICSTOREENUM_MULTIPLE_CONTEXT
{
    ...
    DRM_LICSTOREENUM_CONTEXT  *pLwrEnum; /* Pointer to the enumeration context for the next license */

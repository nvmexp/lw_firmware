...
typedef enum
{
    ...
    TRACE_ENTER_SCOPE   = 1,
    TRACE_LEAVE_SCOPE   = 2
    /* OEM may define lwstomized events starting with value 4. */
...
typedef enum
{
    ...
    /* OEM may define lwstomized channels starting with mask 0x04. */
} eTraceChannelType;
...
typedef struct __tagTRACE_GLOBAL_CONTEXT
{
    ...
    */
    ...
    /*
    ** Flag indicating whether is lwrrently in
    ** Oem_Trace_Enter/LeaveScope() API. This flag
    ** is used to prevent relwrsive entering

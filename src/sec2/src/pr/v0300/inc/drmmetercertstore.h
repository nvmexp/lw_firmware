...
#ifndef DRM_METERCERT_STORE
#define DRM_METERCERT_STORE
...
**
** Returns:     DRM_SUCCESS on success or DRM_E_ILWALIDARG if the arguments are invalid.
**
**********************************************************************/
...
/*********************************************************************
**
** Function: DRM_MCS_IlwalidateMeterCert
**
** Synopsis: ilwalidate the indicated meter cert from the meter cert store; its absense
**           is not an error
**
** Arguments:
**
...
DRM_API DRM_RESULT DRM_CALL DRM_MCS_IlwalidateMeterCert(
    __in       DRM_METERCERT_CONTEXT  *f_pcontextMeterCert,
    __in const DRM_MID                *f_pmid );

EXIT_PK_NAMESPACE;

#endif // DRM_METERCERT_STORE

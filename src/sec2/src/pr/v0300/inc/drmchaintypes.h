...
#ifndef DRM_CHAINTYPES_H
#define DRM_CHAINTYPES_H
...
{
    /* __in    */ DRM_LICSTORE_CONTEXT              *rgpLicStoreLwrrent[DRM_MAX_LICENSE_CHAIN_DEPTH]; /* Context to an Open license store for each license in the chain */

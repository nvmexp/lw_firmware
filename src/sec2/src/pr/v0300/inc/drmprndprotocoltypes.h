...
#ifndef DRMPRNDPROTOCOLTYPES_H
#define DRMPRNDPROTOCOLTYPES_H
...
typedef struct __tagDRM_PRND_TRANSMITTER_SESSION_CONTEXT
{
    ...
    DRM_DWORD                                            dwReceiverSelwrityLevel;               /* From receiver leaf certificate from registration request. [Leaf certificate is verified to not have higher level than any other cert in chain.] */
...
DRM_OBFUS_PTR_BTM
    ...
    DRM_GUID                                             guidLwrrentLicenseMessageID;
    DRM_GUID                                             guidLwrrentLMIDForLicGen;

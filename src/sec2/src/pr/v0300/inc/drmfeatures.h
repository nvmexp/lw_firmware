...
#ifndef DRMSETFEATURES_H
#define DRMSETFEATURES_H
...
//
// LWE (kwilson) added include file for compilation
//
...
# MS internal only (No value in OEM modification):
# Set this flag to '1' to allow test code exelwtables to link with a DLL.
#------------------------------------------------------------------------------
*/
...
#error DRM_SUPPORT_NOLWAULTSIGNING must be defined by your profile
#endif
...
#error DRM_SUPPORT_SELWREOEMHAL must be defined by your profile
#endif

#ifndef DRM_SUPPORT_SELWREOEMHAL_PLAY_ONLY
#error DRM_SUPPORT_SELWREOEMHAL_PLAY_ONLY must be defined by your profile
#endif

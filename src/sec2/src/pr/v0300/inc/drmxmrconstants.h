...
#ifndef DRM_XMR_CONSTANTS_H
#define DRM_XMR_CONSTANTS_H
...
enum XMR_OBJECT_TYPE
{
    ...
    XMR_OBJECT_TYPE_SELWRITY_LEVEL                                     = 0x0034,
    ...
    XMR_OBJECT_TYPE_EXELWTE_POLICY_CONTAINER                           = 0x003F,
    XMR_OBJECT_TYPE_EXELWTE_POLICY_OBJECT                              = 0x0040,
    ...
    XMR_OBJECT_TYPE_ILWALID_RESERVED_53                                = 0x0053,    /* Deprecated: 0x0053 was dolwmented in PlayReady 2.0 CHM for Content Boundary Identification Object */
    ...
    XMR_OBJECT_TYPE_SELWRE_STOP_OBJECT                                 = 0x005A,

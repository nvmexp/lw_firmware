...
#ifndef DRMBLACKBOXTYPES_H
#define DRMBLACKBOXTYPES_H
...
DRM_OBFUS_PTR_BTM
DRM_OBFUS_PTR_TOP
    DRM_XMRFORMAT                  *m_pxmrLicense;    /* An HMAC signature of this license will be callwlated and compared to m_pbSignature */
DRM_OBFUS_PTR_BTM

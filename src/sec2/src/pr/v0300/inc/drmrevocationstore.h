...
#ifndef DRM_REVOCATIONSTORE_H
#define DRM_REVOCATIONSTORE_H
...
**              DRM_E_ILWALIDARG if a parameter is incorrect or
...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL DRM_RVS_InitRevocationStore(
    ...
    __in  const DRM_SELWRECORE_CONTEXT       *f_pSelwreCoreCtx,

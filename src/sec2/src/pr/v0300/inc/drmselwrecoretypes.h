...
#ifndef DRMSELWRECORETYPES_H
#define DRMSELWRECORETYPES_H 1
...
#define DRM_SELWRECORE_DisableBlobCache( __pSelwreCoreCtx ) do { (__pSelwreCoreCtx)->fDisableBlobCache = TRUE; } while(FALSE)

EXIT_PK_NAMESPACE;

#endif // DRMSELWRECORETYPES_H

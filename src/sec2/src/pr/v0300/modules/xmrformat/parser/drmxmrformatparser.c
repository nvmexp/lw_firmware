...
#define XMRFORMAT_REMAP_XBINARY_ERROR_CODES(dr)         \
    do                                                  \
    {                                                   \
        switch( (dr) )                                  \
        {                                               \
...
#define VALIDATE_ENABLERS( pXmrLicense, IS_VALID_MACRO, ObjPath, ContainerType, ObjectType )                                \
    do {                                                                                                                    \
    ...
    __in    const DRM_XMRFORMAT                        *f_pXmrLicense )
{
    ...
    VALIDATE_ENABLERS( f_pXmrLicense, XMRFORMAT_IS_PLAY_VALID, PlaybackPolicyContainer, XMR_OBJECT_TYPE_PLAY_ENABLER_CONTAINER, XMR_OBJECT_TYPE_PLAY_ENABLER_OBJECT );

    /* Validate the Copy Policy Container Object */
    VALIDATE_ENABLERS( f_pXmrLicense, XMRFORMAT_IS_COPY_VALID, CopyPolicyContainer, XMR_OBJECT_TYPE_COPY_ENABLER_CONTAINER, XMR_OBJECT_TYPE_COPY_ENABLER_OBJECT );

    ...
    __out          DRM_DWORD   *f_pcchTarget )
{
    ...
    /*
    ** The following mathsafe fuctions are equivalent to:
    ** pw32szSourceEnd = f_pw32szSource+f_cchSource
    */
    ChkDR( DRM_DWordMult( f_cchSource, sizeof(*f_pw32szSource), &dwOffset ) );
    ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)f_pw32szSource, dwOffset, (DRM_DWORD_PTR*)&pw32szSourceEnd ) );
    ...
    __inout                          DRM_STRING  *f_pdstrTarget )
{
    ...
    /* Initialize boundaries for source */
    /*
    ** The following mathsafe functions are equivalent to:
    ** pw32szSourceEnd = f_pw32szSource+f_cchSource
    */
    ChkDR( DRM_DWordMult( f_cchSource, sizeof(*f_pw32szSource), &dwOffset ) );
    ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)f_pw32szSource, dwOffset, (DRM_DWORD_PTR*)&pw32szSourceEnd ) );
...
{
    DRM_RESULT  dr         = DRM_SUCCESS;
    DRM_STRING  dstrSource = DRM_EMPTY_DRM_STRING;
    ...
    __inout                                 DRM_DWORD   *f_pcchTarget )
{
    ...
    */
    ...
    ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)f_pw32szTarget, dwOffset, (DRM_DWORD_PTR*)&pw32szTargetEnd ) );

    ...
    __deref_out DRM_XB_UNKNOWN_CONTAINER    **f_ppItem )
{
    ...
    DRMASSERT( pHead != NULL );
    __analysis_assume( pHead != NULL );
    ...
    __inout_bcount(*f_pcbObject)       DRM_VOID                    *f_pvObject )
{
    ...
    if( pwordlist->cWORDs > 0 )
    {
        ...
        ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)pwordlist->pwordBuffer, pwordlist->iWords, (DRM_DWORD_PTR*)&pvResult ) );
        ...
        for( i = 0; i < pwordlist->cWORDs; i++ )
        {
            ...
            ChkDR( DRM_DWordPtrAddSame( (DRM_DWORD_PTR*)&pvResult, sizeof(DRM_WORD) ) );
        }
    }
...
{
    DRM_RESULT        dr          = DRM_SUCCESS;
    DRM_XB_DWORDLIST *pdwordlist  = ( DRM_XB_DWORDLIST * )f_pvObject;
    DRM_DWORD         iDWORD      = 0;
    DRM_DWORD         dwResult    = 0;
    ...
    if( pdwordlist->cDWORDs > 0 )
    {
        ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)pdwordlist->pdwordBuffer, pdwordlist->iDwords, (DRM_DWORD_PTR*)&pvTarget ) );

        for( iDWORD = 0; iDWORD < pdwordlist->cDWORDs; iDWORD++ )
        {
            ChkDR( _DRM_XB_Parse_DWORD( f_pbBuffer,
                                        f_piObject,
                                        f_pcbObject,
                                        pvTarget ) );

            /* safe math not necessary - value checked above at dwordmult call */
            ChkDR( DRM_DWordPtrAddSame( (DRM_DWORD_PTR*)&pvTarget, sizeof( DRM_DWORD ) ) );
        }
    }
    ...
    __inout_bcount(*f_pcbObject)       DRM_VOID                    *f_pvObject )
{
    DRM_RESULT        dr         = DRM_SUCCESS;
    DRM_DWORD         iObject    = *f_piObject;
    DRM_XB_QWORDLIST *pqwordlist = ( DRM_XB_QWORDLIST * )f_pvObject;
    DRM_DWORD         iQWORD     = 0;
    DRM_DWORD         dwResult   = 0;
    DRM_DWORD_PTR     pvResult;
    ...
    if( pqwordlist->cQWORDs > 0 )
    {
        ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)pqwordlist->pqwordBuffer, pqwordlist->iQwords, (DRM_DWORD_PTR*)&pvResult ) );
        for( iQWORD = 0; iQWORD < pqwordlist->cQWORDs; iQWORD++ )
        {
            ...
            ChkDR( DRM_DWordPtrAddSame( (DRM_DWORD_PTR*)&pvResult, DRM_SIZEOFQWORD ) );
        }
    }
...
static DRM_NO_INLINE DRM_RESULT DRM_CALL _DRM_XB_Parse_UNKNOWN_OBJECT(
    ...
    __in                               DRM_DWORD                    f_iObject,
    __in                               DRM_DWORD                    f_cbObject,
    __inout_bcount(f_cbObject)         DRM_XB_UNKNOWN_OBJECT       *f_pUnknown )
{
    DRM_RESULT       dr         = DRM_SUCCESS;
...
PREFAST_POP
{
    ...
    for( iElement = 0; iElement < f_cElements; iElement++ )
    {
        ...
        ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)f_pvObject, pElement->wOffsetInLwrrentStruct, (DRM_DWORD_PTR*)&pobject ) );
                ...
                case XB_SIZE_IS_WORD_IN_ANOTHER_STRUCT_MEMBER:
                    {
                        ...
                        */
                        ...
                        ChkDR(DRM_DWordPtrAdd((DRM_DWORD_PTR)f_pvObject, pElement->xbSize.wOffset, (DRM_DWORD_PTR*)&pwptr));
                ...
                case XB_SIZE_IS_RELATIVE_WORD:
                    {
                        ...
                        ChkDR( _DRM_XB_Parse_WORD( f_pbBinaryFormat, &iLwrrent, &cbLengthLeft, &wElementCount ) );
                        cElementCount = wElementCount;
                ...
                case XB_SIZE_IS_WORD_IN_ANOTHER_STRUCT_MEMBER:
                    {
                        ...
                        */
                        ChkArg( (DRM_DWORD)pElement->xbSize.wOffset + sizeof(DRM_WORD) <= (DRM_DWORD)pElement->wOffsetInLwrrentStruct );
                        ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)f_pvObject, pElement->xbSize.wOffset, (DRM_DWORD_PTR*)&pvElement ) );
                ...
                case XB_SIZE_IS_RELATIVE_WORD:
                    {
                        ...
                        ChkDR( _DRM_XB_Parse_WORD( f_pbBinaryFormat, &iLwrrent, &cbLengthLeft, &wDataToRead ) );
                    ...
                    */
                    {
                        ...
                        ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)f_pvObject, pElement->wOffsetInLwrrentStruct, (DRM_DWORD_PTR*)&pxbbaRawData ) );
    ...
    __in    const   DRM_XB_FORMAT_DESCRIPTION   *f_pFormat )
{
    ...
    {
        if( UNKNOWN_CONTAINER_ID == f_pFormat->pEntryDescriptions[idx].wType )
        {
    ...
    __inout         DRM_VOID                    *f_pvObject )
{
         ...
         iLwrrent += cbChild )
    {
        ...
        ChkDR( DRM_DWordAdd( iLwrrent, sizeof( DRM_WORD ) * 2, &dwResult ) );
        NETWORKBYTES_TO_DWORD( cbChild, f_pbBinaryFormat, dwResult );
                    ...
                    for( idx = 0;
                         ...
                         idx ++ )
                     {
                         ...
                         && pEntryDescr[idx].xbSize.eSizeType == XB_SIZE_IS_ELEMENT_COUNT )
                        {
                            ...
                            ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)pobject, pEntryDescr[idx].wOffsetInLwrrentStruct, (DRM_DWORD_PTR*)&pcElementCount ) );
                        }
                        ...
                        */
                            ...
                            && pEntryDescr[idx].xbSize.eSizeType == XB_SIZE_IS_DATA_IN_OBJECT_FOR_WEAKREF )
                        {
                            ...
                            ChkDR( DRM_DWordPtrAdd( (DRM_DWORD_PTR)pobject, pEntryDescr[idx].wOffsetInLwrrentStruct, (DRM_DWORD_PTR*)&pxbbaRawData ) );
    ...
    __inout                         DRM_VOID                    *f_pStruct )
{
    ...
    if( f_pformat[iFormat].pHeaderDescription->eAlign > XB_ALIGN_1_BYTE )
    {
        ...
        ChkBOOL( ((DRM_DWORD_PTR)f_pb & ( f_pformat[iFormat].pHeaderDescription->eAlign - 1)) == 0, DRM_E_XB_ILWALID_ALIGNMENT );
    }
    ...
    else
    {
        ...
        */
        ...
        if( f_pformat[iFormat].pHeaderDescription->wOffsetOfSizeInHeaderStruct != DRM_XB_EXTENDED_HEADER_SIZE_OFFSET_ILWALID )
        {
            ...
            ChkDR( DRM_DWordPtrAddSame( (DRM_DWORD_PTR*)&pdwStruct,
    ...
    __out       DRM_DWORD       *f_pcbChild )
{
    ...
    */
    ...
    iNext -= cbNext; /* cbNext is either 0 or iNext was just added to cbNext, so safe to subtract it. */

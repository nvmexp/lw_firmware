    ...
    __inout_bcount( DRM_AES_BLOCKLEN )       DRM_BYTE                f_rgbData[ DRM_AES_BLOCKLEN ] )
{
    ...
    ChkDR( OEM_TEE_CRYPTO_AES128_EncryptOneBlock( (OEM_TEE_KEY*)f_pKey, f_rgbData, fCryptoMode ) );
    ...
    __inout_bcount( DRM_AES_BLOCKLEN )       DRM_BYTE                f_rgbData[ DRM_AES_BLOCKLEN ] )
{
    ...
    ChkDR( OEM_TEE_CRYPTO_AES128_DecryptOneBlock( (OEM_TEE_KEY*)f_pKey, f_rgbData, fCryptoMode ) );

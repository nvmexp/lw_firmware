...
#ifndef OEMTEECRYPTOINTERNALTYPES_H
#define OEMTEECRYPTOINTERNALTYPES_H 1
...
typedef struct __tagOEM_TEE_KEY_AES
{
    ...
    /*
    ** LWE: (vyadav) Don't need to store the data struct below as
...
#endif // OEMTEECRYPTOINTERNALTYPES_H

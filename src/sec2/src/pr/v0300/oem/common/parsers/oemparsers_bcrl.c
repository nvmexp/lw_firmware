    ...
    __inout                                 PUBKEY_P256            *f_pPublicSignKey )
{
    ...
    DRM_BCERTFORMAT_PARSER_CONTEXT  oParserCtx              = {{0}};  // LWE (nkuo) - changed due to compile error "missing braces around initializer"
    ...
    ChkDR( DRM_BCERTFORMAT_InitializeParserContext(
        ...
        DRM_NO_OF(rgdwKeyUsageSet),     /* f_cRequiredKeyUsages             */
        rgdwKeyUsageSet,                /* f_pdwRequiredKeyUsages           */
        0,                              /* f_cResults                       */
        NULL,                           /* f_pResults                       */
        &oParserCtx ) );
    ...
    __in_ecount_opt(1)                const PUBKEY_P256            *f_pRootPubkey )
{
    CLAW_AUTO_RANDOM_CIPHER
    DRM_RESULT  dr      = DRM_SUCCESS;
    PUBKEY_P256 pub_key = {{0}};  // LWE (nkuo) - changed due to compile error "missing braces around initializer"

...
DRM_API DRM_RESULT DRM_CALL Colwert_BigEndianBytesToDigits(
...
DRM_API DRM_RESULT DRM_CALL Colwert_DigitsToBigEndianBytes(
...
DRM_API DRM_RESULT DRM_CALL Colwert_P256_BigEndianBytesToDigits(
...
DRM_API DRM_RESULT DRM_CALL Colwert_P256_BigEndianBytesToDigitsModOrder(
...
DRM_API DRM_RESULT DRM_CALL Colwert_P256_ModularIntToDigitsModOrder(
    __in_ecount( ECC_P256_INTEGER_SIZE_IN_ECAFFINES ) const  digit_t   f_rgecInModularInt[],
    __in_ecount( 1 )                                  const  elwrve_t *f_pElwrve,
    __out_ecount( ECC_P256_INTEGER_SIZE_IN_DIGITS )          digit_t   f_rgbOutDigits[] );

DRM_API DRM_RESULT DRM_CALL Colwert_P256_DigitsToBigEndianBytes(
...
DRM_EXPORT_VAR extern DRM_GLOBAL_CONST elwrve_t g_Elwrve;

...
//
// LWE (nkuo) - falcon tool 6.2.1 (gcc 4.3.2) can't handle the 64bit multiplication
// properly when any of the operands is a constant.  So here we call __muldi3
// directly to make sure this multiplication can be properly handled.
//
extern unsigned long long  __muldi3 (unsigned long long, unsigned long long); 
#define DPRODUU(u1, u2) __muldi3(DRM_UI64(u1), DRM_UI64(u2))
//#define DPRODUU(u1, u2) (DRM_UI64(u1) * DRM_UI64(u2))

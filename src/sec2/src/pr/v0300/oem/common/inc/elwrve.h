...
/*
             ...
             This file (elwrve.h) has definitions for
...
DRM_API DRM_BOOL DRM_CALL ecaffine_addition
      (const digit_t *, const digit_t *, digit_t *,
       const DRM_LONG, const struct elwrve_t*, digit_t *, struct bigctx_t *f_pBigCtx);

DRM_API DRM_BOOL DRM_CALL ecaffine_addition_subtraction
      (const digit_t *, const digit_t *, digit_t *,
       digit_t *, const struct elwrve_t*, digit_t *, struct bigctx_t *f_pBigCtx);
...
DRM_API DRM_BOOL DRM_CALL ecaffine_is_infinite(const digit_t *, const struct elwrve_t*, struct bigctx_t *f_pBigCtx);

DRM_API DRM_BOOL DRM_CALL ecaffine_multiply_pm1
          (const digit_t *, digit_t *, const DRM_LONG, const struct elwrve_t*, struct bigctx_t *f_pBigCtx);

DRM_API DRM_BOOL DRM_CALL ecaffine_negate(const digit_t *, digit_t *,
                                   const struct elwrve_t*, struct bigctx_t *f_pBigCtx);

DRM_API DRM_BOOL DRM_CALL ecaffine_on_lwrve(const digit_t *, const struct elwrve_t*,
...
DRM_API DRM_BOOL DRM_CALL ecaffine_PPQ(const digit_t *, const digit_t *,
                                ...
                                const struct elwrve_t*, digit_t *, struct bigctx_t *f_pBigCtx);

DRM_API DRM_BOOL DRM_CALL ecaffine_random(digit_t *, const struct elwrve_t*,
...
DRM_API DRM_BOOL DRM_CALL ec_initialize(const digit_t *, const digit_t *,
                                const field_desc_t*, struct elwrve_t*, struct bigctx_t *f_pBigCtx, struct bigctx_t*);

DRM_API DRM_BOOL DRM_CALL ec_free(struct elwrve_t*, struct bigctx_t *f_pBigCtx);     /* IN/OUT */

...
#ifndef OEMTEETYPES_H
#define OEMTEETYPES_H 1
...
** OEM_TEE_LPROV_GetModelSelwrityVersion.  If this value is
...
** the out parameter f_pdwSelwrityVersion in the OEM TEE function 
** OEM_TEE_LPROV_GetModelSelwrityVersion.  If this value is
** used, validation of the model certificate's Security Version will 
** be skipped during local provisioning.
*/
#define OEM_TEE_LPROV_SELWRITY_VERSION_IGNORE  DRM_MAX_UNSIGNED_TYPE(DRM_DWORD)
...
** therefore ilwalidating the DRM_TEE_CONTEXT associated with that
...
**
** pbUnprotectedOEMData MUST be allocated with OEM_TEE_BASE_SelwreMemAlloc
** and MUST be freed with OEM_TEE_BASE_SelwreMemFree.
*/
...
** Note that OEM_TEE_AES128CTR_DECRYPTION_MODE_NOT_SELWRE
...
** OEM_TEE_AES128CTR_DECRYPTION_MODE_NOT_SELWRE
** must *NOT* be changed by the OEM.
*/
typedef enum
{
    OEM_TEE_AES128CTR_DECRYPTION_MODE_NOT_SELWRE        = 0x0,
...
typedef enum
{
    OEM_TEE_RPROV_BOOTSTRAP_ID_MESSAGE_ILWALID       = 0x0,
...
#define OEM_TEE_MEMORY_HANDLE_ILWALID NULL
...
**
** For Perf, MAX_ALLOWED_TIME_BEFORE_CLOCK_RESYNC was pre-callwlated.

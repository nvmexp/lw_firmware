...
#define DIGITS_TO_DWORDS_DRMBIGNUM_IMPL() do { OEM_SELWRE_DIGITTCPY( pbyte, pdigit, lng_dwords ); return TRUE; } while( FALSE )
#define DWORDS_TO_DIGITS_DRMBIGNUM_IMPL() do { OEM_SELWRE_DIGITTCPY( pdigit, (digit_t*)pdword, lng_dwords ); return TRUE; } while( FALSE )

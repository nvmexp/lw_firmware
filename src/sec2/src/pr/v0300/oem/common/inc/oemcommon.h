...
** If the device supports Device Assets (DRM_SUPPORT_DEVICEASSETS=1), this function MUST be implemented by the OEM.
*/
DRM_API DRM_RESULT DRM_CALL Oem_Device_GetSelwreStoreGlobalPasswordSeed(
...
/*
** OEM_MANDATORY:
** If the device supports Secure Clock (DRM_SUPPORT_SELWRE_CLOCK=1), this function MUST be implemented by the OEM.
*/
...
** For all devices, this function MUST be implemented by the OEM.
*/
DRM_API DRM_RESULT DRM_CALL Oem_Platform_Init( DRM_VOID );

/*
** OEM_MANDATORY:
** For all devices, this function MUST be implemented by the OEM.
*/
DRM_API DRM_RESULT DRM_CALL Oem_Platform_UnInit( DRM_VOID );
...
#define SAFE_SELWRE_OEM_FREE( p, c )                                    \
    if (p != NULL)                                                      \
    {                                                                   \
...
typedef enum __tagOEM_HAL_KEY_TYPE
{
    ...
    OEM_HAL_KEY_TYPE_AES_OMAC1_SELWRE_STORE           = 10,

...
**       but rather to the files dislwssed in the comments further down
**       regarding them.
**
** NOTE: DRM_RESULTS can be colwerted into Windows HRESULTS without any
 ...
 *
 */
#define DRM_E_ILWALIDARG                 ((DRM_RESULT)0x80070057L)
...
/*
 * MessageId: DRM_E_ILWALID_COMMAND_LINE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_COMMAND_LINE       ((DRM_RESULT)0x80070667L)
 ...
 * MessageText:
 *
 * A problem has oclwrred in the Digital Rights Management component.
 *
 */
...
/*
 * MessageId: DRM_E_P256_COLWERSION_FAILURE
 *
 * MessageText:
 *
 * An error oclwrred while colwerting between P256 types.
 *
 */
#define DRM_E_P256_COLWERSION_FAILURE    ((DRM_RESULT)0x80040E87L)
 ...
 * MessageText:
 *
 * An error oclwrred in an asymmetric P256 cryptographic operation.
 *
 */
 ...
 * MessageText:
 *
 * An error oclwrred while attempting to map a plaintext array to a EC Point: There is no colwersion for this byte array to a EC Point.
 *
 */
#define DRM_E_P256_PLAINTEXT_MAPPING_FAILURE ((DRM_RESULT)0x80040E89L)

/*
 * MessageId: DRM_E_P256_ILWALID_SIGNATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_P256_ILWALID_SIGNATURE     ((DRM_RESULT)0x80040E8AL)
...
/*
 * MessageId: DRM_E_CH_ILWALID_HEADER
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_CH_ILWALID_HEADER          ((DRM_RESULT)0x80041108L)

/*
 * MessageId: DRM_E_CH_ILWALID_CHECKSUM
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_CH_ILWALID_CHECKSUM        ((DRM_RESULT)0x80041109L)
...
/*
 * MessageId: DRM_E_LIC_ILWALID_LICENSE
 *
 * MessageText:
 *
 *  DRM_E_LIC_ILWALID_LICENSE
 *
 */
#define DRM_E_LIC_ILWALID_LICENSE        ((DRM_RESULT)0x80041205L)
...
/*
 * MessageId: DRM_E_CPRMEXP_ILWALID_TOKEN
 *
 * MessageText:
 *
 *  DRM_E_CPRMEXP_ILWALID_TOKEN
 *
 */
#define DRM_E_CPRMEXP_ILWALID_TOKEN      ((DRM_RESULT)0x80041404L)

/*
 * MessageId: DRM_E_CPRMEXP_ILWALID_CONSTANT
 *
 * MessageText:
 *
 *  DRM_E_CPRMEXP_ILWALID_CONSTANT
 *
 */
#define DRM_E_CPRMEXP_ILWALID_CONSTANT   ((DRM_RESULT)0x80041405L)

/*
 * MessageId: DRM_E_CPRMEXP_ILWALID_VARIABLE
 *
 * MessageText:
 *
 *  DRM_E_CPRMEXP_ILWALID_VARIABLE
 *
 */
#define DRM_E_CPRMEXP_ILWALID_VARIABLE   ((DRM_RESULT)0x80041406L)

/*
 * MessageId: DRM_E_CPRMEXP_ILWALID_FUNCTION
 *
 * MessageText:
 *
 *  DRM_E_CPRMEXP_ILWALID_FUNCTION
 *
 */
#define DRM_E_CPRMEXP_ILWALID_FUNCTION   ((DRM_RESULT)0x80041407L)

/*
 * MessageId: DRM_E_CPRMEXP_ILWALID_ARGUMENT
 *
 * MessageText:
 *
 *  DRM_E_CPRMEXP_ILWALID_ARGUMENT
 *
 */
#define DRM_E_CPRMEXP_ILWALID_ARGUMENT   ((DRM_RESULT)0x80041408L)

/*
 * MessageId: DRM_E_CPRMEXP_ILWALID_CONTEXT
 *
 * MessageText:
 *
 *  DRM_E_CPRMEXP_ILWALID_CONTEXT
 *
 */
#define DRM_E_CPRMEXP_ILWALID_CONTEXT    ((DRM_RESULT)0x80041409L)
...
/*
 * MessageId: DRM_E_ILWALID_SIGNATURE
 *
 * MessageText:
 *
 * License signature failure.
 *
 */
#define DRM_E_ILWALID_SIGNATURE          ((DRM_RESULT)0x800480CFL)
...
/*
 * MessageId: DRM_E_SELWRESTORE_LOCK_NOT_OBTAINED
 *
 * MessageText:
 *
 * Before reading or writing data to selwrestore in raw mode, first the lock must be obtained using DRM_SST_OpenData.
 *
 */
#define DRM_E_SELWRESTORE_LOCK_NOT_OBTAINED ((DRM_RESULT)0x800480D4L)
 ...
 * MessageText:
 *
 * An error oclwrred in an asymmetric cryptographic operation.
 *
 */
#define DRM_E_PKCRYPTO_FAILURE           ((DRM_RESULT)0x800480D5L)

/*
 * MessageId: DRM_E_ILWALID_DST_SLOT_SIZE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_DST_SLOT_SIZE      ((DRM_RESULT)0x800480D6L)
...
/*
 * MessageId: DRM_E_DRMUTIL_ILWALID_CERT
 *
 * MessageText:
 *
 *  DRM_E_DRMUTIL_ILWALID_CERT
 *
 */
#define DRM_E_DRMUTIL_ILWALID_CERT       ((DRM_RESULT)0x80049007L)
...
/*
 * MessageId: DRM_E_DEVICE_SELWRITY_LEVEL_TOO_LOW
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_DEVICE_SELWRITY_LEVEL_TOO_LOW ((DRM_RESULT)0x8004A004L)
...
/*
 * MessageId: DRM_E_ILWALID_METERRESPONSE_SIGNATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_METERRESPONSE_SIGNATURE ((DRM_RESULT)0x8004A013L)

/*
 * MessageId: DRM_E_ILWALID_LICENSE_REVOCATION_LIST_SIGNATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_LICENSE_REVOCATION_LIST_SIGNATURE ((DRM_RESULT)0x8004A014L)

/*
 * MessageId: DRM_E_ILWALID_METERCERT_SIGNATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_METERCERT_SIGNATURE ((DRM_RESULT)0x8004A015L)
...
/*
 * MessageId: DRM_E_ILWALID_REVOCATION_LIST
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_REVOCATION_LIST    ((DRM_RESULT)0x8004A018L)

/*
 * MessageId: DRM_E_ELWELOPE_CORRUPT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ELWELOPE_CORRUPT           ((DRM_RESULT)0x8004A019L)

/*
 * MessageId: DRM_E_ELWELOPE_FILE_NOT_COMPATIBLE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ELWELOPE_FILE_NOT_COMPATIBLE ((DRM_RESULT)0x8004A01AL)
 ...
 *
 */
#define DRM_E_ILWALID_SLK                ((DRM_RESULT)0x8004A01CL)
 ...
 *
 */
#define DRM_E_ILWALID_RIGHT              ((DRM_RESULT)0x8004C003L)

/*
 * MessageId: DRM_E_ILWALID_LICENSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_LICENSE            ((DRM_RESULT)0x8004C006L)
...
/*
 * MessageId: DRM_E_ILWALID_LICENSE_STORE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_LICENSE_STORE      ((DRM_RESULT)0x8004C019L)
...
/*
 * MessageId: DRM_E_ILWALID_XML_TAG
 *
 * MessageText:
 *
 * Invalid XML tag
 *
 */
#define DRM_E_ILWALID_XML_TAG            ((DRM_RESULT)0x8004C020L)
...
/*
 * MessageId: DRM_E_ILWALID_SELWRESTORE_PASSWORD
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_SELWRESTORE_PASSWORD ((DRM_RESULT)0x8004C029L)

/*
 * MessageId: DRM_E_SELWRESTORE_CORRUPT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTORE_CORRUPT        ((DRM_RESULT)0x8004C02AL)

/*
 * MessageId: DRM_E_SELWRESTORE_FULL
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTORE_FULL           ((DRM_RESULT)0x8004C02BL)
...
/*
 * MessageId: DRM_E_ILWALID_DEVICE_CERTIFICATE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_DEVICE_CERTIFICATE ((DRM_RESULT)0x8004C035L)
...
/*
 * MessageId: DRM_E_CLK_ILWALID_RESPONSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_CLK_ILWALID_RESPONSE       ((DRM_RESULT)0x8004C03FL)

/*
 * MessageId: DRM_E_CLK_ILWALID_DATE
 *
 * MessageText:
 *
 * The secure clock response is invalid.
 *
 */
#define DRM_E_CLK_ILWALID_DATE           ((DRM_RESULT)0x8004C040L)

/*
 * MessageId: DRM_E_ILWALID_DEVCERT_TEMPLATE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_DEVCERT_TEMPLATE   ((DRM_RESULT)0x8004C042L)
...
/*
 * MessageId: DRM_E_METERING_ILWALID_COMMAND
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_METERING_ILWALID_COMMAND   ((DRM_RESULT)0x8004C051L)
...
/*
 * MessageId: DRM_E_OEM_RSA_ILWALID_PRIVATE_KEY
 *
 * MessageText:
 *
 * Invalid private key.
 *
 */
#define DRM_E_OEM_RSA_ILWALID_PRIVATE_KEY ((DRM_RESULT)0x8004C06DL)
...
/*
 * MessageId: DRM_E_ILWALID_PLAYREADY_OBJECT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_PLAYREADY_OBJECT   ((DRM_RESULT)0x8004C06FL)
...
/*
 * MessageId: DRM_E_ILWALID_BASE64
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_BASE64             ((DRM_RESULT)0x8004C074L)
...
/*
 * MessageId: DRM_E_ILWALID_LICENSE_RESPONSE_SIGNATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_LICENSE_RESPONSE_SIGNATURE ((DRM_RESULT)0x8004C076L)

/*
 * MessageId: DRM_E_ILWALID_LICENSE_RESPONSE_ID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_LICENSE_RESPONSE_ID ((DRM_RESULT)0x8004C077L)
...
/*
 * MessageId: DRM_E_ILWALID_DOMAIN_JOIN_RESPONSE_SIGNATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_DOMAIN_JOIN_RESPONSE_SIGNATURE ((DRM_RESULT)0x8004C079L)
 ...
 * MessageText:
 *
 * A server error oclwrred during device activation.
 *
 */
...
/*
 * MessageId: DRM_E_ACTIVATION_CLIENT_ALREADY_LWRRENT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ACTIVATION_CLIENT_ALREADY_LWRRENT ((DRM_RESULT)0x8004C083L)
...
/*
 * MessageId: DRM_E_LICEVAL_ILWALID_PRND_LICENSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_LICEVAL_ILWALID_PRND_LICENSE ((DRM_RESULT)0x8004C0C5L)
...
/*
 * MessageId: DRM_E_XMR_ILWALID_UNKNOWN_OBJECT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_XMR_ILWALID_UNKNOWN_OBJECT ((DRM_RESULT)0x8004C0E3L)
...
/*
 * MessageId: DRM_E_ILWALID_DEVCERT_ATTRIBUTE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_DEVCERT_ATTRIBUTE  ((DRM_RESULT)0x8004C200L)
...
/*
 * MessageId: DRM_S_TEST_COLWERTED_FILE
 *
 * MessageText:
 *
 * The file was colwerted to a PlayReady file during the action.
 *
 */
#define DRM_S_TEST_COLWERTED_FILE        ((DRM_RESULT)0x0004C301L)
...
/*
 * MessageId: DRM_E_TEST_CBC_ILWERSEMAC_FAILURE
 *
 * MessageText:
 *
 * Decrypted data not equal to original in Ilwerse MAC operation.
 *
 */
#define DRM_E_TEST_CBC_ILWERSEMAC_FAILURE ((DRM_RESULT)0x8004C306L)
...
/*
 * MessageId: DRM_E_TEST_ILWALIDARG
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEST_ILWALIDARG            ((DRM_RESULT)0x8004C308L)
...
/*
 * MessageId: DRM_E_TEST_ILWALID_OPL_CALLBACK
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEST_ILWALID_OPL_CALLBACK  ((DRM_RESULT)0x8004C31CL)
 ...
 * MessageText:
 *
 * A global variable needed for test exelwtion has not been set correctly.
 *
 */
...
/*
 * MessageId: DRM_E_TEST_ILWALID_DEVICE_WRAPPER
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEST_ILWALID_DEVICE_WRAPPER ((DRM_RESULT)0x8004C331L)

/*
 * MessageId: DRM_E_TEST_ILWALID_WMDM_WRAPPER
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEST_ILWALID_WMDM_WRAPPER  ((DRM_RESULT)0x8004C332L)

/*
 * MessageId: DRM_E_TEST_ILWALID_WPD_WRAPPER
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEST_ILWALID_WPD_WRAPPER   ((DRM_RESULT)0x8004C333L)

/*
 * MessageId: DRM_E_TEST_ILWALID_FILE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEST_ILWALID_FILE          ((DRM_RESULT)0x8004C334L)
 ...
 * MessageText:
 *
 * A failure oclwrred during the test case cleanup phase.
 *
 */
...
/*
 * MessageId: DRM_E_ILWALID_REV_INFO
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_REV_INFO           ((DRM_RESULT)0x8004C3E9L)
 ...
 * MessageText:
 *
 * A failure oclwrred in bignum modular arithmetic.
 *
 */
#define DRM_E_MODULAR_ARITHMETIC_FAILURE ((DRM_RESULT)0x8004C3F3L)

/*
 * MessageId: DRM_E_REVOCATION_ILWALID_PACKAGE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_REVOCATION_ILWALID_PACKAGE ((DRM_RESULT)0x8004C3F5L)
...
/*
 * MessageId: DRM_E_DOMAIN_ILWALID_GUID
 *
 * MessageText:
 *
 * Not a correct GUID.
 *
 */
#define DRM_E_DOMAIN_ILWALID_GUID        ((DRM_RESULT)0x8004C500L)

/*
 * MessageId: DRM_E_DOMAIN_ILWALID_LWSTOM_DATA_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_DOMAIN_ILWALID_LWSTOM_DATA_TYPE ((DRM_RESULT)0x8004C501L)
...
/*
 * MessageId: DRM_E_DOMAIN_ILWALID_LWSTOM_DATA
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_DOMAIN_ILWALID_LWSTOM_DATA ((DRM_RESULT)0x8004C508L)
...
/*
 * MessageId: DRM_E_DOMAIN_ILWALID_DOMKEYXMR_DATA
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_DOMAIN_ILWALID_DOMKEYXMR_DATA ((DRM_RESULT)0x8004C50AL)

/*
 * MessageId: DRM_E_DOMAIN_STORE_ILWALID_KEY_RECORD
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_DOMAIN_STORE_ILWALID_KEY_RECORD ((DRM_RESULT)0x8004C50BL)
 ...
 * MessageText:
 *
 * An internal server error oclwrred.
 *
 */
#define DRM_E_SERVER_INTERNAL_ERROR      ((DRM_RESULT)0x8004C600L)

/*
 * MessageId: DRM_E_SERVER_ILWALID_MESSAGE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SERVER_ILWALID_MESSAGE     ((DRM_RESULT)0x8004C601L)
 ...
 * MessageText:
 *
 * An error specific to the service has oclwrred.
 *
 */
...
/*
 * MessageId: DRM_E_SERVER_ILWALID_LICENSEID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SERVER_ILWALID_LICENSEID   ((DRM_RESULT)0x8004C611L)
...
/*
 * MessageId: DRM_E_INITIATORS_ILWALID_SERVICEID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_INITIATORS_ILWALID_SERVICEID ((DRM_RESULT)0x8004C781L)

/*
 * MessageId: DRM_E_INITIATORS_ILWALID_ACCOUNTID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_INITIATORS_ILWALID_ACCOUNTID ((DRM_RESULT)0x8004C782L)

/*
 * MessageId: DRM_E_INITIATORS_ILWALID_MID
 *
 * MessageText:
 *
 * The account ID data is not valid.
 *
 */
#define DRM_E_INITIATORS_ILWALID_MID     ((DRM_RESULT)0x8004C783L)
...
/*
 * MessageId: DRM_E_BCERT_ILWALID_SIGNATURE_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_SIGNATURE_TYPE ((DRM_RESULT)0x8004C800L)
...
/*
 * MessageId: DRM_E_BCERT_ILWALID_CERT_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CERT_TYPE    ((DRM_RESULT)0x8004C802L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_FEATURE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_FEATURE      ((DRM_RESULT)0x8004C803L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_KEY_USAGE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_KEY_USAGE    ((DRM_RESULT)0x8004C804L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_SELWRITY_VERSION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_SELWRITY_VERSION ((DRM_RESULT)0x8004C805L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_KEY_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_KEY_TYPE     ((DRM_RESULT)0x8004C806L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_KEY_LENGTH
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_KEY_LENGTH   ((DRM_RESULT)0x8004C807L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_MAX_LICENSE_SIZE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_MAX_LICENSE_SIZE ((DRM_RESULT)0x8004C808L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_MAX_HEADER_SIZE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_MAX_HEADER_SIZE ((DRM_RESULT)0x8004C809L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_MAX_LICENSE_CHAIN_DEPTH
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_MAX_LICENSE_CHAIN_DEPTH ((DRM_RESULT)0x8004C80AL)

/*
 * MessageId: DRM_E_BCERT_ILWALID_SELWRITY_LEVEL
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_SELWRITY_LEVEL ((DRM_RESULT)0x8004C80BL)
...
/*
 * MessageId: DRM_E_BCERT_ILWALID_ISSUERKEY_LENGTH
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_ISSUERKEY_LENGTH ((DRM_RESULT)0x8004C81BL)
...
/*
 * MessageId: DRM_E_BCERT_ILWALID_MAX_KEY_USAGES
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_MAX_KEY_USAGES ((DRM_RESULT)0x8004C81FL)

/*
 * MessageId: DRM_E_BCERT_ILWALID_MAX_FEATURES
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_MAX_FEATURES ((DRM_RESULT)0x8004C820L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_CHAIN_HEADER_TAG
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CHAIN_HEADER_TAG ((DRM_RESULT)0x8004C821L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_CHAIN_VERSION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CHAIN_VERSION ((DRM_RESULT)0x8004C822L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_CHAIN_LENGTH
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CHAIN_LENGTH ((DRM_RESULT)0x8004C823L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_CERT_HEADER_TAG
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CERT_HEADER_TAG ((DRM_RESULT)0x8004C824L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_CERT_VERSION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CERT_VERSION ((DRM_RESULT)0x8004C825L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_CERT_LENGTH
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_CERT_LENGTH  ((DRM_RESULT)0x8004C826L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_SIGNEDCERT_LENGTH
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_SIGNEDCERT_LENGTH ((DRM_RESULT)0x8004C827L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_PLATFORM_IDENTIFIER
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_PLATFORM_IDENTIFIER ((DRM_RESULT)0x8004C828L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_NUMBER_EXTDATARECORDS
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_NUMBER_EXTDATARECORDS ((DRM_RESULT)0x8004C829L)

/*
 * MessageId: DRM_E_BCERT_ILWALID_EXTDATARECORD
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_EXTDATARECORD ((DRM_RESULT)0x8004C82AL)
...
/*
 * MessageId: DRM_E_BCERT_ILWALID_EXTDATA_LENGTH
 *
 * MessageText:
 *
 * Callwlated and written extended data object lengths do not match.
 *
 */
#define DRM_E_BCERT_ILWALID_EXTDATA_LENGTH ((DRM_RESULT)0x8004C82DL)
...
/*
 * MessageId: DRM_E_BCERT_ILWALID_WARNING_DAYS
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_WARNING_DAYS ((DRM_RESULT)0x8004C83CL)

/*
 * MessageId: DRM_E_BCERT_ILWALID_DIGEST
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_BCERT_ILWALID_DIGEST       ((DRM_RESULT)0x8004C83DL)
 ...
 * MessageText:
 *
 * Ilwalud pre-shared public key ID.
 *
 */
#define DRM_E_XMLSIG_PUBLIC_KEY_ID       ((DRM_RESULT)0x8004C903L)

/*
 * MessageId: DRM_E_XMLSIG_ILWALID_KEY_FORMAT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_XMLSIG_ILWALID_KEY_FORMAT  ((DRM_RESULT)0x8004C904L)
...
/*
 * MessageId: DRM_E_UTF_ILWALID_CODE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_UTF_ILWALID_CODE           ((DRM_RESULT)0x8004CA01L)
...
/*
 * MessageId: DRM_E_SOAPXML_ILWALID_STATUS_CODE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SOAPXML_ILWALID_STATUS_CODE ((DRM_RESULT)0x8004CB00L)
...
/*
 * MessageId: DRM_E_TEE_ILWALID_KEY_DATA
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_ILWALID_KEY_DATA       ((DRM_RESULT)0x8004CD10L)
...
/*
 * MessageId: DRM_E_TEE_ILWALID_CONTEXT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_ILWALID_CONTEXT        ((DRM_RESULT)0x8004CD12L)
...
/*
 * MessageId: DRM_E_TEE_PROVISIONING_ILWALID_RESPONSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_PROVISIONING_ILWALID_RESPONSE ((DRM_RESULT)0x8004CD19L)

/*
 * MessageId: DRM_E_TEE_PROXY_ILWALID_SERIALIZATION_MESSAGE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_PROXY_ILWALID_SERIALIZATION_MESSAGE ((DRM_RESULT)0x8004CD1AL)

/*
 * MessageId: DRM_E_TEE_PROXY_ILWALID_SERIALIZATION_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_PROXY_ILWALID_SERIALIZATION_TYPE ((DRM_RESULT)0x8004CD1BL)
...
/*
 * MessageId: DRM_E_TEE_ILWALID_HEADER_FOOTER_SIZE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_ILWALID_HEADER_FOOTER_SIZE ((DRM_RESULT)0x8004CD1DL)
...
/*
 * MessageId: DRM_E_TEE_PROXY_ILWALID_BUFFER_ALIGNMENT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_PROXY_ILWALID_BUFFER_ALIGNMENT ((DRM_RESULT)0x8004CD20L)

/*
 * MessageId: DRM_E_TEE_PROXY_ILWALID_ALIGNMENT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_TEE_PROXY_ILWALID_ALIGNMENT ((DRM_RESULT)0x8004CD21L)
 ...
 * MessageText:
 *
 * The client must be revalidated before exelwting the intended operation.
 *
 */
#define DRM_E_ND_MUST_REVALIDATE         ((DRM_RESULT)0x8004CE00L)

/*
 * MessageId: DRM_E_ND_ILWALID_MESSAGE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ND_ILWALID_MESSAGE         ((DRM_RESULT)0x8004CE01L)

/*
 * MessageId: DRM_E_ND_ILWALID_MESSAGE_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ND_ILWALID_MESSAGE_TYPE    ((DRM_RESULT)0x8004CE02L)

/*
 * MessageId: DRM_E_ND_ILWALID_MESSAGE_VERSION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ND_ILWALID_MESSAGE_VERSION ((DRM_RESULT)0x8004CE03L)

/*
 * MessageId: DRM_E_ND_ILWALID_SESSION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ND_ILWALID_SESSION         ((DRM_RESULT)0x8004CE04L)
...
/*
 * MessageId: DRM_E_ND_ILWALID_PROXIMITY_RESPONSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ND_ILWALID_PROXIMITY_RESPONSE ((DRM_RESULT)0x8004CE07L)
...
/*
 * MessageId: DRM_E_ND_ILWALID_CONTEXT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ND_ILWALID_CONTEXT         ((DRM_RESULT)0x8004CE0BL)
...
/*
 * MessageId: DRM_E_ASF_ILWALID_OPERATION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ASF_ILWALID_OPERATION      ((DRM_RESULT)0x8004CF04L)
...
/*
 * MessageId: DRM_E_ASF_ILWALID_DATA
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ASF_ILWALID_DATA           ((DRM_RESULT)0x8004CF20L)
...
/*
 * MessageId: DRM_E_ASF_ILWALID_STREAM_NUMBER
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ASF_ILWALID_STREAM_NUMBER  ((DRM_RESULT)0x8004CF23L)
...
/*
 * MessageId: DRM_E_ILWALID_MOVE_RESPONSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_ILWALID_MOVE_RESPONSE      ((DRM_RESULT)0x8004D301L)
...
/*
 * MessageId: DRM_E_MOVE_FORMAT_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_MOVE_FORMAT_ILWALID        ((DRM_RESULT)0x8004D308L)

/*
 * MessageId: DRM_E_MOVE_SIGNATURE_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_MOVE_SIGNATURE_ILWALID     ((DRM_RESULT)0x8004D309L)
...
/*
 * MessageId: DRM_E_XB_ILWALID_OBJECT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_XB_ILWALID_OBJECT          ((DRM_RESULT)0x8004D401L)
...
/*
 * MessageId: DRM_E_XB_ILWALID_VERSION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_XB_ILWALID_VERSION         ((DRM_RESULT)0x8004D405L)
...
/*
 * MessageId: DRM_E_XB_ILWALID_ALIGNMENT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_XB_ILWALID_ALIGNMENT       ((DRM_RESULT)0x8004D407L)
...
/*
 * MessageId: DRM_E_PRND_MESSAGE_VERSION_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_MESSAGE_VERSION_ILWALID ((DRM_RESULT)0x8004D700L)
...
/*
 * MessageId: DRM_E_PRND_MESSAGE_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_MESSAGE_ILWALID       ((DRM_RESULT)0x8004D702L)

/*
 * MessageId: DRM_E_PRND_SESSION_ID_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_SESSION_ID_ILWALID    ((DRM_RESULT)0x8004D703L)
...
/*
 * MessageId: DRM_E_PRND_PROXIMITY_DETECTION_RESPONSE_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_PROXIMITY_DETECTION_RESPONSE_ILWALID ((DRM_RESULT)0x8004D705L)
 ...
 * MessageText:
 *
 * The PRND License Request Message used Content Identifier Type Custom.  A Content Identifier Callback to colwert the value to a KID is required.
 *
 */
#define DRM_E_PRND_LICENSE_REQUEST_CID_CALLBACK_REQUIRED ((DRM_RESULT)0x8004D707L)

/*
 * MessageId: DRM_E_PRND_LICENSE_RESPONSE_CLMID_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_LICENSE_RESPONSE_CLMID_ILWALID ((DRM_RESULT)0x8004D708L)
...
/*
 * MessageId: DRM_E_PRND_ILWALID_LWSTOM_DATA_TYPE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_ILWALID_LWSTOM_DATA_TYPE ((DRM_RESULT)0x8004D70BL)
 ...
 * MessageText:
 *
 * The Receiver is lwrrently unable to process a message of this type because it is in the middle of renewing the session.
 *
 */
#define DRM_E_PRND_BUSY_PERFORMING_RENEWAL ((DRM_RESULT)0x8004D70FL)

/*
 * MessageId: DRM_E_PRND_LICENSE_REQUEST_ILWALID_ACTION
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_LICENSE_REQUEST_ILWALID_ACTION ((DRM_RESULT)0x8004D710L)
...
/*
 * MessageId: DRM_E_PRND_ILWALID_CERT_DIGEST
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_PRND_ILWALID_CERT_DIGEST   ((DRM_RESULT)0x8004D714L)
...
/*
 * MessageId: DRM_E_M2TS_DDPLUS_FORMAT_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_DDPLUS_FORMAT_ILWALID ((DRM_RESULT)0x8004D806L)
...
/*
 * MessageId: DRM_E_M2TS_TABLE_ID_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_TABLE_ID_ILWALID      ((DRM_RESULT)0x8004D809L)

/*
 * MessageId: DRM_E_M2TS_PACKET_SYNC_BYTE_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_PACKET_SYNC_BYTE_ILWALID ((DRM_RESULT)0x8004D80AL)

/*
 * MessageId: DRM_E_M2TS_ADAPTATION_LENGTH_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_ADAPTATION_LENGTH_ILWALID ((DRM_RESULT)0x8004D80BL)

/*
 * MessageId: DRM_E_M2TS_PAT_HEADER_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_PAT_HEADER_ILWALID    ((DRM_RESULT)0x8004D80CL)

/*
 * MessageId: DRM_E_M2TS_PMT_HEADER_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_PMT_HEADER_ILWALID    ((DRM_RESULT)0x8004D80DL)
 ...
 * MessageText:
 *
 * An internal error oclwrred during encryptrion.
 *
 */
#define DRM_E_M2TS_INTERNAL_ERROR        ((DRM_RESULT)0x8004D810L)

/*
 * MessageId: DRM_E_M2TS_ADTS_FORMAT_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_ADTS_FORMAT_ILWALID   ((DRM_RESULT)0x8004D811L)

/*
 * MessageId: DRM_E_M2TS_MPEGA_FORMAT_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_MPEGA_FORMAT_ILWALID  ((DRM_RESULT)0x8004D812L)

/*
 * MessageId: DRM_E_M2TS_CA_DESCRIPTOR_LENGTH_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_CA_DESCRIPTOR_LENGTH_ILWALID ((DRM_RESULT)0x8004D813L)

/*
 * MessageId: DRM_E_M2TS_CRC_FIELD_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_CRC_FIELD_ILWALID     ((DRM_RESULT)0x8004D814L)
...
/*
 * MessageId: DRM_E_M2TS_ILWALID_UNALIGNED_DATA
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_ILWALID_UNALIGNED_DATA ((DRM_RESULT)0x8004D816L)
...
/*
 * MessageId: DRM_E_M2TS_SECTION_LENGTH_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_SECTION_LENGTH_ILWALID ((DRM_RESULT)0x8004D824L)

/*
 * MessageId: DRM_E_M2TS_PROGRAM_INFO_LENGTH_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_PROGRAM_INFO_LENGTH_ILWALID ((DRM_RESULT)0x8004D825L)

/*
 * MessageId: DRM_E_M2TS_PES_HEADER_ILWALID
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_M2TS_PES_HEADER_ILWALID    ((DRM_RESULT)0x8004D826L)
...
/*
 * MessageId: DRM_E_LICGEN_CHILD_SELWRITY_LEVEL_TOO_LOW
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_LICGEN_CHILD_SELWRITY_LEVEL_TOO_LOW ((DRM_RESULT)0x8004D909L)
...
/*
 * MessageId: DRM_E_RPROV_ILWALID_REQUEST
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_RPROV_ILWALID_REQUEST      ((DRM_RESULT)0x8004DB00L)
...
/*
 * MessageId: DRM_E_RPROV_ILWALID_RESPONSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_RPROV_ILWALID_RESPONSE     ((DRM_RESULT)0x8004DB02L)
...
#define DRM_E_SELWRESTOP_BASECODE  (DRM_E_BASECODE + 0x1C00)
#define DRM_E_SELWRESTOP_FINALCODE (DRM_E_BASECODE + 0x1CFF)

/*
 * MessageId: DRM_E_SELWRESTOP_STORE_CORRUPT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTOP_STORE_CORRUPT   ((DRM_RESULT)0x8004DC00L)

/*
 * MessageId: DRM_E_SELWRESTOP_SESSION_LOCKED
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTOP_SESSION_LOCKED  ((DRM_RESULT)0x8004DC02L)

/*
 * MessageId: DRM_E_SELWRESTOP_SESSION_CORRUPT
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTOP_SESSION_CORRUPT ((DRM_RESULT)0x8004DC03L)

/*
 * MessageId: DRM_E_SELWRESTOP_SESSION_ACTIVE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTOP_SESSION_ACTIVE  ((DRM_RESULT)0x8004DC04L)

/*
 * MessageId: DRM_E_SELWRESTOP_SESSION_NOT_FOUND
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTOP_SESSION_NOT_FOUND ((DRM_RESULT)0x8004DC05L)

/*
 * MessageId: DRM_E_SELWRESTOP_ILWALID_RESPONSE
 *
 * MessageText:
 *
 ...
 *
 */
#define DRM_E_SELWRESTOP_ILWALID_RESPONSE ((DRM_RESULT)0x8004DC06L)
...
/* ============================================================
**
** 0x8004de00 to 0x8004deff are being used without MSFT
** permission for capturing errors where we failed to translate
** an internal error code to one in range 0x8004dd00 to
** 0x8004ddff. It is not expected that we will ever generate
** any error in range 0x8004de00 to 0x8004deff
**
** ============================================================
*/
 ...
 *
 */
#define DRM_E_OEM_FLCN_STATUS_TO_DRM_STATUS_TRANSLATION_FAILED ((DRM_RESULT)0x8004DE00L)
...
#define DRM_E_DEPRECATED_LIC_ILWALID_REVLIST                                      ((DRM_RESULT)0x80041209L)
...
#define DRM_E_DEPRECATED_ILWALID_LICENSE_FLAGS                                    ((DRM_RESULT)0x8004C005L)
...
#define DRM_E_DEPRECATED_ILWALID_TIME                                             ((DRM_RESULT)0x8004C011L)
#define DRM_E_DEPRECATED_ILWALID_BIND_ID                                          ((DRM_RESULT)0x8004C015L)
...
#define DRM_E_DEPRECATED_CLIENT_TIME_ILWALID                                      ((DRM_RESULT)0x8004C01CL)
...
#define DRM_E_DEPRECATED_ILWALID_DEVSTORE_ATTRIBUTE                               ((DRM_RESULT)0x8004C067L)
#define DRM_E_DEPRECATED_ILWALID_DEVSTORE_ENTRY                                   ((DRM_RESULT)0x8004C068L)
...
#define DRM_E_DEPRECATED_LRB_ILWALID_SIGNATURE                                    ((DRM_RESULT)0x8004C0A1L)
#define DRM_E_DEPRECATED_LRB_LGPUBKEY_MISMATCH                                    ((DRM_RESULT)0x8004C0A2L)
#define DRM_E_DEPRECATED_LRB_ILWALID_LICENSE_DATA                                 ((DRM_RESULT)0x8004C0A3L)
...
#define DRM_E_DEPRECATED_BCERT_ILWALID_EXTDATA_SIGNED_LENGTH                      ((DRM_RESULT)0x8004C830L)
#define DRM_E_DEPRECATED_BCERT_ILWALID_EXTDATA_RECORD_TYPE                        ((DRM_RESULT)0x8004C831L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_BAD_GLOBAL_DATA_POINTER                     ((DRM_RESULT)0x8004CD00L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_ILWALID_GLOBAL_DATA                         ((DRM_RESULT)0x8004CD01L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_FORMATTING_ERROR                            ((DRM_RESULT)0x8004CD02L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_BAD_SCHEME_DATA_POINTER                     ((DRM_RESULT)0x8004CD03L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_BAD_PER_THREAD_AES_DATA_POINTER             ((DRM_RESULT)0x8004CD04L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_BAD_PER_THREAD_AES_BUFFER_POINTER           ((DRM_RESULT)0x8004CD05L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_AES_INSUFFICIENT_BUFFER                     ((DRM_RESULT)0x8004CD06L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_VERSION_MISMATCH                            ((DRM_RESULT)0x8004CD07L)
#define DRM_E_DEPRECATED_SELWRE_TRACE_UNEXPECTED_ERROR                            ((DRM_RESULT)0x8004CD08L)
...
#define DRM_E_DEPRECATED_KEYFILE_ILWALID_PLATFORM                                 ((DRM_RESULT)0x8004D500L)
...
#define DRM_E_DEPRECATED_KEYFILE_ILWALID_SIGNATURE                                ((DRM_RESULT)0x8004D506L)
...
#define DRM_E_DEPRECATED_KEYFILE_FORMAT_ILWALID                                   ((DRM_RESULT)0x8004D50DL)

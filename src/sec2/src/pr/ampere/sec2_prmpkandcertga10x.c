...
/* ------------------------- Function Prototypes ---------------------------- */
/* ------------------------- Global Variables ------------------------------- */
LwU32 g_mpke_sl150_debug[NUM_SIG_PER_UCODE][PR_MPK_SIZE_DWORD] GCC_ATTRIB_ALIGN(SCP_BUF_ALIGNMENT);
LwU32 g_mpke_sl150_prod[NUM_SIG_PER_UCODE][PR_MPK_SIZE_DWORD]  GCC_ATTRIB_ALIGN(SCP_BUF_ALIGNMENT);
LwU32 g_mpke_sl3000_prod[NUM_SIG_PER_UCODE][PR_MPK_SIZE_DWORD] GCC_ATTRIB_ALIGN(SCP_BUF_ALIGNMENT);
...
#define OEM_TEE_LPROV_DEVICECERT_SIGNDATA_START_OFFSET_SL3000_GA10X      0x0014
#define OEM_TEE_LPROV_DEVICECERT_SIGNDATA_LENGTH_SL3000_GA10X            0x0188
#define OEM_TEE_LPROV_DEVICECERT_SIGNATURE_OFFSET_SL3000_GA10X           0x01a8

#define OEM_TEE_LPROV_DEVICECERT_CERTID_OFFSET_SL3000_GA10X              0x002c
#define OEM_TEE_LPROV_DEVICECERT_CLIENTID_OFFSET_SL3000_GA10X            0x006c
#define OEM_TEE_LPROV_DEVICECERT_CERTDIGEST_OFFSET_SL3000_GA10X          0x0048

#define OEM_TEE_LPROV_DEVICECERT_PUBKEY_SIGN_OFFSET_SL3000_GA10X         0x00c8
#define OEM_TEE_LPROV_DEVICECERT_PUBKEY_ENCRYPT_OFFSET_SL3000_GA10X      0x0118
#define OEM_TEE_LPROV_DEVICECERT_PUBKEY_PRND_ENCRYPT_OFFSET_SL3000_GA10X 0x0000 /* This define is not applicable since Lwpu doesn't support PRND */

/* ------------------------- Static Variables ------------------------------- */
/*
//
// These XML-tag-like cert info gets changed every time MPK is changed, this needs to be replaced whenever new MPK is added.
//  Although it is commented out and not used, lets change this whenever new MPK is added
//
<PlayReady_Cert_Chain>
    ...
    <Certificate_1>
        <Basic_Data>
            ...
            <Features>
CRL Support,PlayReady3 Features,
            </Features>
        </Basic_Data>
        <Key_Data>
            <KEY_0>
                ...
                <Key_Value>GDc9UmbWDKebP5/l8k0ITZMmOgRYrUhvZtOJjjqk1G/0fP8VOQ1pLskYbEPSLjZDOaKM7XkI6BTLyIh5C2xKJg==</Key_Value>
                <Key_Usage>Sign,</Key_Usage>
            </KEY_0>
            <KEY_1>
                <Key_Type>0x1</Key_Type>
                <Length>512 bit</Length>
                <Key_Value>7px7Jc6VZmbNdRZPfsvHythkb7Ps0b2UWKqoNdAE47Y3lFLRGZc5Mwwa2Jhsi6uxXUXswgJCWoJ3cYGqOaFkzg==</Key_Value>
                <Key_Usage>Encrypt Key,</Key_Usage>
            </KEY_1>
        </Key_Data>
        <Robustness_Data_2>
            <Selwrity_Version>1.0.0.0</Selwrity_Version>
            <Platform_Identifier>-1 (OEM or Unspecified)</Platform_Identifier>
        </Robustness_Data_2>
        <Manufacturer>
            <Manufacturer>Lwpu Corporation</Manufacturer>
            <Model_Name>GA10X</Model_Name>
            <Model_Number>GA10X</Model_Number>
        </Manufacturer>
        <Signature>
            <Signature_Type>0x1</Signature_Type>
            <Issuer_Key_Length>512</Issuer_Key_Length>
            <Issuer_Key_Value>Tic/imri8u3Bt9ciHcaVkO8qcIlwaPJONxOWCJl/FbdOvxzZQ417unalzosyUDT8wmlA9Wc9XYbG/y5IUz7lfw==</Issuer_Key_Value>
        </Signature>
...
CRL Support,PlayReady3 Features,
        ...
        <Key_Data>
            <KEY_0>
                <Key_Type>0x1</Key_Type>
                <Length>512 bit</Length>
                <Key_Value>Tic/imri8u3Bt9ciHcaVkO8qcIlwaPJONxOWCJl/FbdOvxzZQ417unalzosyUDT8wmlA9Wc9XYbG/y5IUz7lfw==</Key_Value>
                <Key_Usage>Sign,Issuer-Device,</Key_Usage>
            </KEY_0>
        </Key_Data>
        <Robustness_Data_2>
            <Selwrity_Version>1.0.0.0</Selwrity_Version>
        ...
        <Signature>
            <Signature_Type>0x1</Signature_Type>
            <Issuer_Key_Length>512</Issuer_Key_Length>
            <Issuer_Key_Value>39A+paj5Ejz9rXeAes3xQx36f/3SLTppue7Mnbgbz2U828O8ChEydqHDxRNT+0800Fj/wFFMQvmL5TIkX8J3Aw==</Issuer_Key_Value>
        </Signature>
...
Empty
        ...
        <Key_Data>
            <KEY_0>
                <Key_Type>0x1</Key_Type>
                <Length>512 bit</Length>
                <Key_Value>39A+paj5Ejz9rXeAes3xQx36f/3SLTppue7Mnbgbz2U828O8ChEydqHDxRNT+0800Fj/wFFMQvmL5TIkX8J3Aw==</Key_Value>
        ...
        <Manufacturer>
            ...
            <Model_Number>(null)</Model_Number>
        </Manufacturer>
        <Signature>
            <Signature_Type>0x1</Signature_Type>
            <Issuer_Key_Length>512</Issuer_Key_Length>
...
// The data in this cert array is generated whenever MPK is changed. This would be replaced with new cert data. 
static LwU8 s_rgbDeviceCertTemplate_SL3000_GA10X[] PR_ATTR_DATA_OVLY(_s_rgbDeviceCertTemplate_SL3000_GA10X) =
{
    ...
    , 
    ...
    0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4e, 0x27, 0x3f, 0x8a, 
    0x6a, 0xe2, 0xf2, 0xed, 0xc1, 0xb7, 0xd7, 0x22, 0x1d, 0xc6, 0x95, 0x90, 0xef, 0x2a, 0x70, 0x89, 
    0xef, 0x68, 0xf2, 0x4e, 0x37, 0x13, 0x96, 0x08, 0x99, 0x7f, 0x15, 0xb7, 0x4e, 0xbf, 0x1c, 0xd9, 
    0x43, 0x8d, 0x7b, 0xba, 0x76, 0xa5, 0xce, 0x8b, 0x32, 0x50, 0x34, 0xfc, 0xc2, 0x69, 0x40, 0xf5, 
    0x67, 0x3d, 0x5d, 0x86, 0xc6, 0xff, 0x2e, 0x48, 0x53, 0x3e, 0xe5, 0x7f, 0x00, 0x00, 0x00, 0x02, 
    ...
    0x47, 0x41, 0x31, 0x30, 0x58, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x47, 0x41, 0x31, 0x30, 
    0x58, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08, 0x00, 0x00, 0x00, 0x90, 0x00, 0x01, 0x00, 0x40, 
    0x84, 0x0e, 0xbd, 0x6f, 0x9c, 0x62, 0xd3, 0xbf, 0x0a, 0xd5, 0x7a, 0x24, 0x09, 0x6f, 0xff, 0x36, 
    0xa0, 0xa6, 0xbe, 0x83, 0xd2, 0x19, 0x9a, 0x8e, 0xd7, 0xbc, 0xbc, 0x71, 0x16, 0x93, 0xd0, 0x76, 
    0xad, 0x50, 0x9d, 0xdf, 0x7a, 0xd3, 0x81, 0x04, 0xd8, 0xe1, 0x41, 0xbe, 0xf0, 0x59, 0x4f, 0x7d, 
    0x3d, 0x36, 0x7f, 0xc9, 0x37, 0xbe, 0x24, 0x44, 0xba, 0x72, 0x3b, 0x0a, 0xcd, 0x46, 0x57, 0x08, 
 ...
 */
void
prGetSL3000DeviceCertTemplate_GA10X
(
    LwU8  **ppCert,
    LwU32  *pCertSize,
...
)
{
    ...
    *ppCert    = s_rgbDeviceCertTemplate_SL3000_GA10X;
    *pCertSize = sizeof(s_rgbDeviceCertTemplate_SL3000_GA10X);

    pDTLCI->ibCertID                                             = OEM_TEE_LPROV_DEVICECERT_CERTID_OFFSET_SL3000_GA10X;
    pDTLCI->ibCertClientID                                       = OEM_TEE_LPROV_DEVICECERT_CLIENTID_OFFSET_SL3000_GA10X;
    pDTLCI->ibCertDigest                                         = OEM_TEE_LPROV_DEVICECERT_CERTDIGEST_OFFSET_SL3000_GA10X;
    pDTLCI->ibSignData                                           = OEM_TEE_LPROV_DEVICECERT_SIGNDATA_START_OFFSET_SL3000_GA10X;
    pDTLCI->cbSignData                                           = OEM_TEE_LPROV_DEVICECERT_SIGNDATA_LENGTH_SL3000_GA10X;
    pDTLCI->ibSignature                                          = OEM_TEE_LPROV_DEVICECERT_SIGNATURE_OFFSET_SL3000_GA10X;
    pDTLCI->rgibPubKeys[ DRM_TEE_LPROV_PUBKEY_SIGN_IDX ]         = OEM_TEE_LPROV_DEVICECERT_PUBKEY_SIGN_OFFSET_SL3000_GA10X;
    pDTLCI->rgibPubKeys[ DRM_TEE_LPROV_PUBKEY_ENCRYPT_IDX ]      = OEM_TEE_LPROV_DEVICECERT_PUBKEY_ENCRYPT_OFFSET_SL3000_GA10X;
#ifndef PR_V0404
    pDTLCI->rgibPubKeys[ DRM_TEE_LPROV_PUBKEY_PRND_ENCRYPT_IDX ] = OEM_TEE_LPROV_DEVICECERT_PUBKEY_PRND_ENCRYPT_OFFSET_SL3000_GA10X;
#endif
}
 ...
 */
FLCN_STATUS
prCheckDependentBinMilwersion_GA10X(void)
{
    ...
    //
    // TODO: PJAMBHLEKAR: Replace this comment with TURING specific HAL
    // The numbers have been obtained as follows
    // ACR: Adding one to the values found at https://rmopengrok.lwpu.com/source/xref/r400_00/uproc/acr/src/acr/turing/acructu10x.c#acrGetUcodeBuildVersion_GA10X as of 06/26/2018
    ...
    // Scrubber: Adding one to the values found at https://rmopengrok.lwpu.com/source/s?refs=SELWRESCRUB_HS_UCODE_VERSION_TU102&project=r400_00 as of 06/26/2018
    // GSP: Adding one to the values found at https://rmopengrok.lwpu.com/source/s?refs=GSP_GA10X_UCODE_VERSION&project=r400_00 as of 06/26/2018
    //
...
prDecryptMpk_GA10X(LwU32 *pOut)
{
    ...
    CHECK_FLCN_STATUS(CSB_REG_RD32_HS_ERRCHK(LW_CSEC_FALCON_UCODE_VERSION(SEC2_RTOS_COMMON_ID-1), &ucodeVersion));

    if (ucodeVersion < NUM_SIG_PER_UCODE)
    {
        mpkIndex = (NUM_SIG_PER_UCODE - 1) - ucodeVersion;
    }
    else
    {
    ...
    {
        pSl = g_mpke_sl150_debug[mpkIndex];
    }
    else
    {
        ...
        //
        pSl = g_mpke_sl150_prod[mpkIndex];
#else
        pSl = g_mpke_sl3000_prod[mpkIndex];
#endif
    }

    // Ensure we are not running with revoked ACR, scrubber, UDE ucodes
    CHECK_FLCN_STATUS(prCheckDependentBinMilwersion_HAL(&PrHal));

...
sub setup_client_info
{
    ...
    my %client_info = (
        # General client Info
        NAME            => 'SEC2',
        CONFIG_FILE     => $self->{LW_ROOT}.'/uproc/sec2/build/mcheck/mcheck.config',
        ...
        RMCFG_SRC_PATH  => $self->{LW_ROOT}.'/uproc/sec2/src',
        RMCFG_ARGS      => '--mode sec2-config '.
                           '--config '.$self->{LW_ROOT}.'/uproc/sec2/config/sec2-config.cfg ',

...
const PKC_VERIFICATION_MANIFEST manifest = {
    ...
    .debugAccessControl    = {
        ...
        // All commands are disabled, enablement is per-partition basis.
        .dbgctl =
    ...
    .ioPmp.entry = {
        ...
        [2] = { // Permit DMA to SCP buffer in shared DMEM region

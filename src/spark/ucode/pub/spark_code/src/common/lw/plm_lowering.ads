...
--
--  @description
--  This package provides main routine to call sub routines to lower specific plms
--

package Plm_Lowering
with SPARK_Mode => On
is

   -- Main Plm Lowering routine which calls sub routines to lower plms for Fecs, Gpcs, Pmu
   -- @param Status The Status of the routine. It is an OUT param.

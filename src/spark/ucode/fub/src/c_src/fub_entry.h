...
#ifndef HS_INIT_TU10X_ADS
#define HS_INIT_TU10X_ADS
extern void
  GNAT_LINKER_SECTION(".imem_pub")
...
#ifndef LW_TYPES_SHIFT_RIGHT_OP_ADS
#define LW_TYPES_SHIFT_RIGHT_OP_ADS

#endif /* LW_TYPES_SHIFT_RIGHT_OP_ADS */

#ifndef EXCEPTIONS_LW_ADS
#define EXCEPTIONS_LW_ADS
extern void
  GNAT_LINKER_SECTION(".imem_pub")
exception_handler_selwre_hang_pub(void);
extern const lw_types__lwu32 exceptions_lw__acr_stack_bottom_limit;

#endif /* EXCEPTIONS_LW_ADS */

#ifndef EXCEPTIONS_TU10X_ADS
#define EXCEPTIONS_TU10X_ADS
extern void
  GNAT_LINKER_SECTION(".imem_pub")
exceptions_tu10x__stack_underflow_installer(void);

#endif /* EXCEPTIONS_TU10X_ADS */
...
#ifndef SEC_ENTRY_ADS
#define SEC_ENTRY_ADS
extern void
  GNAT_LINKER_SECTION(".imem_pub")
sec_entry__hs_entry_noninline(ucode_post_codes__lw_ucode_unified_error_type *status);
extern void sec_entry__dummy_wrapper_hsentry(void);
extern const lw_types__lwu32 sec_entry__flcn_dmem_size_in_blk;
extern const natural sec_entry__flcn_dmem_blk_align_bits;
typedef lw_types__lwu32 sec_entry__rand_num16_arr_type[4];
extern sec_entry__rand_num16_arr_type sec_entry__rand_num16_byte
  GNAT_ALIGN(4);
extern system__address __stack_chk_guard;

#endif /* SEC_ENTRY_ADS */

#ifndef FUB_POST_CODES_ADS
#define FUB_POST_CODES_ADS
typedef integer_32 fub_post_codes__fub_status;
enum {fub_post_codes__fub_ok=0, fub_post_codes__fub_err_new_fuse_value_not_reflected=1, fub_post_codes__fub_err_ilwalid_rawperiod=
  2, fub_post_codes__fub_err_voltage_check_failed=3, fub_post_codes__fub_err_fuse_burn_not_required=4, fub_post_codes__fub_err_unsupported_chip=
  5, fub_post_codes__fub_err_bin_revoked=6, fub_post_codes__fub_err_temperature_below_limit=7, fub_post_codes__fub_err_temperature_above_allowed_limit=
  8, fub_post_codes__fub_err_devid_not_supported=9, fub_post_codes__fub_err_devid_sw_override_not_blown=10, fub_post_codes__fub_err_in_gc6_exit_path=
  11, fub_post_codes__fub_err_bin_plm_protection_not_raised=12, fub_post_codes__fub_err_bin_plm_protection_already_raised=
  13, fub_post_codes__fub_err_bin_waiting_for_bar0_status_to_idle=14, fub_post_codes__fub_err_bin_waiting_for_fusectrl_to_idle_after_read=
  15, fub_post_codes__fub_err_bin_waiting_for_idle_after_write=16, fub_post_codes__fub_err_bin_waiting_for_voltage_to_shift_levels=
  17, fub_post_codes__fub_err_bin_waiting_for_fuse_sense=18, fub_post_codes__fub_err_csb_priv_read_error=19, fub_post_codes__fub_err_ilwalid_argument=
  20, fub_post_codes__fub_err_csb_priv_wrtie_error=21, fub_post_codes__fub_err_wait_for_bar0_idle_failed=22, fub_post_codes__fub_err_not_supported=
  23, fub_post_codes__fub_err_generic=24, fub_post_codes__fub_err_vqps_programminng_failed=25, fub_post_codes__fub_err_unexpected_falcon_engid=
  26, fub_post_codes__fub_err_reg_key_did_not_specify_gsync_enabling=27, fub_post_codes__fub_err_reg_key_did_not_specify_devid_based_hulk_revoke=
  28, fub_post_codes__fub_err_enable_gsync_bit_already_set_in_mask=29, fub_post_codes__fub_err_devid_based_hulk_revoke_bit_already_set_in_mask=
  30, fub_post_codes__fub_err_enabling_gsync_bit_not_set_in_mask=31, fub_post_codes__fub_err_devid_based_hulk_revoke_bit_not_set_in_mask=
  32, fub_post_codes__fub_err_fusectrl_plm_not_raised=33, fub_post_codes__fub_err_hulk_allow_dram_chipid_read_bit_already_set_in_mask=
  34, fub_post_codes__fub_err_hulk_revoke_dram_chipid_read_bit_already_set_in_mask=35, fub_post_codes__fub_err_hulk_allowing_dram_chipid_read_not_set_in_mask=
  36, fub_post_codes__fub_err_hulk_revoking_dram_chipid_read_not_set_in_mask=37, fub_post_codes__fub_err_hulk_revoke_dram_chipid_read_fuse_already_burned=
  38, fub_post_codes__fub_err_hulk_dram_chipid_read_fuse_not_burned_before=39, fub_post_codes__fub_err_bin_waiting_for_cpuctl_alias_en_false=
  40, fub_post_codes__fub_err_ssp_stack_check_failed=41, fub_post_codes__fub_err_geforce_sku_recovery_spare_bit_not_set_in_mask=
  42, fub_post_codes__fub_err_geforce_sku_recovery_spare_bit_already_set_in_mask=43, fub_post_codes__fub_err_geforce_sku_recovery_strap_not_reworked=
  44, fub_post_codes__fub_err_geforce_sku_recovery_gfw_rev_bit_not_set_in_mask=45, fub_post_codes__fub_err_geforce_sku_recovery_gfw_rev_bit_already_set_in_mask=
  46, fub_post_codes__fub_err_geforce_sku_recovery_gfw_rev_fuse_not_burned_before=47, fub_post_codes__fub_err_fuse_not_in_range=
  48, fub_post_codes__fub_err_bad_voltage=49, fub_post_codes__fub_err_self_revocation_failed=50, fub_post_codes__fub_err_csb_interface_bad_value=
  51, fub_post_codes__fub_err_lwflash_rev_for_wp_bypass_spare_bit_not_set_in_mask=52, fub_post_codes__fub_err_lwflash_rev_for_wp_bypass_spare_bit_already_set_in_mask=
  53, fub_post_codes__fub_err_gfw_rev_for_wp_bypass_bit_already_set_in_mask=54, fub_post_codes__fub_err_gfw_rev_for_wp_bypass_not_set_in_mask=
  55, fub_post_codes__fub_err_unexpected_halt_enable=56, fub_post_codes__fub_err_hypervisor_decode_trap_write_protection_unset=
  57, fub_post_codes__fub_err_smbpbi_write_protection_enabled=58, fub_post_codes__fub_err_aws_ude_version_check_failed=
  59, fub_post_codes__fub_err_hypervisor_write_check_failed=60, fub_post_codes__fub_err_local_mem_range_is_not_set=
  61, fub_post_codes__fub_err_selwre_bus_request_failed=62, fub_post_codes__fub_err_selwre_bus_not_supported=63, fub_post_codes__fub_err_pri_failure_for_se_reg_access_over_se_bus=
  64, fub_post_codes__fub_err_vhr_not_empty=65, fub_post_codes__fub_err_se_bus_default_timeout_ilwalid=66, fub_post_codes__fub_err_se_mutex_acquire_error=
  67, fub_post_codes__fub_err_timeout=68, fub_post_codes__fub_err_auto_qs2_ahesasc_not_set_in_mask=69, fub_post_codes__fub_err_auto_qs2_ahesasc_already_set_in_mask=
  70, fub_post_codes__fub_err_auto_qs2_asb_not_set_in_mask=71, fub_post_codes__fub_err_auto_qs2_asb_already_set_in_mask=
  72, fub_post_codes__fub_err_auto_qs2_lwflash_not_set_in_mask=73, fub_post_codes__fub_err_auto_qs2_lwflash_already_set_in_mask=
  74, fub_post_codes__fub_err_auto_qs2_imageselect_not_set_in_mask=75, fub_post_codes__fub_err_auto_qs2_imageselect_already_set_in_mask=
  76, fub_post_codes__fub_err_auto_qs2_hulk_not_set_in_mask=77, fub_post_codes__fub_err_auto_qs2_hulk_already_set_in_mask=
  78, fub_post_codes__fub_err_auto_qs2_fwsec_not_set_in_mask=79, fub_post_codes__fub_err_auto_qs2_fwsec_already_set_in_mask=
  80, fub_post_codes__fub_progress_bin_entering_hs_code=241, fub_post_codes__fub_progress_rm_loading_binary_on_falcon=
  242};
typedef character fub_post_codes__Tfub_statusSS[3235];
typedef character fub_post_codes__T1s[3235];
typedef integer fub_post_codes__TTfub_statusSSP1;
extern const fub_post_codes__Tfub_statusSS fub_post_codes__fub_statusS;
typedef integer_16 *fub_post_codes__Tfub_statusNB;
typedef integer_16 fub_post_codes__T5s[84];
typedef integer_16 fub_post_codes__Tfub_statusNT[84];
typedef integer fub_post_codes__Tfub_statusND1;
extern const fub_post_codes__Tfub_statusNT fub_post_codes__fub_statusN;
typedef fub_post_codes__fub_status *fub_post_codes__Tfub_statusAB;
typedef fub_post_codes__fub_status fub_post_codes__T9s[83];
typedef fub_post_codes__fub_status fub_post_codes__Tfub_statusAT[83];
typedef integer fub_post_codes__Tfub_statusAD1;
extern const fub_post_codes__Tfub_statusAT fub_post_codes__fub_statusA;
#endif /* FUB_POST_CODES_ADS */
...
#ifndef TU10X_HAL_ADS
#define TU10X_HAL_ADS
typedef struct _tu10x__hal__chip {
  character _null_record;
} tu10x__hal__chip;
extern void
  GNAT_LINKER_SECTION(".imem_pub")
tu10x__hal__fub_report_status(fub_post_codes__fub_status status);
#endif /* TU10X_HAL_ADS */

#ifndef FUB_ENTRY_ADS
#define FUB_ENTRY_ADS
extern void fub_entry_wrapper(void);
#endif /* FUB_ENTRY_ADS */

#ifndef SEC_ENTRY_ADB
#define SEC_ENTRY_ADB

...
#ifndef REG_RD_WR_BAR0_TU10X_ADS
#define REG_RD_WR_BAR0_TU10X_ADS
extern void
  GNAT_LINKER_SECTION(".imem_pub")
reg_rd_wr_bar0_tu10x__bar0_wait_idle(void);
extern const dev_sec_csb_ada__lw_csec_bar0_csr_byte_enable_field reg_rd_wr_bar0_tu10x__lw_csec_bar0_csr_byte_enable_val_for_bar0_read;
extern void
  GNAT_LINKER_SECTION(".imem_pub")
...
#endif /* REG_RD_WR_BAR0_TU10X_ADS */
...
#ifndef DEV_FPF_ADS
#define DEV_FPF_ADS
typedef struct _dev_fpf__lw_fpf_opt_fuse_ucode_gfw_rev_register {
  unsigned_32 data : 8;
  unsigned_32 _pad1 : 24;
} GNAT_PACKED dev_fpf__lw_fpf_opt_fuse_ucode_gfw_rev_register;
extern const lw_types__reg_addr_types__bar0_addr dev_fpf__lw_fpf_opt_fuse_ucode_gfw_rev_addr;
#endif /* DEV_FPF_ADS */

#ifndef DEV_FUSE_ADS
#define DEV_FUSE_ADS
typedef struct _dev_fuse__lw_fuse_opt_fuse_ucode_gfw_rev_register {
  unsigned_32 data : 8;
  unsigned_32 _pad1 : 24;
} GNAT_PACKED dev_fuse__lw_fuse_opt_fuse_ucode_gfw_rev_register;
extern const lw_types__reg_addr_types__bar0_addr dev_fuse__lw_fuse_opt_fuse_ucode_gfw_rev_addr;
#endif /* DEV_FUSE_ADS */

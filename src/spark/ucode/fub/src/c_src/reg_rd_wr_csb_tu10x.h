...
#ifndef PRI_ERR_HANDLING_ADB
#define PRI_ERR_HANDLING_ADB
typedef lw_types__Tlwu32B pri_err_handling__uc_csberrstatGP208__sourceX;
typedef dev_sec_csb_ada__lw_csec_falcon_csberrstat_register pri_err_handling__uc_csberrstatGP208__targetX
  GNAT_ALIGN(4);

#endif /* PRI_ERR_HANDLING_ADB */

...
#ifdef IN_ADA_BODY
const lw_types__lwu32 sec_entry__flcn_dmem_size_in_blk = 256U;
#endif /* IN_ADA_BODY */
extern const natural sec_entry__flcn_dmem_blk_align_bits;
#ifdef IN_ADA_BODY
const natural sec_entry__flcn_dmem_blk_align_bits = 8;
#endif /* IN_ADA_BODY */
typedef lw_types__lwu32 sec_entry__rand_num16_arr_type[4];
extern sec_entry__rand_num16_arr_type sec_entry__rand_num16_byte
  GNAT_ALIGN(4);
#ifdef IN_ADA_BODY
sec_entry__rand_num16_arr_type sec_entry__rand_num16_byte
  GNAT_ALIGN(4);
#endif /* IN_ADA_BODY */
extern system__address __stack_chk_guard;
#ifdef IN_ADA_BODY
system__address __stack_chk_guard;
#endif /* IN_ADA_BODY */

#endif /* SEC_ENTRY_ADS */

#ifndef EXCEPTIONS_TU10X_ADB
#define EXCEPTIONS_TU10X_ADB
typedef dev_sec_csb_ada__lw_csec_falcon_stackcfg_register exceptions_tu10x__uc_lwu32GP416__sourceX
  GNAT_ALIGN(4);
typedef lw_types__Tlwu32B exceptions_tu10x__uc_lwu32GP416__targetX;

#endif /* EXCEPTIONS_TU10X_ADB */

#ifndef EXCEPTIONS_LW_ADB
#define EXCEPTIONS_LW_ADB
typedef lw_types__Tlwu32B exceptions_lw__from_rawGP399__sourceX;
typedef dev_falc_spr__lw_falc_sec_spr_register exceptions_lw__from_rawGP399__targetX;
typedef dev_falc_spr__lw_falc_sec_spr_register exceptions_lw__to_rawGP631__sourceX;
typedef lw_types__Tlwu32B exceptions_lw__to_rawGP631__targetX;

#endif /* EXCEPTIONS_LW_ADB */
...
#ifndef SCP_RAND_COMMON_LW_ADB
#define SCP_RAND_COMMON_LW_ADB

#endif /* SCP_RAND_COMMON_LW_ADB */

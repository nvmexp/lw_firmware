...
void fub_entry_wrapper(void) {
  ucode_post_codes__lw_ucode_unified_error_type status = ucode_post_codes__ucode_err_code_noerror;
  {
    typedef integer fub_entry__fub_entry_wrapper__T1b;
    fub_entry__fub_entry_wrapper__T1b unused_loop_var;

    for (unused_loop_var = 1; unused_loop_var <= 1; unused_loop_var++) {{
        lw_types__lwu32 dmem_addr;

        {
          typedef integer fub_entry__fub_entry_wrapper__T4b;
          fub_entry__fub_entry_wrapper__T4b unused_loop_var;
          ...
          for (unused_loop_var = 1; unused_loop_var <= 1; unused_loop_var++) {
            ...
            clearFalconGprs();
            {
              lw_types__lwu32 C14b;
              {
              {
                  lw_types__lwu32 C17b;
                  {
                    extern lw_types__lwu32 falc_rspr_sp_spr_wrapper(void);

                    C17b = falc_rspr_sp_spr_wrapper();
                  }
                  C14b = C17b;
                ...
                }}
              {
                ...
                while (addr < C14b) {
                  const lw_types__lwu32 C21b = addr;
                  {
                    const void *_val_address = ((system__address)(C21b));
#define val (*(volatile lw_types__lwu32* const)_val_address)
                  ...
                  #undef val
                  {
                    const lw_types__lwu32_types__n_type C23b = (lw_types__lwu32_types__n_type)addr;
                    addr = (lw_types__lwu32)(lw_types__lwu32_types__n_type)((lw_types__lwu32_types__base_type)C23b +
                      4U);
                ...
                dev_falc_spr__lw_falc_sec_spr_register sec_spr;
              {
                ...
                {
                  lw_types__lwu32 C50b;
                  {

                    C50b = falc_rspr_sec_spr_wrapper();
                  }
                  *((lw_types__lwu32 *)&sec_spr) = C50b;
                  sec_spr.disable_exceptions = 0;
                  {
                    const lw_types__lwu32 C54b = (*(lw_types__lwu32*)(&sec_spr));
                    falc_wspr_sec_spr_wrapper(C54b);

                  }
                }}
              exceptions_tu10x__stack_underflow_installer();
              {
                const lw_types__lwu32 C57b = ((lw_types__lwu32)((system__address)&sec_entry__rand_num16_byte[0U]));
                {
                  lw_types__lwu32 val;
                  ...
                  dev_sec_csb_ada__lw_csec_scp_ctl1_register scp_ctl1_reg;
                {
                  ...
                  *((lw_types__lwu32 *)&scp_rndctl1_reg) = val;
                  ...
                  {
                    const lw_types__lwu32 C65b = (*(lw_types__lwu32*)(&scp_rndctl1_reg));
                    {
                      extern void falc_stxb_wrapper(lw_types__lwu32 addr, lw_types__lwu32 val);

                      falc_stxb_wrapper(82176U, C65b);
                    }
                    {
                      extern lw_types__lwu32 falc_ldx_i_wrapper(lw_types__lwu32 addr, lw_types__lwu32 bitnum);
                    ...
                    *((lw_types__lwu32 *)&scp_rndctl11_reg) = val;
                    ...
                    {
                      const lw_types__lwu32 C71b = (*(lw_types__lwu32*)(&scp_rndctl11_reg));
                      {
                        extern void falc_stxb_wrapper(lw_types__lwu32 addr, lw_types__lwu32 val);

                        falc_stxb_wrapper(84736U, C71b);
                      }
                      {
                        extern lw_types__lwu32 falc_ldx_i_wrapper(lw_types__lwu32 addr, lw_types__lwu32 bitnum);
                      ...
                      *((lw_types__lwu32 *)&scp_ctl1_reg) = val;
                      ...
                      {
                        const lw_types__lwu32 C77b = (*(lw_types__lwu32*)(&scp_ctl1_reg));
                        {
                          extern void falc_stxb_wrapper(lw_types__lwu32 addr, lw_types__lwu32 val);

                          falc_stxb_wrapper(65792U, C77b);
                        }
                ...
                falc_scp_trap(31U);
                {
                  lw_types__lwu32 C81b;
                  {

                    C81b = falc_sethi_i(C57b, 5U);
                  }
                  falc_trapped_dmwrite(C81b);
                  falc_scp_rand(4U);
                  falc_scp_rand(3U);
                  falc_dmwait();
                  falc_scp_xor(5U, 4U);
                  ...
                  {
                    lw_types__lwu32 C91b;
                    {

                      C91b = falc_sethi_i(C57b, 3U);
                    }
                    falc_trapped_dmread(C91b);
                    falc_dmwait();
                    falc_scp_trap(0U);
                    {
                      lw_types__lwu32 val;
                      dev_sec_csb_ada__lw_csec_scp_ctl1_register scp_ctl1_reg;
                    {
                      ...
                      *((lw_types__lwu32 *)&scp_ctl1_reg) = val;
                      ...
                      {
                        const lw_types__lwu32 C101b = (*(lw_types__lwu32*)(&scp_ctl1_reg));
                        {
                          extern void falc_stxb_wrapper(lw_types__lwu32 addr, lw_types__lwu32 val);

                          falc_stxb_wrapper(65792U, C101b);
                        }
      ...
      tu10x__hal__fub_report_status(0);
    }
  }
  main_block: ;

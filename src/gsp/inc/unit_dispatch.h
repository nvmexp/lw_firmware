 ...
 * queues.  In general however, unit-tasks need to be fed commands from the GSP
 ...
 */
#define  DISP2UNIT_EVT_OS_TMR_CALLBACK  (0x02)

/*!
 * Represents a wrapper that is used encapsulate all the information required
 * to dispatch a GSP command to a unit-task for processing.
 */
typedef struct
{
    /*!

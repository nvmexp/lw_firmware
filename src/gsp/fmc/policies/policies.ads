...
--------------------------------------------------------------------------------
   ...
   Partition_RTOS_Core_Pmp : constant Plcy_Core_Pmp := (
        ...
        Core_Pmp_Entry'(Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_6000#), 2)),
                            Address_Mode => OFF,
                            Access_Mode => Core_Pmp_Access_Mode_None,
                            Reserved => 0),
        ...
        Core_Pmp_Entry'(Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_4000#), 2)),
                            Address_Mode => OFF,
                            Access_Mode => Core_Pmp_Access_Mode_None,
                            Reserved => 0),
...
-------------------------------------------------------------------------------------------------------------------------------
    ...
    Partition_RTOS_Policy : constant External_Policy := (
        Switchable_To       => Plcy_Switchable_To_Array'(
                                ...
                                others => DENIED),
        Entry_Point_Address => 16#00010_6000#,
        Ucode_Id            => 4,
        Sspm                => Plcy_SSPM'(
                                Splm => 10#5#,
                                Ssecm => SSECM_INSEC),

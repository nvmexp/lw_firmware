...
#ifndef _UCODE_POSTCODES_H_
#define _UCODE_POSTCODES_H_
...
#define LW_UCODE_POST_CODE_FWSECLIC_REG2                                    0x23        // scratch register offset. LW_PBUS_SW_SCRATCH(35)
#define LW_UCODE_POST_CODE_FWSECLIC_FORMAL_BIOSCERT_ERR_CODE               31:16        // 16bit error code, for BIOS Cert verification. used after Ampere
...
typedef enum
{
        ...
        LW_UCODE_ERR_CODE_HS_MODE_EXIT_ADDRESS_ILWALID,                       // 0x9E
        LW_UCODE_ERR_CODE_BCRT2X_CERT_ALGOTYPE_NOT_SUPPORTED,                 // 0x9F
        LW_UCODE_ERR_CODE_GFWIMAGE_IFR_NOT_PRESENT,                           // 0xA0
        LW_UCODE_ERR_CODE_GFWIMAGE_XUSB_IFR_PARTITION_ILWALID_ID,             // 0xA1
        LW_UCODE_ERR_CODE_GFWIMAGE_XUSB_IFR_CFG_TABLE_NOT_PRESENT,            // 0xA2
        LW_UCODE_ERR_CODE_XUSB_FW_VERIFY_SIGNATURE_MISMATCH,                  // 0xA3
        LW_UCODE_ERR_CODE_XUSB_FW_BRANCH_ID_MISMATCH,                         // 0xA4
        LW_UCODE_ERR_CODE_XUSB_FW_UNSUPPORTED_VERSION,                        // 0xA5
        LW_UCODE_ERR_CODE_XUSB_FW_UNSUPPORTED_CHIP,                           // 0xA6
        LW_UCODE_ERR_CODE_XUSB_FW_ILWALID_CFG_TABLE,                          // 0xA7
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_ILWALID_TYPE,                     // 0xA8
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_ID_MATCH_NOT_FOUND,               // 0xA9
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_EXCLUDED_CHIP_ID,                 // 0xAA
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_EXCLUDED_DEV_ID,                  // 0xAB
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_EXCLUDED_BOARD_ID,                // 0xAC
        LW_UCODE_ERR_CODE_XUSB_FW_GENERIC_TABLE_VER_UNSUPPORTED,              // 0xAD
        LW_UCODE_ERR_CODE_XUSB_FW_GENERIC_TABLE_SIG_TYPE_UNSUPPORTED,         // 0xAE
        LW_UCODE_ERR_CODE_XUSB_FW_GENERIC_TABLE_ENTRY_COUNT_UNSUPPORTED,      // 0xAF
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_TABLE_ILWALID_OFFSET,             // 0xB0
        LW_UCODE_ERR_CODE_XUSB_FW_HW_TARGET_TABLE_VER_UNSUPPORTED,            // 0xB1
        LW_UCODE_ERR_CODE_RSA_SIGNATURE_ILWALID,                              // 0xB2
        LW_UCODE_ERR_CODE_XUSB_FW_UNSUPPORTED_VERSION_AND_RSA_REQUIRED,       // 0xB3
        LW_UCODE_ERR_CODE_HYPERVISOR_EEPROM_WRITE_PROTECT_ENABLED,            // 0xB4
        LW_UCODE_ERR_CODE_BCRT2X_SELWRITYZONE_SIGNATURE_OPERATION_MODE_UNDEFINED, // 0xB5
        LW_UCODE_ERR_CODE_BCRT2X_VDPA_INTBLK_ENTRY_NOT_FOUND,                 // 0xB6
        LW_UCODE_ERR_CODE_ROM_DIR_IFR_EXPECTED,                               // 0xB7
        LW_UCODE_ERR_CODE_ROM_DIR_ILWALID_SIG,                                // 0xB8
        LW_UCODE_ERR_CODE_PUSHPOLL_MAIN_CPU_SIDE_ERROR,                       // 0xB9
        LW_UCODE_ERR_CODE_PUSHPOLL_ILWALID_STATE,                             // 0xBA
        LW_UCODE_ERR_CODE_PUSHPOLL_WRITE_PAYLOAD_TIMEOUT,                     // 0xBB
        LW_UCODE_ERR_CODE_PUSHPOLL_READ_PAYLOAD_TIMEOUT,                      // 0xBC
        LW_UCODE_ERR_CODE_PUSHPOLL_PAYLOAD_BUFFER_UNDER_SIZE,                 // 0xBD
        LW_UCODE_ERR_CODE_PUSHPOLL_PAYLOAD_COMMAND_ILWALID,                   // 0xBE
        LW_UCODE_ERR_CODE_PUSHPOLL_ROM_DIR_ILWALID,                           // 0xBF
        LW_UCODE_ERR_CODE_PUSHPOLL_ROM_DIR_VERSION_NOT_SUPPORTED,             // 0xC0
        LW_UCODE_ERR_CODE_PUSHPOLL_ROM_DIR_SIZE_ILWALID,                      // 0xC1
        LW_UCODE_ERR_CODE_PUSHPOLL_READ_PAYLOAD_OVERSIZE_DATALINE,            // 0xC2
        LW_UCODE_ERR_CODE_FLASH_STATUS_ENTRY_SIG_VERIFY_FAIL,                 // 0xC3
        LW_UCODE_ERR_CODE_FLASH_STATUS_LEDGER_SECTOR_READ_FAIL,               // 0xC4
        LW_UCODE_ERR_CODE_FLASH_STATUS_CLEAN_ENTRY_NOT_FOUND,                 // 0xC5
        LW_UCODE_ERR_CODE_FLASH_STATUS_REMAINED_ENTRIES_NOT_CLEAN,            // 0xC6
        LW_UCODE_ERR_CODE_FLASH_STATUS_LEDGER_ERASE_FAIL,                     // 0xC7
        LW_UCODE_ERR_CODE_FLASH_STATUS_NEW_ENTRY_WRITE_FAIL,                  // 0xC8
        LW_UCODE_ERR_CODE_FLASH_STATUS_LAST_ENTRY_RETIRE_FAIL,                // 0xC9
        LW_UCODE_ERR_CODE_ROM_DIR_EMPTY_SECBASE,                              // 0xCA
        LW_UCODE_ERR_CODE_SPI_TRANSFER_TYPE_UNSUPPORTED,                      // 0xCB
        LW_UCODE_ERR_CODE_SPICLK_SETTING_TYPE_UNSUPPORTED,                    // 0xCC
        LW_UCODE_ERR_CODE_FS_EPR_FS_LEDGER_ILWALID_OFFSET,                    // 0xCD
        LW_UCODE_ERR_CODE_FS_EPR_FS_HEADER_ILWALID_OFFSET,                    // 0xCE
        LW_UCODE_ERR_CODE_FS_EPR_FS_HEADER_ILWALID_IDENTIFIER,                // 0xCF
        LW_UCODE_ERR_CODE_FS_EPR_FS_HEADER_ILWALID_VERSION,                   // 0xD0
        LW_UCODE_ERR_CODE_FS_EPR_FS_HEADER_ILWALID_HDR_SIZE,                  // 0xD1
        LW_UCODE_ERR_CODE_FS_IMG_FS_LEDGER_ILWALID_OFFSET,                    // 0xD2
        LW_UCODE_ERR_CODE_FS_IMG_FS_LEDGER_NOT_COMPATIBLE,                    // 0xD3
        LW_UCODE_ERR_CODE_FS_EPR_ILWALID_IFR_IMAGE,                           // 0xD4
        LW_UCODE_ERR_CODE_IMEM_DMEM_GUID_MISMATCH,                            // 0xD5
        LW_UCODE_ERR_CODE_CERT_CERT_SIZE_EXCEED_LIMIT,                        // 0xD6
        LW_UCODE_ERR_CODE_CERT_CERT_MAIN_STRUCTURE_SIZE_EXCEED_LIMIT,         // 0xD7
        LW_UCODE_ERR_CODE_CERT_EXTENSION_LINKED_LIST_OUTOF_BOUNDARY,          // 0xD8
        LW_UCODE_ERR_CODE_CERT_EXTENSION_HEADER_SIZE_EXCEED_LIMIT,            // 0xD9
        LW_UCODE_ERR_CODE_CERT_NO_EXTENSION_CERT_NOT_SUPPORTED,               // 0xDA
        LW_UCODE_ERR_CODE_CERT_EXTENSION_NUM_MISMATCH_WITH_LINKEDLIST,        // 0xDB
        LW_UCODE_ERR_CODE_CERT_EXTENSION_LINKED_LIST_WRONG_PREV_NODE_POINTER, // 0xDC
        LW_UCODE_ERR_CODE_LWFLASH_CPU_CODE_ERROR,                             // 0xDD
        LW_UCODE_ERR_CODE_CERT21_FMT_HAT_ENTRY_SIZE_EXCEED_LIMIT,             // 0xDE
        LW_UCODE_ERR_CODE_EEPROM_OTP_USER_IDX_OUT_OF_RANGE,                   // 0xDF
        LW_UCODE_ERR_CODE_NULL_POINTER,                                       // 0xE0
        LW_UCODE_ERR_CODE_EEPROM_PROT_DEVICE_UNSUPPORTED,                     // 0xE1
        LW_UCODE_ERR_CODE_EEPROM_PROT_CFG_CHANGE_FAILED,                      // 0xE2
        LW_UCODE_ERR_CODE_EEPROM_PROT_REGION_OUT_OF_RANGE,                    // 0xE3
        LW_UCODE_ERR_CODE_EEPROM_PROT_SPI_ROM_WRITE_PROTECT_ENABLED,          // 0xE4
        LW_UCODE_ERR_CODE_EEPROM_PROT_SPI_ROM_WRITE_LOCKED,                   // 0xE5
        LW_UCODE_ERR_CODE_CERT_SIZE_ILWALID,                                  // 0xE6
        LW_UCODE_ERR_CODE_EEPROM_SFDP_DEVICE_UNSUPPORTED,                     // 0xE7
        LW_UCODE_ERR_CODE_SPI_POLL_FOR_READY_TIMEOUT,                         // 0xE8
        LW_UCODE_ERR_CODE_PUSHPOLL_PAYLOAD_SIZE_NOT_4BYTE_ALIGNED,            // 0xE9
        LW_UCODE_ERR_CODE_PUSHPOLL_PAYLOAD_ADDRESS_NOT_4BYTE_ALIGNED,         // 0xEA
...
#define LW_UCODE_POST_CODE_PREOS_PROG_COMPLETE                        0x00000005
...
typedef enum
{
        ...
        LW_UCODE_PREOS_STAT_ILLUM_INIT_START,                         // 0x21 - Illumination STAT codes shouldn't be changed without changing STATUS_CODE_OFFSET in illumination.c
        LW_UCODE_PREOS_STAT_ILLUM_ZONE0_START,                        // 0x22
        LW_UCODE_PREOS_STAT_ILLUM_ZONE0_END,                          // 0x23
        LW_UCODE_PREOS_STAT_ILLUM_ZONE1_START,                        // 0x24
        LW_UCODE_PREOS_STAT_ILLUM_ZONE1_END,                          // 0x25
        LW_UCODE_PREOS_STAT_ILLUM_ZONE2_START,                        // 0x26
        LW_UCODE_PREOS_STAT_ILLUM_ZONE2_END,                          // 0x27
        LW_UCODE_PREOS_STAT_ILLUM_ZONE3_START,                        // 0x28
        LW_UCODE_PREOS_STAT_ILLUM_ZONE3_END,                          // 0x29
        LW_UCODE_PREOS_STAT_ILLUM_ZONE_TRIGGER_START,                 // 0x2A
        LW_UCODE_PREOS_STAT_ILLUM_ZONE_TRIGGER_END,                   // 0x2B
        LW_UCODE_PREOS_STAT_ILLUM_INIT_END,                           // 0x2C
        LW_UCODE_PREOS_STAT_RRL_FETCH_FAILED,                         // 0x2D
        LW_UCODE_PREOS_STAT_RRLTASK_INIT_START,                       // 0x2E
        LW_UCODE_PREOS_STAT_RRLTASK_INIT_END,                         // 0x2F
        LW_UCODE_PREOS_STAT_CHECK_SMC_ENABLE_FAILED,                  // 0x30
        LW_UCODE_PREOS_STAT_IPV_READ_MLW_SCRATCH_START,               // 0x31
        LW_UCODE_PREOS_STAT_IPV_READ_MLW_SCRATCH_END,                 // 0x32
        LW_UCODE_PREOS_STAT_IPV_SET_GPU_SCRATCH_FAILED,               // 0x33
        LW_UCODE_PREOS_STAT_EROT_SEND_BOOT_COMPETE_START,             // 0x34
        LW_UCODE_PREOS_STAT_EROT_SEND_BOOT_COMPETE_END,               // 0x35
} LW_UCODE_PREOS_STAT;
...
#define LW_UCODE_POST_CODE_UDE_PROG_COMPLETE                                0x00000007
...
#define LW_UCODE_POST_CODE_COMPACTION_PROG_COMPLETE                         0x00000007
#define LW_UCODE_POST_CODE_COMPACTION_PROG_AUTH_SCRIPT                      0x00000008
#define LW_UCODE_POST_CODE_COMPACTION_PROG_RESIGN                           0x00000009
...
#define LW_UCODE_POST_CODE_GC6_PROG_COMPLETE                                0x00000006
...
#define LW_UCODE_POST_CODE_HULK_REG4                                        0x23        // scratch register offset. LW_PBUS_SW_SCRATCH(35)
#define LW_UCODE_POST_CODE_FORMAL_HULK_ERR_CODE                             15:0        // 16-bit HULK ERROR Code field. Used for GA100 and beyond
...
#define LW_UCODE_POST_CODE_FLOORSWEEP_SMC_ERR_CODE                          23:22       // Error code for SMC floorsweep module
#define LW_UCODE_POST_CODE_FLOORSWEEP_INFOROM_ERR_CODE                      21:20       // Error code for InfoROM floorsweep module
...
#define LW_UCODE_POST_CODE_BOOTBLOCK_REG                                    0x19        // scratch register offset. LW_PBUS_SW_SCRATCH(25)
#define LW_UCODE_POST_CODE_BOOTBLOCK_ERR_CODE                               15:0        // Error code for BootStrap and ImageSelect
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG                                   19:16
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG_NOT_STARTED                       0x00000000
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG_STARTED                           0x00000001
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG_IN_SELWREMODE                     0x00000002
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG_EXIT_SELWREMODE                   0x00000003
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG_START_UCODE                       0x00000004
#define LW_UCODE_POST_CODE_BOOTBLOCK_PROG_COMPLETE                          0x00000005
#define LW_UCODE_POST_CODE_BOOTBLOCK_ITERATIONS                             23:20       // Number of times BootStrap ilwoked
...
#define LW_UCODE_POST_CODE_IST_REG                                          0x1A        // scratch register offset. LW_PBUS_SW_SCRATCH(26)
#define LW_UCODE_POST_CODE_IST_PROG                                         3:0         // Progress code for IST
#define LW_UCODE_POST_CODE_IST_PROG_NOT_STARTED                             0x00000000
#define LW_UCODE_POST_CODE_IST_PROG_STARTED                                 0x00000001
#define LW_UCODE_POST_CODE_IST_PROG_SEQ_RAM_LOAD_START                      0x00000002
#define LW_UCODE_POST_CODE_IST_PROG_SEQ_RAM_LOAD_COMPLETE                   0x00000003
#define LW_UCODE_POST_CODE_IST_PROG_SEQ_RAM_VERIFY_START                    0x00000004
#define LW_UCODE_POST_CODE_IST_PROG_SEQ_RAM_VERIFY_COMPLETE                 0x00000005
#define LW_UCODE_POST_CODE_IST_PROG_SCRIPT_START                            0x00000006
#define LW_UCODE_POST_CODE_IST_PROG_SCRIPT_COMPLETE                         0x00000007
#define LW_UCODE_POST_CODE_IST_PROG_SW_TEMP_ABORTED                         0x00000008
#define LW_UCODE_POST_CODE_IST_PROG_COMPLETE                                0x0000000E
#define LW_UCODE_POST_CODE_IST_PROG_ABORTED                                 0x0000000F
#define LW_UCODE_POST_CODE_IST_ERR_CODE                                     31:16       // Error code for IST

// Since FuseRework doesn't define system state, its progress and errors are reported in
// the running Falcon's MAILBOX registers
// PROG is stored in MAILBOX0
// ERR is stored in MAILBOX1
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG                                  3:0
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_NOT_STARTED                      0x00000000
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_STARTED                          0x00000001
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_SETUP_INPUTS                     0x00000002
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_GET_LWRR_BLOCK                   0x00000003
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_COMPOSE_NEW_BLOCK                0x00000004
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_CHECK_NEW_BLOCK                  0x00000005
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_BLOW                             0x00000006
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_VERIFY                           0x00000007
#define LW_UCODE_POST_CODE_FUSEREWORK_PROG_COMPLETE                         0x0000000F
#define LW_UCODE_POST_CODE_FUSEREWORK_MACRO                                 5:4
#define LW_UCODE_POST_CODE_FUSEREWORK_MACRO_NONE                            0x00000000
#define LW_UCODE_POST_CODE_FUSEREWORK_MACRO_FUSE                            0x00000001
#define LW_UCODE_POST_CODE_FUSEREWORK_MACRO_FPF                             0x00000002
#define LW_UCODE_POST_CODE_FUSEREWORK_MACRO_RIR                             0x00000003

#define LW_UCODE_POST_CODE_FLOORSWEEP_RECOVERY_REG                          0x19        // scratch register offset. LW_PBUS_SW_SCRATCH(25)
#define LW_UCODE_POST_CODE_FLOORSWEEP_RECOVERY_ERR_CODE                     27:24       // Error code for floorsweeping recovery code

#define LW_UCODE_POST_CODE_FUB_PROG                                         3:0
#define LW_UCODE_POST_CODE_FUB_PROG_NOT_STARTED                             0x00000000
#define LW_UCODE_POST_CODE_FUB_PROG_STARTED                                 0x00000001
#define LW_UCODE_POST_CODE_FUB_PROG_SET_VOLTAGE                             0x00000002
#define LW_UCODE_POST_CODE_FUB_PROG_GET_FUSE_INFO                           0x00000003

#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_HULK                          0x00000004
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_GFW_REV                       0x00000005
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_ROM_FLASH_REV                 0x00000006
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_LWDEC_REV                     0x00000007
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_LWDEC_UCODE2_VER              0x00000008
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_LWDEC_UCODE4_VER              0x00000009

#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_ENABLE_HULK                   0x00000004
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_REVOKE_HULK                   0x00000005
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_PMU_UCODE4_VER                0x00000006
#define LW_UCODE_POST_CODE_FUB_PROG_BURN_FUSE_SEC2_UCODE2_VER               0x00000007

#define LW_UCODE_POST_CODE_FUB_PROG_COMPLETE                                0x0000000F

//for core86 only
#define LW_UCODE_POST_CODE_IPV_BOOT_REG                                     0x11        // scratch register offset. LW_PBUS_SW_SCRATCH(17)
#define LW_UCODE_POST_CODE_IPV_BOOT_ERR_CODE                                15:0

#define LW_UCODE_POST_CODE_IPV_BOOT_PROG                                    18:16
#define LW_UCODE_POST_CODE_IPV_BOOT_PROG_NOT_STARTED                        0x00000000
#define LW_UCODE_POST_CODE_IPV_BOOT_PROG_STARTED                            0x00000001
#define LW_UCODE_POST_CODE_IPV_BOOT_PROG_IPV_INIT_COMPLETE                  0x00000002
#define LW_UCODE_POST_CODE_IPV_BOOT_PROG_IPV_ACTIVATED_CHECK_COMPLETE       0x00000003
#define LW_UCODE_POST_CODE_IPV_BOOT_PROG_MLW_READ_COMPLETE                  0x00000004
#define LW_UCODE_POST_CODE_IPV_BOOT_PROG_COMPLETE                           0x00000005
...
typedef enum
{
        ...
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_UDE_COMPLETED_WITH_ERRORS =                                     0x0A5,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_INCORRECT_LS_UCODE_REVISION =                                   0x0A6,
        LW_FWSECLIC_ERR_CODE_BCRT2X_CERT_ALGOTYPE_NOT_SUPPORTED =                                       0x0A7,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_SYS_XTAL4X_CFG_CLK_GOOD_FALSE =                                 0x0A8,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_DEVID_OVERRIDE_VDPA_ENTRY_OVERFLOW =                            0X0A9,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_DEVID_OVERRIDE_TABLE_SIZE_OVERFLOW =                            0X0AA,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_DEVID_OVERRIDE_SIGNATURE_CHECK_FAILED =                         0X0AB,
        LW_FWSECLIC_ERR_CODE_FORMAL_ERROR_CODE_IN_REG_INDEX23 =                                         0x0AC,      // We are running out of space for older 10bits HULK and BIOS Cert error code fields. Redirect to new 16bits fields
        LW_FWSECLIC_ERR_CODE_CERT21_FMT_HAT_ENTRY_SIZE_EXCEED_LIMIT =                                   0x0AD,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_FEATUTES_VDPA_ENTRY_SIZE_MISMATCH =                             0x0AE,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_FEATURES_HEADER_VERSION_CHECK_FAILED =                          0x0AF,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_FEATURES_HEADER_SIZE_CHECK_FAILED =                             0x0B0,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_FEATURES_ENTRY_SIZE_CHECK_FAILED =                              0x0B1,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_PRE_LTSSM_SKIPPED =                                             0x0B2,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_SYS_XTAL4X_CFG_PLL_LOCK_FALSE =                                 0x0B3,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_DEVID_OVERRIDE_NOT_DISABLED_IN_PROD =                           0x0B4,
        LW_FWSECLIC_ERR_CODE_FALCONLOADER_VERSION_REVOKED =                                             0x0B5,
        LW_FWSECLIC_ERR_CODE_FALCONLOADER_UNKNOWN_DESCRIPTOR_TYPE =                                     0x0B6,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_ILWALID_GC6_ELWIRONMENT =                                       0x0B7,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_ILWALID_LTSSM_STATE =                                           0x0B8,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_BOOTSTRAP_NOT_COMPLETE =                                        0x0B9,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_FAIL_TO_ENFORCE_COT =                                           0x0BA,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_ILWALID_IFR_STATE =                                             0x0BB,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_PREOS_INIT_EXELWTION_TIMEOUT =                                  0x0BC,
        LW_FWSECLIC_ERR_CODE_SELWREBOOT_FBFALCON_BOOT_TRAINING_FAILURE =                                0x0BD,
        LW_FWSECLIC_ERR_CODE_FRTS_WPR_CONFIG_ILWALID =                                                  0x0BE,
        LW_FWSECLIC_ERR_CODE_FRTS_OUTPUT_DESC_REGIONOFFSETSIZE_MISMATCH =                               0X0BF,
        LW_FWSECLIC_ERR_CODE_FRTS_COT_FAILURE_BOOTSTRAP =                                               0X0C0,
        LW_FWSECLIC_ERR_CODE_FRTS_COT_FAILURE_FWSEC =                                                   0X0C1,

        LW_FWSECLIC_ERR_CODE_BCRT2X_CERT_CONTROL_HEADER_OFFSET_OVERFLOW =                               0x0C2,
        LW_FWSECLIC_ERR_CODE_NEXT_CERT_OFFSET_OVERFLOW =                                                0x0C3,
        LW_FWSECLIC_ERR_CODE_NEXT_CERT_OVERFLOW =                                                       0x0C4,
        LW_FWSECLIC_ERR_CODE_BCRT2X_CERT_CONTROL_HEADER_META_OFFSET_OVERFLOW =                          0x0C5,
        LW_FWSECLIC_ERR_CODE_BCRT2X_METADATA_HEADER_INSUFFICIENT_SIZE =                                 0x0C6,
        LW_FWSECLIC_ERR_CODE_CERT20_INTBLK_VDPA_BLOCK_INSUFFICIENT_SIZE =                               0x0C7,
        LW_FWSECLIC_ERR_CODE_BCRT2X_CERT_CONTROL_HEADER_INSUFFICIENT_SIZE =                             0x0C8,
        LW_FWSECLIC_ERR_CODE_BCRT2X_CERT_INSUFFICIENT_SIZE =                                            0x0C9,
        LW_FWSECLIC_ERR_CODE_CORRUPTED_NBSI_GLOB_HEADER_OFFSET =                                        0x0CA,
        LW_FWSECLIC_ERR_CODE_CERT_FLAG_OFFSET_OVERFLOW =                                                0x0CB,
        LW_FWSECLIC_ERR_CODE_CERT_TYPE_OFFSET_OVERFLOW =                                                0x0CC,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_CORRUPTED =                                                      0x0CD,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_EXTENSION_6_INSUFFICIENT_DATA =                                  0x0CE,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_EXTENSION_7_INSUFFICIENT_DATA =                                  0x0CF,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_EXTENSION_9_INSUFFICIENT_DATA =                                  0x0D0,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_EXTENSION_11_INSUFFICIENT_DATA =                                 0x0D1,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_SEC_SCRATCH_BUFFER_OVERFLOW =                                    0x0D2,
        LW_FWSECLIC_ERR_CODE_CERT_HULK_EXTENSION_7_OVERWHELM_REG =                                      0x0D3,
        /*********  Values 0x200 to 0x2FF are reserved for Shared functions error codes.              *********/
        ...
        LW_UCODE_ERR_GFWIMAGEPARSER_ROM_DIRECTORY_ILWALID_OFFSET =                                      0x2AB,
        LW_UCODE_ERR_GFWIMAGEPARSER_ROM_DIRECTORY_ILWALID_IDENTIFIER =                                  0x2AC,
        LW_UCODE_ERR_GFWIMAGEPARSER_ROM_DIRECTORY_ILWALID_VERSION =                                     0x2AD,
        LW_UCODE_ERR_GFWIMAGEPARSER_ROM_DIRECTORY_ILWALID_SIZE =                                        0x2AE,
        LW_UCODE_ERR_GFWIMAGE_READ_ILWALID_ALIGNMENT =                                                  0x2AF,
        LW_UCODE_ERR_ROMWINDOW_ILWALID_OFFSET =                                                         0x2B0,
        LW_UCODE_ERR_ROMWINDOW_ILWALID_SIZE =                                                           0x2B1,
        LW_UCODE_ERR_SEMUTEX_ACQUIRE_MUTEX_ID_NOT_AVAILABLE =                                           0x2B2,
        LW_UCODE_ERR_SEMUTEX_ACQUIRE_MUTEX_ACQUIRE_ERROR =                                              0x2B3,
        LW_UCODE_ERR_SEMUTEX_RELEASE_MUTEX_RELEASE_ERROR =                                              0x2B4,
        LW_UCODE_ERR_SEBUS_SEND_REQUEST_TIMEOUT_CHANNEL_EMPTY =                                         0x2B5,
        LW_UCODE_ERR_SEBUS_SEND_REQUEST_TIMEOUT_WRITE_COMPLETE =                                        0x2B7,
        LW_UCODE_ERR_SEBUS_GET_DATA_TIMEOUT =                                                           0x2B8,
        LW_UCODE_ERR_SEBUS_GET_DATA_BUS_REQUEST_FAIL =                                                  0x2B9,
        LW_UCODE_DEVINIT_HEADER_DATA_NOT_PRESENT =                                                      0x2BA,
        LW_UCODE_DEVINIT_HEADER_SIGNATURE_TYPE_MISMATCH =                                               0x2BB,
        LW_UCODE_DEVINIT_SIGNATURE_MISMATCH =                                                           0x2BC,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_ILWALID_HDR_SIZE =                                          0x2BD,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_ILWALID_IDENTIFIER =                                        0x2BE,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_ILWALID_VERSION =                                           0x2BF,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_LEDGER_ILWALID_OFFSET =                                     0x2C0,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_HEADER_ILWALID_OFFSET =                                     0x2C1,
        LW_UCODE_ERR_ROMDIRECTORY_RFW_FS_UNALIGNED_ROMDIR_OFFSET =                                      0x2C2,
        LW_UCODE_ERR_ROMDIRECTORY_RFW_FS_ILWALID_ROMDIR_OFFSET =                                        0x2C3,
        LW_UCODE_ERR_ROMDIRECTORY_RFW_FS_ILWALID_IDENTIFIER =                                           0x2C4,
        LW_UCODE_ERR_ROMDIRECTORY_RFW_FS_ILWALID_VERSION =                                              0x2C5,
        LW_UCODE_ERR_ROMDIRECTORY_RFW_FS_ILWALID_SIZE =                                                 0x2C6,
        LW_UCODE_ERR_ROMDIRECTORY_RFW_FS_ILWALID_OPROM_OFFSET =                                         0x2C7,
        LW_UCODE_ERR_GFWIMAGEPARSER_ILWALID_INFOROM_OFFSET =                                            0x2C8,
        LW_UCODE_ERR_HS_MEM_CMP_ERROR =                                                                 0x2C9,
        LW_UCODE_ERR_UTMIPLL_LOCK_WAIT_TIMEOUT =                                                        0x2CA,
        LW_UCODE_ERR_GFWIMAGEPARSER_INFOROM_SUBGLOB_NOT_FOUND =                                         0x2CB,
        LW_UCODE_ERR_GFWIMAGEPARSER_NBSI_DIR_SIG_NOT_FOUND =                                            0x2CC,
        LW_UCODE_ERR_DSS_UNPACKED_DATA_UNALIGNED =                                                      0x2CD,
        LW_UCODE_ERR_DSS_UNPACKED_DATA_OVERFLOW =                                                       0x2CE,
        LW_UCODE_ERR_DSS_TYPE_COUNT_UNALIGNED =                                                         0x2CF,
        LW_UCODE_ERR_DSS_TYPE_ILWALID =                                                                 0x2D0,
        LW_UCODE_ERR_DSS_NESTED_REPEAT_OVERFLOW =                                                       0x2D1,
        LW_UCODE_ERR_DSS_NESTED_REPEAT_UNMATCHED =                                                      0x2D2,
        LW_UCODE_ERR_DSS_REPEAT_COUNT_EXCEEDED =                                                        0x2D3,
        LW_UCODE_ERR_PMU2XUSB_XUSB_NOT_ENABLED =                                                        0x2D4,
        LW_UCODE_ERR_PMU2XUSB_ACK_ASSERTED =                                                            0x2D5,
        LW_UCODE_ERR_PMU2XUSB_ACK_TIMEOUT =                                                             0x2D6,
        LW_UCODE_ERR_PMU2XUSB_REQ_ACTIVE =                                                              0x2D7,
        LW_UCODE_ERR_SEBUS_VHR_CHECK_FAILED =                                                           0x2D8,
        LW_UCODE_ERR_SEBUS_DEFAULT_TIMEOUT_ILWALID =                                                    0x2D9,
        LW_UCODE_ERR_SEBUS_ERR_MUTEX_ACQUIRE =                                                          0x2DA,
        LW_UCODE_ERR_CERT_CERT_SIZE_EXCEED_LIMIT =                                                      0x2DB,
        LW_UCODE_ERR_CERT_CERT_MAIN_STRUCTURE_SIZE_EXCEED_LIMIT =                                       0x2DC,
        LW_UCODE_ERR_CERT_EXTENSION_LINKED_LIST_OUTOF_BOUNDARY =                                        0x2DD,
        LW_UCODE_ERR_CERT_EXTENSION_HEADER_SIZE_EXCEED_LIMIT =                                          0x2DE,
        LW_UCODE_ERR_CERT_NO_EXTENSION_CERT_NOT_SUPPORTED =                                             0x2DF,
        LW_UCODE_ERR_CERT_EXTENSION_NUM_MISMATCH_WITH_LINKEDLIST =                                      0x2E0,
        LW_UCODE_ERR_CERT_EXTENSION_LINKED_LIST_WRONG_PREV_NODE_POINTER =                               0x2E1,
        LW_UCODE_ERR_DEVINIT_NOT_COMPLETED =                                                            0x2E2,
        LW_UCODE_ERR_ACR_NOT_UNLOADED =                                                                 0x2E3,
        LW_UCODE_ERR_FBFALCON_NOT_HALTED =                                                              0x2E4,
        LW_UCODE_ERR_GSP_NOT_HALTED =                                                                   0x2E5,
        LW_UCODE_ERR_PWR_NOT_HALTED =                                                                   0x2E6,
        LW_UCODE_ERR_PMC_ENABLED =                                                                      0x2E7,
        LW_UCODE_ERR_GFWIMAGE_READ_OFFSET_EXCEEDS_MEDIA_BOUNDARY =                                      0x2E8,
        LW_UCODE_ERR_FUSE_CLOCK_SWITCH_MONITOR_UNSELWRE =                                               0x2E9,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_ILWALID_ENTRY_SIZE =                                        0x2EA,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_ILWALID_LEDGER_SIZE =                                       0x2EB,
        LW_UCODE_ERR_BOOTBLOCKPARSER_RFW_FS_ILWALID_LEDGER_COUNT =                                      0x2EC,
        LW_UCODE_ERR_DMA_TRANSFER_SIZE_ILWALID =                                                        0x2ED,
        LW_UCODE_ERR_FUSE_CLK_FMON_FAULT_DETECTED =                                                     0x2EE,
        LW_UCODE_ERR_FUSE_SELWRITY_MONITOR_SCPM_FAULT_DETECTED =                                        0x2EF,
        LW_UCODE_ERR_FUSE_SELWRITY_MONITOR_POD_FAULT_DETECTED =                                         0x2F0,

        LW_UCODE_ERR_CERT_CERT_MAIN_STRUCTURE_INSUFFICIENT_SIZE =                                       0x2F1, 
        LW_UCODE_ERR_CERT_CERT_CERT_SIZE_SMALL_THAN_STRUCT_SIZE =                                       0x2F2,
        LW_UCODE_ERR_CERT_INSUFFICIENT_CERT_SIZE =                                                      0x2F3,
        LW_UCODE_ERR_CERT_NEXT_EXTENSION_AT_LOWER_OFFSET =                                              0x2F4,
        LW_UCODE_ERR_CERT_EXTENSION_ENTRY_NUM_EXCEED_MAX =                                              0x2F5,
        LW_UCODE_ERR_CERT_START_OFFSET_OVERFLOW =                                                       0x2F6,
        /*********  Values 0x300 to 0x3FF are reserved for HULK specific error codes.                   *********/
        /*********  These values will be written to the following register:                             *********/
        /*********  LW_UCODE_POST_CODE_HULK_ERR_CODE(LW_PBUS_VBIOS_SCRATCH(5)[9:0]                      *********/
        /* These enums are populated by helper function. Any changes here might require updates to call sites. */
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXPLM_READ_SENDREQUEST_TIMEOUT =                       0x300,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXPLM_READ_SENDREQUEST_TIMEOUT_DUMMY =                 0x301,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXPLM_READ_GETDATA_TIMEOUT =                           0x302,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXPLM_READ_GETDATA_REQUEST_FAIL =                      0x303,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXPLM_WRITE_TIMEOUT_CHANNEL_EMPTY =                    0x304,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXPLM_WRITE_TIMEOUT_WRITE_COMPLETE =                   0x305,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXID_READ_SENDREQUEST_TIMEOUT =                        0x306,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXID_READ_SENDREQUEST_TIMEOUT_DUMMY =                  0x307,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXID_READ_GETDATA_TIMEOUT =                            0x308,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXID_READ_GETDATA_REQUEST_FAIL =                       0x309,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXID_NOT_AVAILABLE =                                   0x30A,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXMUTEX_WRITE_TIMEOUT_CHANNEL_EMPTY =                  0x30B,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXMUTEX_WRITE_TIMEOUT_WRITE_COMPLETE =                 0x30C,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXMUTEX_READ_SENDREQUEST_TIMEOUT =                     0x30D,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXMUTEX_READ_SENDREQUEST_TIMEOUT_DUMMY =               0x30E,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXMUTEX_READ_GETDATA_TIMEOUT =                         0x30F,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEXMUTEX_READ_GETDATA_REQUEST_FAIL =                    0x310,
        LW_HULK_ERR_SEMUTEX_ACQUIRE_BSI_WRITE_MUTEX_ACQUIRE_ERROR =                                     0x311,
        LW_HULK_ERR_POST_DEVINIT_LICENSE_PROCESSING_DEVINIT_NOT_COMPLETED =                             0x312,
        LW_HULK_ERR_PRE_DEVINIT_LICENSE_PROCESSING_DEVINIT_ALREADY_COMPLETED =                          0x313,
        LW_HULK_ERR_UNSUPPORTED_HULK_LICENSE_TYPE =                                                     0x314,
        LW_HULK_ERR_COT_FAILURE_BOOTSTRAP =                                                             0x315,
        LW_HULK_ERR_COT_FAILURE_FWSEC =                                                                 0x316,
        LW_HULK_ERR_LWLIPT_LNK_RESET_RSTSEQ_ERROR =                                                     0x317,
        LW_HULK_ERR_LICENSE_PTR_ILWALID =                                                               0x318,
        LW_HULK_ERR_LICENSE_TOO_BIG =                                                                   0x319,
        LW_HULK_ERR_LICENSE_UNSUPPORTED_VERSION =                                                       0x320,
        LW_HULK_ERR_LICENSE_PDI_MISMATCH =                                                              0x321,
        LW_HULK_ERR_LICENSE_STRICT_ID_PDI_MISMATCH =                                                    0x322,

        /*********  Values 0x400 to 0x4FF are reserved for UDE-specific error codes.                    *********/
        /*********  These values will be written to the following register:                             *********/
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
        LW_UDE_ERR_DEVINIT_TABLES_OUT_OF_BOUND =                                                        0x467,
        LW_UDE_ERR_DEVINIT_SCRIPTS_OUT_OF_BOUND =                                                       0x468,
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
        LW_UDE_ERR_MEMINFO_TABLE_GET_HEADER_FAILED =                                                    0x469,
        LW_UDE_ERR_TMRS_SEQ_LIST_TABLE_GET_HEADER_FAILED =                                              0x46A,
        LW_UDE_ERR_TMRS_SEQ_TABLE_GET_HEADER_FAILED =                                                   0x46B,
        LW_UDE_ERR_TMRS_CODE_TABLE_GET_HEADER_FAILED =                                                  0x46C,
        LW_UDE_ERR_MEMINFO_TABLE_GET_ENTRY_FAILED =                                                     0x46D,
        LW_UDE_ERR_TMRS_SEQ_LIST_TABLE_GET_ENTRY_FAILED =                                               0x46E,
        LW_UDE_ERR_TMRS_SEQ_TABLE_GET_ENTRY_FAILED =                                                    0x46F,
        LW_UDE_ERR_TMRS_CODE_TABLE_GET_ENTRY_FAILED =                                                   0x470,
        LW_UDE_ERR_TMRS_LWRRENT_PHASE_ILWALID =                                                         0x471,
        LW_UDE_ERR_TMRS_SEQ_LIST_ITEM_TYPE_ILWALID =                                                    0x472,
        LW_UDE_ERR_TMRS_SEQ_LIST_INDEX_OUT_OF_BOUNDS =                                                  0x473,
        LW_UDE_ERR_TMRS_SEQ_INDEX_OUT_OF_BOUNDS =                                                       0x474,
        LW_UDE_ERR_TMRS_CODE_INDEX_OUT_OF_BOUNDS =                                                      0x475,
        LW_UDE_ERR_TMRS_CODE_UNSUPPORTED_MODE =                                                         0x476,
        LW_UDE_ERR_TMRS_CODE_ILWALID_REG =                                                              0x477,
        LW_UDE_ERR_TMRS_CODE_LENGTH_NOT_MULTIPLE_OF_STRIDE =                                            0x478,
        LW_UDE_ERR_TMRS_CODE_PAYLOAD_LENGTH_TOO_LARGE =                                                 0x479,
        LW_UDE_ERR_CFGDATA_TABLE_HDR_VERSION_MISMATCH =                                                 0x47A,

        /*********  Values 0x500 to 0x7FF are reserved for RISCV Devinit-specific error codes.          *********/
        /*********  These values will be written to the following register:                             *********/
        /*********  LW_GFW_GLOBAL_DEVINIT_ERROR_CODE(LW_PBUS_VBIOS_SCRATCH(12)[31:16]                   *********/
        LW_DEVINIT_ERR_PARTITION_SWITCH_FAIL =                                                          0x500,
        LW_DEVINIT_ERR_INTERRUPT_PRIV_STORE_ERROR =                                                     0x501,
        LW_DEVINIT_ERR_INTERRUPT_UNKNOWN_INTERRUPT =                                                    0x502,
        LW_DEVINIT_ERR_EXCEPTION_INST_ADDR_MISALIGNED =                                                 0x503,
        LW_DEVINIT_ERR_EXCEPTION_INST_ACCESS_FAULT =                                                    0x504,
        LW_DEVINIT_ERR_EXCEPTION_ILLEGAL_INST =                                                         0x505,
        LW_DEVINIT_ERR_EXCEPTION_BRKPT_SW_ASSERT =                                                      0x506,
        LW_DEVINIT_ERR_EXCEPTION_LOAD_ADDRESS_MISALIGNED =                                              0x507,
        LW_DEVINIT_ERR_EXCEPTION_LOAD_ACCESS_FAULT =                                                    0x508,
        LW_DEVINIT_ERR_EXCEPTION_STORE_ADDRESS_MISALIGNED =                                             0x509,
        LW_DEVINIT_ERR_EXCEPTION_STORE_ACCESS_FAULT =                                                   0x50A,
        LW_DEVINIT_ERR_EXCEPTION_INST_PAGE_FAULT =                                                      0x50B,
        LW_DEVINIT_ERR_EXCEPTION_LOAD_PAGE_FAULT =                                                      0x50C,
        LW_DEVINIT_ERR_EXCEPTION_STORE_PAGE_FAULT =                                                     0x50D,
        LW_DEVINIT_ERR_EXCEPTION_UNKNOWN =                                                              0x50E,
        LW_DEVINIT_ERR_CLOCKS_PLL_0_LOCKDET_FAIL =                                                      0x50F,
        LW_DEVINIT_ERR_CLOCKS_PLL_0_IDDQ_FAIL =                                                         0x510,
        LW_DEVINIT_ERR_CLOCKS_PLL_1_LOCKDET_FAIL =                                                      0x511,
        LW_DEVINIT_ERR_CLOCKS_PLL_1_IDDQ_FAIL =                                                         0x512,
        LW_DEVINIT_ERR_HBM_FBP_PLL_LOCK_FAIL =                                                          0x513,
        LW_DEVINIT_ERR_HBM_FBP_CAL_LOCK_FAIL =                                                          0x514,
        LW_DEVINIT_ERR_PRIV_RING_INIT_1_FAIL =                                                          0x515,
        LW_DEVINIT_ERR_PRIV_RING_INIT_2_FAIL =                                                          0x516,
        LW_DEVINIT_ERR_PRIV_RING_INIT_3_FAIL =                                                          0x517,
        LW_DEVINIT_ERR_PRIV_RING_INIT_4_FAIL =                                                          0x518,
        LW_DEVINIT_ERR_CPR_CLOCKS_ON_FAIL =                                                             0x519,
        LW_DEVINIT_ERR_PLM_LOWERING_WR_FAIL =                                                           0x51A,
        LW_DEVINIT_ERR_PLM_RESTORE_WR_FAIL =                                                            0x51B,
        LW_DEVINIT_ERR_PWR_SENSORS_TABLE_VER_INCORRECT =                                                0x51C,
        LW_DEVINIT_ERR_PWR_SENSORS_TABLE_HEADER_SIZE_INCORRECT =                                        0x51D,
        LW_DEVINIT_ERR_PWR_SENSORS_TABLE_HEADER_ENTRY_SIZE_INCORRECT =                                  0x51E,
        LW_DEVINIT_ERR_PWR_SENSORS_TABLE_HEADER_ENTRY_COUNT_INCORRECT =                                 0x51F,
        LW_DEVINIT_ERR_VFE_TABLE_VER_INCORRECT =                                                        0x520,
        LW_DEVINIT_ERR_VFE_HEADER_SIZE_INCORRECT =                                                      0x521,
        LW_DEVINIT_ERR_VFE_TABLE_HEADER_IND_ENTRY_SIZE_INCORRECT =                                      0x522,
        LW_DEVINIT_ERR_VFE_TABLE_HEADER_IND_ENTRY_COUNT_INCORRECT =                                     0x523,
        LW_DEVINIT_ERR_CPR_RESET_NOT_DEASSERTED_FAIL =                                                  0x524,
        LW_DEVINIT_ERR_CPR_CLOCKS_ALREADY_ON_FAIL =                                                     0x525,
        LW_DEVINIT_ERR_CLOCKS_PLL_2_LOCKDET_FAIL =                                                      0x526,
        LW_DEVINIT_ERR_CLOCKS_PLL_3_LOCKDET_FAIL =                                                      0x527,
        LW_DEVINIT_ERR_GPUADC_13_SUM2_IN4_ILWALID_PROV_IDX =                                            0x528,
        LW_DEVINIT_ERR_GPUADC_13_IPC_BA_ILWALID_PROV_UNIT =                                             0x529,
        LW_DEVINIT_ERR_GPUADC_13_IPC_ADC_ILWALID_PROV_UNIT =                                            0x52A,
        LW_DEVINIT_ERR_GPUADC_13_IPC_PROV_IDX_ADC_SUM_ILWALID =                                         0x52B,
        LW_DEVINIT_ERR_GPUADC_13_IPC_ADC_SUM_ILWALID_PROV_UNIT =                                        0x52C,
        LW_DEVINIT_ERR_GPUADC_13_IPC1_BA_ILWALID_PROV_UNIT =                                            0x52D,
        LW_DEVINIT_ERR_GPUADC_13_IPC1_ADC_ILWALID_PROV_UNIT =                                           0x52E,
        LW_DEVINIT_ERR_GPUADC_13_IPC1_PROV_IDX_ADC_SUM_ILWALID =                                        0x52F,
        LW_DEVINIT_ERR_GPUADC_13_IPC1_ADC_SUM_ILWALID_PROV_UNIT =                                       0x530,
        LW_DEVINIT_ERR_GPUADC_13_IPC2_BA_ILWALID_PROV_UNIT =                                            0x531,
        LW_DEVINIT_ERR_GPUADC_13_IPC2_ADC_ILWALID_PROV_UNIT =                                           0x532,
        LW_DEVINIT_ERR_GPUADC_13_IPC2_PROV_IDX_ADC_SUM_ILWALID =                                        0x533,
        LW_DEVINIT_ERR_GPUADC_13_IPC2_ADC_SUM_ILWALID_PROV_UNIT =                                       0x534,
        LW_DEVINIT_ERR_GPUADC_13_IPC3_BA_ILWALID_PROV_UNIT =                                            0x535,
        LW_DEVINIT_ERR_GPUADC_13_IPC3_ADC_ILWALID_PROV_UNIT =                                           0x536,
        LW_DEVINIT_ERR_GPUADC_13_IPC3_PROV_IDX_ADC_SUM_ILWALID =                                        0x537,
        LW_DEVINIT_ERR_GPUADC_13_IPC3_ADC_SUM_ILWALID_PROV_UNIT =                                       0x538,
        LW_DEVINIT_ERR_GPUADC_13_BEACON1_ILWALID_PROV_IDX =                                             0x539,
        LW_DEVINIT_ERR_GPUADC_13_BEACON2_ILWALID_PROV_IDX =                                             0x53A,
        LW_DEVINIT_ERR_GPUADC_13_SUM1_IN1_ILWALID_PROV_IDX =                                            0x53B,
        LW_DEVINIT_ERR_GPUADC_13_SUM1_IN2_ILWALID_PROV_IDX =                                            0x53C,
        LW_DEVINIT_ERR_GPUADC_13_SUM1_IN3_ILWALID_PROV_IDX =                                            0x53D,
        LW_DEVINIT_ERR_GPUADC_13_SUM1_IN4_ILWALID_PROV_IDX =                                            0x53E,
        LW_DEVINIT_ERR_GPUADC_13_NULL_PTR_EXCEPTION =                                                   0x53F,
        LW_DEVINIT_ERR_GPUADC_13_SUM2_IN1_ILWALID_PROV_IDX =                                            0x540,
        LW_DEVINIT_ERR_GPUADC_13_SUM2_IN2_ILWALID_PROV_IDX =                                            0x541,
        LW_DEVINIT_ERR_GPUADC_13_SUM2_IN3_ILWALID_PROV_IDX =                                            0x542,
        LW_DEVINIT_ERR_GPUADC_13_NUM_CHANNELS_ERROR =                                                   0x543,
        LW_DEVINIT_ERR_GPUADC_13_OFFSET1_ILWALID_PROV_IDX =                                             0x544,
        LW_DEVINIT_ERR_GPUADC_13_OFFSET2_ILWALID_PROV_IDX =                                             0x545,
        LW_DEVINIT_ERR_LIBLWRISCV_CANARY_FAIL =                                                         0x546,
        LW_DEVINIT_ERR_HBMPLL_COEFF_MDIV_IS_ZERO =                                                      0x547,
        LW_DEVINIT_ERR_HBMPLL_COEFF_PDIV_IS_ZERO =                                                      0x548,
        ...
        LW_COMPACTION_ERR_DMEM_VALIDATION =                                                             0xC15,
        LW_COMPACTION_ERR_XMEMSEL_OVERFLOW =                                                            0xC16,
        LW_COMPACTION_ERR_FIXUP_OVERFLOW =                                                              0xC17,
        LW_COMPACTION_ERR_XLAT_NOT_FOUND =                                                              0xC18,
        LW_COMPACTION_ERR_MEMCPY_OVERFLOW =                                                             0xC19,

        ////////////////////////////////////////////////////////////////////////////////////////////////////////
        LW_HULK_ILWALID_COMMAND =                                                                       0x1012,

        /*********  Values 0x1400 to 0x17FF are reserved for BootBlock-specific error codes.            *********/
        /*********  These values will be written to the following register:                             *********/
        /*********  LW_UCODE_POST_CODE_BOOTBLOCK_ERR_CODE (LW_PBUS_VBIOS_SCRATCH(25)[15:0])             *********/
        LW_BOOTBLOCK_ERR_IFR_NOT_FOUND =                                                                0x1400,
        LW_BOOTBLOCK_ERR_BOOTSTRAP_ENTRY_POINT_ILWALID =                                                0x1401,
        LW_BOOTBLOCK_ERR_BOOTBLOCK_ILWALID_SIGNATURE =                                                  0x1402,
        LW_BOOTBLOCK_ERR_INFOROM_OFFSET_SIZE_UNALIGNED =                                                0x1403,
        LW_BOOTBLOCK_ERR_INFOROM_OFFSET_ILWALID =                                                       0x1404,
        LW_BOOTBLOCK_ERR_FWSEC_POLL_TIMEOUT =                                                           0x1405,
        LW_BOOTBLOCK_ERR_FWSEC_VERSION_REVOKED =                                                        0x1406,
        LW_BOOTBLOCK_ERR_ILWALID_LTSSM_STATE =                                                          0x1407,
        LW_BOOTBLOCK_ERR_PREVIOUS_BOOTSTRAP_EXELWTION =                                                 0x1408,
        LW_BOOTBLOCK_ERR_FAIL_TO_ENFORCE_COT =                                                          0x1409,
        LW_BOOTBLOCK_ERR_FAIL_TO_START_SELWREBOOT =                                                     0x140A,
        LW_BOOTBLOCK_ERR_ILWALID_IFR_STATE =                                                            0x140B,
        LW_BOOTBLOCK_ERR_RFFS_ILWALID_LEDGER_DATA =                                                     0x140C,
        LW_BOOTBLOCK_ERR_ILWALID_INITIAL_DESC_ROM_OFFSET =                                              0x140D,
        LW_BOOTBLOCK_ERR_ILWALID_SECBASE =                                                              0x140E,
        ...
        /*********  These values will be written to the same register as PREOS.                         *********/

        /*********  Values 0x2000 to 0x200F are reserved for translating InfoROM FS return codes.       *********/
        /*********  These values will be written to the same register as PREOS.                         *********/
        LW_PREOS_ERR_INFOROM_FS_ERROR =                                                                 0x2000,
        LW_PREOS_ERR_INFOROM_FS_ERR_NO_FREE_MEM =                                                       0x2001,
        LW_PREOS_ERR_INFOROM_FS_ERR_ILWALID_ARG =                                                       0x2002,
        LW_PREOS_ERR_INFOROM_FS_ERR_ILWALID_STATE =                                                     0x2003,
        LW_PREOS_ERR_INFOROM_FS_ERR_FILE_NOT_FOUND =                                                    0x2004,
        LW_PREOS_ERR_INFOROM_FS_ERR_NOT_SUPPORTED =                                                     0x2005,
        LW_PREOS_ERR_INFOROM_FS_ERR_ILWALID_DATA =                                                      0x2006,

        /*********  Values 0x2010 to 0x23FF are reserved for PREOS oobmon-specific error codes.         *********/
        /*********  These values will be written to the same register as PREOS.                         *********/
        LW_PREOS_ERR_INFOROM_ALREADY_INITIALIZED =                                                      0x2010,
        LW_PREOS_ERR_INFOROM_NOT_FOUND =                                                                0x2011,
        LW_PREOS_ERR_INFOROM_ILWALID_OFFSET =                                                           0x2012,
        LW_PREOS_ERR_INFOROM_CONSTRUCT_FS_ERR =                                                         0x2013,
        LW_PREOS_ERR_INFOROM_PACKED_DATA_TOO_LARGE =                                                    0x2014,
        LW_PREOS_ERR_INFOROM_FILE_NAME_MISMATCH =                                                       0x2015,
        LW_PREOS_ERR_INFOROM_VERSION_MISMATCH =                                                         0x2016,
        LW_PREOS_ERR_INFOROM_SUBVERSION_MISMATCH =                                                      0x2017,
        LW_PREOS_ERR_INFOROM_LICENSE_OBJ_NOT_FOUND =                                                    0x2018,
        LW_PREOS_ERR_INFOROM_ILWALID_OBJID =                                                            0x2029,
        LW_PREOS_ERR_INFOROM_BUFFER_OVERFLOW =                                                          0x202A,

        /*********  Values 0x2400 to 0x27FF are reserved for PREOS dpiim-specific error codes.          *********/
        /*********  These values will be written to the same register as PREOS.                         *********/

        /*********  Values 0x2800 to 0x2BFF are reserved for PREOS PBI-specific error codes.            *********/
        /*********  These values will be written to the same register as PREOS.                         *********/
        LW_UCODE_ERR_PBI_GENERIC_FAILURE  =                                                             0x2800,
        LW_UCODE_ERR_PBI_USB_LOCK_ENABLED  =                                                            0x2801,
        LW_UCODE_ERR_PBI_GET_DRAM_INFO_SITE_FLOORSWEPT =                                                0x2803,
        LW_UCODE_ERR_PBI_GET_DRAM_INFO_OUT_OF_RANGE_DWORD_REQUESTED =                                   0x2804,
        LW_UCODE_ERR_PBI_GET_DRAM_INFO_OUT_OF_RANGE_SELECTOR_VALUE_REQUESTED =                          0x2805,
        LW_UCODE_ERR_PBI_GET_DRAM_INFO_GLOBAL_BUFFER_NOT_POPULATED =                                    0x2806,

        /*********  Values 0x2C00 to 0x2FFF are reserved for fbFalcon running FRTS                      *********/
        /*********  These values will be written to LW_UCODE_POST_CODE_FBFALCON_FRTS_REG11,             *********/
        ...
        /*********  Values 0x3000 to 0x31FF are reserved for SE lib error codes.                        *********/
        /*********  These values are derived from SE_STATUS present in SE lib header file setypes.h     *********/
        LW_UCODE_ERR_SE_LIB_ERR_CODE_ENUM_BASE_VAL =                                                    0x3000,
        LW_UCODE_ERR_SE_LIB_BAD_INPUT_DATA =                                                            0x3001,
        LW_UCODE_ERR_SE_LIB_POINT_NOT_ON_LWRVE =                                                        0x3002,
        LW_UCODE_ERR_SE_LIB_PKA_OP_ILWALID_OPCODE =                                                     0x3003,
        LW_UCODE_ERR_SE_LIB_PKA_OP_F_STACK_UNDERFLOW =                                                  0x3005,
        LW_UCODE_ERR_SE_LIB_PKA_OP_F_STACK_OVERFLOW =                                                   0x3006,
        LW_UCODE_ERR_SE_LIB_PKA_OP_WATCHDOG =                                                           0x3007,
        LW_UCODE_ERR_SE_LIB_PKA_OP_HOST_REQUEST =                                                       0x3008,
        LW_UCODE_ERR_SE_LIB_PKA_OP_P_STACK_UNDERFLOW =                                                  0x3009,
        LW_UCODE_ERR_SE_LIB_PKA_OP_P_STACK_OVERFLOW =                                                   0x300A,
        LW_UCODE_ERR_SE_LIB_PKA_OP_MEM_PORT_COLLISION =                                                 0x300B,
        LW_UCODE_ERR_SE_LIB_PKA_OP_OPERATION_SIZE_EXCEED_CFG =                                          0x300C,
        LW_UCODE_ERR_SE_LIB_PKA_OP_UNKNOWN_ERR =                                                        0x300D,
        LW_UCODE_ERR_SE_LIB_NOT_SUPPORTED =                                                             0x300E,
        LW_UCODE_ERR_SE_LIB_ILWALID_ARGUMENT =                                                          0x300F,
        LW_UCODE_ERR_SE_LIB_ILLEGAL_OPERATION =                                                         0x3010,
        LW_UCODE_ERR_SE_LIB_TIMEOUT =                                                                   0x3011,
        LW_UCODE_ERR_SE_LIB_NO_FREE_MEM =                                                               0x3012,
        LW_UCODE_ERR_SE_LIB_MUTEX_ACQUIRE =                                                             0x3013,
        LW_UCODE_ERR_SE_LIB_MUTEX_ID_NOT_AVAILABLE =                                                    0x3014,
        LW_UCODE_ERR_SE_LIB_MORE_PROCESSING_REQUIRED =                                                  0x3015,
        LW_UCODE_ERR_SE_LIB_FAILED_ECDSA_ATTEMPTS =                                                     0x3016,
        LW_UCODE_ERR_SE_LIB_ILWALID_KEY_SIZE =                                                          0x3017,
        LW_UCODE_ERR_SE_LIB_TRNG_R256_NOT_ENABLED =                                                     0x3018,
        LW_UCODE_ERR_SE_LIB_SECBUS_READ_ERROR =                                                         0x3019,
        LW_UCODE_ERR_SE_LIB_SECBUS_WRITE_ERROR =                                                        0x301A,
        LW_UCODE_ERR_SE_LIB_CSB_PRIV_READ_ERROR =                                                       0x301B,
        LW_UCODE_ERR_SE_LIB_CSB_PRIV_READ_0xBADF_VALUE_RECEIVED =                                       0x301C,
        LW_UCODE_ERR_SE_LIB_CSB_PRIV_WRITE_ERROR =                                                      0x301D,
        LW_UCODE_ERR_SE_LIB_ERROR =                                                                     0x30FF,

        /*********  Values 0x3200 to 0x33FF are reserved for IST error codes                            *********/
        /*********  These values will be written to LW_UCODE_POST_CODE_IST_REG,                         *********/
        /*********   LW_UCODE_POST_CODE_IST_ERR_CODE  31:16                                             *********/
        LW_IST_ERR_TABLE_HEADER_PARSE_FAILED =                                                          0x3200,
        LW_IST_ERR_TABLE_HEADER_VERSION_FAILED =                                                        0x3201,
        LW_IST_ERR_TABLE_HEADER_SIZE_FAILED =                                                           0x3202,
        LW_IST_ERR_TABLE_ENTRY_SIZE_FAILED =                                                            0x3203,
        LW_IST_ERR_TABLE_ENTRY_COUNT_MISMATCH =                                                         0x3204,
        LW_IST_ERR_TABLE_BUF_OVERFLOW =                                                                 0x3205,
        LW_IST_ERR_TABLE_SIZE_MISMATCH =                                                                0x3206,
        LW_IST_ERR_TABLE_HASH_MISMATCH =                                                                0x3207,
        LW_IST_ERR_TABLE_ENTRY_PARSE_FAILED =                                                           0x3208,
        LW_IST_ERR_TABLE_ENTRY_SIGNATURE_ILWALID =                                                      0x3209,

        /*********  Values 0x3400 to 0x35FF are reserved for fuserework error codes.                    *********/
        /*********  These values will be written to Falcon MAILBOX1 15:0                                *********/
        LW_FUSEREWORK_ERR_ILWALID_SOURCE_SKU =                                                          0x3400,
        LW_FUSEREWORK_ERR_FUSE_BURN_NOT_REQUIRED =                                                      0x3401,
        LW_FUSEREWORK_ERR_FUSE_SIZE_MISMATCH  =                                                         0x3402,
        LW_FUSEREWORK_ERR_ILWALID_ARGUMENT =                                                            0x3403,
        LW_FUSEREWORK_ERR_ILWALID_NEW_FUSE_VALUE =                                                      0x3404,
        LW_FUSEREWORK_ERR_NEW_FUSE_VALUE_NOT_REFLECTED =                                                0x3405,
        LW_FUSEREWORK_ERR_UNSUPPORTED_FUNCTION =                                                        0x3406,
        LW_FUSEREWORK_ERR_INSUFFICIENT_RECORDS =                                                        0x3407,
        LW_FUSEREWORK_ERR_FUSE_NOT_WHITELISTED =                                                        0x3408,

        /*********  Values 0x3600 to 0x37FF are reserved for aws sanity error codes.                    *********/
        /*********  These values will be written to Falcon MAILBOX0 15:0                                *********/
        LW_AWSSANITY_ERR_DISP =                                                                         0x3600,
        LW_AWSSANITY_ERR_LOCALMEMRANGE =                                                                0x3601,
        LW_AWSSANITY_ERR_ACR =                                                                          0x3602,
        LW_AWSSANITY_ERR_DOUBLEEXEC =                                                                   0x3603,
        LW_AWSSANITY_ERR_DEVID =                                                                        0x3604,
        LW_AWSSANITY_ERR_PMCENABLED =                                                                   0x3605,
        LW_AWSSANITY_ERR_FBFALCON =                                                                     0x3606,
        LW_AWSSANITY_ERR_GSP =                                                                          0x3607,
        LW_AWSSANITY_ERR_PMU =                                                                          0x3608,
        LW_AWSSANITY_ERR_DEVIDOVERRIDE =                                                                0x3609,
        LW_AWSSANITY_ERR_PRIVSEC =                                                                      0x360A,
        LW_AWSSANITY_ERR_MEMLOCK =                                                                      0x360B,
        LW_AWSSANITY_ERR_DISPEND =                                                                      0x360C,

        LW_AWSSANITY_ERR_1A =                                                                           0x3610,
        LW_AWSSANITY_ERR_1B =                                                                           0x3611,
        LW_AWSSANITY_ERR_4BIISINGLE =                                                                   0x3612,
        LW_AWSSANITY_ERR_4BIISINGLE_I1 =                                                                0x3613,
        LW_AWSSANITY_ERR_4BIIISINGLE =                                                                  0x3614,
        LW_AWSSANITY_ERR_4BIIISINGLE_I1 =                                                               0x3615,
        LW_AWSSANITY_ERR_4BIIDUAL0 =                                                                    0x3616,
        LW_AWSSANITY_ERR_4BIIDUAL0_I1 =                                                                 0x3617,
        LW_AWSSANITY_ERR_4BIIIDUAL0 =                                                                   0x3618,
        LW_AWSSANITY_ERR_4BIIIDUAL0_I1 =                                                                0x3619,
        LW_AWSSANITY_ERR_4BIIDUAL1 =                                                                    0x361A,
        LW_AWSSANITY_ERR_4BIIDUAL1_I1 =                                                                 0x361B,
        LW_AWSSANITY_ERR_4BIIIDUAL1 =                                                                   0x361C,
        LW_AWSSANITY_ERR_4BIIIDUAL1_I1 =                                                                0x361D,
        LW_AWSSANITY_ERR_4BIV_RD =                                                                      0x361E,
        LW_AWSSANITY_ERR_4BIV_WR =                                                                      0x361F,
        LW_AWSSANITY_ERR_4CRDWR_RDERR =                                                                 0x3620,
        LW_AWSSANITY_ERR_4CRDWR_WRERR =                                                                 0x3621,
        LW_AWSSANITY_ERR_4CRD_RDERR =                                                                   0x3622,
        LW_AWSSANITY_ERR_4CRD_WRERR =                                                                   0x3623,
        LW_AWSSANITY_ERR_4CWR_RDERR =                                                                   0x3624,
        LW_AWSSANITY_ERR_4CWR_WRERR =                                                                   0x3625,
        LW_AWSSANITY_ERR_4CNA_RDERR =                                                                   0x3626,
        LW_AWSSANITY_ERR_4CNA_WRERR =                                                                   0x3627,
        LW_AWSSANITY_ERR_5 =                                                                            0x3628,

        /*********  Values 0x3800 to 0x47FF are reserved for Shared Error Code                       *********/
        LW_UCODE_ERR_CODE_SHARED_START                                                                = 0x3800,
        LW_UCODE_ERR_CODE_HW_SHA_PREP_TIMEOUT                                                         = 0x3801,
        LW_UCODE_ERR_CODE_HW_SHA_RESET_FAILED                                                         = 0x3802,
        LW_UCODE_ERR_CODE_HW_SHA_TIMEOUT                                                              = 0x3803,
        LW_UCODE_ERR_CODE_HW_SHA_ERROR                                                                = 0x3804,
        LW_UCODE_ERR_CODE_HW_SHA_MUTEX_LOCKED_ERROR                                                   = 0x3805,
        LW_UCODE_ERR_CODE_RSAPSS_EM_ANCHOR_CHECK_FAILED                                               = 0x3806,
        LW_UCODE_ERR_CODE_RSAPSS_MASKDB_LEFT_MARK_ERROR                                               = 0x3807,
        LW_UCODE_ERR_CODE_RSAPSS_MASKDB_SALT_MARK_ERROR                                               = 0x3808,
        LW_UCODE_ERR_CODE_RSAPSS_MASKDB_PS_ERROR                                                      = 0x3809,
        LW_UCODE_ERR_CODE_RSAPSS_SIG_VERIFY_FAILED                                                    = 0x380a,
        LW_UCODE_ERR_CODE_RSA_SIGNATURE_PADDING_TYPE_ILWALID                                          = 0x380b,
        LW_UCODE_ERR_CODE_RSAPSS_SIGNATURE_SIZE_UNSUPPORTED                                           = 0x380c,
        LW_UCODE_ERR_CODE_CERTIFICATE_POINTER_ILWALID                                                 = 0x380d,
        LW_UCODE_ERR_CODE_VERIFY_LICENSE_TYPE_ILWALID                                                 = 0x380e,
        LW_UCODE_ERR_CODE_BCRT30_CERT_ALGOTYPE_NOT_SUPPORTED                                          = 0x380f,
        LW_UCODE_ERR_CODE_HULK_CAN_ONLY_USE_ON_DEBUG_FUSED_BOARD                                      = 0x3810,
        LW_UCODE_ERR_CODE_ROM_DIR_FLASH_TIME_UPDATE_NOT_SUPPORTED                                     = 0x3811,
        LW_UCODE_ERR_CODE_UCODE_VER_REVOKED                                                           = 0x3812,
        LW_UCODE_ERR_CODE_UCODE_VER_UNSUPPORTED                                                       = 0x3813,
        LW_UCODE_ERR_CODE_BCRT30_CERT_LWD_REVOKED                                                     = 0x3814,
        LW_UCODE_ERR_CODE_CCC_SELECT_ENGINE_ERROR                                                     = 0x3815,
        LW_UCODE_ERR_CODE_CCC_CRYPTO_INIT_ERROR                                                       = 0x3816,
        LW_UCODE_ERR_CODE_CCC_LWPKA_ACQUIRE_MUTEX_ERROR                                               = 0x3817,
        LW_UCODE_ERR_CODE_CCC_LWPKA_MODULAR_EXPONENTIATION_ERROR                                      = 0x3818,
        LW_UCODE_ERR_CODE_RSAPSS_ILWALID_PARAMS                                                       = 0x3819,

        /*********  Values 0x4800 to 0x48FF are reserved for LWSwitch error codes.     *********/
        LW_SWITCHINIT_ERROR_CLOCKS_SWITCHPLL_NOT_LOCKED                                               = 0x4800,
        LW_SWITCHINIT_ERROR_CLOCKS_SWITCHCLK_NOT_RDY                                                  = 0x4801,
        LW_SWITCHINIT_ERROR_CLOCKS_SYSTEMCLK_NOT_RDY                                                  = 0x4802,
        LW_SWITCHINIT_ERROR_CLOCKS_PTIMER_COMPROMISED                                                 = 0x4803,
        LW_SWITCHINIT_ERROR_PRIV_RING_INIT_RESULTS_FAIL                                               = 0x4804,
        LW_SWITCHINIT_ERROR_PRIV_RING_INIT_INTERRUPT_STATUS0_ERROR                                    = 0x4805,
        LW_SWITCHINIT_ERROR_PRIV_RING_INIT_INTERRUPT_STATUS1_ERROR                                    = 0x4806,
        LW_SWITCHUTILS_ERROR_LWLIPT_LNK_RESET_RSTSEQ_DEASSERTION_ERROR                                = 0x4807,
        LW_SWITCHUTILS_ERROR_LWLIPT_LNK_RESET_RSTSEQ_ASSERTION_ERROR                                  = 0x4808,
        LW_SWITCHBOOT_ERROR_SANITIZE_INCORRECT_LS_UCODE_REVISION                                      = 0x4809,
        LW_SWITCHBOOT_ERROR_SANITIZE_ILWALID_UCODE_DESCRIPTOR_INFO                                    = 0x480a,
        LW_SWITCHBOOT_ERROR_SANITIZE_RESIDENT_UCODE_HASH_MISMATCH                                     = 0x480b,
        LW_SWITCHBOOT_ERROR_PRE_LTSSM_EXELWTION_SKIPPED                                               = 0x480c,
        LW_SWITCH_HULK_ERROR_LWLIPT_LNK_RESET_RSTSEQ_ERROR                                            = 0x480d,
        LW_SWITCHBOOT_ERROR_NPORT_SRAM_INIT_TIMEOUT_ERROR                                             = 0x480e,

        /*********  Values 0x4900 to 0x49FF are reserved for Cert3.0 verification error codes.        *********/
        /*********  Refer to ucode_post_codes.ads for these errors                                    *********/

        LW_CERT30_ROM_DIR_OFFSET_OUT_OF_RANGE                                                         = 0x4900,
        LW_CERT30_ROM_DIRECTORY_ILWALID                                                               = 0x4901,
        LW_CERT30_ROM_DIRECTORY_INFOROM_ILWALID                                                       = 0x4902,
        LW_CERT30_IFR_HEADER_MALFORMED                                                                = 0x4903,
        LW_CERT30_BOOT_BLOCK_OFFSETS_MALFORMED                                                        = 0x4904,
        LW_CERT30_FLASH_STATUS_HEADER_MALFORMED                                                       = 0x4905,
        LW_CERT30_CERT_BLOCK_CONTROL_HEADER_ILWALID                                                   = 0x4906,
        LW_CERT30_CERT_BLOCK_METADATA_HEADER_ILWALID                                                  = 0x4907,
        LW_CERT30_CERT_HEADER_ILWALID                                                                 = 0x4908,
        LW_CERT30_CERT_TYPE_HEADER_MAIN_STRUCT_MISMATCH                                               = 0x4909,
        LW_CERT30_CERT_TYPE_ILWALID                                                                   = 0x490A,
        LW_CERT30_FIRST_CERT_HEADER_FLAG_ILWALID                                                      = 0x490B,
        LW_CERT30_SECOND_CERT_HEADER_FLAG_ILWALID                                                     = 0x490C,
        LW_CERT30_CERT_MAIN_STRUCT_ILWALID                                                            = 0x490D,
        LW_CERT30_SHA_HANG                                                                            = 0x490E,
        LW_CERT30_SHA_EXELWTION_ERROR                                                                 = 0x490F,
        LW_CERT30_SHA_ACQUIRE_MUTEX_ERROR                                                             = 0x4910,
        LW_CERT30_MASTER_CERTIFICATE_SHA_MISMATCH                                                     = 0x4911,
        LW_CERT30_VDPA_HEADER_ILWALID                                                                 = 0x4912,
        LW_CERT30_VDPA_ENTRY_ILWALID                                                                  = 0x4913,
        LW_CERT30_VDPA_INT_FMT_ENTRY_FMT_LEN_ILWALID                                                  = 0x4914,
        LW_CERT30_SELWRITY_ZONE_SIGNATURE_MISMATCH                                                    = 0x4915,
        LW_CERT30_SELWRITY_ZONE_SIGNATURE_LOCATION_ILWALID                                            = 0x4916,
        LW_CERT30_VDPA_INT_BLK_ENTRY_CODE_TYPE_ILWALID                                                = 0x4917,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_ILWALID                                               = 0x4918,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_OFFSET_ILWALID                                        = 0x4919,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_LOC_OFFSET_ILWALID                                    = 0x491A,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_X86_LOC_OFFSET_ILWALID                                = 0x491B,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_EFI_LOC_OFFSET_ILWALID                                = 0x491C,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_EXT_LOC_OFFSET_ILWALID                                = 0x491D,
        LW_CERT30_VDPA_INT_BLK_ENTRY_MINOR_TYPE_NBSI_LOC_OFFSET_ILWALID                               = 0x491E,
        LW_CERT30_VDPA_INT_BLK_ENTRY_BLOCK_SIZE_ILWALID                                               = 0x491F,
        LW_CERT30_VDPA_GET_ENTRY_FROM_DIRT_ID_TYPE_ILWALID                                            = 0x4920,
        LW_CERT30_VDPA_GET_ENTRY_FROM_DIRT_ID_NOT_FOUND                                               = 0x4921,
        LW_CERT30_SELWRITY_ZONE_SIZE_ILWALID                                                          = 0x4922,
        LW_CERT30_SELWRITY_ZONE_KEY_SELECT_ILWALID                                                    = 0x4923,
        LW_CERT30_OPROM_SIGNATURE_ILWALID                                                             = 0x4924,
        LW_CERT30_CERT_EXT_HEADER_ILWALID                                                             = 0x4925,
        LW_CERT30_VENDOR_GET_EXTENSION_FAIL                                                           = 0x4926,
        LW_CERT30_MASTER_GET_EXTENSION_FAIL                                                           = 0x4927,
        LW_CERT30_VENDOR_EXTENSION_NP_OFFSET_ILWALID                                                  = 0x4928,
        LW_CERT30_MASTER_EXTENSION_NP_OFFSET_ILWALID                                                  = 0x4929,
        LW_CERT30_VENDOR_EXTENSION_VENDOR_NAME_OFFSET_ILWALID                                         = 0x492A,
        LW_CERT30_VENDOR_EXTENSION_VENDOR_NAME_SIZE_ILWALID                                           = 0x492B,
        LW_CERT30_VENDOR_EXTENSION_GPU_ID_OFFSET_ILWALID                                              = 0x492C,
        LW_CERT30_VENDOR_EXTENSION_GPU_ID_ILWALID                                                     = 0x492D,
        LW_CERT30_ROM_DIRECTORY_HASH_MISMATCH                                                         = 0x492E,
        LW_CERT30_VDPA_INT_BLK_HASH_MISMATCH                                                          = 0x492F,
        LW_CERT30_VDPA_INT_BLK_ENTRY_OFFSET_ILWALID                                                   = 0x4930,
        LW_CERT30_VDPA_INT_BLK_SIZE_ILWALID                                                           = 0x4931,
        LW_CERT30_VDPA_INT_FMT_SIZE_ILWALID                                                           = 0x4932,
        LW_CERT30_VDPA_INT_FMT_HASH_MISMATCH                                                          = 0x4933,
        LW_CERT30_CERT_HEADER_FLAG_ILWALID                                                            = 0x4934,
        LW_CERT30_CERT_TYPE_MISMATCH_WITH_HEADER                                                      = 0x4935,
        LW_CERT30_FIRST_CERT_TYPE_ILWALID                                                             = 0x4936,
        LW_CERT30_SECOND_CERT_TYPE_HEADER_MAIN_STRUCT_MISMATCH                                        = 0x4937,
        LW_CERT30_SECOND_CERT_TYPE_ILWALID                                                            = 0x4938,
        LW_CERT30_DUPLICATE_CERT_FOUND                                                                = 0x4939,
        LW_CERT30_NO_VALID_SEC_ZONE_FOUND                                                             = 0x493A,
        LW_CERT30_SEC_ZONE_NOT_FOUND                                                                  = 0x493B,
        LW_CERT30_INT_BLK_ENTRY_NOT_FOUND                                                             = 0x493C,
        LW_CERT30_INT_BLK_ENTRY_VALID_SEC_ZONE_NOT_FOUND                                              = 0x493D,
        LW_CERT30_INT_FMT_ENTRY_NOT_FOUND                                                             = 0x494E,
        LW_CERT30_THIRD_CERT_HEADER_FLAG_ILWALID                                                      = 0x494F,
        LW_CERT30_VENDOR_CERT_SIZE_OVERFLOW                                                           = 0x4950,
        LW_CERT30_MASTER_CERT_SIZE_OVERFLOW                                                           = 0x4951,
        LW_CERT30_UEFI_EXTENSION_NP_OFFSET_ILWALID                                                    = 0x4952,
        LW_CERT30_ILWALID_SEC_ZONE_BUFFER_SIZE                                                        = 0x4953,
        LW_CERT30_ILWALID_UCODE_REVISION                                                              = 0x4954,

        /*********  Values 0x4A00 to 0x4AFF are reserved for fub error codes.                         *********/
        /*********  These values will be written to Falcon MAILBOX1 15:0                              *********/
        LW_FUB_ERR_ILWALID_DEVID                                                                      = 0x4A00,
        LW_FUB_ERR_FUSE_ALREADY_BLOWN                                                                 = 0x4A01,
        LW_FUB_ERR_BAD_VOLTAGE                                                                        = 0x4A02,
        LW_FUB_ERR_ILWALID_REV                                                                        = 0x4A03,

        /*********  Values 0x4B00 to 0x4CFF are reserved for LWFlash error codes.                     *********/
        LW_LWFLASH_ERROR_RFFS_ILWALID_LEDGER_DATA                                                     = 0x4B00,

        /*********  Values 0x4D00 to 0x4DFF are reserved for InfoROM ParaVirtualization error codes.  *********/
        LW_IPV_ACTIVATELIB_IPV_TOKEN_SIGNATURE_ILWALID                                                = 0x4D00,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_GPU_GUID_ILWALID                                                 = 0x4D01,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_TOKENID_ILWALID                                                  = 0x4D02,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_VERSION_ILWALID                                                  = 0x4D03,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_SEQUENCE_ILWALID                                                 = 0x4D04,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_STATE_DISABLED                                                   = 0x4D05,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_SIZE_ILWALID                                                     = 0x4D06,
        LW_IPV_ACTIVATELIB_IPV_TOKEN_STATE_ILWALID                                                    = 0x4D07,
        LW_IPV_BOOTLIB_EXELWTION_NOT_ALLOWED                                                          = 0x4D08,
        LW_IPV_BOOTLIB_MUTEX_ACQUIRE_RELEASE_ERROR                                                    = 0x4D09,
        LW_IPV_BOOTLIB_SKU_UNSUPPORTED                                                                = 0x4D0A,
        LW_IPV_BOOTLIB_MLW_SCRATCH_READ_FAILED                                                        = 0x4D0B,
        LW_IPV_BOOTLIB_MLW_SCRATCH_ILWALID                                                            = 0x4D0C,
...
#define LW_UCODE_FOOTNOTE_GP_BUFFER_ALLOCATION_FAILED_SOURCE_VBIOS_SIG_VERIF                               98
#define LW_UCODE_FOOTNOTE_GP_BUFFER_ALLOCATION_FAILED_SOURCE_IST_SIG_VERIF                                 99
...
#define LW_UCODE_FOOTNOTE_GP_BUFFER_TAKE_FAILED_SOURCE_PARSECERT_INST1                                     90
...
// footnote for below error code:
//     LW_UCODE_ERR_CODE_PUSHPOLL_ILWALID_STATE
//     LW_UCODE_ERR_CODE_PUSHPOLL_WRITE_PAYLOAD_TIMEOUT
//     LW_UCODE_ERR_CODE_PUSHPOLL_READ_PAYLOAD_TIMEOUT
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_MODE                                                     3:0
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_MODE_WRITE_PAYLOAD                                       1
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_MODE_READ_PAYLOAD                                        2
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_STATE                                                    7:4
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_STATE_ONE_OF_INIT_STATE_FOR_MODE_WRITE_PAYLOAD           1
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_STATE_ONE_OF_CLOSING_STATE_FOR_MODE_WRITE_PAYLOAD        2
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_STATE_ONE_OF_INIT_STATE_FOR_MODE_READ_PAYLOAD            3
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_STATE_ONE_OF_CLOSING_STATE_FOR_MODE_READ_PAYLOAD         4
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_EXPECTING_PAYLOAD_STATE                                            15:8

#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_SAVED_MODE                                                         17:16
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_SAVED_STATE                                                        22:20
#define LW_UCODE_FOOTNOTE_PUSHPOLL_ILWALID_STATE_SAVED_PAYLOAD_STATE                                                31:24

// footnote for below error code:
//     LW_UCODE_ERR_CODE_PUSHPOLL_PAYLOAD_BUFFER_UNDER_SIZE
//     LW_UCODE_ERR_CODE_PUSHPOLL_PAYLOAD_COMMAND_ILWALID
#define LW_UCODE_FOOTNOTE_PUSHPOLL_PAYLOAD_BUFFER_UNDER_SIZE_COMMAND                                                15:0

// footnote for below error code:
//     LW_UCODE_ERR_CODE_CERT_HULK_DATA_BUFFER_TOO_SMALL
#define LW_UCODE_FOOTNOTE_CERT_HULK_DATA_BUFFER_TOO_SMALL_SOURCE                                                    7:0
#define LW_UCODE_FOOTNOTE_CERT_HULK_DATA_BUFFER_TOO_SMALL_SOURCE_ENG_HULK                                             1
#define LW_UCODE_FOOTNOTE_CERT_HULK_DATA_BUFFER_TOO_SMALL_SOURCE_BCRT                                                 2

// footnote for below error code:
//   LW_UCODE_ERR_CERT_EXTENSION_LINKED_LIST_OUTOF_BOUNDARY
//   LW_UCODE_ERR_CODE_CERT_EXTENSION_LINKED_LIST_OUTOF_BOUNDARY,
#define LW_UCODE_FOOTNOTE_CERT_EXTENSION_LINKED_LIST_OUTOF_BOUNDARY_GETEXTENSION                                      1
#define LW_UCODE_FOOTNOTE_CERT_EXTENSION_LINKED_LIST_OUTOF_BOUNDARY_GETNEXTEXTENSION                                  2

// footnote for below error code:
//    LW_UCODE_ERR_CERT_EXTENSION_LINKED_LIST_WRONG_PREV_NODE_POINTER
//    LW_UCODE_ERR_CODE_CERT_EXTENSION_LINKED_LIST_WRONG_PREV_NODE_POINTER
#define LW_UCODE_FOOTNOTE_CERT_EXTENSION_LINKED_LIST_WRONG_PREV_NODE_POINTER_GETEXTENSION                             1
#define LW_UCODE_FOOTNOTE_CERT_EXTENSION_LINKED_LIST_WRONG_PREV_NODE_POINTER_GETNEXTEXTENSION                         2

//  footnote for below error code:
//     LW_UCODE_ERR_CODE_HW_SHA_TIMEOUT
#define LW_UCODE_FOOTNOTE_HW_SHA_TIMEOUT_SHA_STATUS                                                          7:0  // holds the value of _SHA_STATUS register
#define LW_UCODE_FOOTNOTE_HW_SHA_TIMEOUT_INSTANCE                                                            15:8 // holds the value of calling instance

//  footnote for below error code:
//     LW_UCODE_ERR_CODE_HW_SHA_ERROR
#define LW_UCODE_FOOTNOTE_HW_SHA_ERROR_ERR_STATUS                                                            15:0  // holds the value of _SHA_STATUS register
#define LW_UCODE_FOOTNOTE_HW_SHA_ERROR_INSTANCE                                                              23:16 // holds the value of calling instance

#endif // _UCODE_POSTCODES_H_

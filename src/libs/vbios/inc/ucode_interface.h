...
// UCODE IDs
// IDs for HS ucodes that only support debug-fused parts
#define FALC_UCODE_APP_ID_DEVINIT_ENGINE_GC6_DBG         0x42
#define FALC_UCODE_APP_ID_DEVINIT_COMPACT_DBG            0x43
#define FALC_UCODE_APP_ID_FWSEC_DBG                      0x45
#define FALC_UCODE_APP_ID_HULK_DBG                       0x49

// IDs for HS ucodes that only support prod-fused parts
#define FALC_UCODE_APP_ID_DEVINIT_ENGINE_GC6_PROD        0x82
#define FALC_UCODE_APP_ID_DEVINIT_COMPACT_PROD           0x83
#define FALC_UCODE_APP_ID_FWSEC_PROD                     0x85
#define FALC_UCODE_APP_ID_HULK_PROD                      0x89
...
#define  FALC_UCODE_APP_ID_IMAGESELECT           0x0A
#define  FALC_UCODE_APP_ID_UNITTEST              0x0B
#define  FALC_UCODE_APP_ID_AUTOBOOT              0x0C
#define  FALC_UCODE_APP_ID_FUSEREWORK            0x0D
#define  FALC_UCODE_APP_ID_AWS_SANITY            0x0E
#define  FALC_UCODE_APP_ID_BOOTSTRAP             0x0F
#define  FALC_UCODE_APP_ID_SKATE_CHECKOUT        0x10
#define  FALC_UCODE_APP_ID_SWITCHBOOT            0x11
#define  FALC_UCODE_APP_ID_FUB                   0x12
#define  FALC_UCODE_APP_ID_IPV_ACTIVATE          0x13
#define  FALC_UCODE_APP_ID_IPV_BOOT              0x14
...
#define LW_DMEMMAPPER_UCODE_FEATURE_FOOTNOTE_CODE       5:5    //
#define LW_DMEMMAPPER_UCODE_FEATURE_FOOTNOTE_CODE_YES     1    // Foot note code supported
#define LW_DMEMMAPPER_UCODE_FEATURE_FOOTNOTE_CODE_NO      0    // Foot note code not supported
#define LW_DMEMMAPPER_UCODE_FEATURE_ENCRYPTION          6:6    //
#define LW_DMEMMAPPER_UCODE_FEATURE_ENCRYPTION_YES        1    // uCode Encryption enabled
#define LW_DMEMMAPPER_UCODE_FEATURE_ENCRYPTION_NO         0    // uCode Encryption not enabled
#define LW_DMEMMAPPER_UCODE_FEATURE_PUSHPOLL            9:7    // Bi-Directional Push-Poll version
#define LW_DMEMMAPPER_UCODE_FEATURE_PUSHPOLL_ILWALID_VERSION 7 // Invalid version number
#define LW_DMEMMAPPER_UCODE_FEATURE_PUSHPOLL_V2           1    // Version 2, utilizes _QUEUE_HEAD/TAIL registers
#define LW_DMEMMAPPER_UCODE_FEATURE_PUSHPOLL_V1           0    // Version 1, utilizes _PPWR_PMU_MAILBOX registers
...
struct FALCON_REGISTER_MAP_INT        // Registers used in uCode
{
        ...
        LwU32 ptimer0;
        LwU32 ptimer1;
#if FALC_UCODE_APP_ID == FALC_UCODE_APP_ID_LWFLASH
        LwU32 mailboxIdx0;
        LwU32 cpuctl;
        LwU32 scpCtlDebug;
#endif
...
// From bios.h
// https://confluence.lwpu.com/display/GFWT/Redundant+Firmware%3A+Design#RedundantFirmware:Design-ROMDirectory
// Version 0x0001 and 0x0002 share same format of this struct.
// ROM file build with version 0x0002 is the redundant firmware readiness image.
typedef struct LW_ROM_DIRECTORY_V1
{
    LwU32   identifier;         // "RFRD"
    LwU16   version;            // ROM Directory Structure Version
    LwU16   structSize;         // Size of ROM Directory Structure
    LwU32   opRomOffset;        // PCI Option ROM Offset
    LwU32   opRomSize;          // PCI Option ROM Size
    LwU32   infoRomOffset;      // InfoROM Offset
    LwU32   infoRomSize;        // InfoROM Size
    LwU32   blOffset;           // Bootloader Ucode Offset
    LwU32   secBase;            // Secondary Base
} LWROMDirectoryV1, *LWROMDirectoryV1Ptr;

#define LW_ROM_DIRECTORY_IDENTIFIER     0x44524652  // "RFRD"
#define LW_ROM_DIRECTORY_SIGNATURE_SIZE         16

#define LW_ROM_DIRECTORY_VER_1              0x0001  // version 0x0001
#define LW_ROM_DIRECTORY_VER_2              0x0002  // version 0x0002 assigned for RFW candidate image

#ifndef BYTES_PER_SECTOR
#define BYTES_PER_SECTOR        ( 4 << 10 )
#endif  // BYTES_PER_SECTOR

#define FLASH_STATUS_ENTRY_MAX_COUNT    BYTES_PER_SECTOR / sizeof( LW_RFW_FS_ENTRY_V1 )

#define LW_RFW_FS_ENTRY_FLAGS_CLEAN                             0:0
#define LW_RFW_FS_ENTRY_FLAGS_CLEAN_TRUE                        0x1
#define LW_RFW_FS_ENTRY_FLAGS_CLEAN_FALSE                       0x0
#define LW_RFW_FS_ENTRY_UPDATESTATUS_PRI_PART_START             0:0
#define LW_RFW_FS_ENTRY_UPDATESTATUS_PRI_PART_START_NO          0x1
#define LW_RFW_FS_ENTRY_UPDATESTATUS_PRI_PART_START_YES         0x0
#define LW_RFW_FS_ENTRY_UPDATESTATUS_PRI_PART_END               1:1
#define LW_RFW_FS_ENTRY_UPDATESTATUS_PRI_PART_END_NO            0x1
#define LW_RFW_FS_ENTRY_UPDATESTATUS_PRI_PART_END_YES           0x0
#define LW_RFW_FS_ENTRY_UPDATESTATUS_SEC_PART_START             2:2
#define LW_RFW_FS_ENTRY_UPDATESTATUS_SEC_PART_START_NO          0x1
#define LW_RFW_FS_ENTRY_UPDATESTATUS_SEC_PART_START_YES         0x0
#define LW_RFW_FS_ENTRY_UPDATESTATUS_SEC_PART_END               3:3
#define LW_RFW_FS_ENTRY_UPDATESTATUS_SEC_PART_END_NO            0x1
#define LW_RFW_FS_ENTRY_UPDATESTATUS_SEC_PART_END_YES           0x0
...
#define LW_IN_CMD_RRD_FLAG_BUS_TYPE                7:0   // Indicate register bus type
#define LW_IN_CMD_RRD_FLAG_BUS_TYPE_PRIV             0   // Register need to access throgh PRIV bus
#define LW_IN_CMD_RRD_FLAG_BUS_TYPE_CSB              1   // Register need to access throgh CSB bus
 ...
 *
 */
#define LW_IN_CMD_RWR_FLAG_BUS_TYPE                7:0   // Indicate register bus type
#define LW_IN_CMD_RWR_FLAG_BUS_TYPE_PRIV             0   // Register need to access throgh PRIV bus
#define LW_IN_CMD_RWR_FLAG_BUS_TYPE_CSB              1   // Register need to access throgh CSB bus
typedef struct {
        LwU32 regAddress;
        LwU32 regVal;
        LwU32 flag;
...
typedef struct {
        ...
        LwU32 u32UtcTimeNsLo;   // Lower 32 bit of UTC (Unix timestamps) (ns) for ptimer init
        LwU32 u32UtcTimeNsHi;   // Higher 32 bit of UTC (Unix timestamps) (ns) for ptimer init
...
//
// Push-Poll defines
//  https://wiki.lwpu.com/engwiki/index.php/VBIOS/Security/Various_Selwrity_Topics/Push_Poll_Cycle
//

//
// Payload Command related defines and structures
//   Note:  Payload Commands are sent by uCode to Lwflash CPU side of code for various data exchange tasks,
//          typically while uCode is running at HS mode
//
//          Each Payload has 2 or 3 parts:
//             1.  PUSHPOLL_PAYLOAD_HEADER_S structure.  Starting at offset 0 of data buffer the LWFLASH allocated to
//                                                       store payload from uCode. payload command is in this structure
//             2.  PUSHPOLL_PAYLOAD_CMD Stucture.        This should be a small structure, with variable size.
//                                                       It contains the parameters for the command
//             3.  Payload data                          This portion contains the data for exchanging between Lwfalsh uCode and main CPU side
//                                                       its presence, content and size are payload command dependent
//
//
//
//         For security, only uCode can initiate a Payload command.
//         Data retrieved by uCode from Lwflash CPU side is subject to security verification.
//

// Payload Header Structure
#define LW_UCODE_PUSHPOLL_PAYLOAD_HEADER_VERSIZE_VER      7:0            // Payload Header Version field
#define LW_UCODE_PUSHPOLL_PAYLOAD_HEADER_VERSIZE_VER_1      1            // Payload Header Version 1
#define LW_UCODE_PUSHPOLL_PAYLOAD_HEADER_VERSIZE_SIZE    15:8            // Payload Header Size field,  with size of _PAYLOAD_HEADER_S
typedef struct {
    LwU32      verSize;            // version and size of this structure
    LwU32      payloadCmd;         // Command that uCode send to Lwflash CPU code
    LwU32      payloadSize;        // Entire payload size
                                   //   Note: for _MODE_WRITE_PAYLOAD,  this member has the size of sum of _PAYLOAD_HEADER_S, _PAYLOAD_CMD_xxx and Payload data
                                   //         for _MODE_READ_PAYLOAD,   this member has the size of sum of _PAYLOAD_HEADER_S, _PAYLOAD_CMD_xxx.
                                   //            size of Payload data replied by Lwflash CPU is not included in this field, instead, it could be specified in struct _PAYLOAD_CMD_xxx
    LwU32      reserved;           // Reserved field
} PUSHPOLL_PAYLOAD_HEADER_S, *PUSHPOLL_PAYLOAD_HEADER_SPTR;

#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH                   1      // Send with _MODE_WRITE_PAYLOAD, for patching data from uCode into VBIOS image at main CPU size
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR                 2      // Send with _MODE_READ_PAYLOAD, for getting an ROM Direcroty from CPU side


//
// PUSHPOLL_PAYLOAD_CMD_xxx Stuctures
//   Note: 1. Each payload command should has its own PUSHPOLL_PAYLOAD_CMD_ structure. This payload command structure will be immediately follow the Payload Header Structure - PUSHPOLL_PAYLOAD_HEADER_S
//         2. size of PUSHPOLL_PAYLOAD_CMD_xxx Stucture should be less than LW_UCODE_PUSHPOLL_PAYLOAD_CMD_MAX_SIZE
//
#define  LW_UCODE_PUSHPOLL_PAYLOAD_CMD_MAX_SIZE                 128

// Command LW_UCODE_PUSHPOLL_PAYLOAD_COMMAND_DATA_SCRATCH  related structure and defines
//  Brief:  This payload command is a uCode write command.
//          uCode usees this command to patche a data blob from uCode into VBIOS image in main CPU side of Lwflash buffer
//
//          The data blob for this payload with size that specified in member size of PUSHPOLL_PAYLOAD_CMD_VB_PATCH_S is immediately followed after struct PUSHPOLL_PAYLOAD_CMD_VB_PATCH_S
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_VERSIZECMD_VER            7:0          // Version field
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_VERSIZECMD_VER_1          1            // Version 1
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_VERSIZECMD_SIZE           15:8         // This structure size
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_VERSIZECMD_CMD            31:16        // Should always have value  LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH.  It is used by SW to confirm the command and structure
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_VBIOSOBJECTTYPE_ROMDIR    1            // ROM Directory
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_FLAG_IFR                  0:0          // Specify if vbiosImageOffset is offset from IFR or VBIOS image
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_FLAG_IFR_NO               0            // vbiosImageOffset is not for IFR, it is for VBIOS image
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_VB_PATCH_FLAG_IFR_YES              1            // vbiosImageOffset is a IFR offset
typedef struct {
    LwU32      verSizeCmd;         // with version, size of this structure,  and payload command confirmation
    LwU32      vbiosObjectType;    // VBIOS image object type for the patching data
    LwU32      vbiosObjectType1;   // VBIOS image object type for the patching data.  Lwrrently Reserved
    LwU32      vbiosImageOffset;   // VBIOS image offset to patch the data.  Note: only used when Lwflash cannot correct locate data object offset in VBIOS using vbiosObjectType
    LwU32      size;               // Size of VBIOS image data blob in payload located right after this structure. The size of structure itself is not included
    LwU32      flag;               // arbitrary modifiers
}PUSHPOLL_PAYLOAD_CMD_VB_PATCH_S, *PUSHPOLL_PAYLOAD_CMD_VB_PATCH_SPTR;

// Command LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR related structure and defines
//  Brief:  This payload command is a uCode read command.
//          uCode usees this command to read an ROM Directory from main CPU side of Lwflash buffer
//
//          The data blob for this payload with size that specified in member size of PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_S is immediately followed after struct PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_S
//          This data blob should be the ROM Directory LWFlash retrived and send back to uCode
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_VERSIZECMD_VER      7:0            // Version field
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_VERSIZECMD_VER_1      1            // Version 1
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_VERSIZECMD_SIZE    15:8            // This structure size
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_VERSIZECMD_CMD     31:16           // Should always have value  LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR.  It is used by SW to confirm the command and structure
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_FLAG_SOURCE         3:0            // Specify if vbiosImageOffset is offset from IFR or VBIOS image
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_FLAG_SOURCE_IMAGE     0            // Getting ROM Directory from VBIOS ROM
#define LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_FLAG_SOURCE_LWF       1            // Getting ROM Directory from LWFLash.  This ROM Direcroty should be an updated version, and not the original one in VBIOS image
typedef struct {
    LwU32      verSizeCmd;         // with version, size of this structure,  and payload command confirmation
    LwU32      size;               // Estimated size of updated ROM Direcroy,  which uCode expecting Lwflash will send back
    LwU32      flag;               // arbitrary modifiers
}PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_S, *PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR_SPTR;

//  Structures for payload data for different Commands:

#define LW_UCODE_PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_FLAG_ROM_DIR_VALID              0:0
#define LW_UCODE_PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_FLAG_ROM_DIR_VALID_NO             0
#define LW_UCODE_PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_FLAG_ROM_DIR_VALID_YES            1

#define LW_UCODE_PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_FLAG_UPDATED_ROM_DIR            1:1
#define LW_UCODE_PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_FLAG_UPDATED_ROM_DIR_NO           0
#define LW_UCODE_PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_FLAG_UPDATED_ROM_DIR_YES          1

// command LW_UCODE_PUSHPOLL_PAYLOAD_CMD_GET_ROMDIR struct for payload
typedef struct {
    LwU32              romDirOffset;
    LwU32              flag;
    LWROMDirectoryV1   romDir;
    LwU8               romDirSig[32];
} PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_S, *PUSHPOLL_PAYLOAD_GET_ROMDIR_PAYLOAD_SPTR;


// Push-Poll Cycle Defines
// Use PMU_MAILBOX(i) (i=0~11) for image block data feeding
// Note: We have total 12 Mailbox registers, we used one register ( _MAILBOX(11) )  for CTRL0,  the rest of 11 registers is used for dataline
#define LW_UCODE_PUSHPOLL_CTL0_OFFSET                               19:0        // used by _MODE_READ.  Other _MODE_XXX overloads this field
#define LW_UCODE_PUSHPOLL_CTL0_OFFSET_INIT                          0x00000000

#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE                        7:0         // used by _MODE_WRITE_PAYLOAD and _MODE_READ_PAYLOAD,  Other _MODE_XXX overloads this field
// States for _MODE_WRITE_PAYLOAD
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_INIT                   0x00000000  // INIT state,  no payload activity
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_LWF_RCV_PENDING        0x00000001  // LWF Data recerving pending            -- Lwflash set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_LWF_RCV_COMPLETE       0x00000002  // LWF Complete read data from data line -- Lwflash set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_LWF_DLV_PENDING        0x00000003  // LWF Data sending pending              -- Lwflash set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_LWF_DLV_COMPLETE       0x00000004  // LWF Complete write Data to data line  -- Lwflash set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_UCODE_RCV_PENDING      0x00000005  // UCODE Receiving data pending          -- uCode set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_UCODE_RCV_COMPLETE     0x00000006  // UCODE Complete read from data line    -- uCode set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_UCODE_DLV_PENDING      0x00000007  // UCODE Deliver pending                 -- uCode set this state
#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_STATE_UCODE_DLV_COMPLETE     0x00000008  // UCODE Complete write to data line     -- uCode set this state

#define LW_UCODE_PUSHPOLL_CTL0_PAYLOAD_DATALINE_SIZE                25:8        // data line size used by _MODE_WRITE_PAYLOAD and _MODE_READ_PAYLOAD

#define LW_UCODE_PUSHPOLL_CTL0_SIZE                                 25:20       // data line size used by _MODE_READ
#define LW_UCODE_PUSHPOLL_CTL0_SIZE_INIT                            0x00000000

#define LW_UCODE_PUSHPOLL_CTL0_MODE                                 27:26
#define LW_UCODE_PUSHPOLL_CTL0_MODE_INIT                            0x00000000  // Initial Mode
#define LW_UCODE_PUSHPOLL_CTL0_MODE_READ                            0x00000000  // Read VBIOS image data from Lwflash buffer
#define LW_UCODE_PUSHPOLL_CTL0_MODE_WRITE_PAYLOAD                   0x00000001  // uCode Write payload data to Lwflash buffer. uCode set this mode
#define LW_UCODE_PUSHPOLL_CTL0_MODE_READ_PAYLOAD                    0x00000002  // uCode Read payload data from CPU side of Lwflash. uCode set this mode
#define LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET                        28:28
#define LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET_INIT                   0x00000000
#define LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET_TRUE                   0x00000001  // Data offset into IFR image
#define LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET_FALSE                  0x00000000  // Data offset into normal rom image
#define LW_UCODE_PUSHPOLL_CTL0_STATE                                31:29       // Push Poll cycle status: 0x00 ~ 0x07
// States for _MODE_*  ( All Supported Modes )
#define LW_UCODE_PUSHPOLL_CTL0_STATE_INIT                           0x00000000  // Initial state
#define LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_REQ                      0x00000001  // uCode initialize a push poll cycle  -- uCode set this state
#define LW_UCODE_PUSHPOLL_CTL0_STATE_COMPLETE                       0x00000006  // All Push Poll Cycles completed.     -- uCode set this state

// States used by _MODE_READ only
#define LW_UCODE_PUSHPOLL_CTL0_STATE_LWF_DLV_PENDING                0x00000002  // LWF Data Delivery pending           -- Lwflash set this state
#define LW_UCODE_PUSHPOLL_CTL0_STATE_LWF_DLV_COMPLETE               0x00000003  // LWF Complete Copy Data to Scratches -- Lwflash set this state
#define LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_RCV_PENDING              0x00000004  // UCODE Service pending               -- uCode set this state
#define LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_RCV_COMPLETE             0x00000005  // UCODE Service Complete              -- uCode set this state

// States used by _MODE_WRITE_PAYLOAD and _MODE_READ_PAYLOAD
#define LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_PAYLOAD_COMPLETE         0x00000002  // UCODE Completes a section of payload write in _WRITE_PAYLOAD mode     -- uCode set this state
                                                                                // UCODE Completes a section of payload wrtie in _READ_PAYLOAD mode      -- uCode set this state
                                                                                //   Note: One good exmaple of a section of payload could be strlwt PUSHPOLL_PAYLOAD_HEADER_S.
                                                                                //         uCode always start the pushpoll payload cycle by sending a PUSHPOLL_PAYLOAD_HEADER_S first
#define LW_UCODE_PUSHPOLL_CTL0_STATE_LWF_REQ                        0x00000003  // LWFLASH initialize a push poll cycle to send back data uCode requested -- Lwflash set this state
                                                                                //   Note: only used in _READ_PAYLOAD mode
#define LW_UCODE_PUSHPOLL_CTL0_STATE_LWF_PAYLOAD_COMPLETE           0x00000004  // LWFLASH Completes the payload read in  _WRITE_PAYLOAD mode             -- Lwflash set this state
                                                                                // LWFLASH Completes the payload write    _READ_PAYLOAD mode              -- Lwflash set this state

#define LW_UCODE_PUSHPOLL_CTL0_STATE_NO_CHANGE_CONSTANT             0x0000ffff  // this constant is used to signature no change for the state. It is used in internal routines, but not used during actual communication
//
// Keep defines with PushPull name for backward compatibility.  They are used from Maxwell to Volta.
//
#define LW_UCODE_PUSHPULL_DATA_SCRATCH                      LW_PPWR_PMU_MAILBOX
#define LW_UCODE_PUSHPULL_DATA_SCRATCH_COUNT                ( LW_PPWR_PMU_MAILBOX__SIZE_1 - 1 )

#define LW_UCODE_PUSHPULL_CTL0                              LW_PPWR_PMU_MAILBOX(11)
#define LW_UCODE_PUSHPULL_CTL0_OFFSET                       LW_UCODE_PUSHPOLL_CTL0_OFFSET
#define LW_UCODE_PUSHPULL_CTL0_OFFSET_INIT                  LW_UCODE_PUSHPOLL_CTL0_OFFSET_INIT
#define LW_UCODE_PUSHPULL_CTL0_SIZE                         LW_UCODE_PUSHPOLL_CTL0_SIZE
#define LW_UCODE_PUSHPULL_CTL0_SIZE_INIT                    LW_UCODE_PUSHPOLL_CTL0_SIZE_INIT
#define LW_UCODE_PUSHPULL_CTL0_IS_IFR_OFFSET                LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET
#define LW_UCODE_PUSHPULL_CTL0_IS_IFR_OFFSET_INIT           LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET_INIT
#define LW_UCODE_PUSHPULL_CTL0_IS_IFR_OFFSET_TRUE           LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET_TRUE
#define LW_UCODE_PUSHPULL_CTL0_IS_IFR_OFFSET_FALSE          LW_UCODE_PUSHPOLL_CTL0_IS_IFR_OFFSET_FALSE
#define LW_UCODE_PUSHPULL_CTL0_STATE                        LW_UCODE_PUSHPOLL_CTL0_STATE
#define LW_UCODE_PUSHPULL_CTL0_STATE_INIT                   LW_UCODE_PUSHPOLL_CTL0_STATE_INIT
#define LW_UCODE_PUSHPULL_CTL0_STATE_UCODE_REQ              LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_REQ
#define LW_UCODE_PUSHPULL_CTL0_STATE_LWF_DLV_PENDING        LW_UCODE_PUSHPOLL_CTL0_STATE_LWF_DLV_PENDING
#define LW_UCODE_PUSHPULL_CTL0_STATE_LWF_DLV_COMPLETE       LW_UCODE_PUSHPOLL_CTL0_STATE_LWF_DLV_COMPLETE
#define LW_UCODE_PUSHPULL_CTL0_STATE_UCODE_RCV_PENDING      LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_RCV_PENDING
#define LW_UCODE_PUSHPULL_CTL0_STATE_UCODE_RCV_COMPLETE     LW_UCODE_PUSHPOLL_CTL0_STATE_UCODE_RCV_COMPLETE
#define LW_UCODE_PUSHPULL_CTL0_STATE_COMPLETE               LW_UCODE_PUSHPOLL_CTL0_STATE_COMPLETE
#define LW_UCODE_PUSHPULL_CTL0_STATE_DEVINIT_INFO_REQ       0x00000007

#define PUSHPULL_CPU_SIDE_BUFFER_SIZE                       20*1024     // This define is used to statically allocate a buffer used for
                                                                        // PUSHPOLL_PAYLOAD commands on main CPU side of LWFLASH
...
#define  LW_LWF_VDPA_DATA_BUFFER_SIZE           6*1024  // used for VDPA table,  include header, and signature
...
//This macro is for mapping SE lib error codes to LW_UCODE_UNIFIED_ERROR_TYPE
//This should only be used for SE lib function calls
#define SE_LIB_ASSERT_OK_OR_EXIT( function ) \
        do \
        { \
            SE_STATUS status; \
            status = function; \
            if( status != SE_OK ) \
            { \
                errCode = (LW_UCODE_UNIFIED_ERROR_TYPE)(status + LW_UCODE_ERR_SE_LIB_ERR_CODE_ENUM_BASE_VAL); \
                goto exitPoint; \
            } \
        } while(0)
...
// ucodes besides FWSEC don't have footnotes
// for shared code, just ignore the footnote part
#if FALC_UCODE_APP_ID == FALC_UCODE_APP_ID_FW_SEC_LIC
...
#define ASSERT_OK_OR_EXIT_FWSECLIC_FN( function, footnote ) \
    ...
    { \
        ...
        if( errCode != LW_UCODE_ERR_CODE_NOERROR ) \
        { \
            extern LwU32 fwseclic_footnote_code; \
            fwseclic_footnote_code = footnote; \
            goto exitPoint; \
        } \
    } while(0)

#define EXIT_POINT_ASSERT_OK_OR_REPORT_ERROR_FWSEC_FN( function, footnote ) \
    do \
    { \
        errCodeExitPoint = function; \
        if( ( errCodeExitPoint != LW_UCODE_ERR_CODE_NOERROR ) && ( errCode == LW_UCODE_ERR_CODE_NOERROR ) ) \
...
#define ASSERT_OK_OR_EXIT_FWSECLIC_FN( function, footnote ) ASSERT_OK_OR_EXIT( function )

#define EXIT_POINT_ASSERT_OK_OR_REPORT_ERROR_FWSEC_FN( function, footnote ) EXIT_POINT_ASSERT_OK_OR_REPORT_ERROR( function )

#endif // FALC_UCODE_APP_ID == FALC_UCODE_APP_ID_FW_SEC_LIC

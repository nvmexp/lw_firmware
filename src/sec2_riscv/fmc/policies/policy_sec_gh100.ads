...
package Policies is
    ...
    Core_Pmp_Entry_imem_shr_Start : constant Core_Pmp_Entry  := (
        Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_1000#), 2)),
        Address_Mode => OFF,
        Access_Mode => Core_Pmp_Access_Mode_None,
        Reserved => 0
    );
    ...
    Core_Pmp_Entry_imem_shr_End : constant Core_Pmp_Entry  := (
        Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_5000#), 2)),
        Address_Mode => TOR,
    ...
    Core_Pmp_Entry_dmem_shr_Start : constant Core_Pmp_Entry  := (
        Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_1000#), 2)),
        Address_Mode => OFF,
        Access_Mode => Core_Pmp_Access_Mode_None,
        Reserved => 0
    );
    ...
    Core_Pmp_Entry_dmem_shr_End : constant Core_Pmp_Entry  := (
        Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_1400#), 2)),
        Address_Mode => TOR,
        Access_Mode => Core_Pmp_Access_Mode_RW,
        Reserved => 0
    );
    ...
    Worklaunch_Core_Pmp : constant Plcy_Core_Pmp := (
        -- Shared regions
        Core_Pmp_Entry_imem_shr_Start,
        Core_Pmp_Entry_imem_shr_End,
        Core_Pmp_Entry_dmem_shr_Start,
        Core_Pmp_Entry_dmem_shr_End,
        Core_Pmp_Entry_LocalIo_Start,
        Core_Pmp_Entry_LocalIo_End,
        Core_Pmp_Entry_Pri_Start,
        Core_Pmp_Entry_Pri_End,
        Core_Pmp_Entry_print_shr_Start,
        Core_Pmp_Entry_print_shr_End,
        -- Imem
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_5000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => Core_Pmp_Access_Mode_None,
                                Reserved => 0),
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_7000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => Core_Pmp_Access_Mode_RX,
                                Reserved => 0),
        -- Dmem
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_1400#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => Core_Pmp_Access_Mode_None,
                                Reserved => 0),
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_4C00#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => Core_Pmp_Access_Mode_RW,
                                Reserved => 0),
    ...
    RTOS_Core_Pmp : constant Plcy_Core_Pmp := (
        ...
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_7000#), 2)),
                                ...
                                Access_Mode => Core_Pmp_Access_Mode_None,
                                Reserved => 0),
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0011_6000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => Core_Pmp_Access_Mode_RX,
                                Reserved => 0),
        -- Dmem
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_4C00#), 2)),
                                ...
                                Access_Mode => Core_Pmp_Access_Mode_None,
                                Reserved => 0),
        Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_7400#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => Core_Pmp_Access_Mode_RW,
                                Reserved => 0),
    ...
    Partition_ID_Worklaunch : constant Partition_ID := 1;

    -- Worklaunch partition
    P_Worklaunch_Policy : constant External_Policy := (
    ...
    P_RTOS_Policy : constant External_Policy := (
        Switchable_To       => Plcy_Switchable_To_Array'(
                                    others => PERMITTED),
        Entry_Point_Address => 16#00010_1010#,
        Ucode_Id            => 2,
        Sspm                => Plcy_SSPM'(
                                Splm => 16#5#, -- L2
                                Ssecm => SSECM_SEC),
...
-------------------------------------------------------------------------------------------------------------------------------
    External_Policies : constant External_Policy_Array := External_Policy_Array'(
        Partition_ID_Worklaunch => P_Worklaunch_Policy,

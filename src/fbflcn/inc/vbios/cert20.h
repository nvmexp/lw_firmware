...
#define BCRT20_SHA256_SIZE             32
#define BCRT20_DMHASH_SIZE             16
#define BCRT20_FLW128HASH_SIZE         16
#define BCRT20_AES128_SIZE             BCRT20_DMHASH_SIZE
#define BCRT20_3AES128_SIG_SIZE        32
#define BCRT20_RSA_MODULUS             128
#define BCRT20_RSA1K_SIG_SIZE          128
#define BCRT20_RSA2K_SIG_SIZE          256
#define BCRT20_RSA3K_MODULUS		   384
#define BCRT20_RSA3K_SIG_SIZE          384
#define BCRT20_ECC256_SIG_SIZE         32
...
#define    LW_BCRT20_TYPE_CERT_HULK                         12
...
#define    IS_TYPE_LICENSE_CERT(x) ( (x) == LW_BCRT20_TYPE_CERT_HULK )
...
#define CERT20_EXT_TYPE6_MAX_EXT_NUM                              32                              // number of ECID could one Cert have
...
typedef struct {
    LwU32      ver_size;                                              /* Version and Size field */
    LwU32      imgDevID;                                              /* DevID in VBIOS image.  Only lower 16bit used now.  */
    LwU8       buildGUID[16];                                         /* VBIOS Build GUID */
...
typedef struct {
    ...
    LwU32                   flag;               /*  With VDPA table signed, GPU rebrand enabled and etc.   */
    LwU32                   rsvd;               /*  Reserved field                           */
    BCRT2X_PROJ_ID_S        proj_id;            /*  VBIOS ROM's project id,  partner name and ODM name,  only for Cert2.0, Cert2.1. From Cert2.2, they will be move to BCRT2X_METADATA_HEADER_S  */
...
#define LW_BCRT20_VDPA_NORMAL_ENTRIES_MAX_NUMBER                             76
...
typedef  struct {
         ...
         LwU32    size;              // size of this structure
         BCRT2X_PROJ_ID_S  proj_id;  // IDs for VBIOS ROM's project,  partner and ODM
...
#define LW_BCRT2x_CERT_FLAG_FRTS_DISABLE             0:0
#define LW_BCRT2x_CERT_FLAG_FRTS_DISABLE_YES           1
#define LW_BCRT2x_CERT_FLAG_FRTS_DISABLE_NO            0


#define BCRT_FLAG_FIRST_X509       BIT(0)
#define BCRT_FLAG_LAST_X509        BIT(1)
#define BCRT_FLAG_ZBX_SIGNIN_X509  BIT(2)
#define BCRT_FLAG_SYSTEM_MASK     ( BCRT_FLAG_FIRST_X509 | BCRT_FLAG_SYSTEM_MASK | BCRT_FLAG_ZBX_SIGNIN_X509 )
...
// defines used to BIOSMOD sctipt SELWRITYZONE keyword related parameters

...
{
  my $arg = "";
  my $hdr_file = "", my $dmp_file = "", my $path_vpm = "/home/msdec/tools/falcon-gcc/Linux/080214_2243196/bin";
...
sub write_hdr
{
  ...
  print SRC_FILE ""."\n";
  print SRC_FILE ""."\n";
  print SRC_FILE "static LwU32 dmva_ucode_data_".$chip."[] = {\n";
  ...
  print SRC_FILE "// \n";
  print SRC_FILE "// \n";
  print SRC_FILE " static LwU32 dmva_ucode_header_".$chip."[] = {\n";
  my $count;

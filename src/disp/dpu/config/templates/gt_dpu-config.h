...
// each defined gpu, feature, etc, irrespective of it's enable/disable
// state.
...
#define {{$XXCFG}}_ENGINE_ENABLED(ENGINE)   ({{$XXCFG}}_ENGINE_##ENGINE    + _{{$XXCFG}}_vet(_ENGINE_ ## ENGINE))
#define {{$XXCFG}}_CLASS_ENABLED(CLSS)      ({{$XXCFG}}_CLASS_##CLSS       + _{{$XXCFG}}_vet(_CLASS_ ## CLSS))
#define {{$XXCFG}}_API_ENABLED(API)         ({{$XXCFG}}_API_##API          + _{{$XXCFG}}_vet(_API_ ## API))

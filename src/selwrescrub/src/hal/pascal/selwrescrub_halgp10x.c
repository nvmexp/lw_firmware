...
/*!
 * @file selwrescrub_halgp10x.c
 */

#define SELWRESCRUBCFG_ENGINE_SETUP      1   // pull in per-gpu engine interface's
#define SELWRESCRUBCFG_HAL_SETUP_GP10X   1   // All enabled GP10X gpus
#define SELWRESCRUBCFG_HAL_SUPPORT_GP10X 1   // not required, but keeps us honest
...
/*
#if (SELWRESCRUBCFG_CHIP_ENABLED(GP10X))
SELWRESCRUB_RC registerHalModule_GP10X(void)

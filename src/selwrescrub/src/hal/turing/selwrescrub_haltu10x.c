...
/*!
 * @file selwrescrub_haltu10x.c
 */

#define SELWRESCRUBCFG_ENGINE_SETUP      1   // pull in per-gpu engine interface's
#define SELWRESCRUBCFG_HAL_SETUP_TU10X   1   // All enabled TU10X gpus
#define SELWRESCRUBCFG_HAL_SUPPORT_TU10X 1   // not required, but keeps us honest
...
/*
#if (SELWRESCRUBCFG_CHIP_ENABLED(TU10X))
SELWRESCRUB_RC registerHalModule_TU10X(void)

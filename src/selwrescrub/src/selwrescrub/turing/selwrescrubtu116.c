...
/*!
 * @file: selwrescrubtu116.c
 * This file covers HAL for chips TU116 and TU117.
 */
/* ------------------------- System Includes -------------------------------- */
 ...
 */
LwBool
selwrescrubIsChipSupported_TU116(void)
{
 ...
 */
SELWRESCRUB_RC
selwrescrubGetSwUcodeVersion_TU116(LwU32 *pVersionSw)
{
    ...
    // WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING
    //
    // Never use "SELWRESCRUB_TU11X_UCODE_BUILD_VERSION" directly, always use the function selwrescrubGetSwUcodeVersion() to get this
    // The define is used directly here in special case where we need compile time assert instead of fetching this at run time
    //
    CT_ASSERT(SELWRESCRUB_TU116_UCODE_BUILD_VERSION + 3 < DRF_MASK(LW_PGC6_BSI_VPR_SELWRE_SCRATCH_15_SCRUBBER_BINARY_VERSION));
    CT_ASSERT(SELWRESCRUB_TU117_UCODE_BUILD_VERSION + 3 < DRF_MASK(LW_PGC6_BSI_VPR_SELWRE_SCRATCH_15_SCRUBBER_BINARY_VERSION));
    //
    // WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING
    // WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING
    //
    ...
    {
        case LW_PMC_BOOT_42_CHIP_ID_TU116:
            *pVersionSw = SELWRESCRUB_TU116_UCODE_BUILD_VERSION;
            break;
        case LW_PMC_BOOT_42_CHIP_ID_TU117:
            *pVersionSw = SELWRESCRUB_TU117_UCODE_BUILD_VERSION;
            break;
        default:

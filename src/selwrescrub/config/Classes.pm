...
#
#
# selwrescrub-config file that specifies all known classes for SELWRESCRUB applications.
#
...
# selwrescrub-config does not lwrrently manage any classes, so this list is empty.
my $classesRef = [
];

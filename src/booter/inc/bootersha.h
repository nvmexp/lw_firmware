...
#ifndef _BOOTERSHA_H_
#define _BOOTERSHA_H_
...
//
//  Although HW provide 4x32-bit registers to save message length (LW_PFALCON_FALCON_SHA_MSG_LENGTH(i)) and
//  left message length(LW_PFALCON_FALCON_SHA_MSG_LEFT(i)), the unit is bit.
//  And SW needs to update LW_PFALCON_FALCON_SHA_MSG_LEFT(i) (i = 0~3) for every task.
...
//  LW_PFALCON_FALCON_SHA_MSG_LENGTH(0) and LW_PFALCON_FALCON_SHA_MSG_LEFT(0).
...
#define SHA_SRC_CONFIG_SRC_DMEM    LW_CLWDEC_FALCON_SHA_SRC_CONFIG_SRC_DMEM
#define SHA_SRC_CONFIG_SRC_IMEM    LW_CLWDEC_FALCON_SHA_SRC_CONFIG_SRC_IMEM
#define SHA_SRC_CONFIG_SRC_FB      LW_CLWDEC_FALCON_SHA_SRC_CONFIG_SRC_FB
#endif

...
void task_init_entry(LwU64 elfPhysicalBase)
{
    ...
    LOG_INIT(LOG_LEVEL_INFO, "Queuing task1a.\n");
    libosPortSyncSend(LIBOS_SHUTTLE_DEFAULT, TASK1A_PORT, 0, 0, 0, LIBOS_TIMEOUT_INFINITE);

    LOG_INIT(LOG_LEVEL_INFO, "Queuing task1b.\n");
    libosPortSyncSend(LIBOS_SHUTTLE_DEFAULT, TASK1B_PORT, 0, 0, 0, LIBOS_TIMEOUT_INFINITE);

    LOG_INIT(LOG_LEVEL_INFO, "Queuing task2a.\n");
    libosPortSyncSend(LIBOS_SHUTTLE_DEFAULT, TASK2A_PORT, 0, 0, 0, LIBOS_TIMEOUT_INFINITE);

    LOG_INIT(LOG_LEVEL_INFO, "Queuing task2b.\n");
    libosPortSyncSend(LIBOS_SHUTTLE_DEFAULT, TASK2B_PORT, 0, 0, 0, LIBOS_TIMEOUT_INFINITE);

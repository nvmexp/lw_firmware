...
void task_init_entry(LwU64 elfPhysicalBase)
{
    ...
    construct_log_init();
    LOG_INIT(LOG_LEVEL_INFO, "One\n");
    const static __attribute__((section(".logging"))) char static_string[] = "Hello world";
    LOG_INIT(LOG_LEVEL_INFO, "One\n");
    LOG_INIT(LOG_LEVEL_INFO, "Two\n");
    LOG_INIT(LOG_LEVEL_INFO, "%s from 0_simple!\n", static_string);
    LOG_INIT(LOG_LEVEL_INFO, "Four\n");
    LOG_INIT(LOG_LEVEL_INFO, "Five\n");
}

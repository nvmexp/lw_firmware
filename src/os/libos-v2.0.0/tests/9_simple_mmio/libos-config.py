...
image(name="test.elf", sources=['task.c'])
...
memory_region(
    mapping=memory_region.APERTURE_MMIO, 
    aperture_offset=0,
    size=0x1000, 
    name="TASK_INIT_PMC_SMALL", 
    reader_list=['TASK_TEST'], 
    writer_list=['TASK_TEST'])

memory_region(
    mapping=memory_region.APERTURE_MMIO,
    virtual_address=0x0001000000000000, 
    aperture_offset=0,
    size=0x100000000000, 
    name="TASK_INIT_PMC_HUGE", 
    reader_list=['TASK_TEST'], 
    writer_list=['TASK_TEST'])

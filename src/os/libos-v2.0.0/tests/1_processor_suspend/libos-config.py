...
image(name="init.elf", sources=['task.c', 'task1A.c', '$(LIBOS_SOURCE)/lib/init_daemon.c'], preboot_init_mapped=True)
...
task(name='TASK1A', pasid='PASID_INIT', entry='task1A_entry', stack=[8192, memory_region.CACHE], waiting_on='TASK1A_PORT', randomize_initial_registers=True)

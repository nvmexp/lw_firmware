...
{
    task_state *task    = &task_state_map[gsp->xscratch];
...
static LwU64 clobbered_registers_across_ioctl(LwU64 ioctl)
{
    switch (ioctl)
    {
    case LIBOS_SYSCALL_TASK_STATE_QUERY:
        return MASK(RISCV_A0) | /* Register ilwalidated by
                                   kernel_port_copy_and_schedule_and_set_status */
               MASK(RISCV_A1) | MASK(RISCV_A2) | MASK(RISCV_A3) | MASK(RISCV_T0) | MASK(RISCV_T1);

    // We didn't come in via an ECALL
    case LIBOS_SYSCALL_ILWALID:
        return 0;
    ...
    case LIBOS_SYSCALL_PROCESSOR_SUSPEND:
        return 0;
    ...
    case LIBOS_SYSCALL_MEMORY_QUERY:
        return MASK(RISCV_A0) | /* return code */
               MASK(RISCV_A2) | /* access perms */
               MASK(RISCV_A3) | /* region base */
               MASK(RISCV_A4) | /* region size */
               MASK(RISCV_A5) | /* aperture */
               MASK(RISCV_A6);  /* physical offset w/i aperture */

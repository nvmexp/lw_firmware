...
sub write_hdr
{
  my ($hdr_file, $ucode_img, $ucode_size, $image_base, $image_name, $code_offset, $code_size) = @_;
  ...
  print SRC_FILE "};\n\n";
  print SRC_FILE "LwU32 ".$image_name."_desc[] = {\n";
  print SRC_FILE "   ".sprintf("0x%x", $code_offset).", // bsigc6setupCodeOffset\n";
  print SRC_FILE "   ".sprintf("0x%x", $code_size).", // bsigc6setupCodeSize\n";
  print SRC_FILE "};\n";
  print SRC_FILE ""."\n";

...
#define ACR_CMAC_KDF_FULL_LABEL_SIZE   (128)
...
#define ACR_RANDOM_NUM_SIZE_IN_DWORD_1    (1)
#define ACR_RANDOM_NUM_SIZE_IN_DWORD_2    (2)
...
typedef enum _def_acr_cmac_kdf_type
{
    ACR_CMAC_KDF_CODE,
    ACR_CMAC_KDF_DATA,
    ACR_CMAC_KDF_IV
...
typedef enum _def_reg_label
{
    ...
    REG_LABEL_FLCN_RESET_PRIV_LEVEL_MASK,
    REG_LABEL_FLCN_END,
#ifdef ACR_RISCV_LS
...
// Stores liblwriscv drivers Init status.
typedef struct _def_library_status_info
{
    LwBool bScpInitialized;
    LwBool bCryptoDeviceInitialized;

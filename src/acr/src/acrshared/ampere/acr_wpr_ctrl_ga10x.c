...
_acrlibLsfLsbHeaderHandler_v2(LwU32, PLSF_LSB_HEADER_V2, void *)  ATTR_OVLY(OVL_NAME);

static inline ACR_STATUS
_acrlibLsfWprHeaderHandler_v2(LwU32, PLSF_WPR_HEADER_V2, void *)  ATTR_OVLY(OVL_NAME);

static inline ACR_STATUS
_acrlibLsfSubWprHeaderHandler_v2(LwU32, PLSF_SHARED_SUB_WPR_HEADER_V2, void *) ATTR_OVLY(OVL_NAME);

static inline ACR_STATUS
_acrlibLsfUcodeDescHandler_v2(LwU32, PLSF_UCODE_DESC_V2, void *) ATTR_OVLY(OVL_NAME);

static inline ACR_STATUS
_acrlibCheckDependency_v2(PLSF_UCODE_DESC_V2 pUcodeDescV2, void *pIoBuffer) ATTR_OVLY(OVL_NAME);

static inline ACR_STATUS _acrlibLsfLsbHeaderWrapperCmdPrologue(LwU32 command,  PLSF_LSB_HEADER_WRAPPER pWrapper,
                                                               void *pIoBuffer, LwBool *pMoreProcess) ATTR_OVLY(OVL_NAME);

static inline ACR_STATUS _acrlibGetUcodeDescWrapper(PLSF_LSB_HEADER_WRAPPER pWrapper, void *pIoBuffer) ATTR_OVLY(OVL_NAME);

GCC_ATTRIB_ALWAYSINLINE()
static inline ACR_STATUS
_acrlibGetUcodeDescWrapper
(
...
)
{
    ...
    switch (pGenHeader->version)
    {
        ...
        {
           acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pLsfUcodeDescWrapper, LSF_UCODE_DESC_WRAPPER_V2_SIZE_BYTE);
        }
        break;
...
)
{
    ...
    switch (command)
    {
        ...
        {
           acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)&pLsbHeaderV2->hsFmcParams, sizeof(HS_FMC_PARAMS));
        }
        break;
#endif
        ...
        {
           acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)&pLsbHeaderV2->signature, LSF_UCODE_DESC_WRAPPER_V2_SIZE_BYTE);
        }
        break;
...
GCC_ATTRIB_ALWAYSINLINE()
static inline ACR_STATUS
_acrlibLsfLsbHeaderWrapperCmdPrologue
(
    LwU32 command,
...
)
{
    ...
    switch (command)
    {
        case LSF_LSB_HEADER_COMMAND_COPY_WRAPPER:
        {
            ...
            {
                acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pWrapper, LSF_LSB_HEADER_WRAPPER_V2_SIZE_BYTE);
        ...
        case LSF_LSB_HEADER_COMMAND_GET_UCODE_DESC_WRAPPER:
        {
            CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibGetUcodeDescWrapper(pWrapper, pIoBuffer));
            *pMoreProcess = LW_FALSE;
        }
        break;
    }
 ...
 */
ACR_STATUS
acrlibLsfLsbHeaderWrapperCtrl_GA10X
(
    LwU32 command,
    PLSF_LSB_HEADER_WRAPPER pWrapper,
    void *pIoBuffer
)
{
    ...
    CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibLsfLsbHeaderWrapperCmdPrologue(command, pWrapper, pIoBuffer, &bMoreProcess));
    ...
    if (bMoreProcess)
    {
        ...
        switch (pGenericHdr->version)
        {
            case LSF_LSB_HEADER_VERSION_2:
            {
                ...
                CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibLsfLsbHeaderHandler_v2(command, pLsbHeaderV2, pIoBuffer));
            }
            break;
 ...
 */
ACR_STATUS
acrlibLsfWprHeaderWrapperCtrl_GA10X
(
    LwU32 command,
...
)
{
    ...
    switch (pGenericHdr->version)
    {
        case LSF_WPR_HEADER_VERSION_2:
        {
            ...
            CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibLsfWprHeaderHandler_v2(command, pWprHeaderV2, pIoBuffer));
        }
        break;
...
GCC_ATTRIB_ALWAYSINLINE()
static inline ACR_STATUS
_acrlibLsfSubWprHeaderHandler_v2
(
    LwU32 command,
 ...
 */
ACR_STATUS
acrlibLsfSubWprHeaderWrapperCtrl_GA10X
(
    LwU32 command,
...
)
{
    ...
    switch (pGenericHdr->version)
    {
        case LSF_WPR_HEADER_VERSION_2:
        {
            ...
            CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibLsfSubWprHeaderHandler_v2(command, pSubWprV2, pIoBuffer));
        }
        break;
...
)
{
    ...
    switch (command)
    {
        ...
        case LSF_UCODE_DESC_COMMAND_GET_DEBUG_SIGNATURE_CODE:
        {
            ...
            {
                acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pUcodeDescV2->debugSig[LSF_UCODE_COMPONENT_INDEX_CODE],
        ...
        case LSF_UCODE_DESC_COMMAND_GET_DEBUG_SIGNATURE_DATA:
        {
            if (pUcodeDescV2->sigSize <= LSF_SIGNATURE_SIZE_MAX_BYTE &&
                pUcodeDescV2->sigSize <= ACR_LS_SIGNATURE_BUFFER_SIZE_MAX_BYTE)
            {
                acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pUcodeDescV2->debugSig[LSF_UCODE_COMPONENT_INDEX_DATA],
                                pUcodeDescV2->sigSize);
            }
            else
            {
        ...
        case LSF_UCODE_DESC_COMMAND_GET_PROD_SIGNATURE_CODE:
        {
            if (pUcodeDescV2->sigSize <= LSF_SIGNATURE_SIZE_MAX_BYTE &&
                pUcodeDescV2->sigSize <= ACR_LS_SIGNATURE_BUFFER_SIZE_MAX_BYTE)
            {
                acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pUcodeDescV2->prodSig[LSF_UCODE_COMPONENT_INDEX_CODE],
                                pUcodeDescV2->sigSize);
            }
            else
            {
        ...
        case LSF_UCODE_DESC_COMMAND_GET_PROD_SIGNATURE_DATA:
        {
            if (pUcodeDescV2->sigSize <= LSF_SIGNATURE_SIZE_MAX_BYTE &&
                pUcodeDescV2->sigSize <= ACR_LS_SIGNATURE_BUFFER_SIZE_MAX_BYTE)
            {
                acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pUcodeDescV2->prodSig[LSF_UCODE_COMPONENT_INDEX_DATA],
                               pUcodeDescV2->sigSize);
            }
            else
            {
        ...
        {
            CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibCheckDependency_v2(pUcodeDescV2, pIoBuffer));
        }
        break;
        ...
        {
            acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pUcodeDescV2->lsEncIV,
        ...
        case LSF_UCODE_DESC_COMMAND_COPY_DEPMAP_CTX:
        {
            ...
            {
                size = pUcodeDescV2->depMapCount * 8;
                acrlibMemcpy_HAL(pAcrlib, (void *)pIoBuffer, (void *)pUcodeDescV2->depMap, size);
            }
        }
        break;
 ...
 */
ACR_STATUS
acrlibLsfUcodeDescWrapperCtrl_GA10X
(
    LwU32 command,
...
)
{
    ...
    switch (pGenericHdr->version)
    {
        case LSF_WPR_HEADER_VERSION_2:
        {
            ...
            CHECK_STATUS_AND_RETURN_IF_NOT_OK(_acrlibLsfUcodeDescHandler_v2(command, pUcodeDescV2, pIoBuffer));
        }
        break;

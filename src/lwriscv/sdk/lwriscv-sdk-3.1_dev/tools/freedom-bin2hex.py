# Added by ashenfield, from https://github.com/sifive/elf2hex release 1.0.1
# requires Python version >= 3.5
# We are using this because the compiled elf2hex (from Riscv toolchain) has
# a dependency on libfesvr.so and a newer libc than what is available on LSF.
...
def colwert(bit_width, infile, outfile):
...
def main():
    parser = argparse.ArgumentParser(
        description='Colwert a binary file to a format that can be read in '
    ...
    colwert(args.bit_width, args.infile, args.outfile)

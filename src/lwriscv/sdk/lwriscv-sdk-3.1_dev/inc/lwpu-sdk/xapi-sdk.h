...
/* See also:                                                                   */
/*    $LW_ROOT/tools/xapi/inc/xapi-sdk-support.h                               */
...
/* Use hard-code header & trailer size to minimize header file burden on lwtypes.h. */
/* The layout is verified by tests. */
#define XAPI_ELWELOPE_SIZE                 16384
#define XAPI_ELWELOPE_MAX_PAYLOAD_SIZE     (XAPI_ELWELOPE_SIZE - 32 /*header*/ - 4 /*trailer*/)

/* Default max size for an XAPI field  */
#define XAPI_MAX_FIELD_SIZE XAPI_ELWELOPE_MAX_PAYLOAD_SIZE
...
#define XAPI_FIELD_PTR_TO_STRING(FIELD_NAME, MAXCHARS) \
    char    *FIELD_NAME
#define XAPI_FIELD_LWP64_PTR_TO_STRING(FIELD_NAME, MAXCHARS) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_TO_STRING_CI(FIELD_NAME, MAXCHARS) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_TO_STRING_CO(FIELD_NAME, MAXCHARS) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)

#define XAPI_FIELD_FIXED_BYTE_ARRAY(FIELD_NAME, MAXELEMENTS) \
    LwU8    FIELD_NAME[MAXELEMENTS]
...
#define XAPI_FIELD_LWP64_PTR_TO_COUNTED_BYTE_ARRAY(FIELD_NAME, FIELD_COUNT, MAXELEMENTS) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_TO_COUNTED_BYTE_ARRAY_CI(FIELD_NAME, FIELD_COUNT, MAXELEMENTS) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_TO_COUNTED_BYTE_ARRAY_CO(FIELD_NAME, FIELD_COUNT, MAXELEMENTS) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
...
#define XAPI_FIELD_LWP64_PTR_TO_ARRAY(TYPE, PTR_FIELD_NAME, FIELD_COUNT, MAXELEMENTS)  \
    LwP64   PTR_FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_TO_ARRAY_CI(TYPE, PTR_FIELD_NAME, FIELD_COUNT, MAXELEMENTS)  \
    LwP64   PTR_FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_TO_ARRAY_CO(TYPE, PTR_FIELD_NAME, FIELD_COUNT, MAXELEMENTS)  \
    LwP64   PTR_FIELD_NAME LW_ALIGN_BYTES(8)
...
#define XAPI_FIELD_LWP64_PTR(TYPE, FIELD_NAME) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_CI(TYPE, FIELD_NAME) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)
#define XAPI_FIELD_LWP64_PTR_CO(TYPE, FIELD_NAME) \
    LwP64   FIELD_NAME LW_ALIGN_BYTES(8)

...
#define FLD_SET_DRF_DEF(d,r,f,c,v)              ((v) = ((LwU32)(v) & ~DRF_SHIFTMASK(LW##d##r##f)) | DRF_DEF(d,r,f,c))
...
// Simliar to Falcon overlay usage, helps put the variable or function in the designated section.
#ifndef ATTR_SECTION
#define ATTR_SECTION(ov)       __attribute__ ((section(ov)))
#endif

// Helps specify the minimum alignment (in bytes) for a variable or structure field.
#ifndef ATTR_ALIGNED

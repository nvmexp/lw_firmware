...
/* Crypto system config file for Ada shared LWPKA */
...
#define LWRNG_DFIFO_RETRY_COUNT 0xFFFFFFFEU
...
#define LW_PRGNLCL_FALCON_DOC_CTRL  LW_CGSP_FALCON_DOC_CTRL
#define LW_PRGNLCL_FALCON_DOC_D0    LW_CGSP_FALCON_DOC_D0
#define LW_PRGNLCL_FALCON_DOC_D1    LW_CGSP_FALCON_DOC_D1
#define LW_PRGNLCL_FALCON_DIC_CTRL  LW_CGSP_FALCON_DIC_CTRL
#define LW_PRGNLCL_FALCON_DIC_D0    LW_CGSP_FALCON_DIC_D0
#elif CCC_ENGINE_FSP
...
{
    while((localReadInline(LW_PRGNLCL_FALCON_DOC_CTRL) & 0x40000) == 0x0);
...
static inline uint32_t dioSeReadWrapper(const volatile void* addr)
{
    ...
    uint32_t data = localReadInline(LW_PRGNLCL_FALCON_DIC_D0);
    localWriteInline(LW_PRGNLCL_FALCON_DIC_CTRL, 0x80000);
    return data;

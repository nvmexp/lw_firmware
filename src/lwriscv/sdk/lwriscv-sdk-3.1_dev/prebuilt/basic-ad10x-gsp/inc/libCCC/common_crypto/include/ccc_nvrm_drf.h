 ...
 *
 * This originated from nvrm_drf.h. Copy from bootrom and modified by bootrom team,
 * modified for CCC (not significantly).
 */

/**
 * Use the precomputed shift and field values instead of calculating them from

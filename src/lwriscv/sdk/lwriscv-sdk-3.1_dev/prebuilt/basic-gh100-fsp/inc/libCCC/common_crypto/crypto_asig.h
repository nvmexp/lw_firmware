 ...
 *
 */
#ifndef INCLUDED_CRYPTO_ASIG_H
#define INCLUDED_CRYPTO_ASIG_H

#include <crypto_ops.h>

/**
 * @ingroup class_layer_api
 * @defgroup class_layer_asig_handlers Class handlers for asymmetric signatures
 */
/*@{*/

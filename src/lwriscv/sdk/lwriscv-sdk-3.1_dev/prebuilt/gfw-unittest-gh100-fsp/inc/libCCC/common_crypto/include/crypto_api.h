...
typedef enum te_crypto_algo_e {
	...
	TE_ALG_KEYOP_DISPOSE,	/**< [nvpka11] Key dispose */
	TE_ALG_KEYOP_GENPUB,	/**< [nvpka11] Public key generate */
	 ...
	 * MAC value calculation using AES engine.
	 */
	 ...
	 *
	 * Hybrid mode: SW calculated IPAD/OPAD, HW SHA engine used for digesting.
	 */
	...
	/**
	 * SHA digests calculated by HW engine.
	 *
	...
	/** CCC API does not currenlty support SHAKE digests.
...
#define TE_ALG_RSA_NOPAD TE_ALG_MODEXP       /**< Plain RSA cipher, no padding
	...
	TE_ALG_X25519			= 0x00210000,			/**< Curve25519 EC diffie hellman (derivation) */
...
typedef enum engine_id_e {
	...
	/** SE1 accelerator (only in selected SoCs, currenlty in T214 only) */
	...
	CCC_ENGINE_PKA = 0x30,	/**< PKA accelerator for modular operations and
				 * elliptic curves and optionally TRNG */
...
/**
 * @brief Supported EC curves (Only prime field curves supported by
 * the PKA1 accelerator).
 *
 * Since the PKA1 accelerator does not support binary field curves,
 * they are not supported by CCC either.
 *
 * The supported prime field curves can be enabled by a group define
 * (e.g. all NIST curves) or by enabling individual curves one by one
 * (e.g. only support NIST-P256 curve).
 *
 * @enum te_ec_curve_id_e Known EC curve ids
 * @defgroup ec_curves Known EC prime curves
 */
/*@{*/
typedef enum te_ec_curve_id_e {
	TE_CURVE_NONE = 0x0,	/**< Placeholder for unselected curve type  */

	/** Supported NIST prime curves */

	TE_CURVE_NIST_P_192,	/**< NIST-P192 prime curve */
	TE_CURVE_NIST_P_224,	/**< NIST-P224 prime curve */
	TE_CURVE_NIST_P_256,	/**< NIST-P256 prime curve */
	TE_CURVE_NIST_P_384,	/**< NIST-P384 prime curve */

	/**
	 * P521 is currently only supported with T23X CCC version.
	 *
	 * Please add a requirement to get this support for T19X.
	 */
	TE_CURVE_NIST_P_521,	/**< NIST-P521 prime curve */

	/** Brainpool curves */
	TE_CURVE_BRAINPOOL_P160r1, /**< Brainpool-P160R1 curve */
	TE_CURVE_BRAINPOOL_P192r1, /**< Brainpool-P192R1 curve */
	TE_CURVE_BRAINPOOL_P224r1, /**< Brainpool-P224R1 curve */
	TE_CURVE_BRAINPOOL_P256r1, /**< Brainpool-P256R1 curve */
	TE_CURVE_BRAINPOOL_P320r1, /**< Brainpool-P320R1 curve */
	TE_CURVE_BRAINPOOL_P384r1, /**< Brainpool-P384R1 curve */
	TE_CURVE_BRAINPOOL_P512r1, /**< Brainpool-P512R1 curve */

	/** Brainpool twisted curves */
	TE_CURVE_BRAINPOOL_P160t1, /**< Brainpool-P160T1 twisted curve */
	TE_CURVE_BRAINPOOL_P192t1, /**< Brainpool-P192T1 twisted curve */
	TE_CURVE_BRAINPOOL_P224t1, /**< Brainpool-P224T1 twisted curve */
	TE_CURVE_BRAINPOOL_P256t1, /**< Brainpool-P256T1 twisted curve */
	TE_CURVE_BRAINPOOL_P320t1, /**< Brainpool-P320T1 twisted curve */
	TE_CURVE_BRAINPOOL_P384t1, /**< Brainpool-P384T1 twisted curve */
	TE_CURVE_BRAINPOOL_P512t1, /**< Brainpool-P512T1 twisted curve */

	/** Montgomery curve Curve25519 */
	TE_CURVE_C25519,	/**< Curve only used for ECDH with curve25519 (X25519) */

	/** Twisted edwards curve ED25519 */
	TE_CURVE_ED25519,	/**< Curve only used for signatures with ed25519 curve
				 * (ED25519/ED25519PH)
				 */

	/** Koblitz curves over prime field Fp */
	TE_CURVE_KOBLITZ_P_160k1, /**< Koblitz P160K1 curve */
	TE_CURVE_KOBLITZ_P_192k1, /**< Koblitz P192K1 curve */
	TE_CURVE_KOBLITZ_P_224k1, /**< Koblitz P224K1 curve */
	TE_CURVE_KOBLITZ_P_256k1, /**< Koblitz P256K1 curve */
} te_ec_curve_id_t; /**< Type for curve ids */
/*@}*/
 ...
 *
 * Since the only block cipher supported is the AES this is currently
...
struct cipher_aes_gcm_init_s {
	...
	uint32_t nonce_len; /* Currently 12 byte nonces supported (by HW) */
	uint32_t tag_len;
	uint32_t aad_len;
};
...
/**
 * @brief Elliptic Curve (EC) specific init setup.
 *
...
typedef struct ec_init_args_s {
	...
	te_ec_curve_id_t  curve_id; /**< Selected EC curve identity */
 ...
 *
 * Currently no XMSS specific init flags are defined.
 *
 ...
 * converted into a writable data buffer by use of such union mapping:
...
typedef enum te_key_type_e {
	...
	KEY_TYPE_EC_PUBLIC,	/**< Elliptic curve keys (EC curve point) */
...
#define CCC_ED25519_COMPRESSED_POINT_SIZE	32U /**< ED2559 curve size */
...
/*@{*/
typedef struct {
	te_ec_point_t	pubkey;	       /**< PUBKEY (point on curve P = dQ) */
 ...
 *
 * Currently SHA engine and AES engines support asynchronous
 * operations.
 *
 ...
 * the operation is finalized before that occurs. Watchdog trigger can
 ...
 *
 * The mutex watchdog reset occurs in 1.6 seconds after grabbing the
...
typedef struct te_crypto_args_s {
	uint32_t		ca_handle; /**< Unique crypto context identifying handle.
					    * Currently only used by the separate address space

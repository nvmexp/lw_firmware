...
/* Crypto system config file for Shared & SE-lite SE */
...
#define CCC_REG_ACCESS_DEFAULT 0

typedef uint32_t status_t;

#define ccc_device_set_reg(cdev, reg, val) ccc_device_set_reg_normal_redirect((uint32_t*)cdev, reg, val)
#define ccc_device_get_reg(cdev, reg) ccc_device_get_reg_normal_redirect((uint32_t*)cdev, reg)

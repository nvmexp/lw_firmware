...
/* Crypto system config file for FSP LWPKA */
...
#ifndef UPROC_ARCH_RISCV
#error "UPROC_ARCH_RISCV must be set for FSP!\n"
#endif
...
#define LW_ADDRESS_MAP_SE_LWPKA_BASE    0x01510000
#define LW_ADDRESS_MAP_SE_LWRNG_BASE    0x01520000
/**

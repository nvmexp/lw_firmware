 ...
 *
 */
#ifndef INCLUDED_CRYPTO_DERIVE_H
#define INCLUDED_CRYPTO_DERIVE_H

#include <crypto_ops.h>

/**
 * @ingroup class_layer_api
 * @defgroup class_layer_derive_handlers Class handlers for key derivations
 */
/*@{*/
...
/*@}*/
#endif /* INCLUDED_CRYPTO_DERIVE_H */

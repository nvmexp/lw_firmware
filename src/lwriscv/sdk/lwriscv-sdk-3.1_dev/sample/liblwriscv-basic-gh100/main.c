...
int main(void)
{
    ...
    printf("Hello world. You are running on LW_PTOP_PLATFORM=%x, this binary was built on: %s.\n", platform, __DATE__ " " __TIME__);
#else // LWRISCV_PLATFORM_IS_CMOD
    printf("Hello world. You are running on CMOD, this binary was built on: %s.\n", __DATE__ " " __TIME__);

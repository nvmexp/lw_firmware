...
is
    ...
    P0_Core_Pmp : constant Plcy_Core_Pmp := (
        ...
        9 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_9000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        10 => Core_Pmp_Entry'(  Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_a000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,
    ...
    P1_Core_Pmp : constant Plcy_Core_Pmp := (
        ...
        8 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_9000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,

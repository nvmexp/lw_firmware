...
const PKC_VERIFICATION_MANIFEST manifest = {
    ...
    .bAttester = FALSE,
    .mspm         = {
#if LWRISCV_IS_ENGINE_minion
        .mplm = LW_RISCV_CSR_MSPM_MPLM_LEVEL1,
#else
        .mplm = LW_RISCV_CSR_MSPM_MPLM_LEVEL2,
#endif // LWRISCV_IS_ENGINE_minion
        .msecm = 0x0
    },
    ...
    .corePmp = {
        .cfg = {
            ...
            PMP_ENTRY(_PERMITTED, _DENIED, _PERMITTED, _NAPOT, _LOCK, 2)    | // IMEM FMC, write blocked for ALL *MUST BE LOCKED*
            PMP_ENTRY_OFF(3)                                                | // TOR - start for PRI (se next)
            ...
            [3] =    // PMP entry 24-31 -> extpmp2
            PMP_ENTRY_OFF(4)                                                | // TOR - Starting at 0
            PMP_ENTRY(_DENIED, _DENIED, _DENIED, _TOR,   _UNLOCK, 5),         // TOR - Everything - ---
        },
        .addr = {
            // PMPADDR
    ...
    // IO_PMP_MODE - disable all entries
    .ioPmpMode = 0x0,
    ...
    .registerPair.entries       = {
        [0] = {
          ...
          .andMask  = 0,
          .orMask   = DRF_DEF(_PRGNLCL, _RISCV_TRACECTL, _MODE, _FULL)         |

...
is
   ...
   P0_Core_Pmp : constant Plcy_Core_Pmp := (
        ...
        9 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_001A_B000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        10 => Core_Pmp_Entry'(  Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_001A_C000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,

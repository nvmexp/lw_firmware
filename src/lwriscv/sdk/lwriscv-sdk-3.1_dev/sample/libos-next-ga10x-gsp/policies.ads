...
package Policies
is
    External_Parent_Child_Pairs : constant Plcy_Parent_Child_Pair_Array := (
        0 => Plcy_Parent_Child_Pair'(
            Parent   => 1,
            Children => Plcy_Children_Bit_Field'(
                0 => False,
                others => True)
        ),
        1 => Plcy_Parent_Child_Pair'(
            Parent   => 0,
            Children => Plcy_Children_Bit_Field'(
                others => True)
        )
   ...
   P0_Core_Pmp : constant Plcy_Core_Pmp := (
        0 => Core_Pmp_Entry'(   Addr => 16#0FFF_FFFF_FFFF_FFFF#,
                                Address_Mode => NAPOT,
                                Access_Mode => (

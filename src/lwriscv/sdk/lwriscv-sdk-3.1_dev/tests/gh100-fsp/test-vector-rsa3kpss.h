...
#ifndef TESTVECTORRSA3KPSS_H
#define TESTVECTORRSA3KPSS_H

#define RSA3072_BYTE_SIZE (3072U/8U)
#define MESSAGE_BYTE_SIZE (128U)
#define SHA256_BYTE_SIZE  (256U/8U)
...
#define LITTLE_ENDIAN_SHA256HASH    LITTLE_ENDIAN_SIGNATURE
    ...
    unsigned char signature[RSA3072_BYTE_SIZE] = {
    ...
    unsigned char modulus[RSA3072_BYTE_SIZE] = {
    ...
    /* SHA256 HASH in LITTLE ENDIAN format */
    unsigned char sha256_hash[SHA256_BYTE_SIZE] = {
    ...
    uint8_t flags = BIG_ENDIAN_SIGNATURE | BIG_ENDIAN_MODULUS | BIG_ENDIAN_EXPONENT | LITTLE_ENDIAN_SHA256HASH;
#endif
    ...
    unsigned int modulus[RSA3072_BYTE_SIZE] = 
    {
    ...
    uint8_t flags = LITTLE_ENDIAN_SIGNATURE | LITTLE_ENDIAN_MODULUS | BIG_ENDIAN_EXPONENT | LITTLE_ENDIAN_SHA256HASH;
#endif

/* More test vectors can be added here if needed */

#endif // TESTVECTORRSA3KPSS_H

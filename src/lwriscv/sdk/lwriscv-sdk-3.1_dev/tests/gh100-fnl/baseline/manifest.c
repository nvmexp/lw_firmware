...
const PKC_VERIFICATION_MANIFEST manifest = {
    ...
    .registerPair.entries   = {
        [0] = {
            .addr    = LW_PRGNLCL_FALCON_MAILBOX0,
            .andMask = 0,
            .orMask  = MANIFEST_AD_TEST_MAILBOX0,
        },
        [1] = {
            #if LWRISCV_HAS_PRI
                #if LWRISCV_IS_ENGINE_lwdec
                    .addr    = LW_RISCV_AMAP_PRIV_START + ENGINE_REG(_FALCON_MAILBOX1)(LWDEC_INSTANCE), // MK TODO: other LWDEC instances?
                #else
                    .addr    = LW_RISCV_AMAP_PRIV_START + ENGINE_REG(_FALCON_MAILBOX1),
                #endif
            #else
                .addr    = LW_PRGNLCL_FALCON_MAILBOX1,
            #endif
            .andMask = 0,
            .orMask  = MANIFEST_AD_TEST_MAILBOX1,
        },
        [2] = {

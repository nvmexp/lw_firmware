...
/* LWPKA feature configurations for T23X
 */
...
#error "Incorrect LWPKA setup"
#endif

#define HAVE_LWPKA_SCC	  1	/* LWPKA SCC features (Default:1) */
...
#define HAVE_GEN_MULTIPLY 0	/* LWPKA supports generic multiply/reduction.
				 * If 0, use MOD_MULTIPLY instead (faster in LWPKA HW)
				 * and does not need pre-set montgomery values.
				 */
#endif

#define LWPKA_MAX_KEYSLOTS 4U

#ifndef HAVE_LWPKA_RESET
#define HAVE_LWPKA_RESET 0
#endif

/* Config features from PKA1 config file mapped to LWPKA
 * automatically when enabled with this.
 */
#define MAP_PKA1_CONFIG_TO_LWPKA 1

/* By default use LWPKA HW mutex locks (mutexes are optional)
 *
...
/* LWPKA now uses the LONG FORM group equation for
...
/* Algorithms, on the other hand, get mapped directly to LWPKA.
 * Use either PKA1 or LWPKA defines for algorithm support.
 */
...
/* CCC feature settings for LWPKA

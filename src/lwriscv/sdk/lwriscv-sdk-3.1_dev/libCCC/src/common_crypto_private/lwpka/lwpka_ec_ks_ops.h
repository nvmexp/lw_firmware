...
#define CCC_MANIFEST_EC_KS_USER_LWDEC	2U /**< LWDEC */
 ...
 */
#define LWPKA_MAX_EC_KEYSTORES 0U
...
/* We have only one keystore location in LWPKA-1.1 prepare for more
 * "keystores".
 */
#define LWPKA_MAX_EC_KEYSTORES 1U
...
static inline bool m_ec_ks_lwrve_supported(te_ec_lwrve_id_t lwrve_id)
{
	return ((TE_LWRVE_NIST_P_256 == lwrve_id) ||
		(TE_LWRVE_NIST_P_384 == lwrve_id) ||
		(TE_LWRVE_NIST_P_521 == lwrve_id));
}

#define CCC_EC_KS_LWRVE_SUPPORTED(lwrve_id) m_ec_ks_lwrve_supported(lwrve_id)

/*@}*/

#if HAVE_LWPKA11_ECKS_KEYOPS
/* Support function to map algorithm to lwpka_engine_ops
 */
...
/** @brief ECDSA with selected lwrves.
 *
 * EC keystore supports the NIST-P256, NIST-P384 and NIST-P521 lwrves.
 */

...
#
# Makefile fragment included by PSC ROM build system
# for building CCC library for T23X.
#
# Subsystem: PSC ROM
# Platfom: T23x
# Version: 0.2
# Contact: jvirtanen@lwpu.com
#
...
#
# CCC_SRC_FILES   : CCC files to compile for PSC ROM in T23x
# CCC_HEADER_FILES: Not required by PSC ROM lwrrently, will be set later (!!!)
...
#
LOCAL__CCC_SUBSYS_NAME := "PSC ROM"
...
# API layer
CCC_SRC_FILES :=  $(CCC_DIR)/crypto_ae.c \
...
# XMSS verify
CCC_SRC_FILES +=  $(CCC_DIR)/xmss/crypto_xmss.c \
                  $(CCC_DIR)/xmss/ccc_xmss_verify.c \
                  $(CCC_DIR)/xmss/ccc_xmss_sha256.c
...
CCC_SRC_FILES +=  $(CCC_PRIVATE_DIR)/tegra_se_genrnd.c

# Initialize LWRNG device
CCC_SRC_FILES += $(CCC_PRIVATE_DIR)/tegra_lwrng_init.c

...
#
# Makefile fragment included by LwTboot build system
...
#
# CCC_SRC_FILES   : CCC files to compile for LwTboot
# CCC_HEADER_FILES: CCC header files required by LwTboot
...
# Drng function
CCC_SRC_FILES +=  $(CCC_DIR)/tegra_rng1.c

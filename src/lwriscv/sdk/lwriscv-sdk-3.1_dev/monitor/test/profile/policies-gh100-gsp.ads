...
is
    ...
    P0_Core_Pmp : constant Plcy_Core_Pmp := (
        ...
        2 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_5000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        3 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_8000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => PERMITTED,
        ...
        9 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0018_4000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        10 => Core_Pmp_Entry'(  Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0020_0000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,
        ...
        11 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0140_0000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        12 => Core_Pmp_Entry'(  Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0160_0000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,
    ...
    P1_Core_Pmp : constant Plcy_Core_Pmp := (
        0 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_3000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        1 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0010_5000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => PERMITTED,
                                    Write_Access => DENIED,
        ...
        8 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0020_0000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,
        ...
        9 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0140_0000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        10 => Core_Pmp_Entry'(  Addr => PMP_Address(Shift_Right(LwU64(16#0000_0000_0160_0000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Exelwtion_Access => DENIED,
                                    Write_Access => PERMITTED,
...
,
           1 => External_Policy'(
                    ...
                    Secret_Mask         => Plcy_Secret_Mask'(
                                            Scp_Secret_Mask0 => 0,
                                            Scp_Secret_Mask1 => 0,
                                            Scp_Secret_Mask_lock0 => 16#FFFF_FFFF#,
                                            Scp_Secret_Mask_lock1 => 16#FFFF_FFFF#),
                    Debug_Control       => P0_Debug_Control,
                    Mpu_Control         => P1_Mpu_Control,
                    Device_Map_Group_0  => P0_Device_Map_Group_0,
                    Device_Map_Group_1  => P0_Device_Map_Group_1,

...
package Dummy_Policy_Constants
is
    Debug_Control : constant Plcy_Debug_Control := Plcy_Debug_Control'(
    ...
    Mpu_Control : constant Plcy_Mpu_Control := Plcy_Mpu_Control'(
        Hash_LWMPU_Enable => 1,
        Start_Index       => 0,
        Entry_Count       => 128);

    Device_Map_Group_0 : constant Plcy_Device_Map_Group_0 := (
        MMODE => (
    ...
    Device_Map_Group_1 : constant Plcy_Device_Map_Group_1 := (
        KEY => (
            Readable => SUBMMODE_READ_ENABLE,
            Writable => SUBMMODE_WRITE_ENABLE,
            Reserved => 0),
    ...
    Device_Map_Group_2 : constant Plcy_Device_Map_Group_2 := (
        SCP => (
            Readable => SUBMMODE_READ_ENABLE,
            Writable => SUBMMODE_WRITE_ENABLE,
            Reserved => 0),
    ...
    Device_Map_Group_3 : constant Plcy_Device_Map_Group_3 := (
        PLM => (
            Readable => SUBMMODE_READ_ENABLE,
            Writable => SUBMMODE_WRITE_ENABLE,
            Reserved => 0),
    ...
    Core_Pmp : constant Plcy_Core_Pmp := (
        0 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0010_1000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => DENIED,
                                    Read_Access => DENIED,
                                    Reserved => 0),
                                Reserved => 0),

        1 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0010_2000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Execution_Access => PERMITTED,
                                    Write_Access => DENIED,
                                    Read_Access => PERMITTED,
                                    Reserved => 0),
                                Reserved => 0),

        2 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0010_3000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        3 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0010_4000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Execution_Access => PERMITTED,
                                    Write_Access => DENIED,
        ...
        4 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0018_1000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        5 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0018_3000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Execution_Access => DENIED,
        ...
        7 => Core_Pmp_Entry'    (Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0018_3000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        8 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0018_4000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => PERMITTED,
        ...
        9 => Core_Pmp_Entry'(   Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0018_f000#), 2)),
                                Address_Mode => OFF,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => DENIED,
        ...
        10 => Core_Pmp_Entry'(  Addr => PMP_Address(Shift_Right(NvU64(16#0000_0000_0019_0000#), 2)),
                                Address_Mode => TOR,
                                Access_Mode => (
                                    Execution_Access => DENIED,
                                    Write_Access => PERMITTED,

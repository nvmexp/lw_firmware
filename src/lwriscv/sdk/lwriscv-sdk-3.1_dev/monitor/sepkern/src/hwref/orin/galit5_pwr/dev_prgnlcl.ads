...
is
    ...
    LW_PRGNLCL_FALCON_IMEMT_FAULT_CORRECTED_INIT   : constant NvU1 := 16#0#;
    LW_PRGNLCL_FALCON_IMEMT_FAULT_UNCORRECTED_INIT : constant NvU1 := 16#0#;

    type LW_PRGNLCL_FALCON_IMEMT_Register is record
        Tag               : NvU16;
        Fault_Corrected   : NvU1;
        Fault_Uncorrected : NvU1;
    end record with
        Size        => 32,
        Object_Size => 32;
    ...
    for LW_PRGNLCL_FALCON_IMEMT_Register use record
        Tag               at 0 range  0 .. 15;
        Fault_Corrected   at 0 range 16 .. 16;
        Fault_Uncorrected at 0 range 17 .. 17;
    end record;
    ...
    LW_PRGNLCL_FALCON_DMEMT_FAULTED_INIT : constant NvU1 := 16#0#;
    ...
    LW_PRGNLCL_FALCON_SAFETY_ERB_DATA_CORRECTED_ERR   : constant NvU32 := 16#eafe_0c00#;
    LW_PRGNLCL_FALCON_SAFETY_ERB_DATA_UNCORRECTED_ERR : constant NvU32 := 16#eafe_1cff#;

    type LW_PRGNLCL_FALCON_SAFETY_ERB_Register is record
        Data : NvU32;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FALCON_SAFETY_ERB_Register use record
        Data at 0 range 0 .. 31;
    end record;

    LW_PRGNLCL_FALCON_SAFETY_MAILBOX_DATA_INIT : constant NvU32 := 16#0#;

    type LW_PRGNLCL_FALCON_SAFETY_MAILBOX_Register is record
        Data : NvU32;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FALCON_SAFETY_MAILBOX_Register use record
        Data at 0 range 0 .. 31;
    end record;
    ...
    type LW_PRGNLCL_FALCON_SAFETY_CTRL_FUSE_OPT_ECC_EN_Field is (EN_FALSE, EN_TRUE) with
        Size => 1;
    for LW_PRGNLCL_FALCON_SAFETY_CTRL_FUSE_OPT_ECC_EN_Field use (EN_FALSE => 16#0#, EN_TRUE => 16#1#);
    ...
    LW_PRGNLCL_FALCON_SAFETY_CTRL_EXC_ON_DMEM_ERR_INIT   : constant NvU1 := 16#0#;
    LW_PRGNLCL_FALCON_SAFETY_CTRL_EXC_ON_DMEM_ERR_TRUE   : constant NvU1 := 16#1#;
    LW_PRGNLCL_FALCON_SAFETY_CTRL_EXC_ON_DMEM_ERR_FALSE  : constant NvU1 := 16#0#;
    LW_PRGNLCL_FALCON_SAFETY_CTRL_HALT_ON_IMEM_ERR_INIT  : constant NvU1 := 16#0#;
    LW_PRGNLCL_FALCON_SAFETY_CTRL_HALT_ON_IMEM_ERR_TRUE  : constant NvU1 := 16#1#;
    LW_PRGNLCL_FALCON_SAFETY_CTRL_HALT_ON_IMEM_ERR_FALSE : constant NvU1 := 16#0#;
    ...
    type LW_PRGNLCL_FALCON_SAFETY_CTRL_DMEM_PARITY_DIS_Field is (DIS_TRUE, DIS_INIT) with
        Size => 2;
    for LW_PRGNLCL_FALCON_SAFETY_CTRL_DMEM_PARITY_DIS_Field use (DIS_TRUE => 16#1#, DIS_INIT => 16#2#);
    type LW_PRGNLCL_FALCON_SAFETY_CTRL_IMEM_ECC_DIS_Field is (DIS_TRUE, DIS_INIT) with
        Size => 2;
    for LW_PRGNLCL_FALCON_SAFETY_CTRL_IMEM_ECC_DIS_Field use (DIS_TRUE => 16#1#, DIS_INIT => 16#2#);
    ...
    type LW_PRGNLCL_FALCON_SAFETY_CTRL_Register is record
        ...
        Fuse_Opt_Ecc_En           : LW_PRGNLCL_FALCON_SAFETY_CTRL_FUSE_OPT_ECC_EN_Field;
        ...
        Exc_On_Dmem_Err           : NvU1;
        Halt_On_Imem_Err          : NvU1;
        Riscv_Dcls_Dis            : NvU2;
        Dmem_Parity_Dis           : LW_PRGNLCL_FALCON_SAFETY_CTRL_DMEM_PARITY_DIS_Field;
        Imem_Ecc_Dis              : LW_PRGNLCL_FALCON_SAFETY_CTRL_IMEM_ECC_DIS_Field;
    end record with
        Size        => 32,
        Object_Size => 32;
    ...
    for LW_PRGNLCL_FALCON_SAFETY_CTRL_Register use record
        ...
        Fuse_Opt_Ecc_En           at 0 range 16 .. 16;
        Riscv_Dcls_Inout_Dff_Slcg at 0 range 12 .. 12;
        Riscv_Dcls_Clk_En         at 0 range 10 .. 11;
        Exc_On_Dmem_Err           at 0 range  9 ..  9;
        Halt_On_Imem_Err          at 0 range  8 ..  8;
        Riscv_Dcls_Dis            at 0 range  6 ..  7;
        Dmem_Parity_Dis           at 0 range  4 ..  5;
        Imem_Ecc_Dis              at 0 range  0 ..  1;
    end record;
    ...
    LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_VALUE_INIT : constant NvU32 := 16#0#;

    type LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_Register is record
        Value : NvU32;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_Register use record
        Value at 0 range 0 .. 31;
    end record;

    LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_HI_VALUE_INIT : constant NvU32 := 16#0#;

    type LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_HI_Register is record
        Value : NvU32;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_HI_Register use record
        Value at 0 range 0 .. 31;
    end record;
    ...
    type LW_PRGNLCL_FALCON_PMM_FBIF_DSTAT_SEL_Field is (SEL_1KTRANSFER, SEL_RREQ, SEL_WREQ, SEL_1KTRANSFER_SC, SEL_RREQ_SC, SEL_WREQ_SC) with
        Size => 3;
    for LW_PRGNLCL_FALCON_PMM_FBIF_DSTAT_SEL_Field use (SEL_1KTRANSFER => 16#0#, SEL_RREQ => 16#1#, SEL_WREQ => 16#2#, SEL_1KTRANSFER_SC => 16#3#, SEL_RREQ_SC => 16#4#,
         SEL_WREQ_SC                                                   => 16#5#);
    type LW_PRGNLCL_FALCON_PMM_FBIF_STALL0_SEL_Field is
        ...
        Size => 4;
    for LW_PRGNLCL_FALCON_PMM_FBIF_STALL0_SEL_Field use (SEL_RDAT_WAIT => 16#0#, SEL_RDM_CLIENT => 16#1#, SEL_WDF_FULL => 16#2#, SEL_RQQ_FULL => 16#3#, SEL_RDM_PORTQ => 16#4#,
         SEL_RDM_ALLOC => 16#5#, SEL_FB_BSY => 16#6#, SEL_ORQ => 16#7#, SEL_RDAT_WAIT_SC => 16#8#, SEL_RDM_CLIENT_SC => 16#9#, SEL_WDF_FULL_SC => 16#a#, SEL_RQQ_FULL_SC => 16#b#,
         SEL_RDM_PORTQ_SC                                              => 16#c#, SEL_RDM_ALLOC_SC => 16#d#, SEL_FB_BSY_SC => 16#e#, SEL_ORQ_SC => 16#f#);
    ...
    type LW_PRGNLCL_FALCON_EXCI_EXCAUSE_Field is
        (EXCAUSE_TRAP0, EXCAUSE_TRAP1, EXCAUSE_TRAP2, EXCAUSE_TRAP3, EXCAUSE_ILL_INS, EXCAUSE_ILW_INS, EXCAUSE_MISS_INS, EXCAUSE_DHIT_INS, EXCAUSE_SP_OVERFLOW, EXCAUSE_BRKPT_INS,
         EXCAUSE_DMEM_MISS_INS, EXCAUSE_DMEM_DHIT_INS, EXCAUSE_DMEM_PAFAULT_INS, EXCAUSE_DMEM_PERMISSION_INS, EXCAUSE_DMEM_FAULT_INS, EXCAUSE_BROM_CALL_INS,
         EXCAUSE_KMEM_VIOLATION_INS, EXCAUSE_BMEM_PERMISSION_INS) with
        Size => 5;
    for LW_PRGNLCL_FALCON_EXCI_EXCAUSE_Field use (EXCAUSE_TRAP0 => 16#0#, EXCAUSE_TRAP1 => 16#1#, EXCAUSE_TRAP2 => 16#2#, EXCAUSE_TRAP3 => 16#3#, EXCAUSE_ILL_INS => 16#8#,
         ...
         EXCAUSE_DMEM_DHIT_INS => 16#11#, EXCAUSE_DMEM_PAFAULT_INS => 16#12#, EXCAUSE_DMEM_PERMISSION_INS => 16#13#, EXCAUSE_DMEM_FAULT_INS => 16#14#,
         EXCAUSE_BROM_CALL_INS                                  => 16#15#, EXCAUSE_KMEM_VIOLATION_INS => 16#16#, EXCAUSE_BMEM_PERMISSION_INS => 16#17#);
    ...
    LW_PRGNLCL_FALCON_ICD_CMD_FAULTED_INIT  : constant NvU1 := 16#0#;
    LW_PRGNLCL_FALCON_ICD_CMD_FAULTED_TRUE  : constant NvU1 := 16#1#;
    LW_PRGNLCL_FALCON_ICD_CMD_FAULTED_FALSE : constant NvU1 := 16#0#;
    ...
    LW_PRGNLCL_FALCON_DMEM_CARVEOUT_PRIV_LEVEL_MASK_Address          : constant := 16#140_01ac#;
    ...
    LW_PRGNLCL_FALCON_DMEM_PRIV_RANGE0_Address                       : constant := 16#140_0174#;
    LW_PRGNLCL_FALCON_DMEM_PRIV_RANGE1_Address                       : constant := 16#140_0178#;
    ...
    LW_PRGNLCL_FALCON_SAFETY_ERB_Address                             : constant := 16#140_02ec#;
    LW_PRGNLCL_FALCON_SAFETY_MAILBOX_Address                         : constant := 16#140_02f0#;
    ...
    LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_Address                        : constant := 16#140_02f8#;
    LW_PRGNLCL_FALCON_SAFETY_ERR_ADDR_HI_Address                     : constant := 16#140_02fc#;
    ...
    LW_PRGNLCL_FALCON_BR_PARAMS_PRIV_LEVEL_MASK_Address              : constant := 16#140_1250#;
    LW_PRGNLCL_FALCON_KFUSE_LOAD_CTL_PRIV_LEVEL_MASK_Address         : constant := 16#140_125c#;
    LW_PRGNLCL_FALCON_KMEM_PRIV_LEVEL_MASK_Address                   : constant := 16#140_1254#;
    LW_PRGNLCL_FALCON_SHA_RAL_PRIV_LEVEL_MASK_Address                : constant := 16#140_1128#;
    LW_PRGNLCL_FALCON_SHA_CONFIG_Address                             : constant := 16#140_1004#;
    LW_PRGNLCL_FALCON_SHA_TASK_CONFIG_Address                        : constant := 16#140_1008#;
    LW_PRGNLCL_FALCON_SHA_IN_ADDR_Address                            : constant := 16#140_100c#;
    LW_PRGNLCL_FALCON_SHA_IN_ADDR_HI_Address                         : constant := 16#140_1010#;
    LW_PRGNLCL_FALCON_SHA_MSG_LENGTH_0_Address                       : constant := 16#140_101c#;
    LW_PRGNLCL_FALCON_SHA_MSG_LENGTH_1_Address                       : constant := 16#140_1020#;
    LW_PRGNLCL_FALCON_SHA_MSG_LENGTH_2_Address                       : constant := 16#140_1024#;
    LW_PRGNLCL_FALCON_SHA_MSG_LENGTH_3_Address                       : constant := 16#140_1028#;
    LW_PRGNLCL_FALCON_SHA_MSG_LEFT_0_Address                         : constant := 16#140_102c#;
    LW_PRGNLCL_FALCON_SHA_MSG_LEFT_1_Address                         : constant := 16#140_1030#;
    LW_PRGNLCL_FALCON_SHA_MSG_LEFT_2_Address                         : constant := 16#140_1034#;
    LW_PRGNLCL_FALCON_SHA_MSG_LEFT_3_Address                         : constant := 16#140_1038#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_0_Address                      : constant := 16#140_103c#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_1_Address                      : constant := 16#140_1040#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_2_Address                      : constant := 16#140_1044#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_3_Address                      : constant := 16#140_1048#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_4_Address                      : constant := 16#140_104c#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_5_Address                      : constant := 16#140_1050#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_6_Address                      : constant := 16#140_1054#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_7_Address                      : constant := 16#140_1058#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_8_Address                      : constant := 16#140_105c#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_9_Address                      : constant := 16#140_1060#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_10_Address                     : constant := 16#140_1064#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_11_Address                     : constant := 16#140_1068#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_12_Address                     : constant := 16#140_106c#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_13_Address                     : constant := 16#140_1070#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_14_Address                     : constant := 16#140_1074#;
    LW_PRGNLCL_FALCON_SHA_HASH_RESULT_15_Address                     : constant := 16#140_1078#;
    LW_PRGNLCL_FALCON_SHA_OPERATION_Address                          : constant := 16#140_107c#;
    LW_PRGNLCL_FALCON_SHA_STATUS_Address                             : constant := 16#140_1080#;
    LW_PRGNLCL_FALCON_SHA_IN_REQ_CUR_BYTE_ADDR_Address               : constant := 16#140_1084#;
    LW_PRGNLCL_FALCON_SHA_IN_REQ_CUR_BYTE_ADDR_HI_Address            : constant := 16#140_1088#;
    LW_PRGNLCL_FALCON_SHA_PRIV_LOCKDOWN_Address                      : constant := 16#140_108c#;
    LW_PRGNLCL_FALCON_SHA_IN_RESP_CUR_BYTE_ADDR_Address              : constant := 16#140_1090#;
    LW_PRGNLCL_FALCON_SHA_IN_RESP_CUR_BYTE_ADDR_HI_Address           : constant := 16#140_1094#;
    LW_PRGNLCL_FALCON_SHA_ERR_STATUS_Address                         : constant := 16#140_1130#;
    LW_PRGNLCL_FALCON_SHA_ERR_ADDR_Address                           : constant := 16#140_1120#;
    LW_PRGNLCL_FALCON_SHA_ERR_ADDR_HI_Address                        : constant := 16#140_1124#;
    LW_PRGNLCL_FALCON_SHA_INT_STATUS_Address                         : constant := 16#140_1134#;
    LW_PRGNLCL_FALCON_SHA_INT_ENABLE_Address                         : constant := 16#140_1138#;
    LW_PRGNLCL_FALCON_SHA_MUTEX_Address                              : constant := 16#140_1100#;
    LW_PRGNLCL_FALCON_SHA_MUTEX_RELEASE_Address                      : constant := 16#140_1104#;
    LW_PRGNLCL_FALCON_SHA_MUTEX_STATUS_Address                       : constant := 16#140_1108#;
    LW_PRGNLCL_FALCON_SHA_SRC_CONFIG_Address                         : constant := 16#140_1110#;
    LW_PRGNLCL_FALCON_SHA_REQ_CTRL_Address                           : constant := 16#140_1114#;
    LW_PRGNLCL_FALCON_SHA_CTRL_Address                               : constant := 16#140_1098#;
    LW_PRGNLCL_FALCON_SHA_CYA_Address                                : constant := 16#140_1118#;
    LW_PRGNLCL_FALCON_SHA_DBG_INFO_Address                           : constant := 16#140_111c#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_0_Address                          : constant := 16#140_1140#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_1_Address                          : constant := 16#140_1144#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_2_Address                          : constant := 16#140_1148#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_3_Address                          : constant := 16#140_114c#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_4_Address                          : constant := 16#140_1150#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_5_Address                          : constant := 16#140_1154#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_6_Address                          : constant := 16#140_1158#;
    LW_PRGNLCL_FALCON_SHA_DBG_REG_7_Address                          : constant := 16#140_115c#;
    LW_PRGNLCL_FALCON_VER_Address                                    : constant := 16#140_1188#;
    LW_PRGNLCL_FALCON_MOD_SEL_Address                                : constant := 16#140_1180#;
    LW_PRGNLCL_FALCON_MOD_EN_Address                                 : constant := 16#140_1184#;
    LW_PRGNLCL_FALCON_PKCBROM_VER_Address                            : constant := 16#140_118c#;
    LW_PRGNLCL_FALCON_VHRCFG_BASE_Address                            : constant := 16#140_1190#;
    LW_PRGNLCL_FALCON_VHRCFG_ENTNUM_Address                          : constant := 16#140_11e8#;
    LW_PRGNLCL_FALCON_BMEMBASE_Address                               : constant := 16#140_1194#;
    LW_PRGNLCL_FALCON_BROM_CURR_UCODE_ID_Address                     : constant := 16#140_1198#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_0_Address                        : constant := 16#140_11a8#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_1_Address                        : constant := 16#140_11ac#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_2_Address                        : constant := 16#140_11b0#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_3_Address                        : constant := 16#140_11b4#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_4_Address                        : constant := 16#140_11b8#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_5_Address                        : constant := 16#140_11bc#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_6_Address                        : constant := 16#140_11c0#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_7_Address                        : constant := 16#140_11c4#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_8_Address                        : constant := 16#140_11c8#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_9_Address                        : constant := 16#140_11cc#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_10_Address                       : constant := 16#140_11d0#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_11_Address                       : constant := 16#140_11d4#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_12_Address                       : constant := 16#140_11d8#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_13_Address                       : constant := 16#140_11dc#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_14_Address                       : constant := 16#140_11e0#;
    LW_PRGNLCL_FALCON_UCODE_VERSION_15_Address                       : constant := 16#140_11e4#;
    LW_PRGNLCL_FALCON_BROM_ENGIDMASK_Address                         : constant := 16#140_119c#;
    LW_PRGNLCL_FALCON_KFUSE_LOAD_CTL_Address                         : constant := 16#140_11ec#;
    LW_PRGNLCL_FALCON_PR_CTKID_Address                               : constant := 16#140_11f0#;
    LW_PRGNLCL_FALCON_BROM_FUNID_Address                             : constant := 16#140_11a0#;
    LW_PRGNLCL_FALCON_BROM_PARAADDR_0_Address                        : constant := 16#140_1210#;
    LW_PRGNLCL_FALCON_BROM_RETCODE_Address                           : constant := 16#140_11a4#;
    LW_PRGNLCL_FALCON_KMEMBASE_Address                               : constant := 16#140_11f4#;
    LW_PRGNLCL_FALCON_KMEMC_0_Address                                : constant := 16#140_11f8#;
    LW_PRGNLCL_FALCON_KMEMC_1_Address                                : constant := 16#140_11fc#;
    LW_PRGNLCL_FALCON_KMEMD_0_Address                                : constant := 16#140_1200#;
    LW_PRGNLCL_FALCON_KMEMD_1_Address                                : constant := 16#140_1204#;
    LW_PRGNLCL_FALCON_KMEM_CTL_Address                               : constant := 16#140_1208#;
    LW_PRGNLCL_FALCON_KMEMCFG_Address                                : constant := 16#140_120c#;
    LW_PRGNLCL_FALCON_KMEM_VALID_0_Address                           : constant := 16#140_1218#;
    LW_PRGNLCL_FALCON_KMEM_VALID_1_Address                           : constant := 16#140_121c#;
    LW_PRGNLCL_FALCON_KMEM_VALID_2_Address                           : constant := 16#140_1220#;
    LW_PRGNLCL_FALCON_KMEM_VALID_3_Address                           : constant := 16#140_1224#;
    LW_PRGNLCL_FALCON_KMEM_VALID_4_Address                           : constant := 16#140_1228#;
    LW_PRGNLCL_FALCON_KMEM_VALID_5_Address                           : constant := 16#140_122c#;
    LW_PRGNLCL_FALCON_KMEM_VALID_6_Address                           : constant := 16#140_1230#;
    LW_PRGNLCL_FALCON_KMEM_VALID_7_Address                           : constant := 16#140_1234#;
    LW_PRGNLCL_FALCON_KMEM_VIOLATION_CTL_Address                     : constant := 16#140_1238#;
    LW_PRGNLCL_FALCON_EXCI_KMEM_VIOLATION_DBGINF_Address             : constant := 16#140_123c#;
    LW_PRGNLCL_FALCON_KMEM_SLOT_MASK_Address                         : constant := 16#140_1240#;
    LW_PRGNLCL_FALCON_KEYGLOB_CTRL_Address                           : constant := 16#140_1248#;
    LW_PRGNLCL_FALCON_KEYGLOB_DATA_Address                           : constant := 16#140_124c#;
    LW_PRGNLCL_RISCV_EXE_PRIV_LEVEL_MASK_Address                     : constant := 16#140_1304#;
    LW_PRGNLCL_RISCV_CPUCTL_PRIV_LEVEL_MASK_Address                  : constant := 16#140_1308#;
    LW_PRGNLCL_RISCV_IRQ_PRIV_LEVEL_MASK_Address                     : constant := 16#140_1300#;
    LW_PRGNLCL_RISCV_DBGCTL_PRIV_LEVEL_MASK_Address                  : constant := 16#140_1314#;
    LW_PRGNLCL_RISCV_BOOTVEC_PRIV_LEVEL_MASK_Address                 : constant := 16#140_1310#;
    LW_PRGNLCL_RISCV_BCR_PRIV_LEVEL_MASK_Address                     : constant := 16#140_1664#;
    LW_PRGNLCL_RISCV_BCR_DMACFG_SEC_PRIV_LEVEL_MASK_Address          : constant := 16#140_1690#;
    LW_PRGNLCL_RISCV_LWCONFIG_PRIV_LEVEL_MASK_Address                : constant := 16#140_130c#;
    LW_PRGNLCL_RISCV_TRACEBUF_PRIV_LEVEL_MASK_Address                : constant := 16#140_1318#;
    LW_PRGNLCL_RISCV_MSIP_PRIV_LEVEL_MASK_Address                    : constant := 16#140_131c#;
    LW_PRGNLCL_RISCV_MSPM_PRIV_LEVEL_MASK_Address                    : constant := 16#140_1320#;
    LW_PRGNLCL_RISCV_PIC_PRIV_LEVEL_MASK_Address                     : constant := 16#140_1514#;
    LW_PRGNLCL_RISCV_PICSCMASK_PRIV_LEVEL_MASK_Address               : constant := 16#140_1518#;
    LW_PRGNLCL_RISCV_ERR_PRIV_LEVEL_MASK_Address                     : constant := 16#140_151c#;
    LW_PRGNLCL_RISCV_NO_ACCESS_PRIV_LEVEL_MASK_Address               : constant := 16#140_1538#;
    LW_PRGNLCL_RISCV_IRQMSET_Address                                 : constant := 16#140_1520#;
    LW_PRGNLCL_RISCV_IRQMCLR_Address                                 : constant := 16#140_1524#;
    LW_PRGNLCL_RISCV_IRQMASK_Address                                 : constant := 16#140_1528#;
    LW_PRGNLCL_RISCV_IRQDEST_Address                                 : constant := 16#140_152c#;
    LW_PRGNLCL_RISCV_IRQTYPE_Address                                 : constant := 16#140_1530#;
    LW_PRGNLCL_RISCV_IRQDELEG_Address                                : constant := 16#140_1534#;
    LW_PRGNLCL_RISCV_EXTIRQSSET_Address                              : constant := 16#140_1540#;
    LW_PRGNLCL_RISCV_EXTIRQSCLR_Address                              : constant := 16#140_1544#;
    LW_PRGNLCL_RISCV_EXTIRQSTAT_Address                              : constant := 16#140_1548#;
    LW_PRGNLCL_RISCV_EXTIRQMODE_Address                              : constant := 16#140_154c#;
    LW_PRGNLCL_RISCV_EXTIRQSCMASK_Address                            : constant := 16#140_1550#;
    LW_PRGNLCL_RISCV_EXTIRQMSET_Address                              : constant := 16#140_1554#;
    LW_PRGNLCL_RISCV_EXTIRQMCLR_Address                              : constant := 16#140_1558#;
    LW_PRGNLCL_RISCV_EXTIRQMASK_Address                              : constant := 16#140_155c#;
    LW_PRGNLCL_RISCV_EXTIRQDEST_Address                              : constant := 16#140_1560#;
    LW_PRGNLCL_RISCV_EXTIRQTYPE_Address                              : constant := 16#140_1564#;
    LW_PRGNLCL_RISCV_EXTIRQDELEG_Address                             : constant := 16#140_1568#;
    LW_PRGNLCL_RISCV_BOOT_VECTOR_HI_Address                          : constant := 16#140_1384#;
    LW_PRGNLCL_RISCV_BOOT_VECTOR_LO_Address                          : constant := 16#140_1380#;
    LW_PRGNLCL_RISCV_CPUCTL_Address                                  : constant := 16#140_1388#;
    LW_PRGNLCL_RISCV_LWCONFIG_Address                                : constant := 16#140_1390#;
    LW_PRGNLCL_RISCV_CG_Address                                      : constant := 16#140_1398#;
    LW_PRGNLCL_RISCV_CYA_Address                                     : constant := 16#140_139c#;
    LW_PRGNLCL_RISCV_MSPM_Address                                    : constant := 16#140_13a0#;
    LW_PRGNLCL_RISCV_DBGCTL_Address                                  : constant := 16#140_13c8#;
    LW_PRGNLCL_RISCV_DBGCTL_LOCK_Address                             : constant := 16#140_13cc#;
    LW_PRGNLCL_RISCV_ICD_CMD_Address                                 : constant := 16#140_13d0#;
    LW_PRGNLCL_RISCV_ICD_ADDR0_Address                               : constant := 16#140_13d4#;
    LW_PRGNLCL_RISCV_ICD_ADDR1_Address                               : constant := 16#140_13d8#;
    LW_PRGNLCL_RISCV_ICD_WDATA0_Address                              : constant := 16#140_13dc#;
    LW_PRGNLCL_RISCV_ICD_WDATA1_Address                              : constant := 16#140_13e0#;
    LW_PRGNLCL_RISCV_ICD_RDATA0_Address                              : constant := 16#140_13e4#;
    LW_PRGNLCL_RISCV_ICD_RDATA1_Address                              : constant := 16#140_13e8#;
    LW_PRGNLCL_RISCV_RPC_Address                                     : constant := 16#140_13ec#;
    LW_PRGNLCL_RISCV_RSTAT0_Address                                  : constant := 16#140_13f0#;
    LW_PRGNLCL_RISCV_TRACECTL_Address                                : constant := 16#140_1400#;
    LW_PRGNLCL_RISCV_TRACE_RDIDX_Address                             : constant := 16#140_1404#;
    LW_PRGNLCL_RISCV_TRACE_WTIDX_Address                             : constant := 16#140_1408#;
    LW_PRGNLCL_RISCV_TRACEPC_HI_Address                              : constant := 16#140_1410#;
    LW_PRGNLCL_RISCV_TRACEPC_LO_Address                              : constant := 16#140_140c#;
    LW_PRGNLCL_RISCV_MTIMECMP_HI_Address                             : constant := 16#140_13c4#;
    LW_PRGNLCL_RISCV_MTIMECMP_LO_Address                             : constant := 16#140_13c0#;
    LW_PRGNLCL_RISCV_INTR_STATUS_Address                             : constant := 16#140_1394#;
    LW_PRGNLCL_RISCV_MSIP_Address                                    : constant := 16#140_138c#;
    LW_PRGNLCL_RISCV_PRIV_ERR_STAT_Address                           : constant := 16#140_1500#;
    LW_PRGNLCL_RISCV_PRIV_ERR_INFO_Address                           : constant := 16#140_1504#;
    LW_PRGNLCL_RISCV_PRIV_ERR_ADDR_Address                           : constant := 16#140_1508#;
    LW_PRGNLCL_RISCV_PRIV_ERR_ADDR_HI_Address                        : constant := 16#140_150c#;
    LW_PRGNLCL_RISCV_HUB_ERR_STAT_Address                            : constant := 16#140_1510#;
    LW_PRGNLCL_RISCV_IROM_PATCH_CAM_INDEX_Address                    : constant := 16#140_1590#;
    LW_PRGNLCL_RISCV_IROM_PATCH_CAM_ADDR_VALID_Address               : constant := 16#140_1594#;
    LW_PRGNLCL_RISCV_IROM_PATCH_CAM_DATA_Address                     : constant := 16#140_1598#;
    LW_PRGNLCL_RISCV_IROM_PATCH_SECURE_Address                       : constant := 16#140_159c#;
    LW_PRGNLCL_RISCV_IOPMP_INDEX_Address                             : constant := 16#140_15b0#;
    LW_PRGNLCL_RISCV_IOPMP_CFG_Address                               : constant := 16#140_15b4#;
    LW_PRGNLCL_RISCV_IOPMP_ADDR_HI_Address                           : constant := 16#140_15bc#;
    LW_PRGNLCL_RISCV_IOPMP_ADDR_LO_Address                           : constant := 16#140_15b8#;
    LW_PRGNLCL_RISCV_IOPMP_MODE_0_Address                            : constant := 16#140_15c0#;
    LW_PRGNLCL_RISCV_IOPMP_MODE_1_Address                            : constant := 16#140_15c4#;
    LW_PRGNLCL_RISCV_IOPMP_ERR_STAT_Address                          : constant := 16#140_15e0#;
    LW_PRGNLCL_RISCV_IOPMP_ERR_INFO_Address                          : constant := 16#140_15e4#;
    LW_PRGNLCL_RISCV_IOPMP_ERR_ADDR_HI_Address                       : constant := 16#140_15ec#;
    LW_PRGNLCL_RISCV_IOPMP_ERR_ADDR_LO_Address                       : constant := 16#140_15e8#;
    LW_PRGNLCL_RISCV_IOPMP_ERR_CAPEN_Address                         : constant := 16#140_15f0#;
    LW_PRGNLCL_RISCV_SCPDMATRFMOFFS_Address                          : constant := 16#140_1570#;
    LW_PRGNLCL_RISCV_SCPDMATRFCMD_Address                            : constant := 16#140_1574#;
    LW_PRGNLCL_RISCV_SCPDMAPOLL_Address                              : constant := 16#140_1578#;
    LW_PRGNLCL_RISCV_SCP_SECRET_MASK_0_Address                       : constant := 16#140_1580#;
    LW_PRGNLCL_RISCV_SCP_SECRET_MASK_1_Address                       : constant := 16#140_1584#;
    LW_PRGNLCL_RISCV_SCP_SECRET_MASK_LOCK_0_Address                  : constant := 16#140_1588#;
    LW_PRGNLCL_RISCV_SCP_SECRET_MASK_LOCK_1_Address                  : constant := 16#140_158c#;
    LW_PRGNLCL_RISCV_BR_VER_Address                                  : constant := 16#140_1658#;
    LW_PRGNLCL_RISCV_BR_RETCODE_Address                              : constant := 16#140_165c#;
    LW_PRGNLCL_RISCV_BR_PRIV_LOCKDOWN_Address                        : constant := 16#140_1660#;
    LW_PRGNLCL_RISCV_BCR_CTRL_Address                                : constant := 16#140_1668#;
    LW_PRGNLCL_RISCV_BCR_DMACFG_Address                              : constant := 16#140_166c#;
    LW_PRGNLCL_RISCV_BCR_DMACFG_SEC_Address                          : constant := 16#140_1694#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_PKCPARAM_LO_Address                 : constant := 16#140_1670#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_PKCPARAM_HI_Address                 : constant := 16#140_1674#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_FMCCODE_LO_Address                  : constant := 16#140_1678#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_FMCCODE_HI_Address                  : constant := 16#140_167c#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_FMCDATA_LO_Address                  : constant := 16#140_1680#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_FMCDATA_HI_Address                  : constant := 16#140_1684#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_PUBKEY_LO_Address                   : constant := 16#140_1688#;
    LW_PRGNLCL_RISCV_BCR_DMAADDR_PUBKEY_HI_Address                   : constant := 16#140_168c#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVMMODE_0_Address                  : constant := 16#140_1610#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVMMODE_1_Address                  : constant := 16#140_1618#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVMMODE_2_Address                  : constant := 16#140_1620#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVMMODE_3_Address                  : constant := 16#140_1628#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVSUBMMODE_0_Address               : constant := 16#140_1614#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVSUBMMODE_1_Address               : constant := 16#140_161c#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVSUBMMODE_2_Address               : constant := 16#140_1624#;
    LW_PRGNLCL_RISCV_DEVICEMAP_RISCVSUBMMODE_3_Address               : constant := 16#140_162c#;
    LW_PRGNLCL_SCP_CTL0_Address                                      : constant := 16#140_0c00#;
    LW_PRGNLCL_SCP_CTL1_Address                                      : constant := 16#140_0c04#;
    LW_PRGNLCL_SCP_CTL_STAT_Address                                  : constant := 16#140_0c08#;
    LW_PRGNLCL_SCP_CTL_CFG_Address                                   : constant := 16#140_0c0c#;
    LW_PRGNLCL_SCP_CFG0_Address                                      : constant := 16#140_0c10#;
    LW_PRGNLCL_SCP_CTL_DEBUG_Address                                 : constant := 16#140_0c1c#;
    LW_PRGNLCL_SCP_DEBUG0_Address                                    : constant := 16#140_0c20#;
    LW_PRGNLCL_SCP_DEBUG1_Address                                    : constant := 16#140_0c24#;
    LW_PRGNLCL_SCP_DEBUG2_Address                                    : constant := 16#140_0c28#;
    LW_PRGNLCL_SCP_DEBUG_CMD_Address                                 : constant := 16#140_0c30#;
    LW_PRGNLCL_SCP_ACL_FETCH_Address                                 : constant := 16#140_0c40#;
    LW_PRGNLCL_SCP_ACL_KEYABLE_Address                               : constant := 16#140_0c44#;
    LW_PRGNLCL_SCP_ACL_WRITE_Address                                 : constant := 16#140_0c48#;
    LW_PRGNLCL_SCP_STATUS_Address                                    : constant := 16#140_0c50#;
    LW_PRGNLCL_SCP_STAT0_Address                                     : constant := 16#140_0c54#;
    LW_PRGNLCL_SCP_STAT1_Address                                     : constant := 16#140_0c58#;
    LW_PRGNLCL_SCP_SECRET63_CTL_Address                              : constant := 16#140_0c60#;
    LW_PRGNLCL_SCP_RNG_STAT0_Address                                 : constant := 16#140_0c70#;
    LW_PRGNLCL_SCP_RNG_STAT1_Address                                 : constant := 16#140_0c74#;
    LW_PRGNLCL_SCP_INTR_Address                                      : constant := 16#140_0c80#;
    LW_PRGNLCL_SCP_INTR_EN_Address                                   : constant := 16#140_0c84#;
    LW_PRGNLCL_SCP_ACL_VIO_Address                                   : constant := 16#140_0c90#;
    LW_PRGNLCL_SCP_SECURITY_VIO_Address                              : constant := 16#140_0c94#;
    LW_PRGNLCL_SCP_CMD_ERROR_Address                                 : constant := 16#140_0c98#;
    LW_PRGNLCL_SCP_RNDCTL0_Address                                   : constant := 16#140_0d00#;
    LW_PRGNLCL_SCP_RNDCTL1_Address                                   : constant := 16#140_0d04#;
    LW_PRGNLCL_SCP_RNDCTL2_Address                                   : constant := 16#140_0d08#;
    LW_PRGNLCL_SCP_RNDCTL3_Address                                   : constant := 16#140_0d0c#;
    LW_PRGNLCL_SCP_RNDCTL4_Address                                   : constant := 16#140_0d10#;
    LW_PRGNLCL_SCP_RNDCTL5_Address                                   : constant := 16#140_0d14#;
    LW_PRGNLCL_SCP_RNDCTL6_Address                                   : constant := 16#140_0d18#;
    LW_PRGNLCL_SCP_RNDCTL7_Address                                   : constant := 16#140_0d1c#;
    LW_PRGNLCL_SCP_RNDCTL8_Address                                   : constant := 16#140_0d20#;
    LW_PRGNLCL_SCP_RNDCTL9_Address                                   : constant := 16#140_0d24#;
    LW_PRGNLCL_SCP_RNDCTL10_Address                                  : constant := 16#140_0d28#;
    LW_PRGNLCL_SCP_RNDCTL11_Address                                  : constant := 16#140_0d2c#;
    LW_PRGNLCL_SCP_CTL_P2PRX_Address                                 : constant := 16#140_0d30#;
    LW_PRGNLCL_SCP_SCC_DEBUG_HWCFG0_Address                          : constant := 16#140_0d40#;
    LW_PRGNLCL_SCP_SCC_DEBUG_HWCFG1_Address                          : constant := 16#140_0d44#;
    LW_PRGNLCL_SCP_SCC_DEBUG_HWCFG2_Address                          : constant := 16#140_0d48#;
    LW_PRGNLCL_SCP_SCC_DEBUG_STAT0_Address                           : constant := 16#140_0d4c#;
    LW_PRGNLCL_SCP_SCC_DEBUG_STAT1_Address                           : constant := 16#140_0d50#;
    LW_PRGNLCL_SCP_PUBKEYC_Address                                   : constant := 16#140_0d60#;
    LW_PRGNLCL_SCP_PUBKEYD_Address                                   : constant := 16#140_0d64#;
    LW_PRGNLCL_SCP_PK_ADDR_Address                                   : constant := 16#140_0d70#;
    LW_PRGNLCL_SCP_PK_DATA_Address                                   : constant := 16#140_0d74#;
    LW_PRGNLCL_FBIF_REGIONCFG_PRIV_LEVEL_MASK_Address                : constant := 16#140_0e70#;
    LW_PRGNLCL_FBIF_CTL2_PRIV_LEVEL_MASK_Address                     : constant := 16#140_0e88#;
    LW_PRGNLCL_FBIF_TRANSCFG_0_Address                               : constant := 16#140_0e00#;
    LW_PRGNLCL_FBIF_TRANSCFG_1_Address                               : constant := 16#140_0e04#;
    LW_PRGNLCL_FBIF_TRANSCFG_2_Address                               : constant := 16#140_0e08#;
    LW_PRGNLCL_FBIF_TRANSCFG_3_Address                               : constant := 16#140_0e0c#;
    LW_PRGNLCL_FBIF_TRANSCFG_4_Address                               : constant := 16#140_0e10#;
    LW_PRGNLCL_FBIF_TRANSCFG_5_Address                               : constant := 16#140_0e14#;
    LW_PRGNLCL_FBIF_TRANSCFG_6_Address                               : constant := 16#140_0e18#;
    LW_PRGNLCL_FBIF_TRANSCFG_7_Address                               : constant := 16#140_0e1c#;
    LW_PRGNLCL_FBIF_INSTBLK_Address                                  : constant := 16#140_0e20#;
    LW_PRGNLCL_FBIF_TLB_INVALIDATE_PARAM1_LO_Address                 : constant := 16#140_0e90#;
    LW_PRGNLCL_FBIF_TLB_INVALIDATE_PARAM1_HI_Address                 : constant := 16#140_0e94#;
    LW_PRGNLCL_FBIF_CTL_Address                                      : constant := 16#140_0e24#;
    LW_PRGNLCL_FBIF_CTL2_Address                                     : constant := 16#140_0e84#;
    LW_PRGNLCL_FBIF_THROTTLE_Address                                 : constant := 16#140_0e2c#;
    LW_PRGNLCL_FBIF_REGIONCFG_Address                                : constant := 16#140_0e6c#;
    LW_PRGNLCL_FBIF_CG1_Address                                      : constant := 16#140_0e74#;
    LW_PRGNLCL_FBIF_ACHK_BLK_0_Address                               : constant := 16#140_0e30#;
    LW_PRGNLCL_FBIF_ACHK_BLK_1_Address                               : constant := 16#140_0e38#;
    LW_PRGNLCL_FBIF_ACHK_CTL_0_Address                               : constant := 16#140_0e34#;
    LW_PRGNLCL_FBIF_ACHK_CTL_1_Address                               : constant := 16#140_0e3c#;
    LW_PRGNLCL_FBIF_DBG_STAT0_Address                                : constant := 16#140_0e40#;
    LW_PRGNLCL_FBIF_DBG_STAT1_Address                                : constant := 16#140_0e44#;
    LW_PRGNLCL_FBIF_DBG_STAT2_Address                                : constant := 16#140_0e48#;
    LW_PRGNLCL_FBIF_DBG_RDCOUNT_LO_Address                           : constant := 16#140_0e50#;
    LW_PRGNLCL_FBIF_DBG_RDCOUNT_HI_Address                           : constant := 16#140_0e54#;
    LW_PRGNLCL_FBIF_DBG_WRCOUNT_LO_Address                           : constant := 16#140_0e58#;
    LW_PRGNLCL_FBIF_DBG_WRCOUNT_HI_Address                           : constant := 16#140_0e5c#;
    LW_PRGNLCL_FBIF_BW_ALLOC_Address                                 : constant := 16#140_0e4c#;
end Dev_Prgnlcl;

...
--*
--* Copyright 2003-2021 by NVIDIA Corporation.  All rights reserved.  All
...
is
    ...
    LW_RISCV_CSR_MISA_WPRI_RST  : constant NvU36 := 16#0#;
    LW_RISCV_CSR_MISA_EXT2_RST  : constant NvU23 := 16#12_8224#;
    LW_RISCV_CSR_MISA_EXT_C_RST : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MISA_EXT1_RST  : constant NvU2  := 16#0#;
    ...
    LW_RISCV_CSR_MVENDORID_VENDORH_RST : constant NvU32 := 16#0#;
    LW_RISCV_CSR_MVENDORID_VENDORL_RST : constant NvU32 := 16#1eb#;
    ...
    LW_RISCV_CSR_MARCHID_MSB_RST           : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MARCHID_RS1_RST           : constant NvU47 := 16#0#;
    LW_RISCV_CSR_MARCHID_CORE_MAJOR_RST    : constant NvU4  := 16#2#;
    LW_RISCV_CSR_MARCHID_CORE_MINOR_RST    : constant NvU4  := 16#0#;
    ...
    LW_RISCV_CSR_MIMPID_IMPID_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MHARTID_HART_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_WPRI4_RST : constant NvU27 := 16#0#;
    LW_RISCV_CSR_MSTATUS_SXL_RST   : constant NvU2  := 16#2#;
    LW_RISCV_CSR_MSTATUS_UXL_RST   : constant NvU2  := 16#2#;
    LW_RISCV_CSR_MSTATUS_WPRI3_RST : constant NvU8  := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_SUM_DISABLE : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_XS_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_WPRI2_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_WPRI1_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_UPIE_DISABLE : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_WPRI0_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MSTATUS_UIE_DISABLE : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MTVEC_BASE_RST : constant NvU62 := 16#0#;
    ...
    LW_RISCV_CSR_MEDELEG_WPRI3_RST : constant NvU35 := 16#0#;
    ...
    LW_RISCV_CSR_MEDELEG_WPRI2_RST : constant NvU12 := 16#0#;
    ...
    LW_RISCV_CSR_MEDELEG_WPRI1_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MEDELEG_WPRI0_RST : constant NvU3 := 16#0#;
    ...
    LW_RISCV_CSR_MIDELEG_WPRI2_RST : constant NvU54 := 16#0#;
    ...
    LW_RISCV_CSR_MIDELEG_WPRI1_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MIDELEG_WPRI0_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MIP_WIRI3_RST : constant NvU52 := 16#0#;
    LW_RISCV_CSR_MIP_MEIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_WIRI2_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_SEIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_UEIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_MTIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_WIRI1_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_STIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_UTIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_MSIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_WIRI0_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_SSIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIP_USIP_RST  : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_MIE_WPRI3_RST : constant NvU52 := 16#0#;
    LW_RISCV_CSR_MIE_MEIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_WPRI2_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_SEIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_UEIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_MTIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_WPRI1_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_STIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_UTIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_MSIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_WPRI0_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_SSIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MIE_USIE_RST  : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_MHPMCOUNTER_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MCOUNTEREN_RS0_RST     : constant NvU32 := 16#0#;
    LW_RISCV_CSR_MCOUNTEREN_HPM_DISABLE : constant NvU29 := 16#0#;
    ...
    LW_RISCV_CSR_MHPMEVENT_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MSCRATCH_SCRATCH_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MEPC_EPC_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MCAUSE_INT_RST            : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MCAUSE_WLRL_RST           : constant NvU58 := 16#0#;
    LW_RISCV_CSR_MCAUSE_EXCODE_RST         : constant NvU5  := 16#0#;
    LW_RISCV_CSR_MCAUSE_EXCODE_IAMA        : constant NvU5  := 16#0#;
    LW_RISCV_CSR_MCAUSE_EXCODE_IACC_FAULT  : constant NvU5  := 16#1#;
    LW_RISCV_CSR_MCAUSE_EXCODE_ILL         : constant NvU5  := 16#2#;
    LW_RISCV_CSR_MCAUSE_EXCODE_BKPT        : constant NvU5  := 16#3#;
    LW_RISCV_CSR_MCAUSE_EXCODE_LAMA        : constant NvU5  := 16#4#;
    LW_RISCV_CSR_MCAUSE_EXCODE_LACC_FAULT  : constant NvU5  := 16#5#;
    LW_RISCV_CSR_MCAUSE_EXCODE_SAMA        : constant NvU5  := 16#6#;
    LW_RISCV_CSR_MCAUSE_EXCODE_SACC_FAULT  : constant NvU5  := 16#7#;
    LW_RISCV_CSR_MCAUSE_EXCODE_UCALL       : constant NvU5  := 16#8#;
    LW_RISCV_CSR_MCAUSE_EXCODE_SCALL       : constant NvU5  := 16#9#;
    LW_RISCV_CSR_MCAUSE_EXCODE_MCALL       : constant NvU5  := 16#b#;
    LW_RISCV_CSR_MCAUSE_EXCODE_IPAGE_FAULT : constant NvU5  := 16#c#;
    LW_RISCV_CSR_MCAUSE_EXCODE_LPAGE_FAULT : constant NvU5  := 16#d#;
    LW_RISCV_CSR_MCAUSE_EXCODE_SPAGE_FAULT : constant NvU5  := 16#f#;
    LW_RISCV_CSR_MCAUSE_EXCODE_USS         : constant NvU5  := 16#1c#;
    LW_RISCV_CSR_MCAUSE_EXCODE_SSS         : constant NvU5  := 16#1d#;
    LW_RISCV_CSR_MCAUSE_EXCODE_U_SWINT     : constant NvU5  := 16#0#;
    LW_RISCV_CSR_MCAUSE_EXCODE_S_SWINT     : constant NvU5  := 16#1#;
    LW_RISCV_CSR_MCAUSE_EXCODE_M_SWINT     : constant NvU5  := 16#3#;
    LW_RISCV_CSR_MCAUSE_EXCODE_U_TINT      : constant NvU5  := 16#4#;
    LW_RISCV_CSR_MCAUSE_EXCODE_S_TINT      : constant NvU5  := 16#5#;
    LW_RISCV_CSR_MCAUSE_EXCODE_M_TINT      : constant NvU5  := 16#7#;
    LW_RISCV_CSR_MCAUSE_EXCODE_U_EINT      : constant NvU5  := 16#8#;
    LW_RISCV_CSR_MCAUSE_EXCODE_S_EINT      : constant NvU5  := 16#9#;
    LW_RISCV_CSR_MCAUSE_EXCODE_M_EINT      : constant NvU5  := 16#b#;
    ...
    LW_RISCV_CSR_MCAUSE2_WPRI_RST            : constant NvU40 := 16#0#;
    LW_RISCV_CSR_MCAUSE2_CAUSE_NO            : constant NvU8  := 16#0#;
    LW_RISCV_CSR_MCAUSE2_CAUSE_EBREAK        : constant NvU8  := 16#17#;
    LW_RISCV_CSR_MCAUSE2_CAUSE_HW_TRIGGER    : constant NvU8  := 16#18#;
    LW_RISCV_CSR_MCAUSE2_CAUSE_U_SINGLE_STEP : constant NvU8  := 16#19#;
    LW_RISCV_CSR_MCAUSE2_ERROR_NO            : constant NvU16 := 16#0#;
    ...
    LW_RISCV_CSR_MTVAL_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP7S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP6S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP5S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP4S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP3S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP2S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP1S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG0_PMP0S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP15S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP14S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP13S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP12S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP11S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP10S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP9S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPCFG2_PMP8S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_PMPADDR_WIRI_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_PMPADDR_ADDR_RST : constant NvU62 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP23S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP22S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP21S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP20S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP19S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP18S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP17S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG0_PMP16S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP31S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP30S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP29S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP28S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP27S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP26S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP25S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPCFG2_PMP24S_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MEXTPMPADDR_WIRI_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_MEXTPMPADDR_ADDR_RST : constant NvU62 := 16#0#;
    ...
    LW_RISCV_CSR_MSCRATCH2_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MTIMECMP_TIME_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MCFG_WPRI4_RST : constant NvU48 := 16#0#;
    ...
    LW_RISCV_CSR_MCFG_WPRI5_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MCFG_WPRI3_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MCFG_WPRI2_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_MCFG_WPRI1_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MCFG_UWFP_DIS_FALSE : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MBPCFG_WPRI2_RST       : constant NvU42 := 16#0#;
    LW_RISCV_CSR_MBPCFG_RAS_FLUSH_TRUE  : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MBPCFG_BHT_FLUSH_TRUE  : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MBPCFG_BTB_FLUSHM_TRUE : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MBPCFG_WPRI1_RST       : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MBPCFG_BTB_FLUSHS_TRUE : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MBPCFG_BTB_FLUSHU_TRUE : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MBPCFG_WPRI0_RST       : constant NvU13 := 16#0#;
    ...
    LW_RISCV_CSR_MMPUCTL_WPRI1_RST       : constant NvU40 := 16#0#;
    LW_RISCV_CSR_MMPUCTL_ENTRY_COUNT_RST : constant NvU8  := 16#80#;
    LW_RISCV_CSR_MMPUCTL_WPRI0_RST       : constant NvU9  := 16#0#;
    LW_RISCV_CSR_MMPUCTL_START_INDEX_RST : constant NvU7  := 16#0#;
    ...
    LW_RISCV_CSR_MCURRUID_RS0_RST      : constant NvU32 := 16#0#;
    LW_RISCV_CSR_MCURRUID_MCURRUID_RST : constant NvU8  := 16#0#;
    LW_RISCV_CSR_MCURRUID_WPRI0_RST    : constant NvU8  := 16#0#;
    LW_RISCV_CSR_MCURRUID_SCURRUID_RST : constant NvU8  := 16#0#;
    LW_RISCV_CSR_MCURRUID_UCURRUID_RST : constant NvU8  := 16#0#;

    type LW_RISCV_CSR_MCURRUID_Register is record
        Rs0      : NvU32;
        Mcurruid : NvU8;
        Wpri0    : NvU8;
        Scurruid : NvU8;
    ...
    for LW_RISCV_CSR_MCURRUID_Register use record
        Rs0      at 0 range 32 .. 63;
        Mcurruid at 0 range 24 .. 31;
        Wpri0    at 0 range 16 .. 23;
        Scurruid at 0 range  8 .. 15;
        Ucurruid at 0 range  0 ..  7;
    end record;

    LW_RISCV_CSR_MOPT_CMD_HALT : constant NvU5 := 16#0#;
    ...
    LW_RISCV_CSR_MMISCOPEN_WPRI_RST : constant NvU63 := 16#0#;
    ...
    LW_RISCV_CSR_MLDSTATTR_RS0_RST       : constant NvU34 := 16#0#;
    LW_RISCV_CSR_MLDSTATTR_VPR_RST       : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MLDSTATTR_WPR_RST       : constant NvU5  := 16#0#;
    LW_RISCV_CSR_MLDSTATTR_L2C_RD_RST    : constant NvU2  := 16#0#;
    LW_RISCV_CSR_MLDSTATTR_L2C_WR_RST    : constant NvU2  := 16#0#;
    LW_RISCV_CSR_MLDSTATTR_COHERENT_RST  : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MLDSTATTR_CACHEABLE_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MLDSTATTR_RS1_RST       : constant NvU18 := 16#0#;
    ...
    LW_RISCV_CSR_MFETCHATTR_RS0_RST       : constant NvU34 := 16#0#;
    LW_RISCV_CSR_MFETCHATTR_VPR_RST       : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MFETCHATTR_WPR_RST       : constant NvU5  := 16#0#;
    LW_RISCV_CSR_MFETCHATTR_L2C_RD_RST    : constant NvU2  := 16#0#;
    LW_RISCV_CSR_MFETCHATTR_L2C_WR_RST    : constant NvU2  := 16#0#;
    LW_RISCV_CSR_MFETCHATTR_COHERENT_RST  : constant NvU1  := 16#1#;
    LW_RISCV_CSR_MFETCHATTR_CACHEABLE_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_MFETCHATTR_RS1_RST       : constant NvU18 := 16#0#;
    ...
    LW_RISCV_CSR_FFLAGS_RS0_RST    : constant NvU59 := 16#0#;
    LW_RISCV_CSR_FFLAGS_FFLAGS_RST : constant NvU5  := 16#0#;
    ...
    LW_RISCV_CSR_FRM_RS0_RST : constant NvU61 := 16#0#;
    LW_RISCV_CSR_FRM_FRM_RST : constant NvU3  := 16#0#;
    ...
    LW_RISCV_CSR_FCSR_RS0_RST    : constant NvU56 := 16#0#;
    LW_RISCV_CSR_FCSR_FRM_RST    : constant NvU3  := 16#0#;
    LW_RISCV_CSR_FCSR_FFLAGS_RST : constant NvU5  := 16#0#;
    ...
    LW_RISCV_CSR_HPMCOUNTER_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_MSPM_WPRI3_RST : constant NvU32 := 16#0#;
    ...
    LW_RISCV_CSR_MSPM_WPRI2_RST : constant NvU11 := 16#0#;
    ...
    LW_RISCV_CSR_MSPM_WPRI1_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MSPM_MPLM_LEVEL0 : constant NvU4 := 16#1#;
    LW_RISCV_CSR_MSPM_MPLM_LEVEL1 : constant NvU4 := 16#3#;
    LW_RISCV_CSR_MSPM_MPLM_LEVEL2 : constant NvU4 := 16#5#;
    LW_RISCV_CSR_MSPM_MPLM_LEVEL3 : constant NvU4 := 16#f#;
    LW_RISCV_CSR_MSPM_WPRI0_RST   : constant NvU4 := 16#0#;
    LW_RISCV_CSR_MSPM_SPLM_LEVEL0 : constant NvU4 := 16#1#;
    LW_RISCV_CSR_MSPM_SPLM_LEVEL1 : constant NvU4 := 16#3#;
    LW_RISCV_CSR_MSPM_SPLM_LEVEL2 : constant NvU4 := 16#5#;
    LW_RISCV_CSR_MSPM_SPLM_LEVEL3 : constant NvU4 := 16#f#;
    LW_RISCV_CSR_MSPM_UPLM_LEVEL0 : constant NvU4 := 16#1#;
    LW_RISCV_CSR_MSPM_UPLM_LEVEL1 : constant NvU4 := 16#3#;
    LW_RISCV_CSR_MSPM_UPLM_LEVEL2 : constant NvU4 := 16#5#;
    LW_RISCV_CSR_MSPM_UPLM_LEVEL3 : constant NvU4 := 16#f#;
    ...
    LW_RISCV_CSR_MDBGCTL_WIRI_RST : constant NvU58 := 16#0#;
    ...
    type LW_RISCV_CSR_MDBGCTL_ICDPL_Field is (ICDPL_USE_PL0, ICDPL_USE_CUR) with
        Size => 1;
    for LW_RISCV_CSR_MDBGCTL_ICDPL_Field use (ICDPL_USE_PL0 => 16#0#, ICDPL_USE_CUR => 16#1#);
    ...
    LW_RISCV_CSR_MRSP_WPRI2_RST : constant NvU52 := 16#0#;
    ...
    LW_RISCV_CSR_MRSP_WPRI1_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_MRSP_WPRI0_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_SPM_WIRI1_RST : constant NvU47 := 16#0#;
    ...
    LW_RISCV_CSR_SPM_WIRI0_RST   : constant NvU12 := 16#0#;
    LW_RISCV_CSR_SPM_UPLM_LEVEL0 : constant NvU4  := 16#1#;
    LW_RISCV_CSR_SPM_UPLM_LEVEL1 : constant NvU4  := 16#3#;
    LW_RISCV_CSR_SPM_UPLM_LEVEL2 : constant NvU4  := 16#5#;
    LW_RISCV_CSR_SPM_UPLM_LEVEL3 : constant NvU4  := 16#f#;
    ...
    LW_RISCV_CSR_RSP_WPRI1_RST : constant NvU55 := 16#0#;
    ...
    LW_RISCV_CSR_RSP_WPRI0_RST : constant NvU6 := 16#0#;
    ...
    LW_RISCV_CSR_TSELECT_RS0_RST   : constant NvU58 := 16#0#;
    LW_RISCV_CSR_TSELECT_INDEX_RST : constant NvU6  := 16#0#;
    ...
    LW_RISCV_CSR_TDATA1_TDATA1_TYPE_ADDR_DATA : constant NvU4  := 16#2#;
    LW_RISCV_CSR_TDATA1_DMODE_RST             : constant NvU1  := 16#0#;
    LW_RISCV_CSR_TDATA1_MASKMAX_RST           : constant NvU6  := 16#0#;
    LW_RISCV_CSR_TDATA1_RS0_RST               : constant NvU33 := 16#0#;
    LW_RISCV_CSR_TDATA1_TDATA1_SELECT_RST     : constant NvU1  := 16#0#;
    LW_RISCV_CSR_TDATA1_TIMING_RST            : constant NvU1  := 16#0#;
    LW_RISCV_CSR_TDATA1_ACTION_DBG            : constant NvU6  := 16#0#;
    LW_RISCV_CSR_TDATA1_ACTION_ICD            : constant NvU6  := 16#1#;
    LW_RISCV_CSR_TDATA1_CHAIN_RST             : constant NvU1  := 16#0#;
    LW_RISCV_CSR_TDATA1_MATCH_RST             : constant NvU4  := 16#0#;
    ...
    LW_RISCV_CSR_TDATA1_RS1_RST : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_TDATA1_EXECUTE_RST : constant NvU1 := 16#0#;
    LW_RISCV_CSR_TDATA1_STORE_RST   : constant NvU1 := 16#0#;
    LW_RISCV_CSR_TDATA1_LOAD_RST    : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_TDATA2_VALUE_RST : constant NvU64 := 16#0#;
    ...
    type LW_RISCV_CSR_MBIND_Register is record
        Gfid                  : NvU6;
        Inst_Blk_Ptr_Aperture : NvU2;
        Inst_Blk_Ptr_Adr      : NvU28;
    end record with
        Size        => 64,
        Object_Size => 64;
    ...
    for LW_RISCV_CSR_MBIND_Register use record
        ...
        Inst_Blk_Ptr_Adr      at 0 range  0 .. 27;
    end record;

    type LW_RISCV_CSR_MTLBINVDATA1_Register is record
        Ack_Type                     : NvU2;
        Sys_Membar                   : NvU1;
    ...
    for LW_RISCV_CSR_MTLBINVDATA1_Register use record
    ...
    type LW_RISCV_CSR_MTLBINVOP_Register is record
        Target_Adr : NvU37;
    end record with
        Size        => 64,
        Object_Size => 64;

    for LW_RISCV_CSR_MTLBINVOP_Register use record
        Target_Adr at 0 range 0 .. 36;
    end record;

    type LW_RISCV_CSR_MFLUSH_Register is record
        Rs0                   : NvU63;
        Host2fb_Membar_Type_T : NvU1;
    end record with
        Size        => 64,
        Object_Size => 64;
    ...
    LW_RISCV_CSR_MSYSOPEN_WPRI_RST : constant NvU56 := 16#0#;
    ...
    type LW_RISCV_CSR_MSYSOPEN_TLBINVOP_Field is (TLBINVOP_DISABLE, TLBINVOP_ENABLE) with
        Size => 1;
    for LW_RISCV_CSR_MSYSOPEN_TLBINVOP_Field use (TLBINVOP_DISABLE => 16#0#, TLBINVOP_ENABLE => 16#1#);
    type LW_RISCV_CSR_MSYSOPEN_TLBINVDATA1_Field is (TLBINVDATA1_DISABLE, TLBINVDATA1_ENABLE) with
        Size => 1;
    for LW_RISCV_CSR_MSYSOPEN_TLBINVDATA1_Field use (TLBINVDATA1_DISABLE => 16#0#, TLBINVDATA1_ENABLE => 16#1#);
    ...
    type LW_RISCV_CSR_MSYSOPEN_Register is record
        ...
        L2peerinv   : LW_RISCV_CSR_MSYSOPEN_L2PEERILW_Field;
        L2sysinv    : LW_RISCV_CSR_MSYSOPEN_L2SYSILW_Field;
        Flush       : LW_RISCV_CSR_MSYSOPEN_FLUSH_Field;
        Tlbinvop    : LW_RISCV_CSR_MSYSOPEN_TLBINVOP_Field;
        Tlbinvdata1 : LW_RISCV_CSR_MSYSOPEN_TLBINVDATA1_Field;
    ...
    for LW_RISCV_CSR_MSYSOPEN_Register use record
        ...
        L2peerinv   at 0 range 5 ..  5;
        L2sysinv    at 0 range 4 ..  4;
        Flush       at 0 range 3 ..  3;
        Tlbinvop    at 0 range 2 ..  2;
        Tlbinvdata1 at 0 range 1 ..  1;
        Bind        at 0 range 0 ..  0;
    end record;

    type LW_RISCV_CSR_MROMPROT_Register is record
        Rom_Prot : NvU64;
    end record with
        Size        => 64,
        Object_Size => 64;

    for LW_RISCV_CSR_MROMPROT_Register use record
    ...
    type LW_RISCV_CSR_TLBINVDATA1_Register is record
        Ack_Type                     : NvU2;
        Sys_Membar                   : NvU1;
        Cancel_Target_Gpc_Id         : NvU3;
        Cancel_Target_Client_Unit_Id : NvU7;
    ...
    for LW_RISCV_CSR_TLBINVDATA1_Register use record
        Ack_Type                     at 0 range 57 .. 58;
        Sys_Membar                   at 0 range 56 .. 56;
        Cancel_Target_Gpc_Id         at 0 range 53 .. 55;
        Cancel_Target_Client_Unit_Id at 0 range 46 .. 52;
    ...
    type LW_RISCV_CSR_TLBINVOP_Register is record
        Target_Adr : NvU37;
    end record with
        Size        => 64,
        Object_Size => 64;

    for LW_RISCV_CSR_TLBINVOP_Register use record
        Target_Adr at 0 range 0 .. 36;
    end record;
    ...
    LW_RISCV_CSR_SSTATUS_WPRI5_RST : constant NvU29 := 16#0#;
    LW_RISCV_CSR_SSTATUS_UXL_RST   : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SSTATUS_WPRI4_RST : constant NvU12 := 16#0#;
    LW_RISCV_CSR_SSTATUS_MXR_RST   : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_SSTATUS_WPRI3_RST : constant NvU1 := 16#0#;
    LW_RISCV_CSR_SSTATUS_XS_OFF    : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_SSTATUS_WPRI2_RST : constant NvU4 := 16#0#;
    ...
    LW_RISCV_CSR_SSTATUS_WPRI1_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_SSTATUS_UPIE_DISABLE : constant NvU1 := 16#0#;
    LW_RISCV_CSR_SSTATUS_WPRI0_RST    : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_SSTATUS_UIE_DISABLE : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_STVEC_BASE_RST : constant NvU62 := 16#0#;
    ...
    LW_RISCV_CSR_SSCRATCH_SCRATCH_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SIP_WIRI2_RST : constant NvU54 := 16#0#;
    LW_RISCV_CSR_SIP_SEIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIP_UEIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIP_WIRI1_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SIP_STIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIP_UTIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIP_WIRI0_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SIP_SSIP_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIP_USIP_RST  : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_SIE_WPRI2_RST : constant NvU54 := 16#0#;
    LW_RISCV_CSR_SIE_SEIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIE_UEIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIE_WPRI1_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SIE_STIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIE_UTIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIE_WPRI0_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SIE_SSIE_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SIE_USIE_RST  : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_STVAL_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SEPC_EPC_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SCAUSE_INT_RST            : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SCAUSE_WLRL_RST           : constant NvU58 := 16#0#;
    LW_RISCV_CSR_SCAUSE_EXCODE_RST         : constant NvU5  := 16#0#;
    LW_RISCV_CSR_SCAUSE_EXCODE_IAMA        : constant NvU5  := 16#0#;
    LW_RISCV_CSR_SCAUSE_EXCODE_IACC_FAULT  : constant NvU5  := 16#1#;
    LW_RISCV_CSR_SCAUSE_EXCODE_ILL         : constant NvU5  := 16#2#;
    LW_RISCV_CSR_SCAUSE_EXCODE_BKPT        : constant NvU5  := 16#3#;
    LW_RISCV_CSR_SCAUSE_EXCODE_LAMA        : constant NvU5  := 16#4#;
    LW_RISCV_CSR_SCAUSE_EXCODE_LACC_FAULT  : constant NvU5  := 16#5#;
    LW_RISCV_CSR_SCAUSE_EXCODE_SAMA        : constant NvU5  := 16#6#;
    LW_RISCV_CSR_SCAUSE_EXCODE_SACC_FAULT  : constant NvU5  := 16#7#;
    LW_RISCV_CSR_SCAUSE_EXCODE_UCALL       : constant NvU5  := 16#8#;
    LW_RISCV_CSR_SCAUSE_EXCODE_SCALL       : constant NvU5  := 16#9#;
    LW_RISCV_CSR_SCAUSE_EXCODE_IPAGE_FAULT : constant NvU5  := 16#c#;
    LW_RISCV_CSR_SCAUSE_EXCODE_LPAGE_FAULT : constant NvU5  := 16#d#;
    LW_RISCV_CSR_SCAUSE_EXCODE_SPAGE_FAULT : constant NvU5  := 16#f#;
    LW_RISCV_CSR_SCAUSE_EXCODE_USS         : constant NvU5  := 16#1c#;
    LW_RISCV_CSR_SCAUSE_EXCODE_U_SWINT     : constant NvU5  := 16#0#;
    LW_RISCV_CSR_SCAUSE_EXCODE_S_SWINT     : constant NvU5  := 16#1#;
    LW_RISCV_CSR_SCAUSE_EXCODE_U_TINT      : constant NvU5  := 16#4#;
    LW_RISCV_CSR_SCAUSE_EXCODE_S_TINT      : constant NvU5  := 16#5#;
    LW_RISCV_CSR_SCAUSE_EXCODE_U_EINT      : constant NvU5  := 16#8#;
    LW_RISCV_CSR_SCAUSE_EXCODE_S_EINT      : constant NvU5  := 16#9#;
    ...
    LW_RISCV_CSR_SCAUSE2_WPRI_RST            : constant NvU40 := 16#0#;
    LW_RISCV_CSR_SCAUSE2_CAUSE_NO            : constant NvU8  := 16#0#;
    LW_RISCV_CSR_SCAUSE2_CAUSE_EBREAK        : constant NvU8  := 16#17#;
    LW_RISCV_CSR_SCAUSE2_CAUSE_HW_TRIGGER    : constant NvU8  := 16#18#;
    LW_RISCV_CSR_SCAUSE2_CAUSE_U_SINGLE_STEP : constant NvU8  := 16#19#;
    LW_RISCV_CSR_SCAUSE2_ERROR_NO            : constant NvU16 := 16#0#;
    ...
    LW_RISCV_CSR_SATP_MODE_BARE  : constant NvU4  := 16#0#;
    LW_RISCV_CSR_SATP_MODE_LWMPU : constant NvU4  := 16#f#;
    LW_RISCV_CSR_SATP_ASID_BARE  : constant NvU16 := 16#0#;
    LW_RISCV_CSR_SATP_PPN_BARE   : constant NvU44 := 16#0#;
    ...
    LW_RISCV_CSR_SCOUNTEREN_RS0_RST     : constant NvU32 := 16#0#;
    LW_RISCV_CSR_SCOUNTEREN_HPM_DISABLE : constant NvU29 := 16#0#;
    ...
    LW_RISCV_CSR_SSPM_WPRI1_RST : constant NvU46 := 16#0#;
    ...
    LW_RISCV_CSR_SSPM_WPRI0_RST   : constant NvU8 := 16#0#;
    LW_RISCV_CSR_SSPM_SPLM_LEVEL0 : constant NvU4 := 16#1#;
    LW_RISCV_CSR_SSPM_SPLM_LEVEL1 : constant NvU4 := 16#3#;
    LW_RISCV_CSR_SSPM_SPLM_LEVEL2 : constant NvU4 := 16#5#;
    LW_RISCV_CSR_SSPM_SPLM_LEVEL3 : constant NvU4 := 16#f#;
    LW_RISCV_CSR_SSPM_UPLM_LEVEL0 : constant NvU4 := 16#1#;
    LW_RISCV_CSR_SSPM_UPLM_LEVEL1 : constant NvU4 := 16#3#;
    LW_RISCV_CSR_SSPM_UPLM_LEVEL2 : constant NvU4 := 16#5#;
    LW_RISCV_CSR_SSPM_UPLM_LEVEL3 : constant NvU4 := 16#f#;
    ...
    LW_RISCV_CSR_SRSP_WPRI1_RST : constant NvU54 := 16#0#;
    ...
    LW_RISCV_CSR_SRSP_WPRI0_RST : constant NvU4 := 16#0#;
    ...
    LW_RISCV_CSR_SCURRUID_WPRI_RST     : constant NvU48 := 16#0#;
    LW_RISCV_CSR_SCURRUID_SCURRUID_RST : constant NvU8  := 16#0#;
    LW_RISCV_CSR_SCURRUID_UCURRUID_RST : constant NvU8  := 16#0#;

    type LW_RISCV_CSR_SCURRUID_Register is record
        Wpri     : NvU48;
        Scurruid : NvU8;
        Ucurruid : NvU8;
    end record with
    ...
    for LW_RISCV_CSR_SCURRUID_Register use record
        Wpri     at 0 range 16 .. 63;
        Scurruid at 0 range  8 .. 15;
        Ucurruid at 0 range  0 ..  7;
    end record;

    LW_RISCV_CSR_SCFG_WPRI4_RST : constant NvU50 := 16#0#;
    ...
    LW_RISCV_CSR_SCFG_WPRI3_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_SCFG_WPRI2_RST : constant NvU3 := 16#0#;
    ...
    LW_RISCV_CSR_SCFG_WPRI1_RST : constant NvU2 := 16#0#;
    ...
    LW_RISCV_CSR_SCFG_UWFP_DIS_FALSE : constant NvU1 := 16#0#;
    ...
    LW_RISCV_CSR_SBPCFG_WPRI1_RST       : constant NvU46 := 16#0#;
    LW_RISCV_CSR_SBPCFG_BTB_FLUSHS_TRUE : constant NvU1  := 16#1#;
    LW_RISCV_CSR_SBPCFG_BTB_FLUSHU_TRUE : constant NvU1  := 16#1#;
    LW_RISCV_CSR_SBPCFG_WPRI0_RST       : constant NvU16 := 16#0#;
    ...
    LW_RISCV_CSR_SMISCOPEN_WPRI_RST : constant NvU63 := 16#0#;
    ...
    LW_RISCV_CSR_SSCRATCH2_VALUE_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SMPUCTL_WPRI1_RST       : constant NvU40 := 16#0#;
    LW_RISCV_CSR_SMPUCTL_ENTRY_COUNT_RST : constant NvU8  := 16#0#;
    LW_RISCV_CSR_SMPUCTL_WPRI0_RST       : constant NvU16 := 16#0#;
    ...
    LW_RISCV_CSR_SMPUIDX_WPRI_RST  : constant NvU57 := 16#0#;
    LW_RISCV_CSR_SMPUIDX_INDEX_RST : constant NvU7  := 16#0#;
    ...
    LW_RISCV_CSR_SMPUVA_BASE_RST  : constant NvU54 := 16#0#;
    LW_RISCV_CSR_SMPUVA_WPRI1_RST : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SMPUVA_D_RST     : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUVA_A_RST     : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUVA_WPRI_RST  : constant NvU5  := 16#0#;
    LW_RISCV_CSR_SMPUVA_VLD_RST   : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_SMPUPA_BASE_RST : constant NvU54 := 16#0#;
    LW_RISCV_CSR_SMPUPA_WPRI_RST : constant NvU10 := 16#0#;
    ...
    LW_RISCV_CSR_SMPURNG_SMPURNG_RANGE_RST : constant NvU54 := 16#0#;
    LW_RISCV_CSR_SMPURNG_WPRI_RST          : constant NvU10 := 16#0#;
    ...
    LW_RISCV_CSR_SMPUATTR_WPRI2_RST     : constant NvU34 := 16#0#;
    LW_RISCV_CSR_SMPUATTR_VPR_RST       : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_WPR_RST       : constant NvU5  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_L2C_RD_RST    : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_L2C_WR_RST    : constant NvU2  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_COHERENT_RST  : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_CACHEABLE_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_WPRI1_RST     : constant NvU9  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_WPRI0_RST     : constant NvU3  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_SX_RST        : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_SW_RST        : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_SR_RST        : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_UX_RST        : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_UW_RST        : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SMPUATTR_UR_RST        : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_SMPUIDX2_WPRI_RST : constant NvU62 := 16#0#;
    LW_RISCV_CSR_SMPUIDX2_IDX_RST  : constant NvU2  := 16#0#;
    ...
    LW_RISCV_CSR_SMPUVLD_VLD_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SMPUDTY_DTY_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SMPUACC_ACC_RST : constant NvU64 := 16#0#;
    ...
    LW_RISCV_CSR_SSYSOPEN_WPRI_RST        : constant NvU56 := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_L2FLHDTY_RST    : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_L2CLNCOMP_RST   : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_L2PEERILW_RST   : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_L2SYSILW_RST    : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_FLUSH_RST       : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_TLBINVOP_RST    : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_TLBINVDATA1_RST : constant NvU1  := 16#0#;
    LW_RISCV_CSR_SSYSOPEN_BIND_RST        : constant NvU1  := 16#0#;
    ...
    LW_RISCV_CSR_CFG_WIRI0_RST : constant NvU51 := 16#0#;
    ...
    LW_RISCV_CSR_CFG_WIRI1_RST : constant NvU12 := 16#0#;
    ...
    LW_RISCV_CSR_CURRUID_WPRI_RST     : constant NvU56 := 16#0#;
    LW_RISCV_CSR_CURRUID_UCURRUID_RST : constant NvU8  := 16#0#;

    type LW_RISCV_CSR_CURRUID_Register is record
        Wpri     : NvU56;
        Ucurruid : NvU8;
    end record with
        Size        => 64,
    ...
    for LW_RISCV_CSR_CURRUID_Register use record
        Wpri     at 0 range 8 .. 63;
        Ucurruid at 0 range 0 ..  7;
    end record;

    -- offsets of registers --
    LW_RISCV_CSR_MISA_Address           : constant Csr_Addr := 16#301#;
    LW_RISCV_CSR_MVENDORID_Address      : constant Csr_Addr := 16#f11#;
    LW_RISCV_CSR_MARCHID_Address        : constant Csr_Addr := 16#f12#;
    LW_RISCV_CSR_MIMPID_Address         : constant Csr_Addr := 16#f13#;
    LW_RISCV_CSR_MHARTID_Address        : constant Csr_Addr := 16#f14#;
    LW_RISCV_CSR_MSTATUS_Address        : constant Csr_Addr := 16#300#;
    LW_RISCV_CSR_MTVEC_Address          : constant Csr_Addr := 16#305#;
    LW_RISCV_CSR_MEDELEG_Address        : constant Csr_Addr := 16#302#;
    LW_RISCV_CSR_MIDELEG_Address        : constant Csr_Addr := 16#303#;
    LW_RISCV_CSR_MIP_Address            : constant Csr_Addr := 16#344#;
    LW_RISCV_CSR_MIE_Address            : constant Csr_Addr := 16#304#;
    LW_RISCV_CSR_MHPMCOUNTER_0_Address  : constant Csr_Addr := 16#b00#;
    LW_RISCV_CSR_MHPMCOUNTER_1_Address  : constant Csr_Addr := 16#b01#;
    LW_RISCV_CSR_MHPMCOUNTER_2_Address  : constant Csr_Addr := 16#b02#;
    LW_RISCV_CSR_MHPMCOUNTER_3_Address  : constant Csr_Addr := 16#b03#;
    LW_RISCV_CSR_MHPMCOUNTER_4_Address  : constant Csr_Addr := 16#b04#;
    LW_RISCV_CSR_MHPMCOUNTER_5_Address  : constant Csr_Addr := 16#b05#;
    LW_RISCV_CSR_MHPMCOUNTER_6_Address  : constant Csr_Addr := 16#b06#;
    LW_RISCV_CSR_MHPMCOUNTER_7_Address  : constant Csr_Addr := 16#b07#;
    LW_RISCV_CSR_MHPMCOUNTER_8_Address  : constant Csr_Addr := 16#b08#;
    LW_RISCV_CSR_MHPMCOUNTER_9_Address  : constant Csr_Addr := 16#b09#;
    LW_RISCV_CSR_MHPMCOUNTER_10_Address : constant Csr_Addr := 16#b0a#;
    LW_RISCV_CSR_MHPMCOUNTER_11_Address : constant Csr_Addr := 16#b0b#;
    LW_RISCV_CSR_MHPMCOUNTER_12_Address : constant Csr_Addr := 16#b0c#;
    LW_RISCV_CSR_MHPMCOUNTER_13_Address : constant Csr_Addr := 16#b0d#;
    LW_RISCV_CSR_MHPMCOUNTER_14_Address : constant Csr_Addr := 16#b0e#;
    LW_RISCV_CSR_MHPMCOUNTER_15_Address : constant Csr_Addr := 16#b0f#;
    LW_RISCV_CSR_MHPMCOUNTER_16_Address : constant Csr_Addr := 16#b10#;
    LW_RISCV_CSR_MHPMCOUNTER_17_Address : constant Csr_Addr := 16#b11#;
    LW_RISCV_CSR_MHPMCOUNTER_18_Address : constant Csr_Addr := 16#b12#;
    LW_RISCV_CSR_MHPMCOUNTER_19_Address : constant Csr_Addr := 16#b13#;
    LW_RISCV_CSR_MHPMCOUNTER_20_Address : constant Csr_Addr := 16#b14#;
    LW_RISCV_CSR_MHPMCOUNTER_21_Address : constant Csr_Addr := 16#b15#;
    LW_RISCV_CSR_MHPMCOUNTER_22_Address : constant Csr_Addr := 16#b16#;
    LW_RISCV_CSR_MHPMCOUNTER_23_Address : constant Csr_Addr := 16#b17#;
    LW_RISCV_CSR_MHPMCOUNTER_24_Address : constant Csr_Addr := 16#b18#;
    LW_RISCV_CSR_MHPMCOUNTER_25_Address : constant Csr_Addr := 16#b19#;
    LW_RISCV_CSR_MHPMCOUNTER_26_Address : constant Csr_Addr := 16#b1a#;
    LW_RISCV_CSR_MHPMCOUNTER_27_Address : constant Csr_Addr := 16#b1b#;
    LW_RISCV_CSR_MHPMCOUNTER_28_Address : constant Csr_Addr := 16#b1c#;
    LW_RISCV_CSR_MHPMCOUNTER_29_Address : constant Csr_Addr := 16#b1d#;
    LW_RISCV_CSR_MHPMCOUNTER_30_Address : constant Csr_Addr := 16#b1e#;
    LW_RISCV_CSR_MHPMCOUNTER_31_Address : constant Csr_Addr := 16#b1f#;
    LW_RISCV_CSR_MCOUNTEREN_Address     : constant Csr_Addr := 16#306#;
    LW_RISCV_CSR_MHPMEVENT_0_Address    : constant Csr_Addr := 16#320#;
    LW_RISCV_CSR_MHPMEVENT_1_Address    : constant Csr_Addr := 16#321#;
    LW_RISCV_CSR_MHPMEVENT_2_Address    : constant Csr_Addr := 16#322#;
    LW_RISCV_CSR_MHPMEVENT_3_Address    : constant Csr_Addr := 16#323#;
    LW_RISCV_CSR_MHPMEVENT_4_Address    : constant Csr_Addr := 16#324#;
    LW_RISCV_CSR_MHPMEVENT_5_Address    : constant Csr_Addr := 16#325#;
    LW_RISCV_CSR_MHPMEVENT_6_Address    : constant Csr_Addr := 16#326#;
    LW_RISCV_CSR_MHPMEVENT_7_Address    : constant Csr_Addr := 16#327#;
    LW_RISCV_CSR_MHPMEVENT_8_Address    : constant Csr_Addr := 16#328#;
    LW_RISCV_CSR_MHPMEVENT_9_Address    : constant Csr_Addr := 16#329#;
    LW_RISCV_CSR_MHPMEVENT_10_Address   : constant Csr_Addr := 16#32a#;
    LW_RISCV_CSR_MHPMEVENT_11_Address   : constant Csr_Addr := 16#32b#;
    LW_RISCV_CSR_MHPMEVENT_12_Address   : constant Csr_Addr := 16#32c#;
    LW_RISCV_CSR_MHPMEVENT_13_Address   : constant Csr_Addr := 16#32d#;
    LW_RISCV_CSR_MHPMEVENT_14_Address   : constant Csr_Addr := 16#32e#;
    LW_RISCV_CSR_MHPMEVENT_15_Address   : constant Csr_Addr := 16#32f#;
    LW_RISCV_CSR_MHPMEVENT_16_Address   : constant Csr_Addr := 16#330#;
    LW_RISCV_CSR_MHPMEVENT_17_Address   : constant Csr_Addr := 16#331#;
    LW_RISCV_CSR_MHPMEVENT_18_Address   : constant Csr_Addr := 16#332#;
    LW_RISCV_CSR_MHPMEVENT_19_Address   : constant Csr_Addr := 16#333#;
    LW_RISCV_CSR_MHPMEVENT_20_Address   : constant Csr_Addr := 16#334#;
    LW_RISCV_CSR_MHPMEVENT_21_Address   : constant Csr_Addr := 16#335#;
    LW_RISCV_CSR_MHPMEVENT_22_Address   : constant Csr_Addr := 16#336#;
    LW_RISCV_CSR_MHPMEVENT_23_Address   : constant Csr_Addr := 16#337#;
    LW_RISCV_CSR_MHPMEVENT_24_Address   : constant Csr_Addr := 16#338#;
    LW_RISCV_CSR_MHPMEVENT_25_Address   : constant Csr_Addr := 16#339#;
    LW_RISCV_CSR_MHPMEVENT_26_Address   : constant Csr_Addr := 16#33a#;
    LW_RISCV_CSR_MHPMEVENT_27_Address   : constant Csr_Addr := 16#33b#;
    LW_RISCV_CSR_MHPMEVENT_28_Address   : constant Csr_Addr := 16#33c#;
    LW_RISCV_CSR_MHPMEVENT_29_Address   : constant Csr_Addr := 16#33d#;
    LW_RISCV_CSR_MHPMEVENT_30_Address   : constant Csr_Addr := 16#33e#;
    LW_RISCV_CSR_MHPMEVENT_31_Address   : constant Csr_Addr := 16#33f#;
    LW_RISCV_CSR_MSCRATCH_Address       : constant Csr_Addr := 16#340#;
    LW_RISCV_CSR_MEPC_Address           : constant Csr_Addr := 16#341#;
    LW_RISCV_CSR_MCAUSE_Address         : constant Csr_Addr := 16#342#;
    LW_RISCV_CSR_MCAUSE2_Address        : constant Csr_Addr := 16#7d4#;
    LW_RISCV_CSR_MTVAL_Address          : constant Csr_Addr := 16#343#;
    LW_RISCV_CSR_PMPCFG0_Address        : constant Csr_Addr := 16#3a0#;
    LW_RISCV_CSR_PMPCFG2_Address        : constant Csr_Addr := 16#3a2#;
    LW_RISCV_CSR_PMPADDR_0_Address      : constant Csr_Addr := 16#3b0#;
    LW_RISCV_CSR_PMPADDR_1_Address      : constant Csr_Addr := 16#3b1#;
    LW_RISCV_CSR_PMPADDR_2_Address      : constant Csr_Addr := 16#3b2#;
    LW_RISCV_CSR_PMPADDR_3_Address      : constant Csr_Addr := 16#3b3#;
    LW_RISCV_CSR_PMPADDR_4_Address      : constant Csr_Addr := 16#3b4#;
    LW_RISCV_CSR_PMPADDR_5_Address      : constant Csr_Addr := 16#3b5#;
    LW_RISCV_CSR_PMPADDR_6_Address      : constant Csr_Addr := 16#3b6#;
    LW_RISCV_CSR_PMPADDR_7_Address      : constant Csr_Addr := 16#3b7#;
    LW_RISCV_CSR_PMPADDR_8_Address      : constant Csr_Addr := 16#3b8#;
    LW_RISCV_CSR_PMPADDR_9_Address      : constant Csr_Addr := 16#3b9#;
    LW_RISCV_CSR_PMPADDR_10_Address     : constant Csr_Addr := 16#3ba#;
    LW_RISCV_CSR_PMPADDR_11_Address     : constant Csr_Addr := 16#3bb#;
    LW_RISCV_CSR_PMPADDR_12_Address     : constant Csr_Addr := 16#3bc#;
    LW_RISCV_CSR_PMPADDR_13_Address     : constant Csr_Addr := 16#3bd#;
    LW_RISCV_CSR_PMPADDR_14_Address     : constant Csr_Addr := 16#3be#;
    LW_RISCV_CSR_PMPADDR_15_Address     : constant Csr_Addr := 16#3bf#;
    LW_RISCV_CSR_MEXTPMPCFG0_Address    : constant Csr_Addr := 16#7f0#;
    LW_RISCV_CSR_MEXTPMPCFG2_Address    : constant Csr_Addr := 16#7f2#;
    LW_RISCV_CSR_MEXTPMPADDR_0_Address  : constant Csr_Addr := 16#7e0#;
    LW_RISCV_CSR_MEXTPMPADDR_1_Address  : constant Csr_Addr := 16#7e1#;
    LW_RISCV_CSR_MEXTPMPADDR_2_Address  : constant Csr_Addr := 16#7e2#;
    LW_RISCV_CSR_MEXTPMPADDR_3_Address  : constant Csr_Addr := 16#7e3#;
    LW_RISCV_CSR_MEXTPMPADDR_4_Address  : constant Csr_Addr := 16#7e4#;
    LW_RISCV_CSR_MEXTPMPADDR_5_Address  : constant Csr_Addr := 16#7e5#;
    LW_RISCV_CSR_MEXTPMPADDR_6_Address  : constant Csr_Addr := 16#7e6#;
    LW_RISCV_CSR_MEXTPMPADDR_7_Address  : constant Csr_Addr := 16#7e7#;
    LW_RISCV_CSR_MEXTPMPADDR_8_Address  : constant Csr_Addr := 16#7e8#;
    LW_RISCV_CSR_MEXTPMPADDR_9_Address  : constant Csr_Addr := 16#7e9#;
    LW_RISCV_CSR_MEXTPMPADDR_10_Address : constant Csr_Addr := 16#7ea#;
    LW_RISCV_CSR_MEXTPMPADDR_11_Address : constant Csr_Addr := 16#7eb#;
    LW_RISCV_CSR_MEXTPMPADDR_12_Address : constant Csr_Addr := 16#7ec#;
    LW_RISCV_CSR_MEXTPMPADDR_13_Address : constant Csr_Addr := 16#7ed#;
    LW_RISCV_CSR_MEXTPMPADDR_14_Address : constant Csr_Addr := 16#7ee#;
    LW_RISCV_CSR_MEXTPMPADDR_15_Address : constant Csr_Addr := 16#7ef#;
    LW_RISCV_CSR_MSCRATCH2_Address      : constant Csr_Addr := 16#7c0#;
    LW_RISCV_CSR_MTIMECMP_Address       : constant Csr_Addr := 16#7db#;
    LW_RISCV_CSR_MCFG_Address           : constant Csr_Addr := 16#7d5#;
    LW_RISCV_CSR_MBPCFG_Address         : constant Csr_Addr := 16#7dd#;
    LW_RISCV_CSR_MDCACHEOP_Address      : constant Csr_Addr := 16#bd0#;
    LW_RISCV_CSR_MMPUCTL_Address        : constant Csr_Addr := 16#7c9#;
    LW_RISCV_CSR_MCURRUID_Address       : constant Csr_Addr := 16#7d7#;
    LW_RISCV_CSR_MOPT_Address           : constant Csr_Addr := 16#7d8#;
    LW_RISCV_CSR_MMISCOPEN_Address      : constant Csr_Addr := 16#7f9#;
    LW_RISCV_CSR_MLDSTATTR_Address      : constant Csr_Addr := 16#7c8#;
    LW_RISCV_CSR_MFETCHATTR_Address     : constant Csr_Addr := 16#7df#;
    LW_RISCV_CSR_FFLAGS_Address         : constant Csr_Addr := 16#1#;
    LW_RISCV_CSR_FRM_Address            : constant Csr_Addr := 16#2#;
    LW_RISCV_CSR_FCSR_Address           : constant Csr_Addr := 16#3#;
    LW_RISCV_CSR_HPMCOUNTER_0_Address   : constant Csr_Addr := 16#c00#;
    LW_RISCV_CSR_HPMCOUNTER_1_Address   : constant Csr_Addr := 16#c01#;
    LW_RISCV_CSR_HPMCOUNTER_2_Address   : constant Csr_Addr := 16#c02#;
    LW_RISCV_CSR_HPMCOUNTER_3_Address   : constant Csr_Addr := 16#c03#;
    LW_RISCV_CSR_HPMCOUNTER_4_Address   : constant Csr_Addr := 16#c04#;
    LW_RISCV_CSR_HPMCOUNTER_5_Address   : constant Csr_Addr := 16#c05#;
    LW_RISCV_CSR_HPMCOUNTER_6_Address   : constant Csr_Addr := 16#c06#;
    LW_RISCV_CSR_HPMCOUNTER_7_Address   : constant Csr_Addr := 16#c07#;
    LW_RISCV_CSR_HPMCOUNTER_8_Address   : constant Csr_Addr := 16#c08#;
    LW_RISCV_CSR_HPMCOUNTER_9_Address   : constant Csr_Addr := 16#c09#;
    LW_RISCV_CSR_HPMCOUNTER_10_Address  : constant Csr_Addr := 16#c0a#;
    LW_RISCV_CSR_HPMCOUNTER_11_Address  : constant Csr_Addr := 16#c0b#;
    LW_RISCV_CSR_HPMCOUNTER_12_Address  : constant Csr_Addr := 16#c0c#;
    LW_RISCV_CSR_HPMCOUNTER_13_Address  : constant Csr_Addr := 16#c0d#;
    LW_RISCV_CSR_HPMCOUNTER_14_Address  : constant Csr_Addr := 16#c0e#;
    LW_RISCV_CSR_HPMCOUNTER_15_Address  : constant Csr_Addr := 16#c0f#;
    LW_RISCV_CSR_HPMCOUNTER_16_Address  : constant Csr_Addr := 16#c10#;
    LW_RISCV_CSR_HPMCOUNTER_17_Address  : constant Csr_Addr := 16#c11#;
    LW_RISCV_CSR_HPMCOUNTER_18_Address  : constant Csr_Addr := 16#c12#;
    LW_RISCV_CSR_HPMCOUNTER_19_Address  : constant Csr_Addr := 16#c13#;
    LW_RISCV_CSR_HPMCOUNTER_20_Address  : constant Csr_Addr := 16#c14#;
    LW_RISCV_CSR_HPMCOUNTER_21_Address  : constant Csr_Addr := 16#c15#;
    LW_RISCV_CSR_HPMCOUNTER_22_Address  : constant Csr_Addr := 16#c16#;
    LW_RISCV_CSR_HPMCOUNTER_23_Address  : constant Csr_Addr := 16#c17#;
    LW_RISCV_CSR_HPMCOUNTER_24_Address  : constant Csr_Addr := 16#c18#;
    LW_RISCV_CSR_HPMCOUNTER_25_Address  : constant Csr_Addr := 16#c19#;
    LW_RISCV_CSR_HPMCOUNTER_26_Address  : constant Csr_Addr := 16#c1a#;
    LW_RISCV_CSR_HPMCOUNTER_27_Address  : constant Csr_Addr := 16#c1b#;
    LW_RISCV_CSR_HPMCOUNTER_28_Address  : constant Csr_Addr := 16#c1c#;
    LW_RISCV_CSR_HPMCOUNTER_29_Address  : constant Csr_Addr := 16#c1d#;
    LW_RISCV_CSR_HPMCOUNTER_30_Address  : constant Csr_Addr := 16#c1e#;
    LW_RISCV_CSR_HPMCOUNTER_31_Address  : constant Csr_Addr := 16#c1f#;
    LW_RISCV_CSR_MSPM_Address           : constant Csr_Addr := 16#7d9#;
    LW_RISCV_CSR_MDBGCTL_Address        : constant Csr_Addr := 16#7de#;
    LW_RISCV_CSR_MRSP_Address           : constant Csr_Addr := 16#7da#;
    LW_RISCV_CSR_SPM_Address            : constant Csr_Addr := 16#899#;
    LW_RISCV_CSR_RSP_Address            : constant Csr_Addr := 16#89a#;
    LW_RISCV_CSR_TSELECT_Address        : constant Csr_Addr := 16#7a0#;
    LW_RISCV_CSR_TDATA1_Address         : constant Csr_Addr := 16#7a1#;
    LW_RISCV_CSR_TDATA2_Address         : constant Csr_Addr := 16#7a2#;
    LW_RISCV_CSR_DCSR_Address           : constant Csr_Addr := 16#7b0#;
    LW_RISCV_CSR_MBIND_Address          : constant Csr_Addr := 16#bc0#;
    LW_RISCV_CSR_MTLBINVDATA1_Address   : constant Csr_Addr := 16#bc1#;
    LW_RISCV_CSR_MTLBINVOP_Address      : constant Csr_Addr := 16#bc2#;
    LW_RISCV_CSR_MFLUSH_Address         : constant Csr_Addr := 16#bc3#;
    LW_RISCV_CSR_ML2SYSILW_Address      : constant Csr_Addr := 16#bc4#;
    LW_RISCV_CSR_ML2PEERILW_Address     : constant Csr_Addr := 16#bc5#;
    LW_RISCV_CSR_ML2CLNCOMP_Address     : constant Csr_Addr := 16#bc6#;
    LW_RISCV_CSR_ML2FLHDTY_Address      : constant Csr_Addr := 16#bc7#;
    LW_RISCV_CSR_MSYSOPEN_Address       : constant Csr_Addr := 16#7f8#;
    LW_RISCV_CSR_MROMPROT_Address       : constant Csr_Addr := 16#7c4#;
    LW_RISCV_CSR_BIND_Address           : constant Csr_Addr := 16#8c0#;
    LW_RISCV_CSR_TLBINVDATA1_Address    : constant Csr_Addr := 16#8c1#;
    LW_RISCV_CSR_TLBINVOP_Address       : constant Csr_Addr := 16#8c2#;
    LW_RISCV_CSR_FLUSH_Address          : constant Csr_Addr := 16#8c3#;
    LW_RISCV_CSR_L2SYSILW_Address       : constant Csr_Addr := 16#8c4#;
    LW_RISCV_CSR_L2PEERILW_Address      : constant Csr_Addr := 16#8c5#;
    LW_RISCV_CSR_L2CLNCOMP_Address      : constant Csr_Addr := 16#8c6#;
    LW_RISCV_CSR_L2FLHDTY_Address       : constant Csr_Addr := 16#8c7#;
    LW_RISCV_CSR_LWFENCEIO_Address      : constant Csr_Addr := 16#800#;
    LW_RISCV_CSR_LWFENCEMEM_Address     : constant Csr_Addr := 16#801#;
    LW_RISCV_CSR_LWFENCEALL_Address     : constant Csr_Addr := 16#802#;
    LW_RISCV_CSR_SSTATUS_Address        : constant Csr_Addr := 16#100#;
    LW_RISCV_CSR_STVEC_Address          : constant Csr_Addr := 16#105#;
    LW_RISCV_CSR_SSCRATCH_Address       : constant Csr_Addr := 16#140#;
    LW_RISCV_CSR_SIP_Address            : constant Csr_Addr := 16#144#;
    LW_RISCV_CSR_SIE_Address            : constant Csr_Addr := 16#104#;
    LW_RISCV_CSR_STVAL_Address          : constant Csr_Addr := 16#143#;
    LW_RISCV_CSR_SEPC_Address           : constant Csr_Addr := 16#141#;
    LW_RISCV_CSR_SCAUSE_Address         : constant Csr_Addr := 16#142#;
    LW_RISCV_CSR_SCAUSE2_Address        : constant Csr_Addr := 16#5d4#;
    LW_RISCV_CSR_SATP_Address           : constant Csr_Addr := 16#180#;
    LW_RISCV_CSR_SCOUNTEREN_Address     : constant Csr_Addr := 16#106#;
    LW_RISCV_CSR_SSPM_Address           : constant Csr_Addr := 16#5d9#;
    LW_RISCV_CSR_SRSP_Address           : constant Csr_Addr := 16#5da#;
    LW_RISCV_CSR_SCURRUID_Address       : constant Csr_Addr := 16#5d7#;
    LW_RISCV_CSR_SCFG_Address           : constant Csr_Addr := 16#5d5#;
    LW_RISCV_CSR_SBPCFG_Address         : constant Csr_Addr := 16#5dd#;
    LW_RISCV_CSR_SMISCOPEN_Address      : constant Csr_Addr := 16#5f9#;
    LW_RISCV_CSR_SSCRATCH2_Address      : constant Csr_Addr := 16#5c0#;
    LW_RISCV_CSR_SMPUCTL_Address        : constant Csr_Addr := 16#5c9#;
    LW_RISCV_CSR_SMPUIDX_Address        : constant Csr_Addr := 16#5ca#;
    LW_RISCV_CSR_SMPUVA_Address         : constant Csr_Addr := 16#5cb#;
    LW_RISCV_CSR_SMPUPA_Address         : constant Csr_Addr := 16#5cc#;
    LW_RISCV_CSR_SMPURNG_Address        : constant Csr_Addr := 16#5ce#;
    LW_RISCV_CSR_SMPUATTR_Address       : constant Csr_Addr := 16#5cf#;
    LW_RISCV_CSR_SMPUIDX2_Address       : constant Csr_Addr := 16#5d0#;
    LW_RISCV_CSR_SMPUVLD_Address        : constant Csr_Addr := 16#5d1#;
    LW_RISCV_CSR_SMPUDTY_Address        : constant Csr_Addr := 16#5d2#;
    LW_RISCV_CSR_SMPUACC_Address        : constant Csr_Addr := 16#5d3#;
    LW_RISCV_CSR_SSYSOPEN_Address       : constant Csr_Addr := 16#5f8#;
    LW_RISCV_CSR_DCACHEOP_Address       : constant Csr_Addr := 16#8d0#;
    LW_RISCV_CSR_CFG_Address            : constant Csr_Addr := 16#895#;
    LW_RISCV_CSR_CURRUID_Address        : constant Csr_Addr := 16#897#;
end Dev_Riscv_Csr_64;

...
is
    ...
    LW_PRGNLCL_FALCON_INTR_CTRL_PRIV_LEVEL_MASK_WRITE_PROTECTION_ALL_LEVELS_ENABLED  : constant NvU4 := 16#f#;
    ...
    LW_PRGNLCL_FALCON_INTR_CTRL_GFID_INIT : constant NvU6 := 16#0#;
    type LW_PRGNLCL_FALCON_INTR_CTRL_GSP_Field is (GSP_DISABLE, GSP_ENABLE) with
        Size => 1;
    for LW_PRGNLCL_FALCON_INTR_CTRL_GSP_Field use (GSP_DISABLE => 16#0#, GSP_ENABLE => 16#1#);
    type LW_PRGNLCL_FALCON_INTR_CTRL_CPU_Field is (CPU_DISABLE, CPU_ENABLE) with
        Size => 1;
    for LW_PRGNLCL_FALCON_INTR_CTRL_CPU_Field use (CPU_DISABLE => 16#0#, CPU_ENABLE => 16#1#);

    type LW_PRGNLCL_FALCON_INTR_CTRL_Register is record
        Vector : NvU12;
        Gfid   : NvU6;
        Gsp    : LW_PRGNLCL_FALCON_INTR_CTRL_GSP_Field;
        Cpu    : LW_PRGNLCL_FALCON_INTR_CTRL_CPU_Field;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FALCON_INTR_CTRL_Register use record
        Vector at 0 range  0 .. 11;
        Gfid   at 0 range 20 .. 25;
        Gsp    at 0 range 30 .. 30;
        Cpu    at 0 range 31 .. 31;
    end record;
    ...
    type LW_PRGNLCL_FALCON_ENGCTL_STALLREQ_MODE_Field is (MODE_FALSE, MODE_TRUE) with
        Size => 1;
    for LW_PRGNLCL_FALCON_ENGCTL_STALLREQ_MODE_Field use (MODE_FALSE => 16#0#, MODE_TRUE => 16#1#);
    ...
    type LW_PRGNLCL_FALCON_ENGCTL_Register is record
        ...
        Stallreq_Mode  : LW_PRGNLCL_FALCON_ENGCTL_STALLREQ_MODE_Field;
    ...
    type LW_PRGNLCL_FALCON_PMM_FBIF_DSTAT_SEL_Field is
        (SEL_1KTRANSFER, SEL_RREQ, SEL_WREQ, SEL_REQ32BYTE, SEL_REQ64BYTE, SEL_REQ128BYTE, SEL_1KTRANSFER_SC, SEL_RREQ_SC, SEL_WREQ_SC, SEL_REQ32BYTE_SC, SEL_REQ64BYTE_SC,
         SEL_REQ128BYTE_SC) with
        Size => 4;
    for LW_PRGNLCL_FALCON_PMM_FBIF_DSTAT_SEL_Field use
        (SEL_1KTRANSFER => 16#0#, SEL_RREQ => 16#1#, SEL_WREQ => 16#2#, SEL_REQ32BYTE => 16#3#, SEL_REQ64BYTE => 16#4#, SEL_REQ128BYTE => 16#5#, SEL_1KTRANSFER_SC => 16#6#,
         SEL_RREQ_SC    => 16#7#, SEL_WREQ_SC => 16#8#, SEL_REQ32BYTE_SC => 16#9#, SEL_REQ64BYTE_SC => 16#a#, SEL_REQ128BYTE_SC => 16#b#);
    ...
    type LW_PRGNLCL_RISCV_CORE_SELECT_RISCV_RO_ENABLE_Field is (ENABLE_FALSE, ENABLE_TRUE) with
        Size => 1;
    for LW_PRGNLCL_RISCV_CORE_SELECT_RISCV_RO_ENABLE_Field use (ENABLE_FALSE => 16#0#, ENABLE_TRUE => 16#1#);

    type LW_PRGNLCL_RISCV_CORE_SELECT_RISCV_RO_Register is record
        Enable : LW_PRGNLCL_RISCV_CORE_SELECT_RISCV_RO_ENABLE_Field;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_RISCV_CORE_SELECT_RISCV_RO_Register use record
    ...
    type LW_PRGNLCL_FBIF_BLOCKER_DEBUG0_Register is record
        Adr_Lo : NvU32;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FBIF_BLOCKER_DEBUG0_Register use record
        Adr_Lo at 0 range 0 .. 31;
    end record;

    type LW_PRGNLCL_FBIF_BLOCKER_DEBUG1_Register is record
        Adr_Hi : NvU17;
    end record with
        Size        => 32,
        Object_Size => 32;

    for LW_PRGNLCL_FBIF_BLOCKER_DEBUG1_Register use record
        Adr_Hi at 0 range 0 .. 16;
    end record;

    type LW_PRGNLCL_FBIF_BLOCKER_DEBUG2_Register is record
        Op       : NvU5;
        Rd       : NvU1;
        Subid    : NvU8;
        Wid      : NvU3;
    ...
    for LW_PRGNLCL_FBIF_BLOCKER_DEBUG2_Register use record
        Op       at 0 range  0 ..  4;
        Rd       at 0 range  5 ..  5;
        Subid    at 0 range  6 .. 13;
        Wid      at 0 range 22 .. 24;
        Sz       at 0 range 25 .. 29;
        L2_Class at 0 range 30 .. 31;
    end record;
    ...
    LW_PRGNLCL_FALCON_DIODTA_PRIV_LEVEL_MASK_Address                 : constant := 16#128_00f0#;
    ...
    LW_PRGNLCL_FALCON_INTR_CTRL_PRIV_LEVEL_MASK_0_Address            : constant := 16#128_03d8#;
    LW_PRGNLCL_FALCON_INTR_CTRL_PRIV_LEVEL_MASK_1_Address            : constant := 16#128_03dc#;
    ...
    LW_PRGNLCL_FALCON_INTR_CTRL_0_Address                            : constant := 16#128_03e0#;
    LW_PRGNLCL_FALCON_INTR_CTRL_1_Address                            : constant := 16#128_03e4#;
    LW_PRGNLCL_FALCON_INTR_CTRL_0_Size                               : constant := 16#2#;
    LW_PRGNLCL_FALCON_INTR_RETRIGGER_0_Address                       : constant := 16#128_03e8#;
    LW_PRGNLCL_FALCON_INTR_RETRIGGER_1_Address                       : constant := 16#128_03ec#;
    ...
    LW_PRGNLCL_FALCON_CURCTX2_Address                                : constant := 16#128_03c8#;
    LW_PRGNLCL_FALCON_NXTCTX2_Address                                : constant := 16#128_03cc#;
    ...
    LW_PRGNLCL_FALCON_DIO_DOC_CTRL_0_Address                         : constant := 16#128_0370#;
    LW_PRGNLCL_FALCON_DIO_DOC_CTRL_0_Size                            : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DOC_D0_0_Address                           : constant := 16#128_0374#;
    LW_PRGNLCL_FALCON_DIO_DOC_D0_0_Size                              : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DOC_D1_0_Address                           : constant := 16#128_0378#;
    LW_PRGNLCL_FALCON_DIO_DOC_D1_0_Size                              : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DOC_D2_0_Address                           : constant := 16#128_037c#;
    LW_PRGNLCL_FALCON_DIO_DOC_D2_0_Size                              : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DIC_CTRL_0_Address                         : constant := 16#128_0380#;
    LW_PRGNLCL_FALCON_DIO_DIC_CTRL_0_Size                            : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DIC_D0_0_Address                           : constant := 16#128_0384#;
    LW_PRGNLCL_FALCON_DIO_DIC_D0_0_Size                              : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DIC_D1_0_Address                           : constant := 16#128_0388#;
    LW_PRGNLCL_FALCON_DIO_DIC_D1_0_Size                              : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DIC_D2_0_Address                           : constant := 16#128_038c#;
    LW_PRGNLCL_FALCON_DIO_DIC_D2_0_Size                              : constant := 16#1#;
    LW_PRGNLCL_FALCON_DIO_DIO_ERR_0_Address                          : constant := 16#128_0390#;
    ...
    LW_PRGNLCL_RISCV_CORE_SELECT_RISCV_RO_Address                    : constant := 16#128_16a8#;
    ...
    LW_PRGNLCL_SCP_CTL_PKEY_Address                                  : constant := 16#128_0418#;
    ...
    LW_PRGNLCL_FBIF_BIND_STATUS_Address                              : constant := 16#128_3028#;
    ...
    LW_PRGNLCL_FBIF_DBG_R32COUNT_Address                             : constant := 16#128_3060#;
    LW_PRGNLCL_FBIF_DBG_R64COUNT_Address                             : constant := 16#128_3064#;
    LW_PRGNLCL_FBIF_DBG_R128COUNT_Address                            : constant := 16#128_3068#;
    LW_PRGNLCL_FBIF_BLOCKER_DEBUG0_Address                           : constant := 16#128_3078#;
    LW_PRGNLCL_FBIF_BLOCKER_DEBUG1_Address                           : constant := 16#128_307c#;
    LW_PRGNLCL_FBIF_BLOCKER_DEBUG2_Address                           : constant := 16#128_3080#;

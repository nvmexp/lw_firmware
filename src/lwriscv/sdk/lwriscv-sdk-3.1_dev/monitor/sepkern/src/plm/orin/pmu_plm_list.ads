...
package PLM_List
is
    LW_PPRIV_SYS_PRI_SOURCE_ID_PMU : constant LwU20 := 16#1#;
    ...
    PLM_AD_Pair : constant PLM_Array_Type := (
        ...
        PLM_Pair'(
            ...
            Data    => ( -- MMINTS-TODO: consider later restricting this to L2/L3 just in case; this will be L2-only for other PMU builds
                ...
                Source_Enable        => LW_PPRIV_SYS_PRI_SOURCE_ID_PMU
            )
        ),
        PLM_Pair'(

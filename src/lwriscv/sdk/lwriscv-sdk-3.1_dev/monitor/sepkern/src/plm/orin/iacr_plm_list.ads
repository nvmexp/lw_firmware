...
package PLM_List
is
    LW_PPRIV_SYS_PRI_SOURCE_ID_GSP : constant LwU20 := 16#3#;
    ...
    PLM_AD_Pair : constant PLM_Array_Type := (
        ...
        PLM_Pair'(
            ...
            Data    => (
                Read_Protection      => LW_PRGNLCL_PRIV_LEVEL_MASK_READ_PROTECTION_ONLY_LEVEL3_ENABLED,
                ...
                Source_Enable        => LW_PPRIV_SYS_PRI_SOURCE_ID_GSP
            )
        ),
        PLM_Pair'(
        ...
        PLM_Pair'(
            Address => LW_PRGNLCL_FALCON_PMB_DMEM_PRIV_LEVEL_MASK_0_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(
            Address => LW_PRGNLCL_FALCON_PMB_DMEM_PRIV_LEVEL_MASK_1_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(
            Address => LW_PRGNLCL_FALCON_PMB_DMEM_PRIV_LEVEL_MASK_2_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(
            Address => LW_PRGNLCL_FALCON_PMB_DMEM_PRIV_LEVEL_MASK_3_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(
        ...
        PLM_Pair'(
            Address => LW_PRGNLCL_FBIF_CTL2_PRIV_LEVEL_MASK_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(
            Address => LW_PRGNLCL_FBIF_REGIONCFG_PRIV_LEVEL_MASK_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(
        ...
        PLM_Pair'(
            Address => LW_PRGNLCL_FALCON_ENGCTL_PRIV_LEVEL_MASK_Address,
            Data    => PRIV_LEVEL_MASK_ALL_DISABLE
        ),
        PLM_Pair'(

 ...
 */
#if LIBOS_CONFIG_ID_SIZE==1
  typedef LwU8                            LibosTaskId;
  typedef LwU8                            LibosPortId;
  typedef LwU8                            LibosPortInternalIndex;
  typedef LwU8                            LibosShuttleId;
  typedef LwU8                            LibosLockId;
#elif LIBOS_CONFIG_ID_SIZE==4
  typedef LwU32                           LibosTaskId;
  typedef LwU32                           LibosPortId;
  typedef LwU32                           LibosPortInternalIndex;
  typedef LwU32                           LibosShuttleId;
  typedef LwU32                           LibosLockId;
#else
# error Please set LIBOS_CONFIG_ID_SIZE in the profile config file.
#endif

typedef LwU64 LibosPriority;

#define ID(x)  _Generic((x),                        \
  LibosObjectNameT: ((LibosPortId)(LwU64)&(x)),       \
  LibosShuttleNameT: ((LibosShuttleId)(LwU64)&(x)), \
  LibosTaskNameT: ((LibosTaskId)(LwU64)&(x)))
...
#if LIBOS_FEATURE_USERSPACE_TRAPS
    LibosShuttleNameExtern(shuttleTaskCrash)
    LibosShuttleNameExtern(shuttleTaskReplay)
    LibosPortNameExtern(portTaskReplay)
#endif

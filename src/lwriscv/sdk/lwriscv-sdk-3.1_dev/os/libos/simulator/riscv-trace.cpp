...
void riscv_tracer::print_address(LwU64 address)
{
    ...
    if (DRF_VAL64(_RISCV_CSR, _SATP, _MODE, core->satp) == LW_RISCV_CSR_SATP_MODE_LWMPU)
...
void riscv_tracer::handler_instruction_start()
{
    ...
    if (core->mpu_translation_enabled)
        ...
        resolve_pc = core->pc - core->elf_address +
                     ((LibosElf64Header *)(&core->firmware->elf[0]))->entry; // really should use PHDR[0] here

    const char *symbol = 0, *directory = 0, *filename = 0;

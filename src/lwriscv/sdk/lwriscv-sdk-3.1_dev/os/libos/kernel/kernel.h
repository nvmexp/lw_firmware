...
#define LIBOS_SECTION_IMEM_PINNED       __attribute__((section(".kernel.hot.text")))
#define LIBOS_SECTION_DMEM_PINNED(name) __attribute__((section(".kernel.hot.data." #name))) name
#define LIBOS_SECTION_DMEM_COLD(name)   __attribute__((section(".kernel.cold.data." #name))) name
#define LIBOS_SECTION_TEXT_STARTUP      __attribute__((section(".kernel.startup")))
#define LIBOS_NORETURN                  __attribute__((noreturn, used, nothrow))
#define LIBOS_NAKED                     __attribute__((naked))
#define LIBOS_SECTION_TEXT_COLD         __attribute__((noinline, section(".kernel.cold.text")))

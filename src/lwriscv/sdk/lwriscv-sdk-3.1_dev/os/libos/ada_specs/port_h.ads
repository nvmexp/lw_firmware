...
package port_h is
  ...
  -- Required by task.c
   ...
   procedure ShuttleReset (resetShuttle : access scheduler_tables_h.Shuttle)  -- /home/jerzhou/scratch/p4/jerzhou_scratch_sw0/sw/lwriscv/main/os/libos/kernel/port.h:35
   with Import => True, 
        Convention => C, 
        External_Name => "ShuttleReset";

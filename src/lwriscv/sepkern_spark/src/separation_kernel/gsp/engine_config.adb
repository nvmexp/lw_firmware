...
package body Engine_Config is
   ...
   procedure Configure is
      ...
      procedure Bar0_Reg_Wr32 is new Riscv_Core.Bar0_Reg.Wr32_Generic (Generic_Register => LW_PGSP_FALCON_LOCKPMB_REGISTER);
      ...
      procedure Bar0_Reg_Rd32 is new Riscv_Core.Bar0_Reg.Rd32_Generic (Generic_Register => LW_PGSP_FALCON_DEBUG1_REGISTER);
      procedure Bar0_Reg_Wr32 is new Riscv_Core.Bar0_Reg.Wr32_Generic (Generic_Register => LW_PGSP_FALCON_DEBUG1_REGISTER);
      ...
      Falcon_Debug1 : LW_PGSP_FALCON_DEBUG1_REGISTER;
      Falcon_Itfen : LW_PFALCON_FALCON_ITFEN_REGISTER;
   begin
      -- Release PMB lock (it is set up correctly now by IOPMP)
      Bar0_Reg_Wr32(Offset => LwU32(Lw_Pgsp_Falcon_Lockpmb),
                    Data => LW_PGSP_FALCON_LOCKPMB_REGISTER'(F_Imem => Lw_Pgsp_Falcon_Lockpmb_Imem_Lock,
                                                             F_Dmem => Lw_Pgsp_Falcon_Lockpmb_Dmem_Unlock));
      ...
      Bar0_Reg_Rd32(Offset => LwU32(Lw_Pgsp_Falcon_Debug1),
                    Data => Falcon_Debug1);
      Falcon_Debug1.F_Ctxsw_Mode1 := Lw_Pgsp_Falcon_Debug1_Ctxsw_Mode1_Bypass_Idle_Checks;

      Bar0_Reg_Wr32(Offset => LwU32(Lw_Pgsp_Falcon_Debug1),
                    Data => Falcon_Debug1);
   ...
   begin
      ...
      Partition_Entry_Point := LW_RISCV_AMAP_IMEM_START + Get_Monitor_Code_Size;

      pragma Assert(Partition_Entry_Point mod 4 = 0);

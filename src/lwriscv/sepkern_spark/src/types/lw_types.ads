...
is
    ...
    type LwBit is range 0 .. 1 with Size => 1;

    type LwBool is new Boolean;

    type HS_BOOL is (HS_ERROR, HS_SUCCESS) with Size => 32, Object_Size => 32;
    for HS_BOOL use
      (HS_ERROR => 16#55#, HS_SUCCESS => 16#AA#);

    type Lw32BitBool is (FALSE, TRUE) with Size => 32, Object_Size => 32;
    for Lw32BitBool use (FALSE => 16#55AA_FA15#, TRUE => 16#AA55_7BCE#);  -- FA15 looks like FALSE; 7BCE looks like TRUE

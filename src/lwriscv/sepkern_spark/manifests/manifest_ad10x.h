 ...
 */
#ifndef __MANIFEST_GA10X_H_
#define __MANIFEST_GA10X_H_
...
typedef struct
{
    ...
    LwU8 bAttester;                     // [Attestation flag] if true, BR DECFUSEKEY and AK subroutines are exelwted (false is defined as 0x55; true is defined as 0xAA; other values will be reported as an error)
    LwU8 reservedBytes0[10];            // [reserved space] all 0s; 1 byte for bHashSaving, 4 bytes for MAX_DELAY_USEC in the furture

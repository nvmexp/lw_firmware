...
typedef struct
{
    ...
    LwU8 reservedByte;                  // [reserved space] all 0s, freed up due to deprecated fields
    LwU8 bDecFuseKeys;                  // [DECFUSEKEY flag] if true, DECFUSEKEY subroutine is exelwted (false is defined as 0x55; true is defined as 0xAA; other values will be reported as an error)

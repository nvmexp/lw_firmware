...
raiseFalconResetPLM(void)
{
    ...
    // Protect falcon reset such that only level 3 can write to LW_CSOE_FALCON_ENGINE_RESET
    val = REG_RD32_STALL(CSB, LW_CSOE_FALCON_RESET_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE, _FALCON_RESET_PRIV_LEVEL_MASK, _WRITE_PROTECTION, _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE, _FALCON_RESET_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE, val);
    val = FLD_SET_DRF(_CSOE, _FALCON_RESET_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE, val);
    val = FLD_SET_DRF(_CSOE, _FALCON_RESET_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE, val);
...
lowerFalconResetPLM(void)
{
    ...
    val = FLD_SET_DRF(_CSOE, _FALCON_RESET_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _ENABLE, val);
    val = FLD_SET_DRF(_CSOE, _FALCON_RESET_PRIV_LEVEL_MASK, _WRITE_VIOLATION, _REPORT_ERROR, val);
    REG_WR32_STALL(CSB, LW_CSOE_FALCON_RESET_PRIV_LEVEL_MASK, val);
}
...
hsSetupPriv()
{
    ...
    val = CSB_REG_RD32(LW_CSOE_FALCON_DMEM_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _READ_PROTECTION_LEVEL0,  _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _READ_PROTECTION_LEVEL1,  _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _READ_PROTECTION_LEVEL2,  _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _DMEM_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR, val);
    CSB_REG_WR32(LW_CSOE_FALCON_DMEM_PRIV_LEVEL_MASK, val);

    // Masks that will allow read write only by Level2 code (SOE).
    val = CSB_REG_RD32(LW_CSOE_FALCON_WDTMR_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _READ_PROTECTION_LEVEL0,  _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _READ_PROTECTION_LEVEL1,  _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _READ_PROTECTION_LEVEL2,  _ENABLE,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,      val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _ENABLE,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _WDTMR_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR, val);
    CSB_REG_WR32(LW_CSOE_FALCON_WDTMR_PRIV_LEVEL_MASK, val);

    // Masks that will allow write only by Level2 code (SOE), but read by any.
    val = CSB_REG_RD32(LW_CSOE_FALCON_IRQTMR_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _IRQTMR_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IRQTMR_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IRQTMR_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IRQTMR_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IRQTMR_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _ENABLE,             val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IRQTMR_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_IRQTMR_PRIV_LEVEL_MASK, val);

    val = CSB_REG_RD32(LW_CSOE_FALCON_EXE_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _EXE_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _EXE_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _EXE_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _EXE_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _EXE_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _ENABLE,             val);
    val = FLD_SET_DRF(_CSOE_FALCON, _EXE_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_EXE_PRIV_LEVEL_MASK, val);
    ...
    //
    val = CSB_REG_RD32(LW_CSOE_FALCON_IMEM_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _IMEM_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IMEM_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IMEM_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IMEM_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IMEM_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _IMEM_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_IMEM_PRIV_LEVEL_MASK, val);

    val = CSB_REG_RD32(LW_CSOE_FALCON_CPUCTL_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _CPUCTL_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _CPUCTL_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _CPUCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _CPUCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _CPUCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _CPUCTL_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_CPUCTL_PRIV_LEVEL_MASK, val);

    val = CSB_REG_RD32(LW_CSOE_FALCON_MTHDCTX_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _MTHDCTX_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _MTHDCTX_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _MTHDCTX_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _MTHDCTX_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _MTHDCTX_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _MTHDCTX_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_MTHDCTX_PRIV_LEVEL_MASK, val);

    val = CSB_REG_RD32(LW_CSOE_FALCON_HSCTL_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _HSCTL_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _HSCTL_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _HSCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _HSCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _HSCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _HSCTL_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_HSCTL_PRIV_LEVEL_MASK, val);

    val = CSB_REG_RD32(LW_CSOE_FALCON_SCTL_PRIV_LEVEL_MASK);
    val = FLD_SET_DRF(_CSOE_FALCON, _SCTL_PRIV_LEVEL_MASK, _READ_PROTECTION,         _ALL_LEVELS_ENABLED, val);
    val = FLD_SET_DRF(_CSOE_FALCON, _SCTL_PRIV_LEVEL_MASK, _READ_VIOLATION,          _REPORT_ERROR,       val);
    val = FLD_SET_DRF(_CSOE_FALCON, _SCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL0, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _SCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL1, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _SCTL_PRIV_LEVEL_MASK, _WRITE_PROTECTION_LEVEL2, _DISABLE,            val);
    val = FLD_SET_DRF(_CSOE_FALCON, _SCTL_PRIV_LEVEL_MASK, _WRITE_VIOLATION,         _REPORT_ERROR,       val);
    CSB_REG_WR32(LW_CSOE_FALCON_SCTL_PRIV_LEVEL_MASK, val);
}

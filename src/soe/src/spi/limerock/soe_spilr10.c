...
/* ------------------------- Static Variables ------------------------------- */
static SPI_DEVICE_ROM_INFO  spiDevicesSupported_LR10[] =
{
        //
        //                                  Packed
        //                                  Info    Dev.
...
/* ------------------------- Prototypes ------------------------------------- */
static void s_spiRomAddrAdjust_LR10(LwU32 *pAddress);
...
spiService_LR10(void)
{
    ...
    //
    PMGR_ISR_REG_WR32(LW_PMGR_PMU_INTR_MSK_SPI, 0);
}
...
)
{
    ...
    if (pSpiDev == NULL)
    {
        ...
        goto spiBusConfigure_LR10_exit;
    }
...
)
{
    ...
    {
        status = FLCN_ERR_ILWALID_STATE;
        goto spiRomSerialBypassEnable_LR10_exit;
    }
...
spiRomSerialBypassEnable_LR10_exit:
    return status;
}
...
)
{
    ...
    for (pTable = spiDevicesSupported_LR10; pTable->manufacturerCode != 0; pTable++)
    {
...
)
{
    ...
    {
        status = FLCN_ERR_ILWALID_STATE;
        goto spiBufferTransfer_LR10_exit;
    }
...
)
{
    ...
    {
        status = FLCN_ERR_ILWALID_STATE;
        goto spiRomReadDirect_LR10_exit;
    }
    ...
    //
    s_spiRomAddrAdjust_LR10(&address);
 ...
 */
FLCN_STATUS
spiRomInitInforomRegionFromScratch_LR10
(
    PSPI_DEVICE_ROM pSpiRom
)
{

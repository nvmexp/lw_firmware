...
/* ------------------------- Static Variables ------------------------------- */
SMBPBI_LWLINK SmbpbiLwlink[LW_MSGBOX_LWLINK_STATE_NUM_LWLINKS_LR10] = {{{0}}};
...
LwU8
smbpbiGetLwlinkErrorCountPerLink_LR10
(
    LwU32 linkNum,
    LwU8  errType,
    LwU32 *pErrorCount
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkErrorCountPerLink_LR10_exit;
    }
...
smbpbiGetLwlinkErrorCountPerLink_LR10_exit:
    return status;
}
#endif
...
#if (SOECFG_FEATURE_ENABLED(SOE_ONLY_LR10))
void
smbpbiGetSublinkLaneWidth_LR10
(
    LwU8 lwliptIdx,
    LwU8 linkIdx,
    LwU8 *pTxWidth,
 ...
 */
LwU32
smbpbiGetLwlinkUnitRegBaseOffset_LR10
(
    LwU32 lwliptNum,
    LwU32 linkNum,
    LwU32 unitRegBase
 ...
 */
LwU8
smbpbiGetLwlinkNumLinkPerLwlipt_LR10
(
    LwU32 *pData
)
{
 ...
 */
LwU8
smbpbiGetLwlinkMaxSublinkWidth_LR10
(
    LwU32 *pData
)
{
...
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkStateV1_LR10_exit;
    }
...
smbpbiGetLwlinkStateV1_LR10_exit:
    return status;
}
...
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkBandwidth_LR10_exit;
    }
...
smbpbiGetLwlinkBandwidth_LR10_exit:
    return status;
}
 ...
 */
LwU8
smbpbiGetLwlinkErrorCount_LR10
(
    LwU8  errType,
    LwU8  arg2,
    LwU32 *pData
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkErrorCount_LR10_exit;
    }
...
smbpbiGetLwlinkErrorCount_LR10_exit:
    return status;
}
...
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkStateV2_LR10_exit;
    }
...
smbpbiGetLwlinkStateV2_LR10_exit:
    return status;
}
 ...
 */
LwU8
smbpbiGetLwlinkSublinkWidth_LR10
(
    LwU8  arg1,
    LwU8  arg2,
    LwU32 *pData,
...
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkSublinkWidth_LR10_exit;
    }
...
smbpbiGetLwlinkSublinkWidth_LR10_exit:
    return status;
}
 ...
 */
LwU8
smbpbiGetLwlinkThroughput_LR10
(
    LwU8    arg1,
    LwU8    arg2,
    LwU32   *pCmd,
...
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkThroughput_LR10_exit;
    }
...
smbpbiGetLwlinkThroughput_LR10_exit:
    return status;
}
 ...
 */
LwU8
smbpbiGetLwlinkErrorState_LR10
(
    LwU8  arg1,
    LwU8  arg2,
    LwU32 *pCmd,
...
)
{
    ...
    if (status != LW_MSGBOX_CMD_STATUS_SUCCESS)
    {
        goto smbpbiGetLwlinkErrorState_LR10_exit;
    }
...
smbpbiGetLwlinkErrorState_LR10_exit:
    return status;
}

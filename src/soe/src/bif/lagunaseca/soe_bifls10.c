...
/* ------------------------- Macros and Defines -----------------------------*/
/* ------------------------ Function Prototypes ---------------------------- */
static LwBool _bifLtssmIsIdle_LS10(void)
    GCC_ATTRIB_SECTION("imem_bif", "_bifLtssmIsIdle_LS10");
static LwBool _bifIsLinkReady_LS10(void)
    GCC_ATTRIB_SECTION("imem_bif", "_bifIsLinkReady_LS10");
static LwBool _bifLtssmIsIdleAndLinkReady_LS10(void)
    GCC_ATTRIB_SECTION("imem_bif", "_bifLtssmIsIdleAndLinkReady_LS10");
static FLCN_STATUS _bifGetBusSpeed_LS10(LwU32 *pSpeed)
    GCC_ATTRIB_SECTION("imem_bif", "_bifGetBusSpeed_LS10");
static FLCN_STATUS _bifWriteNewPcieLinkSpeed_LS10(LwU32 xpPlLinkConfig0, LwU32 linkSpeed)
    GCC_ATTRIB_SECTION("imem_bif", "_bifWriteNewPcieLinkSpeed_LS10");
static FLCN_STATUS _bifSetXpPlLinkRate_LS10(LwU32 *pXpPlLinkConfig0, LwU32 linkSpeed)
    GCC_ATTRIB_SECTION("imem_bif", "_bifSetXpPlLinkRate_LS10");
static void _bifResetXpPlState_LS10(LwU32 xpPlLinkConfig0)
    GCC_ATTRIB_SECTION("imem_bif", "_bifResetXpPlState_LS10");
 ...
 */
static LwBool
_bifLtssmIsIdleAndLinkReady_LS10(void)
{
    return (_bifLtssmIsIdle_LS10() && _bifIsLinkReady_LS10());
}

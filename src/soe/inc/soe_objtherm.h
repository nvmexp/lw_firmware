...
/* ------------------------- Global Variables ------------------------------- */
LwrtosQueueHandle Disp2QThermThd;
...
/*!
 * THERM Object definition
 */
typedef struct
{
    THERM_HAL_IFACES  hal;
} OBJTHERM;
...
/* ------------------------ Static Variables ------------------------------- */
/* ------------------------ Function Prototypes ---------------------------- */
FLCN_STATUS constructTherm(void) GCC_ATTRIB_SECTION("imem_init", "constructTherm");

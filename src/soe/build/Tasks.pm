...
#
# Tasks:
#     Each task that runs in the SOE's RTOS is defined in this file.
...
#     Each worker thread that runs in the SOE's RTOS is defined in this file.
...
my $tasksRaw = [
    ...
    SOETASK_CORE =>
    {
        OSTASK_DEFINE => [
            ...
            OVERLAY_IMEM         => "OVL_INDEX_ILWALID",
            PRIV_LEVEL_EXT       => 2,
            PRIV_LEVEL_CSB       => 2, #Must be L2 for DMA
        ],
    ...
    SOETASK_SMBPBI =>
    {
        ...
        OVERLAY_COMBINATION => [
            [ ALL, ] => [
                [ '.imem_saw', '.imem_therm', ],
                [ '.imem_smbpbi', '.imem_therm', ],
                [ '.imem_bif', '.imem_saw', '.imem_smbpbi', ],
            ],
        ],
    },

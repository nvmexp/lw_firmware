...
#
#  SOE product app:                    //sw/.../uproc/soe/src/makefile.lwmk
#      $RESMAN_ROOT/../../uproc/soe/src/makefile.lwmk
#
...
SOECFG_DIR                    ?= $(SOECFG_SOESW_ROOT)/../config
SOECFG_CHIPCONFIG_DIR         ?= ../../../drivers/common/chip-config
SOECFG_OUTPUTDIR              ?= $(SOECFG_DIR)
SOECFG_VERBOSE                ?= 
SOE2CFG_HEADER                 ?= $(SOECFG_OUTPUTDIR)/soe-config.h
...
SOECFG_CLEAN          =
SOECFG_CLEAN         += $(SOE2CFG_HEADER) $(SOECFG_MAKEFRAGMENT)
...
soecfgOutputDirs = $(sort $(SOECFG_OUTPUTDIR)/ $(dir $(SOE2CFG_HEADER) $(SOECFG_MAKEFRAGMENT)))
...
$(SOE2CFG_HEADER): $(SOECFG_MAKEFRAGMENT)

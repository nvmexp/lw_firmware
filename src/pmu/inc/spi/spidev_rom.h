...
#include "pmu_eraseledger.h"
#include "spi/spidev.h"

/* ------------------------- Types Definitions ----------------------------- */
/*!
 * SPI rom device description
 */
typedef struct
{
...
#define LW_ROM_MANUFACTURER_PUYA      (0x85)
...
#define LW_ROM_WRSR_TIMEOUT_US        (500000)

#define LW_ROM_MAX_TIMEOUT_US         LW_ROM_SE_TIMEOUT_US

#define LW_PROM_2_DATA_LIMIT          (2097152)
...
BoardObjGrpIfaceModel10ObjSet       (spiDeviceGrpIfaceModel10ObjSetImpl_ROM)
    GCC_ATTRIB_SECTION("imem_spiLibConstruct", "spiDeviceGrpIfaceModel10ObjSetImpl_ROM");

...
/*!
 * @file    pmu_eraseledger.h
 * @brief   Contains Erase ledger specific defines.
 */

#ifndef PMU_ERASELEDGER_H
#define PMU_ERASELEDGER_H
 ...
 */
#define SPI_FOR_EACH_SECTOR(_pC,_pS) \
...
struct ERASE_LEDGER_DATA_SECTOR
{
     ...
     * so that they can be iterated over using @ref SPI_FOR_EACH_SECTOR() macro.
     */
    ERASE_LEDGER_DATA_SECTOR    *pNext;
};
...
struct ERASE_LEDGER_SECTOR
{
     ...
     * Used by @ref SPI_FOR_EACH_SECTOR() iterating macro.
     */
    ERASE_LEDGER_DATA_SECTOR    *pSectorHead;

    /*!
     * Erase Ledger Sector data structures are linked into a singly linked list so that
     * they can be iterated over using @ref SPI_FOR_EACH_SECTOR() macro.
     */
    ERASE_LEDGER_SECTOR    *pNext;
};
...
struct ERASE_LEDGER
{
     ...
     * Used by @ref SPI_FOR_EACH_SECTOR() iterating macro.
     */
    ERASE_LEDGER_SECTOR  *pSectorHead;
};

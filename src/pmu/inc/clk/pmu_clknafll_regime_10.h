...
#include "g_pmu_clknafll_regime_10.h"

#ifndef G_PMU_CLKNAFLL_REGIME_10_H
#define G_PMU_CLKNAFLL_REGIME_10_H
...
mockable FLCN_STATUS clkNafllGrpProgram(LW2080_CTRL_CLK_CLK_DOMAIN_LIST *pDomainList)
    GCC_ATTRIB_SECTION("imem_perfClkAvfs", "clkNafllGrpProgram");

#endif // G_PMU_CLKNAFLL_REGIME_10_H

...
#ifndef BOARDOBJGRPMASK_E512_H
#define BOARDOBJGRPMASK_E512_H

/*!
 * @file    boardobjgrpmask_e512.h
 *
 * @brief   Holds PMU definitions specific to the _E512 variant of
 *          BOARDOBJGRPMASK.
 */
...
/* ------------------------ Macros and Defines ------------------------------ */
/*!
 * @brief   BOARDOBJGRPMASK child class capable of storing 512 bits indexed
 *          between 0..254.
 */
typedef struct
{
     ...
     */
    LW2080_CTRL_BOARDOBJGRP_MASK_PRIMITIVE  pDataE512[LW2080_CTRL_BOARDOBJGRP_MASK_ARRAY_EXTENSION_SIZE(LW2080_CTRL_BOARDOBJGRP_E512_MAX_OBJECTS)];
} BOARDOBJGRPMASK_E512;
...
static inline void
boardObjGrpMaskInit_E512
(
    BOARDOBJGRPMASK_E512 *pMask
)
{
...
boardObjGrpMaskImport_E512
(
    BOARDOBJGRPMASK_E512               *pMask,
    LW2080_CTRL_BOARDOBJGRP_MASK_E512  *pExtMask
)
{

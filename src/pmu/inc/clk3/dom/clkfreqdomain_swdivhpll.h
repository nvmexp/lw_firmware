...
#ifndef CLK3_DOM_FREQDOMAIN_SWDIVHPLL_H
#define CLK3_DOM_FREQDOMAIN_SWDIVHPLL_H
...
/*!
 * @brief       Inputs for the pll/xtal SW4 switch (ClkSwDivHPllFreqDomain::pllxtal.mux)
 * @memberof    ClkSwDivHPllFreqDomain
 * @protected
 *
 * @details     The preprocessor is used to make sure all domains using this
 *              class have the same value for the POR paths.  As of GA10x,
 *              they do, and the domains are DISPCLK and HUBCLK.
 *
 *              If ClkSwDivHPllFreqDomain is used for additional domains, they
 ...
 *              ClkSwDivHPllFreqDomain to use in place of these macros.
 */
/**@{*/
...
#define CLK_INPUT_SWDIV_XTAL__SWDIVHPLLFREQDOMAIN CLK_INPUT_INDEX__SWDIV4(_PVTRIM, _SYS_DISPCLK_SWITCH_DIVIDER, _XTAL_PLL_REFCLK)
#endif
...
#define CLK_INPUT_SWDIV_PLL__SWDIVHPLLFREQDOMAIN CLK_INPUT_INDEX__SWDIV4(_PVTRIM, _SYS_DISPCLK_SWITCH_DIVIDER, _DISPPLL)
#endif
...
#define CLK_INPUT_SWDIV_SPPLL0_PDIV__SWDIVHPLLFREQDOMAIN CLK_INPUT_INDEX__SWDIV4(_PVTRIM, _SYS_DISPCLK_SWITCH_DIVIDER, _SPPLL0)
#endif
...
#define CLK_INPUT_SWDIV_SPPLL1_PDIV__SWDIVHPLLFREQDOMAIN CLK_INPUT_INDEX__SWDIV4(_PVTRIM, _SYS_DISPCLK_SWITCH_DIVIDER, _SPPLL1)
#endif


/*!
 * @brief       Inputs for the pll/xtal SW2 switch (ClkSwDivHPllFreqDomain::pllxtal.mux)
 * @memberof    ClkSwDivHPllFreqDomain
 * @protected
 */
/**@{*/
#define CLK_INPUT_PLLXTAL_PLL__SWDIVHPLLFREQDOMAIN       0
#define CLK_INPUT_PLLXTAL_XTAL__SWDIVHPLLFREQDOMAIN      1
/**@}*/


/*!
 * @brief       Number of inputs for the pll/xtal SW2 switch (ClkSwDivHPllFreqDomain::pllxtal.mux)
 * @memberof    ClkSwDivHPllFreqDomain
 * @protected
 */
#define CLK_INPUT_PLLXTAL_COUNT__SWDIVHPLLFREQDOMAIN     2


/* ------------------------ Datatypes -------------------------------------- */

typedef struct ClkSwDivHPllFreqDomain               ClkSwDivHPllFreqDomain;
typedef        ClkProgrammableFreqDomain_Virtual    ClkSwDivHPllFreqDomain_Virtual;


/*!
 * @class       ClkSwDivHPllFreqDomain
 ...
 * @protected
 *
 * @details     This class represents domains with a hybrid PLL (a.k.a. HPLL),
 *              SWLDIV, and a mux, for example, DISPCLK and HUBCLK on Ampere.
 *
 ...
 */
struct ClkSwDivHPllFreqDomain
{
    ClkProgrammableFreqDomain   super;          // domain
    ClkSwDiv4                   swdiv;          // output with SW4 and LDIV
    ClkHPll                     pll;            // domain-specific PLL (e.g. DISPPLL)

    struct
    {
        ClkMux                  mux;            // SW2 selecting between PLL v XTAL
        ClkFreqSrc             *input[CLK_INPUT_PLLXTAL_COUNT__SWDIVHPLLFREQDOMAIN];
    } pllxtal;
...
extern const ClkSwDivHPllFreqDomain_Virtual clkVirtual_SwDivHPllFreqDomain;
 ...
 */
/**@{*/
#define     clkRead_SwDivHPllFreqDomain      clkRead_ProgrammableFreqDomain      // Inherit
FLCN_STATUS clkConfig_SwDivHPllFreqDomain(ClkSwDivHPllFreqDomain *this, const ClkTargetSignal *pTarget)
    GCC_ATTRIB_SECTION("imem_libClkConfig", "clkConfig_SwDivHPllFreqDomain");
#define     clkProgram_SwDivHPllFreqDomain   clkProgram_ProgrammableFreqDomain   // Inherit
#define     clkCleanup_SwDivHPllFreqDomain   clkCleanup_ProgrammableFreqDomain   // Inherit
/**@}*/


/* ------------------------ Include Derived Types -------------------------- */

#endif // CLK3_DOM_FREQDOMAIN_SWDIVHPLL_H

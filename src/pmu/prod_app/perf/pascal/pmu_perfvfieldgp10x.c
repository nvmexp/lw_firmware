...
/* ------------------------- Static Variables ------------------------------- */
/*!
 * @brief Lookup table used by perfVfieldRegAddrValidate_GP10X.
 *
 ...
 */
static LwU32 s_vfieldRegAddrLookupTable_GP10X[]
    GCC_ATTRIB_SECTION("dmem_perfVfe", "s_vfieldRegAddrLookupTable_GP10X") =
{
    ...
    0x00000000, 0x00, 0x00,
    0x00000000, 0x00, 0x00,
    0x0010EBB0, 0x00, 0x00,
    0x00000000, 0x00, 0x00,
    0x000214A8, 0x00, 0x00,
    0x000214A0, 0x00, 0x00,
    0x000212D4, 0x00, 0x00,
    0x000214A4, 0x00, 0x00,
    0x000212AC, 0x00, 0x00,
    0x000015FC, 0x00, 0x00,
    0x000015FC, 0x00, 0x00
};

/*
 * s_vfieldRegAddrLookupTable_GP10X is laid out under the assumption that
 ...
 */
FLCN_STATUS
perfVfieldRegAddrValidate_GP10X
(
    LwU8  vfieldId,
    LwU8  segmentIdx,
    LwU32 regAddr
)
{
    return vfeVarRegAddrValidateAgainstTable(
                vfieldId, segmentIdx, regAddr, s_vfieldRegAddrLookupTable_GP10X,
                LW_ARRAY_ELEMENTS(s_vfieldRegAddrLookupTable_GP10X));
}

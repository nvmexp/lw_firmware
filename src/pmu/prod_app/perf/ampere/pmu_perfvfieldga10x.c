...
/* ------------------------- Static Variables ------------------------------- */
/*!
 * @brief Lookup table used by perfVfieldRegAddrValidate_GA10X.
 *
 ...
 *
 * @note TODO Update VField table and enable verification before shipping driver
 *       See pmu_sw/build/VFieldTableGenerator/README.txt for details
 */
static LwU32 s_vfieldRegAddrLookupTable_GA10X[]
    GCC_ATTRIB_SECTION("dmem_perfVfe", "s_vfieldRegAddrLookupTable_GA10X") =
{
    ...
    0x00000000, 0x00, 0x00,
    0x001183AC, 0x00, 0x00,
    0x00820178, 0x00, 0x00,
    0x008202D4, 0x00, 0x00,
    0x00820578, 0x00, 0x00
};

/*
 * s_vfieldRegAddrLookupTable_GA10X is laid out under the assumption that
 ...
 */
FLCN_STATUS
perfVfieldRegAddrValidate_GA10X
(
    LwU8  vfieldId,
    LwU8  segmentIdx,
    LwU32 regAddr
)
{
    return vfeVarRegAddrValidateAgainstTable(
                vfieldId, segmentIdx, regAddr, s_vfieldRegAddrLookupTable_GA10X,
                LW_ARRAY_ELEMENTS(s_vfieldRegAddrLookupTable_GA10X));
}

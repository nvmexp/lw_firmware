...
/* ------------------------- Static Variables ------------------------------- */
/*!
 * @brief Lookup table used by perfVfieldRegAddrValidate_GV100.
 *
 ...
 */
static LwU32 s_vfieldRegAddrLookupTable_GV100[]
    GCC_ATTRIB_SECTION("dmem_perfVfe", "s_vfieldRegAddrLookupTable_GV100") =
{
    ...
    0x000015FC, 0x00, 0x00,
    0x000216EC, 0x00, 0x00,
    0x000216EC, 0x00, 0x00,
    0x0011802C, 0x00, 0x00
};

/*
 * s_vfieldRegAddrLookupTable_GV100 is laid out under the assumption that
 ...
 */
FLCN_STATUS
perfVfieldRegAddrValidate_GV100
(
    LwU8  vfieldId,
    LwU8  segmentIdx,
    LwU32 regAddr
)
{
    return vfeVarRegAddrValidateAgainstTable(
                vfieldId, segmentIdx, regAddr, s_vfieldRegAddrLookupTable_GV100,
                LW_ARRAY_ELEMENTS(s_vfieldRegAddrLookupTable_GV100));
}

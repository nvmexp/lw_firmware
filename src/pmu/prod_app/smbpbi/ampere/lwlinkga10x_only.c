...
/*!
 * @file    lwlinkga10x_only.c
 * @brief   PMU HAL functions for GA10X SMBPBI
 */
...
/* ------------------------ Static Variables -------------------------------- */
SMBPBI_LWLINK SmbpbiLwlink[LW_MSGBOX_LWLINK_STATE_NUM_LWLINKS_GA10X]
 ...
 */
LwU32
smbpbiGetLwlinkUnitRegBaseOffset_GA10X
(
    LwU32 lwliptNum,
    LwU32 localLinkNum,
    LwU32 unitRegBase
)
{
    ...
    //
    // GA10X has only one LWLIPT, so no need to include the LWLIPT stride.
    //
    return unitRegBase + (localLinkNum * unitRegStride);
}
 ...
 */
LwU8
smbpbiGetLwlinkNumLinks_GA10X
(
    LwU32 *pData
)
{
    *pData = LW_MSGBOX_LWLINK_STATE_NUM_LWLINKS_GA10X;
    return LW_MSGBOX_CMD_STATUS_SUCCESS;
}
 ...
 */
LwU8
smbpbiGetLwlinkNumLwlipt_GA10X
(
    LwU32 *pData
)
{
    *pData = LW_MSGBOX_LWLINK_STATE_NUM_LWLIPT_GA10X;
    return LW_MSGBOX_CMD_STATUS_SUCCESS;
}

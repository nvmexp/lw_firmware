...
/*!
 * @file    smbpbitu10x.c
 * @brief   PMU HAL functions for TU10X+ SMBPBI
 */
 ...
 *          by filling the missing bits directly from the HW
 *
...
)
{
    ...
    for (link = 0; link < LW_MSGBOX_LWLINK_STATE_NUM_LWLINKS_TURING; ++link)
    {
 ...
 */
LwU8
smbpbiGetLwlinkNumLinks_TU10X
(
    LwU32 *pData
)
{
    *pData = LW_MSGBOX_LWLINK_STATE_NUM_LWLINKS_TURING;
    return LW_MSGBOX_CMD_STATUS_SUCCESS;
}
 ...
 *
 * @param[in]  arg1      Unused, but needed for HAL interface
 ...
 */
LwU8
smbpbiGetLwlinkBandwidth_TU10X
(
    LwU8   arg1,
    LwU8   arg2,
    LwU32  *pData,
 ...
 */
LwU8
smbpbiGetLwlinkErrorCount_TU10X
(
    LwU8    arg1,
    LwU8    link,
    LwU32   *pData
)
{
    ...
    if (link >= LW_MSGBOX_LWLINK_STATE_NUM_LWLINKS_TURING)
    {

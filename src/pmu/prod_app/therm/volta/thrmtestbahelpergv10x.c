 ...
 */
FLCN_STATUS
thermTestSetLwvddFactorA_GV10X
(
    LwU8    windowIdx,
    LwU32   factorA
)
{
    ...
    if (windowIdx >= LW_CPWR_THERM_PEAKPOWER_CONFIG8__SIZE_1)
    {
        status = FLCN_ERR_OUT_OF_RANGE;
        goto thermTestSetLwvddFactorA_GV10X_exit;
    }

    reg32 = REG_RD32(CSB, LW_CPWR_THERM_PEAKPOWER_CONFIG8(windowIdx));
    reg32 = FLD_SET_DRF_NUM(_CPWR_THERM, _PEAKPOWER_CONFIG8, _FACTOR_A, factorA, reg32);
    REG_WR32(CSB, LW_CPWR_THERM_PEAKPOWER_CONFIG8(windowIdx), reg32);

thermTestSetLwvddFactorA_GV10X_exit:
    return status;
}
 ...
 */
LwU32
thermTestGetLwvddFactorA_GV10X
(
    LwU8   windowIdx
)
{
    ...
    return REG_RD32(CSB, LW_CPWR_THERM_PEAKPOWER_CONFIG8(windowIdx));
}
 ...
 */
FLCN_STATUS
thermTestSetLwvddLeakageC_GV10X
(
    LwU8    windowIdx,
    LwU32   leakageC
)
{
    ...
    if (windowIdx >= LW_CPWR_THERM_PEAKPOWER_CONFIG9__SIZE_1)
    {
        status = FLCN_ERR_OUT_OF_RANGE;
        goto thermTestSetLwvddLeakageC_GV10X_exit;
    }

    reg32 = REG_RD32(CSB, LW_CPWR_THERM_PEAKPOWER_CONFIG9(windowIdx));
    reg32 = FLD_SET_DRF_NUM(_CPWR_THERM, _PEAKPOWER_CONFIG9, _LEAKAGE_C, leakageC, reg32);
    REG_WR32(CSB, LW_CPWR_THERM_PEAKPOWER_CONFIG9(windowIdx), reg32);

thermTestSetLwvddLeakageC_GV10X_exit:
    return status;
}
 ...
 */
LwU32
thermTestGetLwvddLeakageC_GV10X
(
    LwU8   windowIdx
)
{
    ...
    if (windowIdx >= LW_CPWR_THERM_PEAKPOWER_CONFIG9__SIZE_1)
    {
     ...
     reg32 = REG_RD32(CSB, LW_CPWR_THERM_PEAKPOWER_CONFIG9(windowIdx));
     return DRF_VAL(_CPWR_THERM, _PEAKPOWER_CONFIG9, _LEAKAGE_C, reg32);
}

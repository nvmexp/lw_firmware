...
thermPwmSourceDescriptorConstruct_GM10X
(
...
)
{
    ...
    switch (pwmSource)
    {
        ...
        case RM_PMU_PMGR_PWM_SOURCE_THERM_VID_PWM_0:
        {
            ...
            pwmSrcDesc.addrPeriod    = LW_CPWR_THERM_VID0_PWM;
            pwmSrcDesc.addrDutycycle = LW_CPWR_THERM_VID1_PWM;
    ...
    {
        PMU_BREAKPOINT();
        goto thermPwmSourceDescriptorConstruct_GM10X_exit;
    }
...
thermPwmSourceDescriptorConstruct_GM10X_exit:
    return pPwmSrcDesc;
}

...
/*!
 * @file   pmu_fifogm20x.c
 * @brief  HAL-interface for the GM20X Fifo Engine.
 */
...
/* ------------------------- Static Variables ------------------------------- */
static PMU_ENGINE_LOOKUP_TABLE EngineLookupTable_GM20X[] =
{
    {LW_PTOP_DEVICE_INFO_TYPE_ENUM_GRAPHICS, PMU_ENGINE_GR,   0},
    {LW_PTOP_DEVICE_INFO_TYPE_ENUM_COPY2,    PMU_ENGINE_CE2,  0},
    {LW_PTOP_DEVICE_INFO_TYPE_ENUM_LWENC0,   PMU_ENGINE_ENC0, 0},
    {LW_PTOP_DEVICE_INFO_TYPE_ENUM_LWENC1,   PMU_ENGINE_ENC1, 0},
 ...
 */
void
fifoGetEngineLookupTable_GM20X
(
    PMU_ENGINE_LOOKUP_TABLE **pEngineLookupTable,
    LwU32                    *pEngLookupTblSize
)
{
    *pEngineLookupTable = EngineLookupTable_GM20X;
    *pEngLookupTblSize  = LW_ARRAY_ELEMENTS(EngineLookupTable_GM20X);
}
 ...
 */
void
fifoGetLwdecPmuEngineId_GM20X(LwU8 *pPmuEngIdLwdec)
{

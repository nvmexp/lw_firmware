...
/*!
 * @file    boardobjgrp_e255.c
 * @copydoc boardobjgrp_e255.h
 */
...
/* ------------------------ Public Functions -------------------------------- */
/*!
 * @brief   _E255 implementation of @ref BoardObjGrpIfaceModel10Set().
 *
 * @copydetails BoardObjGrpIfaceModel10Set()
 */
FLCN_STATUS
boardObjGrpIfaceModel10Set_E255
(
...
/*!
 * @brief   _E255 implementation of @ref BoardObjGrpIfaceModel10Set(), using AutoDMA feature
 *
 * @copydetails BoardObjGrpIfaceModel10Set()
 */
FLCN_STATUS
boardObjGrpIfaceModel10SetAutoDma_E255
(
    BOARDOBJGRP_IFACE_MODEL_10                *pModel10,
    LwU8                        groupType,
    PMU_DMEM_BUFFER            *pBuffer,
...
/*!
 * @brief   _E255 implementation of @ref BoardObjGrpIfaceModel10GetStatus().
 *
 * @copydetails BoardObjGrpIfaceModel10GetStatus()
 */
FLCN_STATUS
boardObjGrpIfaceModel10GetStatus_E255
(
    BOARDOBJGRP_IFACE_MODEL_10                    *pModel10,
    PMU_DMEM_BUFFER                *pBuffer,
...
/*!
 * @brief   _E255 implementation of @ref BoardObjGrpIfaceModel10GetStatus() using AutoDma feature
 *
 * @copydetails BoardObjGrpIfaceModel10GetStatus()
 */
FLCN_STATUS
boardObjGrpIfaceModel10GetStatusAutoDma_E255
(
    BOARDOBJGRP_IFACE_MODEL_10                    *pModel10,
    PMU_DMEM_BUFFER                *pBuffer,
    BoardObjGrpIfaceModel10GetStatusHeader      (hdrFunc),

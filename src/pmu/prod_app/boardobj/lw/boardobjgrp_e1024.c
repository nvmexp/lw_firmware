...
/*!
 * @file    boardobjgrp_e1024.c
 * @copydoc boardobjgrp_e1024.h
 */
...
/* ------------------------ Public Functions -------------------------------- */
/*!
 * @brief   _E1024 implementation of @ref BoardObjGrpIfaceModel10Set().
 *
 * @copydetails BoardObjGrpIfaceModel10Set()
 */
FLCN_STATUS
boardObjGrpIfaceModel10Set_E1024
(
...
/*!
 * @brief   _E1024 implementation of @ref BoardObjGrpIfaceModel10Set() using AutoDma feature
 *
 * @copydetails BoardObjGrpIfaceModel10Set()
 */
FLCN_STATUS
boardObjGrpIfaceModel10SetAutoDma_E1024
(
    BOARDOBJGRP_IFACE_MODEL_10                *pModel10,
    LwU8                        groupType,
    PMU_DMEM_BUFFER            *pBuffer,
...
/*!
 * @brief   _E1024 implementation of @ref BoardObjGrpIfaceModel10GetStatus().
 *
 * @copydetails BoardObjGrpIfaceModel10GetStatus()
 */
FLCN_STATUS
boardObjGrpIfaceModel10GetStatus_E1024
(
    BOARDOBJGRP_IFACE_MODEL_10                    *pModel10,
    PMU_DMEM_BUFFER                *pBuffer,
...
/*!
 * @brief   _E1024 implementation of @ref BoardObjGrpIfaceModel10GetStatus() using AutoDma feature
 *
 * @copydetails BoardObjGrpIfaceModel10GetStatus()
 */
FLCN_STATUS
boardObjGrpIfaceModel10GetStatusAutoDma_E1024
(
    BOARDOBJGRP_IFACE_MODEL_10                    *pModel10,
    PMU_DMEM_BUFFER                *pBuffer,
    BoardObjGrpIfaceModel10GetStatusHeader      (hdrFunc),

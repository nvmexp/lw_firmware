...
/*!
 * @file clk_domain_35_primary_base-mock.c
 * @brief Mock implementation for clk_domain_35_primary public interface.
 */
 ...
 */
void clkDomainProgVoltToFreqTuple_35_PRIMARYMockInit(void)
{
 ...
 */
void clkDomainProgVoltToFreqTuple_35_PRIMARYMockAddEntry(LwU8 entry, FLCN_STATUS status)
{
 ...
 */
FLCN_STATUS
clkDomainProgVoltToFreqTuple_35_PRIMARY_MOCK
(

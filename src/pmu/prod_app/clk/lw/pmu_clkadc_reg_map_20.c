...
{
    {
        LW2080_CTRL_CLK_ADC_ID_SYS,
        {
            ...
            LW_PTRIM_SYS_NAFLL_SYSNAFLL_LWVDD_ADC_BACKUP_CTRL,
#else
...
#ifdef LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL(0),
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }
...
#ifdef LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL(1),
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }
...
#ifdef LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL(2),
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }
...
#ifdef LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL(3),
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }
...
#ifdef LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL(4),
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }
...
#ifdef LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_GPCNAFLL_ADC_BACKUP_CTRL(5),
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }
...
#ifdef LW_PTRIM_GPC_BCAST_GPCNAFLL_ADC_BACKUP_CTRL
            LW_PTRIM_GPC_BCAST_GPCNAFLL_ADC_BACKUP_CTRL,
#else
            CLK_ADC_REG_UNDEFINED,
#endif
        }

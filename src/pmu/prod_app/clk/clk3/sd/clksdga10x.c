 ...
 *              schematic dag for the GA10x family, which
 *              - Use SWDIVs,
 *              - Have display, and
...
typedef struct
{
    ...
    // MCLK on GA10x is for GDDR/SDDR (not HBM).
    struct
    {
 ...
 * @see     Perforce hw/doc/gpu/SOC/Clocks/Documentation/POR/GA10X/GA10x-clks-Ampere-792-xtal16x_core_clocks.vsdx
 *
    ...
    GCC_ATTRIB_SECTION("dmem_clk3x", "_clkSchematicDag") =
{
    ...
    .utilsclk.swdiv.input[CLK_INPUT_INDEX__SWDIV4AUTOMATIC(_PTRIM, _SYS_XTAL4X_UNIV_SEC_CLK_CTRL, _DEFROST_CLK)] = &clkSchematicDag.defrost.readonly.super.super,
    ...
    .utilsclk.swdiv.input[CLK_INPUT_AUTO_INDEX__SWDIV4AUTOMATIC]                                                 = &clkSchematicDag.defrost.readonly.super.super,
    ...
    .pwrclk.swdiv.input[LW_PTRIM_SYS_PWRCLK_CTRL_CLOCK_SOURCE_SEL_DEFROST_CLK]     = &clkSchematicDag.defrost.readonly.super.super,
    .pwrclk.swdiv.input[CLK_INPUT_AUTO_INDEX__SWDIV2AUTOMATIC]                     = &clkSchematicDag.defrost.readonly.super.super,
...
#if LW_PTRIM_SYS_DRAMCLK_ALT_SWITCH_DIVIDER_CLOCK_SOURCE_SEL_INIT != LW_PTRIM_SYS_DRAMCLK_ALT_SWITCH_DIVIDER_CLOCK_SOURCE_SEL_DEFROST_CLK && \
...
#endif
    .mclk.swdiv.input[CLK_INPUT_INDEX__SWDIV4(_PTRIM, _SYS_DRAMCLK_ALT_SWITCH_DIVIDER, _DEFROST_CLK)]     = &clkSchematicDag.defrost.readonly.super.super,

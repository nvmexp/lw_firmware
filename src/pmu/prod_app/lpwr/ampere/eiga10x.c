...
/*!
 * @brief Function to set Idle mask for EI Passive FSM
 */
void
eiPassiveIdleMaskInit_GA10X(void)
{
    OBJPGSTATE *pPgState = GET_OBJPGSTATE(RM_PMU_LPWR_CTRL_ID_EI_PASSIVE);
    LwU32       im0      = 0;
    LwU32       im1      = 0;
    LwU32       im2      = 0;

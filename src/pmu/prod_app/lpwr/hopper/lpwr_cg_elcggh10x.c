...
lpwrCgElcgPreInit_GH100(void)
{
    ...
    regVal = REG_RD32(CSB, LW_CPWR_THERM_SYS_PRI_HUB_IDLE_FILTER);
    regVal = FLD_SET_DRF(_CPWR_THERM, _SYS_PRI_HUB_IDLE_FILTER,
                         _VALUE, __PROD, regVal);
    REG_WR32(CSB, LW_CPWR_THERM_SYS_PRI_HUB_IDLE_FILTER, regVal);

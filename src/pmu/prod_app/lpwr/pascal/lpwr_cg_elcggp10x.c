...
/* ------------------------- Macros and Defines ----------------------------- */
/* ------------------------- Prototypes ------------------------------------- */
static FLCN_STATUS s_lpwrCgElcgStateChange_GP10X(LwU32 engHwId, LwBool bEnable);
...
)
{
    ...
    if (engHwId == engHwIdGr)
    {
        ...
        {
            status = s_lpwrCgElcgStateChange_GP10X(engHwId, LW_TRUE);
        }
    }
    else
    {
...
)
{
    ...
    if (engHwId == engHwIdGr)
    {
        if (Lpwr.grElcgDisableReasonMask == 0)
        {
            status = s_lpwrCgElcgStateChange_GP10X(engHwId, LW_FALSE);
        }
...
)
{
    ...
    if (engHwId >= LW_CPWR_THERM_GATE_CTRL__SIZE_1)
    {
        ...
        goto lpwrCgElcgStateChange_GP10X_exit;
    }
...
lpwrCgElcgStateChange_GP10X_exit:

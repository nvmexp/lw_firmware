...
/*!
 * @file    i2cdev_stm32f051k8u6tr.c
 * @brief   MLW GPU I2C Device implementation
 * @extends I2C_DEVICE
 */
...
/*!
 * Construct a new STM32F051K8U6TR I2C device object.
 *
 * @copydoc I2cDevConstruct
 */
FLCN_STATUS
i2cDevGrpIfaceModel10ObjSet_STM32F051K8U6TR
(
...
)
{
    ...
    if (status != FLCN_OK)
    {
        goto i2cDevGrpIfaceModel10ObjSet_STM32F051K8U6TR_exit;
    }

    // STM32F051K8U6TR is a Little-Endian Device.
...
i2cDevGrpIfaceModel10ObjSet_STM32F051K8U6TR_exit:
    return status;
}

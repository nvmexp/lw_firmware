...
/* ------------------------- Prototypes ------------------------------------- */
sysSYSLIB_CODE static LwU8 _smbpbiOsfpGetPingPongBuff(SOE_SMBPBI_OSFP_XCEIVER_PING_PONG_BUFF *pBuff, 
                                       SOE_SMBPBI_OSFP_XCEIVER_MASKS *pXcvrMask);
sysSYSLIB_CODE static LwU8 _smbpbiOsfpCheckPresent(SOE_SMBPBI_OSFP_XCEIVER_MASKS *pXcvrMask, 
                                    LwU8 xceiverIdx, LwU8 maskType);
sysSYSLIB_CODE static LwU8 _smbpbiOsfpSendCommand(LwU8 cmd);

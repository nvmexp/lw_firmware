...
/* ------------------------- Macros and Defines ----------------------------- */
/* ------------------------- Prototypes ------------------------------------- */
sysSYSLIB_CODE LwU8 s_smbpbiBundleRulesCheck(LwU32 *pDispRules, LwU32 rulesOffset, LwU8 reqCnt, LwU8 *pRuleCnt, LwU32 *pCmd);
sysSYSLIB_CODE void s_smbpbiApplyRule(LwU32 rule, LwU8 reqIdx, LwU32 dataOut, LwU32 extData, LwU32 *pCmd, LwU32 *pData, LwU32 *pExtData);
 ...
 */
sysTASK_DATA static LwU32    dispRulesStd[] =
{

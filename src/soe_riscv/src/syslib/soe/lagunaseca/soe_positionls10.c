...
/*!
* @file    soe_positionls10.c
* @brief   SOE HAL functions for LS10 to identify device positional id.
*/
...
sysTASK_DATA static const LWSWITCH_GPIO_INFO lwswitch_gpio_pin_Defaults[] =
{
...
sysTASK_DATA static const LwU32 lwswitch_gpio_pin_Default_size = LW_ARRAY_ELEMENTS(lwswitch_gpio_pin_Defaults);

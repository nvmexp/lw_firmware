...
#define DO_TASK_RM_CHNLMGMT     0
#define DO_TASK_WORKLAUNCH      1
#define DO_TASK_RM_THERM        1
#define DO_TASK_RM_CORE         1
#define DO_TASK_RM_SPI          1
#define DO_TASK_RM_BIF          1
#define DO_TASK_RM_SMBPBI       0
...
#define SOE_CMD_QUEUE_RM       0
#define SOE_CMD_QUEUE_DEBUG    1
...
#if DO_TASK_RM_CORE
extern LwrtosQueueHandle Disp2QCoreThd;
#endif

#if DO_TASK_RM_SPI
extern LwrtosQueueHandle Disp2QSpiThd;
#endif

#if DO_TASK_RM_BIF
extern LwrtosQueueHandle Disp2QBifThd;
#endif

...
//
#define SOE_MSG_QUEUE_RM       SOE_CMD_QUEUE_RM
 ...
 *     a. Queue 0 - used by RM to send generic commands to SOE
 *     b. Queue 7 - used by PMU to send GPCCS bootstrap command to SOE
 */
 ...
 */
extern sysTASK_DATA LwU32 SoeMgmtCmdOffset[SOE_CMDMGMT_CMD_QUEUE_NUM];

// Compile time asserts incase any of the queue indexes change!
ct_assert(SOE_RM_CMDQ_LOG_ID == 0);
ct_assert(SOE_RM_MSGQ_LOG_ID == 1);
ct_assert(SOE_QUEUE_NUM == 2);

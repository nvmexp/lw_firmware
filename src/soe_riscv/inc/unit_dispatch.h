 ...
 * queues.  In general however, unit-tasks need to be fed commands from SOE
 ...
 * to dispatch a SOE command to a unit-task for processing.
 */
typedef struct
{
    /*!
...
/*!
 * @brief Structure used to pass CORE related events.
 *  This structure is needed for callback tasks
 */
typedef union
{
    LwU8            eventType;
...
/*!
 * @brief Structure used to pass SMBPBI related events.
 *  This structure is needed for callback tasks
 */
typedef union
{
...
/*!
 * @brief Structure used to pass THERM related events.
 *  This structure is needed for callback tasks
 */
typedef union
{

...
/* ------------------------- Public Functions ------------------------------ */
sysSYSLIB_CODE void sysMonInit(void);
sysSYSLIB_CODE FLCN_STATUS smbpbiDispatch(DISP2UNIT_CMD *pDispSmbpbi);
sysSYSLIB_CODE LwU8 smbpbiHandleMsgBoxRequest(LwU32 *pCmd, LwU32 *pData, LwU32 *pExtData);
sysSYSLIB_CODE LwU8 smbpbiBundleLaunch(LwU32 *pCmd, LwU32 *pData, LwU32 *pExtData);
sysSYSLIB_CODE void smbpbiInitDem(OBJSMBPBI *pSmbpbi);
sysSYSLIB_CODE LwBool smbpbiDemEventSource(void);
sysSYSLIB_CODE LwU8 smbpbiGetDem(LwU8 arg1, LwU8 arg2);
sysSYSLIB_CODE LwU8 smbpbiHostMemRead(LwU32 offset, LwU32 size, LwU8 *pDst);
sysSYSLIB_CODE LwU8 smbpbiHostMemOp(LwU32 cmd, LwU32 *pData);
sysSYSLIB_CODE LwU8 smbpbiRegWr(LwU8 reg, LwU32 data);
sysSYSLIB_CODE LwU8 smbpbiRegRd(LwU8 reg, LwU32 *pData);
sysSYSLIB_CODE LwU8 smbpbiScratchPtr2Offset(LwU8 ptr, SCRATCH_BANK_TYPE bank_type, LwU32 *pOffset);
sysSYSLIB_CODE LwU8 smbpbiScratchRW(LwU32 offset, void *pBuf, LwU32 size, LwBool bWrite);
sysSYSLIB_CODE LwU8 smbpbiCheckEvents(LwU32 *pStatus);
sysSYSLIB_CODE FLCN_STATUS smbpbiReadSharedSurface(void *pDmemAddr, LwU32 offset, LwU32 size);
sysSYSLIB_CODE LwBool smbpbiIsSharedSurfaceAvailable(void);
sysSYSLIB_CODE LwU8 smbpbiInforomRead(LwU32 offset, LwU32 size, LwU8 *pDst);
sysSYSLIB_CODE LwU8 smbpbiInforomWrite(LwU32 offset, LwU32 size, LwU8 *pSrc);
sysSYSLIB_CODE LwU8 smbpbiMapSoeStatusToMsgBoxStatus(FLCN_STATUS status);
sysSYSLIB_CODE LwU8 smbpbiOsfpGetHottest(LwU32 *pCmd, LwU32 *pData, LwU32 *pExtData);
sysSYSLIB_CODE LwU8 smbpbiOsfpGetLedState(LwU32 *pData, LwU32 *pExtData);
sysSYSLIB_CODE LwU8 smbpbiOsfpGetXceiverTemperature(LwU8 xceiverIdx, LwU32 *pData);
sysSYSLIB_CODE LwU8 smbpbiOsfpSetLedLocate(LwU8 xceiverIdx);
sysSYSLIB_CODE LwU8 smbpbiOsfpResetLedLocate(LwU8 xceiverIdx);
sysSYSLIB_CODE LwU8 smbpbiOsfpGetInfo(LwU8 xceiverIdx, LwU8 infoType, LwU8 offset, LwU32 *pData, LwU32 *pExtData);
sysSYSLIB_CODE void smbpbiOsfpSetCaps(LwU32 *pCaps);
sysKERNEL_CODE void smbpbiPreInit(void);
sysSYSLIB_CODE void smbpbiInit(void);

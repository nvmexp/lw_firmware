...
// ACRLIB:hal:GET_LWENC2_CONFIG  -  GP102
...
#define acrlibGetFalconConfig_HAL(_pAcrlib, _arg0, _arg1)  \
        acrlibGetFalconConfig_GP10X((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ , _arg1)
...
#define acrlibSelwreResetFalcon_HAL(_pAcrlib, _arg0)  \
        acrlibSelwreResetFalcon_GP10X((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )
...
#define acrlibSetupSec2Registers_HAL(_pAcrlib, _arg0)  \
        acrlibSetupSec2Registers_GP10X((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )
#define acrlibShouldBootstrapFalcon_HAL(_pAcrlib, _arg0)  \
        acrlibShouldBootstrapFalcon_GP10X((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )

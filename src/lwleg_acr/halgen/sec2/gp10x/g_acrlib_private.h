...
//
// Profile:  acr_sec2-gp10x_fmodel_load
...
AcrlibProgramDmaBase               acrlibProgramDmaBase_GP100   // GP102
...
#if defined(ACRCFG_HAL_SETUP_GP102)

static void     acrlibHalIfacesSetup_GP102(ACRLIB_HAL_IFACES *) 
                    GCC_ATTRIB_SECTION("imem_acr", "acrlibHalIfacesSetup_GP102");

static void acrlibHalIfacesSetup_GP102(ACRLIB_HAL_IFACES *pAcrlibHal)
{

    // GP102's ACRLIB hal interface function pointer block
    static const ACRLIB_HAL_IFACES acrlibHalIfacesInitStruct_GP102 =
    {

        0 // avoid empty typedef
    };  // acrlibHalIfacesInitStruct_GP102

    // init GP102's ACRLIB function ptrs using the init struct above
    *pAcrlibHal = acrlibHalIfacesInitStruct_GP102;
}

#endif  // GP10X or GP102

...
LwBool              acrlibIsBootstrapOwner_GM200(LwU32 falconId)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibIsBootstrapOwner_GM200");
ACR_STATUS          acrlibFindRegMapping_GM200(PACR_FLCN_CONFIG pFlcnCfg, ACR_FLCN_REG_LABEL acrLabel, PACR_REG_MAPPING pMap, PFLCN_REG_TGT pTgt)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFindRegMapping_GM200");
void                acrlibFlcnRegLabelWrite_GM200(PACR_FLCN_CONFIG pFlcnCfg, ACR_FLCN_REG_LABEL reglabel, LwU32 data)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegLabelWrite_GM200");
LwU32               acrlibFlcnRegLabelRead_GM200(PACR_FLCN_CONFIG pFlcnCfg, ACR_FLCN_REG_LABEL reglabel)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegLabelRead_GM200");
LwU32               acrlibFlcnRegRead_GM200(PACR_FLCN_CONFIG pFlcnCfg, FLCN_REG_TGT tgt, LwU32 regOff)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegRead_GM200");
void                acrlibFlcnRegWrite_GM200(PACR_FLCN_CONFIG pFlcnCfg, FLCN_REG_TGT tgt, LwU32 regOff, LwU32 data)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegWrite_GM200");
ACR_STATUS          acrlibGetFalconConfig_GM200(LwU32 falconId, LwU32 falconInstance, PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibGetFalconConfig_GM200");
ACR_STATUS          acrlibPollForScrubbing_GM200(PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibPollForScrubbing_GM200");
LwBool              acrlibIsFalconHalted_GM200(PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibIsFalconHalted_GM200");
ACR_STATUS          acrlibSetupTargetRegisters_GM200(PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupTargetRegisters_GM200");
void                acrlibGetLwrrentTimeNs_GM200(PACR_TIMESTAMP pTime)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibGetLwrrentTimeNs_GM200");
LwU32               acrlibGetElapsedTimeNs_GM200(const PACR_TIMESTAMP pTime)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibGetElapsedTimeNs_GM200");
ACR_STATUS          acrlibCheckTimeout_GM200(LwU32 timeoutNs, ACR_TIMESTAMP startTimeNs, LwS32* pTimeoutLeftNs)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibCheckTimeout_GM200");
ACR_STATUS          acrlibSetupCtxDma_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwU32 ctxDma, LwBool bIsPhysical)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupCtxDma_GM200");
ACR_STATUS          acrlibIssueTargetFalconDma_GM200(LwU32 dstOff, LwU64 fbBase, LwU32 fbOff, LwU32 sizeInBytes, LwU32 regionID, LwBool bIsSync, LwBool bIsDstImem, PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibIssueTargetFalconDma_GM200");
ACR_STATUS          acrlibResetFalcon_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwBool bForceFlcnOnlyReset)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibResetFalcon_GM200");
static void         acrlibSelwreResetFalcon_STUB(PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibSelwreResetFalcon_STUB");
LwU32               acrlibFindFarthestImemBl_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwU32 codeSizeInBytes)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFindFarthestImemBl_GM200");
LwU32               acrlibFindTotalDmemBlocks_GM200(PACR_FLCN_CONFIG pFlcnCfg)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibFindTotalDmemBlocks_GM200");
LwBool              acrlibCheckIfUcodeFitsFalcon_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwU32 ucodeSize, LwBool bIsDstImem)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibCheckIfUcodeFitsFalcon_GM200");
ACR_STATUS          acrlibProgramRegionCfg_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwBool bUseCsb, LwU32 ctxDma, LwU32 regionID)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibProgramRegionCfg_GM200");
void                acrlibSetupBootvec_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwU32 bootvec)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupBootvec_GM200");
void                acrlibSetupDmaCtl_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwBool bIsCtxRequired)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupDmaCtl_GM200");
void                acrlibProgramDmaBase_GM200(PACR_FLCN_CONFIG pFlcnCfg, LwU64 fbBase)   // T21X
                        GCC_ATTRIB_SECTION("imem_acr", "acrlibProgramDmaBase_GM200");
static void         acrlibInitializeStackCfg_STUB(PACR_FLCN_CONFIG arg1, LwU32 arg2)   // T21X
...
// ACRLIB:hal:SELWRE_RESET_FALCON  -  T21X
...
// ACRLIB:hal:INITIALIZE_STACK_CFG  -  T21X

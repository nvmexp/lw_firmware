...
// Haldef:   /home/smadhavan/p4/sw/dev/gpu_drv/chips_a/uproc/tegra_acr/src/../config/haldefs/acr.def
...
#define acrSetupFalconCodeAndDataSubWprs_HAL(_pAcr, _falconId, _pLsbHeaders)  \
        acrSetupFalconCodeAndDataSubWprs_STUB(_falconId, _pLsbHeaders)
#define acrProgramFalconSubWpr_HAL(_pAcr, _falconId, _flcnSubWprId, _startAddr, _endAddr, _readMask, _writeMask)  \
        acrProgramFalconSubWpr_STUB(_falconId, _flcnSubWprId, _startAddr, _endAddr, _readMask, _writeMask)
...
#define acrGetFuseVersionSW_HAL(_pAcr, _pFuseVersion)  \
        acrGetFuseVersionSW_GV11B(_pFuseVersion)
...
#define acrCheckIfBuildIsSupported_HAL(_pAcr)  \
        acrCheckIfBuildIsSupported_GV11B()
#define acrSetupSctlDecodeTrap_HAL(_pAcr)  \
        acrSetupSctlDecodeTrap_STUB()
...
#define acrLockFalconReset_HAL(_pAcr, _bLock)  \
        acrLockFalconReset_GV11B(_bLock)
...
ACR_STATUS          acrInit_T210(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrInit_T210");
void                acrInitScpRng_T210(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrInitScpRng_T210");
ACR_STATUS          acrGetRandNum_T210(LwU32 *pRandInOut)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrGetRandNum_T210");
ACR_STATUS          acrFindWprRegions_T210(LwU32 *pWprIndex)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrFindWprRegions_T210");
ACR_STATUS          acrFindCtxDma_GM200(LwU32 *pCtxDma)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrFindCtxDma_GM200");
ACR_STATUS          acrPollForResetCompletion_GM200(LwU32 validIndexMap)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrPollForResetCompletion_GM200");
ACR_STATUS          acrResetEngineFalcon_GM200(LwU32 validIndexMap)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrResetEngineFalcon_GM200");
ACR_STATUS          acrSetupLSFalcon_GM200(PLSF_LSB_HEADER pLsbHeaders, LwU32 validIndexMap)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrSetupLSFalcon_GM200");
static ACR_STATUS   acrSetupFalconCodeAndDataSubWprs_STUB(LwU32 falconId, PLSF_LSB_HEADER pLsbHeaders)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrSetupFalconCodeAndDataSubWprs_STUB");
static ACR_STATUS   acrProgramFalconSubWpr_STUB(LwU32 falconId, LwU8 flcnSubWprId, LwU32 startAddr, LwU32 endAddr, LwU8 readMask, LwU8 writeMask)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrProgramFalconSubWpr_STUB");
ACR_STATUS          acrPopulateDMAParameters_GM200(LwU32 wprRegIndex)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrPopulateDMAParameters_GM200");
ACR_STATUS          acrReadWprHeader_GM200(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrReadWprHeader_GM200");
ACR_STATUS          acrWriteWprHeader_GM200(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrWriteWprHeader_GM200");
ACR_STATUS          acrReadLsbHeader_GM200(PLSF_WPR_HEADER pWprHeader, PLSF_LSB_HEADER pLsbHeader)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrReadLsbHeader_GM200");
ACR_STATUS          acrScrubUnusedWprWithZeroes_GM200(LwU32 nextKnownOffset, LwU32 size)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrScrubUnusedWprWithZeroes_GM200");
ACR_STATUS          acrSanityCheckBlData_GM200(LwU32 falconId, LwU32 blDataOffset, LwU32 blDataSize)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrSanityCheckBlData_GM200");
ACR_STATUS          acrBootstrapFalcons_GM200(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrBootstrapFalcons_GM200");
LwU32               acrIssueDma_GM200(LwU32 memOff, LwBool bIsImem, LwU32 fbOff, LwU32 sizeInBytes, ACR_DMA_DIRECTION dmaDirection, ACR_DMA_SYNC_TYPE dmaSync, PACR_DMA_PROP pDmaProp)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrIssueDma_GM200");
ACR_STATUS          acrCheckFuseRevocation_GV11B(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrCheckFuseRevocation_GV11B");
void                acrGetFuseVersionHW_GV11B(LwU32 *fuseVersion)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrGetFuseVersionHW_GV11B");
void                acrGetFuseVersionSW_GV11B(LwU32 *fuseVersion)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrGetFuseVersionSW_GV11B");
void                acrCallwlateDmhash_GM200(LwU8 *pHash, LwU8 *pData, LwU32 size)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrCallwlateDmhash_GM200");
ACR_STATUS          acrVerifySignature_GM200(LwU8 *pSignature, LwU32 falconId, LwU32 binarysize, LwU32 binOffset, PLSF_LSB_HEADER pLsfHeader, LwBool bIsUcode)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrVerifySignature_GM200");
LwBool              acrIsDebugModeEnabled_GM200(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrIsDebugModeEnabled_GM200");
void                acrProgramDmaBase_GM200(LwBool bIsImem, PACR_DMA_PROP pDmaProp)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrProgramDmaBase_GM200");
ACR_STATUS          acrCopyUcodesToWpr_T210(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrCopyUcodesToWpr_T210");
static void         acrFetchRegion_STUB(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrFetchRegion_STUB");
ACR_STATUS          acrCheckIfBuildIsSupported_GV11B(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrCheckIfBuildIsSupported_GV11B");
static void         acrSetupSctlDecodeTrap_STUB(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrSetupSctlDecodeTrap_STUB");
void                acrMitigateNsRestartFromHs_T210(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrMitigateNsRestartFromHs_T210");
static ACR_STATUS   acrWriteAcrVersionToBsiSelwreScratch_STUB(LwU32 arg1)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrWriteAcrVersionToBsiSelwreScratch_STUB");
static ACR_STATUS   acrProgramHubEncryption_STUB(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrProgramHubEncryption_STUB");
static void         acrDisableLockdown_STUB(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrDisableLockdown_STUB");
ACR_STATUS          acrLockFalconReset_GV11B(LwBool bLock)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrLockFalconReset_GV11B");
static ACR_STATUS   acrLockFalconRegSpace_STUB(PACR_FLCN_CONFIG pFlcnCfg, LwBool setTrap)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrLockFalconRegSpace_STUB");
static ACR_STATUS   acrLockFalconRegSpaceViaDecodeTrapCommon_STUB(void)   // T19X
                        GCC_ATTRIB_SECTION("imem_acr", "acrLockFalconRegSpaceViaDecodeTrapCommon_STUB");
static ACR_STATUS   acrCopyLsGrpSigToRegsForSec2_STUB(LwU32 *pArg1, LwU32 arg2)   // T19X
...
// ACR:hal:SETUP_FALCON_CODE_AND_DATA_SUB_WPRS  -  T19X
static LW_INLINE ACR_STATUS acrSetupFalconCodeAndDataSubWprs_STUB(
    LwU32         falconId,
...
// ACR:hal:PROGRAM_FALCON_SUB_WPR  -  T19X
static LW_INLINE ACR_STATUS acrProgramFalconSubWpr_STUB(
    LwU32         falconId,
    LwU8          flcnSubWprId,
    LwU32         startAddr,
    LwU32         endAddr,
...
// ACR:hal:FETCH_REGION  -  T19X
static LW_INLINE void acrFetchRegion_STUB(void)
{
}

// ACR:hal:SETUP_SCTL_DECODE_TRAP  -  T19X
static LW_INLINE void acrSetupSctlDecodeTrap_STUB(void)
{
}

// ACR:hal:WRITE_ACR_VERSION_TO_BSI_SELWRE_SCRATCH  -  T19X
...
// ACR:hal:LOCK_FALCON_REG_SPACE_VIA_DECODE_TRAP_COMMON  -  T19X
static LW_INLINE ACR_STATUS acrLockFalconRegSpaceViaDecodeTrapCommon_STUB(void)
{
    return ACR_OK;
}

// ACR:hal:COPY_LS_GRP_SIG_TO_REGS_FOR_SEC2  -  T19X

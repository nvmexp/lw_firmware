...
// ACRLIB:hal:SELWRE_RESET_FALCON  -  GP100
...
// ACRLIB:hal:SETUP_SEC2_REGISTERS  -  GP100
...
// ACRLIB:hal:SHOULD_BOOTSTRAP_FALCON  -  GP100
static LW_INLINE LwBool acrlibShouldBootstrapFalcon_STUB(
    LwU32         arg1
)
{
    return LW_FALSE;
...
#define acrlibSelwreResetFalcon_HAL(_pAcrlib, _arg0)  \
        acrlibSelwreResetFalcon_STUB((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )
...
#define acrlibProgramDmaBase_HAL(_pAcrlib, _arg0, _arg1)  \
        acrlibProgramDmaBase_GP100((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ , _arg1)
#define acrlibGetLwenc2Config_HAL(_pAcrlib, _arg0)  \
        acrlibGetLwenc2Config_GP100((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )
#define acrlibInitializeStackCfg_HAL(_pAcrlib, _arg0, _arg1)  \
        acrlibInitializeStackCfg_GP100((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ , _arg1)
#define acrlibSetupSec2Registers_HAL(_pAcrlib, _arg0)  \
        acrlibSetupSec2Registers_STUB((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )
#define acrlibShouldBootstrapFalcon_HAL(_pAcrlib, _arg0)  \
        acrlibShouldBootstrapFalcon_STUB((_arg0) + (_pAcrlib - _pAcrlib) /* avoid unused warning */ )

//
// hal function prototype defines for direct hal calls.
//

AcrlibIsBootstrapOwner             acrlibIsBootstrapOwner_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibIsBootstrapOwner_GM200");
AcrlibFindRegMapping               acrlibFindRegMapping_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFindRegMapping_GM200");
AcrlibFlcnRegLabelWrite            acrlibFlcnRegLabelWrite_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegLabelWrite_GM200");
AcrlibFlcnRegLabelRead             acrlibFlcnRegLabelRead_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegLabelRead_GM200");
AcrlibFlcnRegRead                  acrlibFlcnRegRead_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegRead_GM200");
AcrlibFlcnRegWrite                 acrlibFlcnRegWrite_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFlcnRegWrite_GM200");
AcrlibGetFalconConfig              acrlibGetFalconConfig_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibGetFalconConfig_GM200");
AcrlibPollForScrubbing             acrlibPollForScrubbing_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibPollForScrubbing_GM200");
AcrlibIsFalconHalted               acrlibIsFalconHalted_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibIsFalconHalted_GM200");
AcrlibSetupTargetRegisters         acrlibSetupTargetRegisters_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupTargetRegisters_GM200");
AcrlibGetLwrrentTimeNs             acrlibGetLwrrentTimeNs_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibGetLwrrentTimeNs_GM200");
AcrlibGetElapsedTimeNs             acrlibGetElapsedTimeNs_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibGetElapsedTimeNs_GM200");
AcrlibCheckTimeout                 acrlibCheckTimeout_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibCheckTimeout_GM200");
AcrlibSetupCtxDma                  acrlibSetupCtxDma_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupCtxDma_GM200");
AcrlibAllowVirtualFbAccess         acrlibAllowVirtualFbAccess_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibAllowVirtualFbAccess_GM200");
AcrlibIssueTargetFalconDma         acrlibIssueTargetFalconDma_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibIssueTargetFalconDma_GM200");
AcrlibResetFalcon                  acrlibResetFalcon_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibResetFalcon_GM200");
static AcrlibSelwreResetFalcon     acrlibSelwreResetFalcon_STUB   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibSelwreResetFalcon_STUB");
AcrlibFindFarthestImemBl           acrlibFindFarthestImemBl_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFindFarthestImemBl_GM200");
AcrlibFindTotalDmemBlocks          acrlibFindTotalDmemBlocks_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibFindTotalDmemBlocks_GM200");
AcrlibProgramRegionCfg             acrlibProgramRegionCfg_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibProgramRegionCfg_GM200");
AcrlibSetupBootvec                 acrlibSetupBootvec_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupBootvec_GM200");
AcrlibSetupDmaCtl                  acrlibSetupDmaCtl_GM200   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupDmaCtl_GM200");
AcrlibProgramDmaBase               acrlibProgramDmaBase_GP100   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibProgramDmaBase_GP100");
AcrlibGetLwenc2Config              acrlibGetLwenc2Config_GP100   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibGetLwenc2Config_GP100");
AcrlibInitializeStackCfg           acrlibInitializeStackCfg_GP100   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibInitializeStackCfg_GP100");
static AcrlibSetupSec2Registers    acrlibSetupSec2Registers_STUB   // GP100
                                       GCC_ATTRIB_SECTION("imem_acr", "acrlibSetupSec2Registers_STUB");
static AcrlibShouldBootstrapFalcon   acrlibShouldBootstrapFalcon_STUB   // GP100

...
AcrlibSetupCtxDma                  acrlibSetupCtxDma_GM200 
...
#if defined(ACRCFG_HAL_SETUP_GV11B)

static void     acrlibHalIfacesSetup_GV11B(ACRLIB_HAL_IFACES *) 
                    GCC_ATTRIB_SECTION("imem_acr", "acrlibHalIfacesSetup_GV11B");

static void acrlibHalIfacesSetup_GV11B(ACRLIB_HAL_IFACES *pAcrlibHal)
{

    // GV11B's ACRLIB hal interface function pointer block
    static const ACRLIB_HAL_IFACES acrlibHalIfacesInitStruct_GV11B =
    {

        0 // avoid empty typedef
    };  // acrlibHalIfacesInitStruct_GV11B

    // init GV11B's ACRLIB function ptrs using the init struct above
    *pAcrlibHal = acrlibHalIfacesInitStruct_GV11B;
}

#endif  // GV11X or GV11B

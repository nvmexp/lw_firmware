...
#define ACRCFG_HAL_SETUP_T19X   1   // All enabled T19X gpus
#define ACRCFG_HAL_SUPPORT_T19X 1   // not required, but keeps us honest
...
#if (ACRCFG_CHIP_ENABLED(T19X))

ACR_STATUS
registerHalModule_T19X(void)
{
    return ACR_OK;
}
#endif

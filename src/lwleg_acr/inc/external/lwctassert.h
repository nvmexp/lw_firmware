 ...
 */
#ifndef LW_CTASSERT_H
#define LW_CTASSERT_H
...
#  define has_extension has_feature // Compatibility with Clang pre-3.0 compilers.
# endif
# define CLANG_C_STATIC_ASSERT has_extension(c_static_assert)
#else
# define CLANG_C_STATIC_ASSERT 0
 ...
 // ISO C11 defines the _Static_assert keyword
# define ct_assert(b)  _Static_assert((b), "Compile time assertion failed: "#b)
# define ct_assert_i(b,line)  _Static_assert((b), "Compile time assertion failed: "#b#line)
#elif (defined(__cplusplus) && __cplusplus >= 201103L)
 // ISO C++11 defines the static_assert keyword
# define ct_assert(b)  static_assert((b), "Compile time assertion failed: "#b)
# define ct_assert_i(b,line)  static_assert((b), "Compile time assertion failed: "#b#line)
#else

...
#define {{$XXCFG}}_CHIP_ENABLED(CHIP)       ({{$XXCFG}}_CHIP_##CHIP        + {{$XXCFG}}_vet(_CHIP_ ## CHIP))
#define {{$XXCFG}}_FEATURE_ENABLED(FEATURE) ({{$XXCFG}}_FEATURE_##FEATURE  + {{$XXCFG}}_vet(_FEATURE_ ## FEATURE))
#define {{$XXCFG}}_ENGINE_ENABLED(ENGINE)   ({{$XXCFG}}_ENGINE_##ENGINE    + {{$XXCFG}}_vet(_ENGINE_ ## ENGINE))
#define {{$XXCFG}}_CLASS_ENABLED(CLSS)      ({{$XXCFG}}_CLASS_##CLSS       + {{$XXCFG}}_vet(_CLASS_ ## CLSS))
#define {{$XXCFG}}_API_ENABLED(API)         ({{$XXCFG}}_API_##API          + {{$XXCFG}}_vet(_API_ ## API))
